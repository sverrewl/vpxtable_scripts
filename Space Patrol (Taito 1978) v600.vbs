...
' Space Patrol - Taito do Brasil 1978 - version 5.5.0
' ****************************************************************
' DOF config - Foxyt
...
' Valores Constants
Const TableName = "SpacePatrol"
Const cGameName = "SpacePatrol"
Const MaxPlayers = 4    ' de 1 a 4
Const MaxMultiplier = 2 ' limita el bonus multiplicador a 5
Const Special1 = 680000 ' puntuación a obtener para partida extra
Const Special2 = 830000 ' puntuación a obtener para partida extra
Const Special3 = 980000 ' puntuación a obtener para partida extra
...
Sub Table1_KeyDown(ByVal Keycode)
    ...
    If bGameInPlay AND NOT Tilted Then
        ' teclas de la falta
        If keycode = LeftTiltKey Then Nudge 90, 8:PlaySound SoundFX("fx_nudge", 0), 0, 1, -0.1, 0.25:CheckTilt
        If keycode = RightTiltKey Then Nudge 270, 8:PlaySound SoundFX("fx_nudge", 0), 0, 1, 0.1, 0.25:CheckTilt
        If keycode = CenterTiltKey Then Nudge 0, 9:PlaySound SoundFX("fx_nudge", 0), 0, 1, 1, 0.25:CheckTilt
...
Sub CreateNewBall()
    ...
    ' y expulsa la bola
    PlaySoundAt SoundFXDOF("fx_Ballrel", 140, DOFPulse, DOFContactors), BallRelease
...
Sub UpdateBonusLights 'enciende o apaga las luces de los bonos según la variable "Bonus"
    Select Case Bonus
        Case 0:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 0
        Case 1:li22.State = 1:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 0
        Case 2:li22.State = 0:li23.State = 1:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 0
        Case 3:li22.State = 0:li23.State = 0:li24.State = 1:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 0
        Case 4:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 1:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 0
        Case 5:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 1:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 0
        Case 6:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 1:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 0
        Case 7:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 1:li29.State = 0:li30.State = 0:li31.State = 0
        Case 8:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 1:li30.State = 0:li31.State = 0
        Case 9:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 1:li31.State = 0
        Case 10:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 1
        Case 11:li22.State = 1:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 1
        Case 12:li22.State = 0:li23.State = 1:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 1
        Case 13:li22.State = 0:li23.State = 0:li24.State = 1:li25.State = 0:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 1
        Case 14:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 1:li26.State = 0:li27.State = 0:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 1
        Case 15:li22.State = 0:li23.State = 0:li24.State = 0:li25.State = 0:li26.State = 0:li27.State = 1:li28.State = 0:li29.State = 0:li30.State = 0:li31.State = 1
...
Sub CheckHighscore
    For x = 1 to PlayersPlayingGame
        If Score(x)> Highscore Then
            Highscore = Score(x)
            PlaySound SoundFXDOF("fx_knocker", 132, DOFPulse, DOFKnocker)
            DOF 117, DOFPulse
            'HighscoreReel.SetValue Highscore
            AddCredits 1
        End If
...
Sub Trigger3_Hit
    ...
    PlaySound "RCA8"
    AddScore 1000
    If li33.State Then AddBonus 1
End Sub

'******************************
'     PATROL lanes & targets
'******************************

'lanes

Sub Trigger13_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger13
    DOF 211, DOFPulse
    If Tilted Then Exit Sub
    PlaySound "RCA5"
    Addscore 500
...
Sub Trigger14_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger14
    DOF 212, DOFPulse
    If Tilted Then Exit Sub
    PlaySound "RCA5"
    Addscore 500
...
Sub Trigger15_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger15
    DOF 213, DOFPulse
    If Tilted Then Exit Sub
    PlaySound "RCA5"
    Addscore 500
...
Sub Trigger16_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger16
    DOF 214, DOFPulse
    If Tilted Then Exit Sub
    PlaySound "RCA5"
    Addscore 500
...
'targets
Sub Target8_hit
    PlaySoundAtBall SoundFXDOF("fx_target", 107, DOFPulse, DOFDropTargets)
    DOF 220, DOFPulse
    If Tilted Then Exit Sub
    PlaySound "RCA9"
    Addscore 1000
...
Sub Target5_hit
    PlaySoundAtBall SoundFXDOF("fx_target", 108, DOFPulse, DOFDropTargets)
    DOF 219, DOFPulse
    If Tilted Then Exit Sub
    PlaySound "RCA9"
    Addscore 1000
...
'******************************
'   SPACE triggers & targets
'******************************

'triggers

Sub Trigger12_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger12
    If li55.State Then
    Else DOF 211, DOFPulse
    End If
    If Tilted Then Exit Sub
    PlaySound "RCA15"
    Addscore 500
...
Sub Trigger11_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger11
    If li54.State Then
    Else DOF 212, DOFPulse
    End If
    If Tilted Then Exit Sub
    PlaySound "RCA15"
    Addscore 500
...
Sub Trigger10_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger10
    If li53.State Then
    Else DOF 210, DOFPulse
    End If
    If Tilted Then Exit Sub
    PlaySound "RCA15"
    Addscore 500
...
Sub Trigger9_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger9
    If li52.State Then
    Else DOF 213, DOFPulse
    End If
    If Tilted Then Exit Sub
    PlaySound "RCA15"
    Addscore 500
...
Sub Trigger8_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger8
    If li51.State Then
    Else DOF 214, DOFPulse
    End If
    If Tilted Then Exit Sub
    PlaySound "RCA15"
    Addscore 500
...
Sub Target7_hit
    PlaySoundAtBall SoundFXDOF("fx_target", 110, DOFPulse, DOFDropTargets)
    If Tilted Then Exit Sub
    If li46.State Then
        Addscore 5000
        Addbonus 1
...
Sub Target6_hit
    ...
    If Tilted Then Exit Sub
    PlaySound "Sino"
    Addscore 1000 + 1000 * (li39.State + li38.State + li37.State + li36.State + li35.State + li34.State)
    If li3.State Then
        AwardExtraBall
    End If
    If li4.State Then
...
'**************************
' Extra ball & DoubleBonus
'**************************

'PATROL lights lit Double Bonus
'PATROL + SPACE lights lit Extra Ball

Sub CheckSpecials
    If li39.State + li38.State + li37.State + li36.State + li35.State + li34.State = 6 Then li4.State = 1
    If li39.State + li38.State + li37.State + li36.State + li35.State + li34.State + li46.State + li45.State + li44.State + li43.State + li43.State = 11 Then li3.State = 1
End Sub
