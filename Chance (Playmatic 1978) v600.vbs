...
' VPX8 - version by JPSalas 2024, version 6.0.0. Graphics by Pedator
' vpinmame script from destruks & TAB table:
...
Sub Table1_Init
    With Controller
        ...
        .SplashInfoLine = "Chance, Playmatic 1978" & vbnewline & "Table by jpsalas v5.5.0"
...
'Bumpers
Sub bumper1_Hit:vpmTimer.PulseSw 37:PlaySoundAt SoundFXDOF("fx_Bumper",105,DOFPulse,DOFContactors), bumper1:End Sub
Sub bumper2_Hit:vpmTimer.PulseSw 26:PlaySoundAt SoundFXDOF("fx_Bumper",106,DOFPulse,DOFContactors), bumper2:End Sub
Sub bumper3_Hit:vpmTimer.PulseSw 26:PlaySoundAt SoundFXDOF("fx_Bumper",107,DOFPulse,DOFContactors), bumper3:End Sub
...
Sub aTargets_Hit(idx):ActiveBall.VelZ = BallVel(Activeball):End Sub
...
Dim TableWidth, TableHeight, TableGlassHitHeight

TableWidth = Table1.width
TableHeight = Table1.height
TableGlassHitHeight = Table1.GlassHeight - 25
...
Sub RollingUpdate()
    ...
    For b = lob to UBound(BOT)
        ...
        'Glass Hit
        If BOT(b).Z > TableGlassHitHeight Then
            PLaySoundAtBall"fx_Glass_Hit"
        End If
