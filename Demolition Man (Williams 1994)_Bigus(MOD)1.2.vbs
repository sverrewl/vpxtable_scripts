...
Const UseVPMModSol = 1
 ...
 '***ROM***ROM***ROM***ROM***
 Const cGameName = "dm_lx4" ' use dm_h6 for profanity
'***************************
...
'**********
 ...
 Sub table1_KeyDown(ByVal Keycode)
  ...
  If KeyCode = RightFlipperKey then FastFlips.FlipR True' :  FastFlips.FlipUR True
    ...
    If keycode = RightMagnaSave Then Controller.Switch(11) = 1: Controller.Switch(12) = 1
 ...
 Sub table1_KeyUp(ByVal Keycode)
  ...
  If KeyCode = RightFlipperKey then FastFlips.FlipR False' :  FastFlips.FlipUR False
    If keycode = LockBarKey Then Controller.Switch(11) = 0: Controller.Switch(12) = 0
     If keycode = RightMagnaSave Then Controller.Switch(11) = 0: Controller.Switch(12) = 0
