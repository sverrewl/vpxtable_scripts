' Flip Flop / IPD No. 889 / January, 1976 / 4 Players
' Bally Manufacturing Corporation (1931-1983) [Trade Name: Bally]
' VPX8 table by jpsalas & Halen v6.0.0
...
'110
'111
'112 Beacon - when all 4 Cards are Flipped
'113 Kicker Left
'114 Kicker Right
'115
'116
...
'119
'120 Ball Release
'121 Bell - Rings 3 thimes when all card are Flipped
'122 Knocker
'123 Credits
'124 Drain_Hit
'131 Chime
...
' Valores Constants
Const TableName = "FlipFlop" ' file name to save highscores and other variables
Const cGameName = "FlipFlop" ' B2S name
Const MaxPlayers = 4         ' 1 to 4 can play
Const MaxMultiplier = 2      ' limit bonus multiplier
Const FreePlay = False       ' Free play or coins
Const Special1 = 136000      ' extra ball or credit
Const Special2 = 158000
Const Special3 = 197000
...
Sub Table1_Init()
    ...
    Credits = 0
    Loadhs
    ScoreReel001.SetValue HSScore(1)
    If B2SOn then
...
Sub BonusCountTimer_Timer
    ...
    If Bonus MOD 2 = 0 Then
        BonusCountTimer.Interval = 300 + 50 * BonusMultiplier
    Else
        BonusCountTimer.Interval = 100 + 50 * BonusMultiplier
    End If
    If Bonus > 0 Then
        Bonus = Bonus -1
...
Sub UpdateBonusLights
    Select Case Bonus
        Case 0, 10:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0
        Case 1, 11:bl1.State = 1:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0
        Case 2, 12:bl1.State = 0:bl2.State = 1:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0
        Case 3, 13:bl1.State = 0:bl2.State = 0:bl3.State = 1:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0
        Case 4, 14:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 1:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0
        Case 5, 15:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 1:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0
        Case 6, 16:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 1:bl7.State = 0:bl8.State = 0:bl9.State = 0
        Case 7, 17:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0
        Case 8, 18:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0
        Case 9, 19:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 1
    End Select
    If Bonus > 9 Then bl10.State = 1
End Sub
...
Sub EndOfGame()
    ...
    SolRFlipper 0
    'reset some lights
    bip1.State = 0:bip2.State = 0:bip3.State = 0:bip4.State = 0:bip5.State = 0
    pl1.State = 0:pl2.State = 0:pl3.State = 0:pl4.State = 0
    cp1.State = 0:cp2.State = 0:cp3.State = 0:cp4.State = 0
    ...
    Select Case Points
        Case 10, 100, 1000
            ...
            If Points = 100 AND(Score(CurrentPlayer)MOD 1000) \ 100 = 0 Then  'new reel 1000
                PlaySound SoundFXDOF("fx_bell1000", 133, DOFPulse, DOFChimes)
...
Sub AddBonus(bonuspoints)
    If(Tilted = False)Then
        ...
        ' only for this table
        If Bonus = 11 Then
            If Not XtraBallLit Then
                XtraBallLit = True
                AlternateXtraBall
            End If
        End If 'bonus = 11
        If Bonus = 19 AND(NOT SpecialAwardedThisBall)Then
            If SpecialLit = False Then
                SpecialLit = True
                AlternateSpecial
            End If
        End If 'bonus = 19
...
Sub UpdateScore(playerpoints)
    Select Case CurrentPlayer
        Case 1:ScoreReel001.Addvalue playerpoints
        Case 2:ScoreReel002.Addvalue playerpoints
        Case 3:ScoreReel003.Addvalue playerpoints
        Case 4:ScoreReel004.Addvalue playerpoints
    End Select
    If B2SOn then
...
Sub ResetScores
    ScoreReel001.SetValue 1:ScoreReel001.ResetToZero
    ScoreReel002.ResetToZero
    ScoreReel003.ResetToZero
    ScoreReel004.ResetToZero
    If B2SOn then
...
Sub UpdateBallInPlay 'update backdrop lights
    ...
    End Select
    If B2SOn then
        Controller.b2ssetData 32, Balls
    End If
    ' Update player light
    Select Case CurrentPlayer
    ...
    End Select
    If B2SOn then
        Controller.b2ssetData 31, PlayersPlayingGame
    end if
End Sub
...
Sub flipper001_Animate: flip001.RotX = flipper001.CurrentAngle: End Sub
Sub flipper002_Animate: flip002.RotX = Flipper002.CurrentAngle: End Sub
Sub flipper003_Animate: flip003.RotX = Flipper003.CurrentAngle: End Sub
Sub flipper004_Animate: flip004.RotX = flipper004.CurrentAngle: End Sub
Sub kicker1f_Animate: kicker1p.RotX = kicker1f.CurrentAngle: End Sub
Sub kicker2f_Animate: kicker2p.RotX = kicker2f.CurrentAngle: End Sub
...
Sub ResetNewBallVariables() 'init variables & lights new ball/player
    ...
    TurnOffPlayfieldLights
    BonusMultiplier = 1
    If Balls = 3 Then BonusMultiplier = 2:l002.State = 1
    If Balls = 5 Then BonusMultiplier = 2:l002.State = 1
...
Sub TurnOffPlayfieldLights()
    ...
    Next
    If B2SOn then
controller.b2ssetData 36,0 'shoot again
End If
End Sub
...
Sub sw11_Hit 'left special
    PlaySoundAt "fx_sensor", sw11
    If NOT Tilted Then
        AddScore 500
        If l021.State Then AwardSpecial:l021.State = 0:SpecialLit = False:SpecialAwardedThisBall = True
        If SpecialLit Then AlternateSpecial
        If XtraBallLit Then AlternateXtraBall
    End If
End Sub

Sub sw12_Hit 'right special
    PlaySoundAt "fx_sensor", sw12
    If NOT Tilted Then
        AddScore 500
        If l022.State Then AwardSpecial:l022.State = 0:SpecialLit = False:SpecialAwardedThisBall = True
        If SpecialLit Then AlternateSpecial
        If XtraBallLit Then AlternateXtraBall
    End If
End Sub
...
Sub kicker1_Hit
    ...
    If NOT Tilted Then
        AddScore 500
        If l023.State Then AwardExtraBall::XtraBallLit = False:l023.State = 0
        If SpecialLit Then AlternateSpecial
        If XtraBallLit Then AlternateXtraBall
    End If
   vpmTimer.AddTimer 1500, "PlaySoundAt SoundFXDOF(""fx_kicker"",113,DOFPulse,DOFContactors), kicker1:kicker1.Kick 137, 12 + RndNbr(3):kicker1f.RotatetoEnd '"
    vpmTimer.AddTimer 2000, "kicker1f.RotatetoStart '"
End Sub
...
Sub kicker2_Hit
    ...
    If NOT Tilted Then
        AddScore 500
        If l024.State Then AwardExtraBall:XtraBallLit = False:l024.State = 0
        If SpecialLit Then AlternateSpecial
        If XtraBallLit Then AlternateXtraBall
    End If
    vpmTimer.AddTimer 1500, "PlaySoundAt SoundFXDOF(""fx_kicker"",114,DOFPulse,DOFContactors), kicker2:kicker2.Kick 223, 12 + RndNbr(3):kicker2f.RotatetoEnd '"
    vpmTimer.AddTimer 2000, "kicker2f.RotatetoStart '"
End Sub

' 10 point rebounds

Sub rsband007_Hit:AddScore 10:End Sub
Sub rsband008_Hit:AddScore 10:End Sub
Sub rsband009_Hit:AddScore 10:End Sub
Sub rsband010_Hit:AddScore 10:End Sub
...
Sub t5_Hit
    ...
    t5p.Z = 10
    vpmTimer.AddTimer 100, "t5p.Z = 0 '"
    If NOT Tilted Then
        AddScore 500
        If l014.State Then AddBonus 4:ResetFlips
    End If
End Sub
...
Sub t6_Hit
    PlaySoundAtBall "fx_passive_bumper"
    t6p.Z = 10
    vpmTimer.AddTimer 100, "t6p.Z = 0 '"
    If NOT Tilted Then
        AddScore 500
        If l013.State Then AddBonus 4:ResetFlips
    End If
End Sub
...
Sub Flip1
    PlaySoundAt SoundFXDOF("fx_diverter",140,DOFPulse,DOFContactors), flip001
    Flipper001.RotatetoEnd
    pin001.IsDropped = 0
    pin005.IsDropped = 0
    f1 = 1:CheckFlips
    vpmTimer.AddTimer 500, "PlaySoundAt""fx_spinner"", flip001:pin001.IsDropped = 1:pin005.IsDropped = 1 '"
End Sub

Sub Flop1
    PlaySoundAt SoundFXDOF("fx_diverter",141,DOFPulse,DOFContactors), flip001
...
Sub Flip2
    PlaySoundAt SoundFXDOF("fx_diverter",142,DOFPulse,DOFContactors), flip002
    Flipper002.RotatetoEnd
    pin002.IsDropped = 0
    pin006.IsDropped = 0
    f2 = 1:CheckFlips
    vpmTimer.AddTimer 500, "PlaySoundAt""fx_spinner"", flip002:pin002.IsDropped = 1:pin006.IsDropped = 1 '"
End Sub

Sub Flop2
    PlaySoundAt SoundFXDOF("fx_diverter",143,DOFPulse,DOFContactors), flip002
...
Sub Flip3
    PlaySoundAt SoundFXDOF("fx_diverter",144,DOFPulse,DOFContactors), flip003
    Flipper003.RotatetoEnd
    pin003.IsDropped = 0
    pin007.IsDropped = 0
    f3 = 1:CheckFlips
    vpmTimer.AddTimer 500, "PlaySoundAt""fx_spinner"", flip003:pin003.IsDropped = 1:pin007.IsDropped = 1 '"
End Sub

Sub Flop3
    PlaySoundAt SoundFXDOF("fx_diverter",145,DOFPulse,DOFContactors), flip003
...
Sub Flip4
    PlaySoundAt SoundFXDOF("fx_diverter",146,DOFPulse,DOFContactors), flip004
    Flipper004.RotatetoEnd
    pin004.IsDropped = 0
    pin008.IsDropped = 0
    f4 = 1:CheckFlips
    vpmTimer.AddTimer 500, "PlaySoundAt""fx_spinner"", flip004:pin004.IsDropped = 1:pin008.IsDropped = 1 '"
End Sub

Sub Flop4
    PlaySoundAt SoundFXDOF("fx_diverter",147,DOFPulse,DOFContactors), flip004
...
Sub ResetFlips
    vpmTimer.AddTimer 100, "Flop1 '"
    vpmTimer.AddTimer 200, "Flop2 '"
    vpmTimer.AddTimer 300, "Flop3 '"
    vpmTimer.AddTimer 400, "Flop4 '"
    f1 = 0
    f2 = 0
    f3 = 0
    f4 = 0
...
' Alternate Special/Extra ball Lights

Sub AlternateSpecial
    Sp = ABS(Sp -1)
    If Sp Then
        l021.State = 1
        l022.State = 0
