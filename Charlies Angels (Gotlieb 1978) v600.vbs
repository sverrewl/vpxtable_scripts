...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Charlie's Angels - Gottlieb 1978" & vbNewLine & "VPX table by JPSalas v.5.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub LeftSlingShot_Slingshot
    PlaySoundAt SoundFXDOF("fx_slingshot", 207, DOFPulse, DOFContactors), Lemk
...
Sub RightSlingShot_Slingshot
    PlaySoundAt SoundFXDOF("fx_slingshot", 208, DOFPulse, DOFContactors), Remk
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 50:PlaySoundAt SoundFXDOF("fx_bumper", 206, DOFPulse, DOFContactors), Bumper1:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 50:PlaySoundAt SoundFXDOF("fx_bumper", 205, DOFPulse, DOFContactors), Bumper2:End Sub

' Drain & Saucers
Sub Drain_Hit:PlaysoundAt "fx_drain", Drain:bsTrough.AddBall Me:End Sub

' Rollovers
Sub sw14_Hit:Controller.Switch(14) = 1:PlaySoundAt "fx_sensor", sw14:DOF 203, DOFOn:End Sub
Sub sw14_UnHit:Controller.Switch(14) = 0:DOF 203, DOFOff:End Sub

Sub sw14a_Hit:Controller.Switch(14) = 1:PlaySoundAt "fx_sensor", sw14a:DOF 204, DOFOn:End Sub
...
Sub sw40_Hit:Controller.Switch(40) = 1:PlaySoundAt "fx_sensor", sw40:DOF 201, DOFOn:End Sub
Sub sw40_UnHit:Controller.Switch(40) = 0:DOF 201, DOFOff:End Sub

Sub sw40a_Hit:Controller.Switch(40) = 1:PlaySoundAt "fx_sensor", sw40a:DOF 202, DOFOn:End Sub
...
Sub UpdateLamps()
    'backdrop lights
        Lampm 1, li1a                  'Ball in play
        Lamp 2, li2                    'Tilt
        Lamp 3, li3                    'High Game to date
        Lampm 4, li4a                  'Same Player Shoots Again
