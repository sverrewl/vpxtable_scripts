...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 50:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper1, VolBump::PlaySFX("bumper1")End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 50:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper2, VolBump::PlaySFX("bumper2")End Sub

' Drain & Saucers
Sub Drain_Hit:PlaysoundAtVol "fx_drain",drain, 1:bsTrough.AddBall Me:End Sub

' Rollovers
Sub sw14_Hit:PlaySFX("LOL"):Controller.Switch(14) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw14_UnHit:Controller.Switch(14) = 0:End Sub

Sub sw14a_Hit:PlaySFX("ROL"):Controller.Switch(14) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw14a_UnHit:Controller.Switch(14) = 0:End Sub

Sub sw13_Hit:PlaySFX("LIL"):Controller.Switch(13) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw13_UnHit:Controller.Switch(13) = 0:End Sub

Sub sw43_Hit:PlaySFX("RIL"):Controller.Switch(43) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw43_UnHit:Controller.Switch(43) = 0:End Sub

Sub sw40_Hit:PlaySFX("TRO1"):Controller.Switch(40) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw40_UnHit:Controller.Switch(40) = 0:End Sub

Sub sw40a_Hit:PlaySFX("TRO4"):Controller.Switch(40) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw40a_UnHit:Controller.Switch(40) = 0:End Sub

Sub sw41_Hit:PlaySFX("TRO2"):Controller.Switch(41) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw41_UnHit:Controller.Switch(41) = 0:End Sub

Sub sw42_Hit:PlaySFX("TRO3"):Controller.Switch(42) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw42_UnHit:Controller.Switch(42) = 0:End Sub

Sub sw20_Hit:Controller.Switch(20) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:PlaySFX("star"):End Sub
Sub sw20_UnHit:Controller.Switch(20) = 0:End Sub

Sub sw21_Hit:Controller.Switch(21) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:PlaySFX("star"):End Sub
Sub sw21_UnHit:Controller.Switch(21) = 0:End Sub

Sub sw22_Hit:Controller.Switch(22) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:PlaySFX("star"):End Sub
Sub sw22_UnHit:Controller.Switch(22) = 0:End Sub

Sub sw23_Hit:Controller.Switch(23) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:PlaySFX("star"):End Sub
Sub sw23_UnHit:Controller.Switch(23) = 0:End Sub

Sub sw24_Hit:Controller.Switch(24) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:PlaySFX("star"):End Sub
...
Sub sw30_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("redDrop"):End Sub
Sub sw31_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("redDrop"):End Sub
Sub sw32_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("redDrop"):End Sub
Sub sw33_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("redDrop"):End Sub
Sub sw34_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("redDrop"):End Sub

Sub sw10_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("whiteDrop"):End Sub
Sub sw11_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("whiteDrop"):End Sub
Sub sw12_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall, 1:PlaySFX("whiteDrop"):End Sub
