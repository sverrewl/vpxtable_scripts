...
Sub table1_KeyDown(ByVal Keycode)
    If keycode = LeftTiltKey Then Nudge 90, 1:PlaySound SoundFX("fx_nudge", 0), 0, 1, -0.1, 0.25
    If keycode = RightTiltKey Then Nudge 270, 1:PlaySound SoundFX("fx_nudge", 0), 0, 1, 0.1, 0.25
	...
	If keycode=AddCreditKey then Playsound "fx_coin": vpmTimer.pulseSW (swCoin1): If SFXon=true then PlaySound "swell_01":End if
End Sub
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 50:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0::PlaySFX("bumper1")End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 50:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0::PlaySFX("bumper2")End Sub

' Drain & Saucers
Sub Drain_Hit:Playsound "fx_drain":bsTrough.AddBall Me:End Sub

' Rollovers
Sub sw14_Hit:PlaySFX("LOL"):Controller.Switch(14) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw14_UnHit:Controller.Switch(14) = 0:End Sub

Sub sw14a_Hit:PlaySFX("ROL"):Controller.Switch(14) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw14a_UnHit:Controller.Switch(14) = 0:End Sub

Sub sw13_Hit:PlaySFX("LIL"):Controller.Switch(13) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw13_UnHit:Controller.Switch(13) = 0:End Sub

Sub sw43_Hit:PlaySFX("RIL"):Controller.Switch(43) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw43_UnHit:Controller.Switch(43) = 0:End Sub

Sub sw40_Hit:PlaySFX("TRO1"):Controller.Switch(40) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw40_UnHit:Controller.Switch(40) = 0:End Sub

Sub sw40a_Hit:PlaySFX("TRO4"):Controller.Switch(40) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw40a_UnHit:Controller.Switch(40) = 0:End Sub

Sub sw41_Hit:PlaySFX("TRO2"):Controller.Switch(41) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw41_UnHit:Controller.Switch(41) = 0:End Sub

Sub sw42_Hit:PlaySFX("TRO3"):Controller.Switch(42) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):End Sub
Sub sw42_UnHit:Controller.Switch(42) = 0:End Sub

Sub sw20_Hit:Controller.Switch(20) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):PlaySFX("star"):End Sub
Sub sw20_UnHit:Controller.Switch(20) = 0:End Sub

Sub sw21_Hit:Controller.Switch(21) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):PlaySFX("star"):End Sub
Sub sw21_UnHit:Controller.Switch(21) = 0:End Sub

Sub sw22_Hit:Controller.Switch(22) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):PlaySFX("star"):End Sub
Sub sw22_UnHit:Controller.Switch(22) = 0:End Sub

Sub sw23_Hit:Controller.Switch(23) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):PlaySFX("star"):End Sub
Sub sw23_UnHit:Controller.Switch(23) = 0:End Sub

Sub sw24_Hit:Controller.Switch(24) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):PlaySFX("star"):End Sub
...
Sub sw30_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("redDrop"):End Sub
Sub sw31_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("redDrop"):End Sub
Sub sw32_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("redDrop"):End Sub
Sub sw33_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("redDrop"):End Sub
Sub sw34_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("redDrop"):End Sub

Sub sw10_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("whiteDrop"):End Sub
Sub sw11_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("whiteDrop"):End Sub
Sub sw12_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):PlaySFX("whiteDrop"):End Sub
...
sfxRestartDelay(3) = 150 'Top Rollover 3
sfxRestartDelay(4) = 150 'Top Rollover 4
sfxRestartDelay(5) = 75 'Car Lane
sfxRestartDelay(6) = 125 'Left Inlane
sfxRestartDelay(7) = 50 'Right Inlane
...
Dim DrainPause
Const DrainPauseDelay=85
Dim GoodLuckPause
Const GoodLuckPauseDelay=25
