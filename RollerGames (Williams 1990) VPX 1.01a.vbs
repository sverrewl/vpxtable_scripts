...
' Bumpers
Sub Bumper1B_Hit:vpmTimer.PulseSw 35:PlaySoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper1B,VolBump:End Sub
Sub Bumper2B_Hit:vpmTimer.PulseSw 36:PlaySoundAtVol SoundFX("fx_bumper2",DOFContactors),Bumper2B,VolBump:End Sub
Sub Bumper3B_Hit:vpmTimer.PulseSw 37:PlaySoundAtVol SoundFX("fx_bumper3",DOFContactors),Bumper3B,VolBump:End Sub
...
Sub sw18_Hit:Controller.Switch(18) = 1:PlaySoundAtVol "fx_sensor", sw18, 1:End Sub
Sub sw18_UnHit:Controller.Switch(18) = 0:End Sub

Sub sw19_Hit:Controller.Switch(19) = 1:PlaySoundAtVol "fx_sensor", sw19, 1:End Sub
...
Sub sw25_Hit:vpmTimer.PulseSw 25:PlaySoundAtVol "fx_postrubber", sw25,VolPo:End Sub
Sub sw26_Hit:vpmTimer.PulseSw 26:PlaySoundAtVol "fx_postrubber", sw26,VolPo:End Sub
Sub sw27_Hit:vpmTimer.PulseSw 27:PlaySoundAtVol "fx_postrubber", sw27,VolPo:End Sub
Sub sw28_Hit:vpmTimer.PulseSw 28:PlaySoundAtVol "fx_postrubber", sw28,VolPo:End Sub
Sub sw29_Hit:vpmTimer.PulseSw 29:PlaySoundAtVol "fx_postrubber", sw29,VolPo:End Sub
...
Sub sw30_Hit:vpmTimer.PulseSw 30:PlaySoundAtVol "fx_postrubber", sw30,VolPo:End Sub
Sub sw31_Hit:vpmTimer.PulseSw 31:PlaySoundAtVol "fx_postrubber", sw31,VolPo:End Sub
Sub sw32_Hit:vpmTimer.PulseSw 32:PlaySoundAtVol "fx_postrubber", sw32,VolPo:End Sub
...
Sub sw56_Hit:Controller.Switch(56) = 1:PlaySoundAtVol "fx_sensor", sw56,1:End Sub
