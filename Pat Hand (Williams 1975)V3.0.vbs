' ******************************************************************
'    VPX 10.8 - version by Klodo81 2023, Pat Hand version 3.0
'
'                     Based on:
...
Sub LeftFlipper2_Animate:LeftFlipperTop2.Rotz = LeftFlipper2.CurrentAngle:End Sub
...
Sub AddScore(Points)
    ...
    Select Case Points
      ...
      If Score(CurrentPlayer) + Points > 99999 Then Exit Sub
...
Sub CheckCards()
  ...
  Case 0 :
    If LTAce.State = 0 And LTJack.State = 0 And LTQueen.State = 0 And LTKing.State = 0 And LT10.State = 0 Then
      ...
      LightBumper1.State = 1 : LightBumper2.State = 1
      CardsRun = 1
    End If
  Case 1 :
    If LTAce.State = 0 And LTJack.State = 0 And LTQueen.State = 0 And LTKing.State = 0 And LT10.State = 0 Then
