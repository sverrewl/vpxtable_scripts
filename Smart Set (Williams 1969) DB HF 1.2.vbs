...
sub bumper1_hit
    if tilt=false then playsound SoundFXDOF("jet1",107,DOFPulse,DOFContactors)
	DOF 108,DOFPulse
    if BumperLight1.state=1 then addscore 10 else addscore 1
end sub

sub bumper2_hit
    if tilt=false then playsound SoundFXDOF("jet1",113,DOFPulse,DOFContactors)
	DOF 114,DOFPulse
    if BumperLight2.state=1 then addscore 10 else addscore 1
end sub

sub bumper3_hit
    if tilt=false then playsound SoundFXDOF("jet1",109,DOFPulse,DOFContactors)
	DOF 110,DOFPulse
    if BumperLight3.state=1 then addscore 10 else addscore 1
end sub

sub bumper4_hit
    if tilt=false then playsound SoundFXDOF("jet1",111,DOFPulse,DOFContactors)
	DOF 112,DOFPulse
