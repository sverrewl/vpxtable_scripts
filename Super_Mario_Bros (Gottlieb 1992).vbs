...
Sub SaveLUT
  ...
  Set ScoreFile=FileObj.CreateTextFile(UserDirectory & "SuperMarioBrothersLUT.txt",True)
...
Sub LoadLUT
  ...
  If Not FileObj.FolderExists(UserDirectory) then
    ...
    Exit Sub
  End if
  If Not FileObj.FileExists(UserDirectory & "SuperMarioBrothersLUT.txt") then
    LUTset=0
    Exit Sub
  End if
  Set ScoreFile=FileObj.GetFile(UserDirectory & "SuperMarioBrothersLUT.txt")
...
' SolCallback(5) = ""                 '5 - Right Slingshot
  ...
  SolCallback(17) = "Flash1"          '17 - Left Ramp Flash
  SolCallback(18) = "Flash2"          '18 - Right Ramp Flash
  SolCallback(19) = "SetLamp 159,"          '19 - Mario Cave Flash (x2)
  SolCallback(20) = "Flash10"         '20 - Castle Flash (x2)
  SolCallback(21) = "Flash6"          '21 - Bottom Left Flash
    SolCallback(22) = "Flash7"          '22 - Upper Left Flash
  SolCallback(23) = "Flash4"          '23 - Upper Center Flash (x2)
  SolCallback(24) = "Flash3"          '24 - Upper Right Flash (x2)
...
Sub Slot1_Hit():Controller.Switch(34) = 1:End Sub
...
Sub sw16_hit: PlaySound "Saucer_Enter_1": End Sub
...
Sub sw26_hit: PlaySound "Saucer_Enter_1": End Sub
Sub sw27_hit: vpmTimer.PulseSw 27:PlaySound "Saucer_Enter_1": End Sub
...
Playsound SoundFX("KickandWire",DOFContactors)
End If
End Sub
...
Sub BallSave(enabled) : If enabled Then PlaySound "Popper" :BallSaver.enabled = True:Else BallSaver.enabled = False:End If: End Sub
Sub BallSaver_Hit() : PlaySound "Popper" : BallSaver.kick 0,35+(rnd*20)  : BallSaver.enabled = False : End Sub
...
Sub Shooter(Enabled)
    If Enabled Then
        Plunger.Fire
    PlaySound SoundFX("Shooterlane",DOFContactors)
...
Sub SolLFlipper(Enabled)
  If Enabled Then
    LF.Fire : Flipper1.RotateToEnd 'leftflipper.rotatetoend
...
Sub Bumper1_Hit:RandomSoundBumperTop Bumper1:Me.TimerEnabled = 1:vpmTimer.PulseSw 10:Me.TimerInterval = 20:End Sub
Sub Bumper2_Hit:RandomSoundBumperMiddle Bumper2:Me.TimerEnabled = 1:vpmTimer.PulseSw 12:Me.TimerInterval = 20:End Sub
Sub Bumper3_Hit:RandomSoundBumperBottom Bumper3:Me.TimerEnabled = 1:vpmTimer.PulseSw 11:Me.TimerInterval = 20:End Sub
...
' End Sub
 ...
 Sub Flash10(Enabled)
  ...
  End If
  Sound_Flash_Relay enabled, Flasherbase10
 End Sub
...
FlasherBloomIntensity = 0.11    ' *** lower this, if the blooms are too bright (i.e. 0.1)     ***
