...
' DOF by arngrim
' VPX 10.8 - version by JPSalas 2025, version 6.0.0
...
Const bRotateSaucers = False 'change this if you want the small saucers to rotate
...
Sub Table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Attack from Mars LE" & vbNewLine & "VPX8 table by JPSalas v6.0.0"
