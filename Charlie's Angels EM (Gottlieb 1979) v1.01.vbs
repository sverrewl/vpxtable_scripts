' Charlie's Angels / IPD No. 5007 / February, 1979 / 4 Players
' D. Gottlieb & Company, a Columbia Pictures Industries Company (1977-1983)
' VPX8 table by jpsalas, 2025, version 1.0.1
...
'DOF config - (these are the codes used on the table)
'101 Left Flipper
'102 Right Flipper
'103 Left Slingshot
'104 Right Slingshot
...
'111 Red DT
'112 Red DTT
'113 reset red droptargets
'114 reset white droptargets
'115 White DT
'116 white DT
'117 white DT
'118
...
' Valores Constants
Const TableName = "CharlieAngelsEM" ' file name to save highscores and other variables
Const cGameName = "CharlieAngelsEM" ' B2S name & DOF config
Const MaxPlayers = 4                ' 1 to 4 can play
Const MaxMultiplier = 3             ' limit bonus multiplier
Const MaxBonus = 19                 ' highest bonus count
...
Sub UpdateStartup
    ...
    If B2SOn then
        ...
        Controller.B2SSetScorePlayer 2, HSScore(2)
        Controller.B2SSetScorePlayer 3, HSScore(3)
        Controller.B2SSetScorePlayer 4, HSScore(4)
        Controller.B2SSetCredits Credits
    Controller.B2SSetData 81,1 'Chr
    Controller.B2SSetData 82,1
    Controller.B2SSetData 83,1
    Controller.B2SSetData 84,1
    Controller.B2SSetCanPlay 4
    End If
  Display_Match
End Sub
...
Sub UpdateBonusLights
    Select Case Bonus
        Case 0:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 1:bl1.State = 1:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 2:bl1.State = 0:bl2.State = 1:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 3:bl1.State = 0:bl2.State = 0:bl3.State = 1:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 4:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 1:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 5:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 1:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 6:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 1:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 7:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 8:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0:bl10.State = 0:Li21.State = 0
        Case 9:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 1:bl10.State = 0:Li21.State = 0
        Case 10:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 0
        Case 11:bl1.State = 1:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 0
        Case 12:bl1.State = 0:bl2.State = 1:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 1
        Case 13:bl1.State = 0:bl2.State = 0:bl3.State = 1:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 1
        Case 14:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 1:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 1
        Case 15:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 1:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 1
        Case 16:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 1:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 1
        Case 17:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0:bl10.State = 1:Li21.State = 1
        Case 18:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0:bl10.State = 1:Li21.State = 1
        Case 19:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 1:bl10.State = 1:Li21.State = 1
    End Select
End Sub
...
Sub EndOfBallComplete()
    ...
    Select Case CurrentPlayer
        Case 1:PlaySound "RotateThruPlayers1"
        Case 2:PlaySound "RotateThruPlayers2"
        Case 3:PlaySound "RotateThruPlayers3"
        Case 4:PlaySound "RotateThruPlayers4"
    End Select
...
Sub AddScore(Points)
    ...
    Select Case Points
        Case 10
            ...
            UpdateScore points
            ' sounds
            PlaySound SoundFXDOF("chime_10", 131, DOFPulse, DOFChimes)
        Case 100
            Score(CurrentPlayer) = Score(CurrentPlayer) + points
            UpdateScore points
            ' sounds
...
Sub UpdateBallInPlay 'update backdrop lights
    ...
    If B2SOn then
    Controller.B2SSetData 81,0 'Chr
    Controller.B2SSetData 82,1
    Controller.B2SSetData 83,0
    Controller.B2SSetData 84,0
    End if
...
Sub ResetNewBallVariables 'init variables & lights new ball/player
    ...
    BonusMultiplier = 1
    ResetRedBank
    vpmTimer.AddTimer 500, "ResetWhiteBank '"
    PlaySound "ReelInitt"
...
Sub ExChangeBumper:BumperOn = NOT BumperOn:TurnOnBumper:End Sub

Sub TurnOFFBumper
    Bumper2Light.State = 0
    Bumper1Light.State = 0
    vpmtimer.AddTimer 1000, "TurnOnBumper '"
End Sub
...
Sub Bumper1_Hit 'top bumper
    ...
    AddScore 10 + 90 * Bumper1Light.State
End Sub

Sub Bumper2_Hit 'lower bumper
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF("fx_bumper", 106, DOFPulse, DOFContactors), Bumper2
    AddScore 10 + 90 * Bumper2Light.State
End Sub
...
Sub sw54a_Hit:AddScore 10:RotateSpecial:Rub1 = 1:sw54a_Timer:ExChangeBumper:End Sub
...
Sub sw54b_Hit:AddScore 10:RotateSpecial:Rub2 = 1:sw54b_Timer:ExChangeBumper:End Sub
Sub sw54b_Timer
    Select Case Rub2
...
Sub sw54c_Hit:AddScore 10:RotateSpecial:Rub3 = 1:sw54c_Timer:ExChangeBumper:End Sub
Sub sw54c_Timer
    Select Case Rub3
...
Sub sw54d_Hit:AddScore 10:RotateSpecial:Rub4 = 1:sw54d_Timer:ExChangeBumper:End Sub
Sub sw54d_Timer
    Select Case Rub4
...
Sub RotateSpecial 'inlane lights
    Dim tmp
    tmp = li20.state
    li20.State = li22.state
    li22.State = tmp
End Sub
...
Sub sw40a_Hit 'C (Right)
    PlaySoundAt "fx_sensor", sw40a
    If Tilted Then Exit Sub
    AddScore 500
    AddBonus 1
    TurnOFFBumper
...
Sub sw41_Hit 'H
    ...
    If li18.State Then
        li18.State = 0
        CheckCHIC
        If li16.State = 0 Then li6.State = 1
    End If
End Sub
...
Sub sw42_Hit 'I
    ...
    If li16.State Then
        li16.State = 0
        CheckCHIC
        If li18.State = 0 Then li6.State = 1
    End If
End Sub

Sub CheckCHIC
    Dim tmp
    tmp = li17.State + li18.State + li16.State + li15.State
    If tmp = 0 Then li22.State = 1
End Sub


' Outlanes

Sub sw14_Hit 'left outlane
...
Sub sw14a_Hit 'right outlane
    PlaySoundAt "fx_sensor", sw14a
    If Tilted Then Exit Sub
    AddScore 500
    AddBonus 1
    TurnOFFBumper
...
Sub sw13_Hit
    ...
    If Tilted Then Exit Sub
    If li20.State Then AwardSpecial
    AddScore 500
    AddBonus 1
    TurnOFFBumper
    ResetRedBank
...
Sub sw43_Hit
    ...
    If Tilted Then Exit Sub
    If li22.State Then AwardSpecial
    AddScore 500
    AddBonus 1
    TurnOFFBumper
    ResetRedBank
...
Sub dt1_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 108, DOFPulse, DOFContactors), dt1:End Sub
Sub dt2_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 109, DOFPulse, DOFContactors), dt2:End Sub
Sub dt3_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 110, DOFPulse, DOFContactors), dt3:End Sub
...
Sub CheckRedBank
    Dim x
    dt(0) = 0
    For x = 1 to 5:dt(0) = dt(0) + dt(x):Next
    If dt(0) = 5 Then
        AddBonusMultiplier 1
        li10.State = 1
    End If
...
Sub ResetRedBank
    ...
    dt5.Isdropped = 0
    Dim x
    For x = 1 to 5:DT(x) = 0:Next
End Sub

' White Droptargets
Sub dt6_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 115, DOFPulse, DOFContactors), dt6:End Sub
Sub dt7_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 116, DOFPulse, DOFContactors), dt7:End Sub
Sub dt8_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 117, DOFPulse, DOFContactors), dt8:End Sub
...
Sub CheckWhiteBank
    Dim x
    dt(0) = 0
    For x = 6 to 8:dt(0) = dt(0) + dt(x):Next
    If dt(0) = 3 Then
        li5.State = 1
        If li21.State Then
            AwardExtraBall
...
Sub ResetWhiteBank
    PlaySoundAt SoundFXDOF("fx_resetdrop", 114, DOFPulse, DOFContactors), dt7
    dt6.Isdropped = 0
    dt7.Isdropped = 0
    dt8.Isdropped = 0
    Dim x
    For x = 6 to 8:DT(x) = 0:Next
End Sub
