...
Sub Table1_Init
  ...
  if credit > 0 then LightCredits.state = 1:end if
...
Sub Table1_KeyDown(ByVal keycode)
  ...
  credit=credit-1
  credittxt.setvalue credit
    If credit = 0 then CreditLight.State = 0
    eg=0
    playno=1
    playno1.state=1
    currpl=1
...
sub coindelay_timer
  ...
  credit=credit+1
  credittxt.setvalue credit
    If credit > 1 then CreditLight.State = 1
  ...
  if (Light17.state)=1 then
    ...
    if B2SOn Then
      ...
      if currpl > playno then
        ...
        Controller.B2SSetData (24+currpl),1
...
Sub sw3_Hit()
  Addscore 1000
  If light11.state=1 then credit=credit+1: playsound "knocke": end if
  credittxt.setvalue credit
End Sub

Sub sw4_Hit()
  Addscore 1000
  If light12.state=1 then credit=credit+1: playsound "knocke": end if
    credittxt.setvalue credit
End Sub
