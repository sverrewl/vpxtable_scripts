' ******************************************************************
'     VPX 10.8 - version by Klodo81 2022, Big Deal version 4.0
'
'                     Based on:
...
Sub Bumper001_Hit 'left
    ...
    If BumperScore = 0 Then AddScore 100 Else AddScore 1000
End Sub
...
Sub TargetB_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 250, DOFPulse, DOFDropTargets), TargetB
    If Tilted Then Exit Sub
  LightB.State = 0
  CheckBigDeal()
    Addscore 1000
...
Sub TargetI_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 250, DOFPulse, DOFDropTargets), TargetI
    If Tilted Then Exit Sub
  LightI.State = 0
  CheckBigDeal()
    Addscore 1000
...
Sub TargetG_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 250, DOFPulse, DOFDropTargets), TargetG
    If Tilted Then Exit Sub
  LightG.State = 0
  CheckBigDeal()
    Addscore 1000
...
Sub TargetD_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 250, DOFPulse, DOFDropTargets), TargetD
    If Tilted Then Exit Sub
  LightD.State = 0
  CheckBigDeal()
    Addscore 1000
...
Sub TargetE_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 250, DOFPulse, DOFDropTargets), TargetE
    If Tilted Then Exit Sub
  LightE.State = 0
  CheckBigDeal()
    Addscore 1000
...
Sub TargetA_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 250, DOFPulse, DOFDropTargets), TargetA
    If Tilted Then Exit Sub
  LightA.State = 0
  CheckBigDeal()
    Addscore 1000
...
Sub TargetL_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 250, DOFPulse, DOFDropTargets), TargetL
    If Tilted Then Exit Sub
  LightL.State = 0
  CheckBigDeal()
    Addscore 1000
...
Sub ResetTargetBIG
  ...
  PlaySoundAt SoundFXDOF ("fx_resetdrop", 111, DOFPulse, DOFContactors), TargetI
End Sub
...
Sub ResetTargetDEAL
  ...
  PlaySoundAt SoundFXDOF ("fx_resetdrop", 112, DOFPulse, DOFContactors), TargetE
End Sub
...
Sub CheckBigDeal()
  If LightStar1.State = 1 And LightStar2.State = 0 Then
    If LightB.State=0 And LightI.State=0 And LightG.State=0 And ResetTargetMode=1 Then LightStar2.State = 1 : vpmtimer.addtimer 200, "ResetTargetBIG '"
    If LightB.State=0 And LightI.State=0 And LightG.State=0 And ResetTargetMode=0 Then LightStar2.State = 1 : vpmtimer.addtimer 200, "ResetTargetBIG : ResetTargetDEAL '"
    If LightD.State=0 And LightE.State=0 And LightA.State=0 And LightL.State=0 And ResetTargetMode=1 Then LightStar2.State = 1 : vpmtimer.addtimer 200, "ResetTargetDEAL '"
    If LightD.State=0 And LightE.State=0 And LightA.State=0 And LightL.State=0 And ResetTargetMode=0 Then LightStar2.State = 1 : vpmtimer.addtimer 200, "ResetTargetBIG : ResetTargetDEAL '"
  End If
  If LightStar1.State = 0 And LightStar2.State = 0 Then
    If LightB.State=0 And LightI.State=0 And LightG.State=0 And ResetTargetMode=1 Then LightStar1.State = 1 : vpmtimer.addtimer 200, "ResetTargetBIG '"
    If LightB.State=0 And LightI.State=0 And LightG.State=0 And ResetTargetMode=0 Then LightStar1.State = 1 : vpmtimer.addtimer 200, "ResetTargetBIG : ResetTargetDEAL '"
    If LightD.State=0 And LightE.State=0 And LightA.State=0 And LightL.State=0 And ResetTargetMode=1 Then LightStar1.State = 1 : vpmtimer.addtimer 200, "ResetTargetDEAL '"
    If LightD.State=0 And LightE.State=0 And LightA.State=0 And LightL.State=0 And ResetTargetMode=0 Then LightStar1.State = 1 : vpmtimer.addtimer 200, "ResetTargetBIG : ResetTargetDEAL '"
  End If
...
Dim BumperScore      ' 0 = (Conservative) score 100  ; 1 = (liberal) score 1000  when the ball hit bumpers
Dim ResetTargetMode  ' 0 = (Conservative) = BIG and DEAL targets reset together when one is completed ; 1 = (liberal) = BIG or DEAL targets reset when one is completed ;
...
Sub Table1_OptionEvent(ByVal eventId)
  ...
  ' Bumper Score
    BumperScore = Table1.Option("Free Play", 0, 1, 1, 1, 0, Array("Conservative score 100","Liberal score 1000"))
  ' Reset Target Mode
    ResetTargetMode = Table1.Option("Free Play", 0, 1, 1, 1, 0, Array("Conservative BIG And DEAL targets reset","Liberal BIG Or DEAL targets reset"))
