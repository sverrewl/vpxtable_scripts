'Star Trip / IPD No. 3605 / April, 1979 / 4 Players
'Game Plan, Incorporated, of Illinois (1978-1985)
'VPX8 by jpsalas, version 6.0.0
...
Dim bsTrough, dtDrop, bsSaucer, x

Const cGameName = "startrip"

Dim VarHidden 'hide the vpinmame window
VarHidden = 1

LoadVPM "00990300", "GamePlan.vbs", 1.2
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Star Trip - Game Plan 1979" & vbNewLine & "VPX8 table by jpsalas v6.0.0"
    ...
    vpmNudge.TiltObj = Array(Bumper001, Bumper002, LeftSlingshot, RightSlingshot, Rightslingshot2)
    ...
    With dtDrop
        .InitDrop Array(T1, T2, T3), Array(10, 12, 4)
...
Sub sw20a_Hit:Controller.Switch(20) = 1:PlaySoundAt "fx_sensor", sw20:End Sub
...
SolCallback(11) = "dtDrop.SolUnhit 1,"
SolCallback(13) = "dtDrop.SolUnhit 2,"
SolCallback(4) = "dtDrop.SolUnhit 3,"
SolCallback(3) = "vpmSolSound SoundFX(""fx_Knocker"",DOFKnocker),"
SolCallback(16) = "GameOn"

Sub GameOn(Enabled)
    vpmNudge.SolGameOn Enabled
    Light004.State = ABS(Enabled)
    Light005.State = ABS(Enabled)
End Sub
