...
Sub Bumper2_Hit : vpmTimer.PulseSw(14) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper2, VolBump: End Sub
...
Sub sw40a_Hit():Controller.Switch(40)=1 : playsoundAtVol"rollover",ActiveBall, VolRol:End Sub
...
Sub sw51a_Hit():Controller.Switch(51)=1 : playsoundAtVol"rollover",ActiveBall, VolRol:End Sub
...
'Moving Target
 Sub sw42_Hit:vpmTimer.PulseSw 42:PlaySoundAtVol "target", ActiveBall, VolTarg
