...
Const cGameName="jokrpokr",UseSolenoids=1,UseLamps=1,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SFlipperOn="fx_Flipperup",SFlipperOff="fx_Flipperdown"
Const SCoin="coin"
...
Sub Drain_Hit:playsound"drain":bsTrough.addball me:End Sub
 ...
 ' Bumpers
 Sub Bumper1_Hit:vpmTimer.PulseSw 10 : playsound"fx_bumper1": End Sub
 Sub Bumper2_Hit:vpmTimer.PulseSw 10 : playsound"fx_bumper1": End Sub
 ...
 ' Rollovers
  ...
  Sub sw11b_Hit:Controller.Switch(11) = 1 : playsound"rollover" : End Sub
  ...
  Sub sw12d_Hit:Controller.Switch(12) = 1 : playsound"rollover" : End Sub
  Sub sw12d_UnHit:Controller.Switch(12) = 0:End Sub
  Sub sw13b_Hit:Controller.Switch(13) = 1 : playsound"rollover" : End Sub
