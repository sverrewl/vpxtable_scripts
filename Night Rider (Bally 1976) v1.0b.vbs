...
Sub solballrelease(enabled)
    bstrough.solexit ssolenoidon, ssolenoidon,enabled:playsoundAtVol SoundFX("BallRelease",DOFContactors), BallRelease,1
End sub
...
Sub SpinnerLeft_spin():PlaySoundAtVol "fx_spinner",SpinnerLeft,VolSpin:vpmtimer.pulsesw 21:end Sub
Sub SpinnerRight_spin():PlaySoundAtVol "fx_spinner",SpinnerRight,VolSpin:vpmtimer.pulsesw 20:end Sub
