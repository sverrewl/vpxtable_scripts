...
Sub TempleWall2_Hit  : vpmTimer.PulseSw 59:Me.TimerEnabled = 1:Hiter = 10 :templeball1.TransY = 15:templeball2.TransY = 15:sw59p.TransZ = 4: playsoundAtVol "fx_chapa", ActiveBall, 1 : Frei = 0: End Sub
...
Sub sw36_Hit  : vpmTimer.PulseSw 36:Me.TimerEnabled = 1:sw36p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw36_Timer:Me.TimerEnabled = 0:sw36p.TransX = 0:End Sub
Sub sw37_Hit  : vpmTimer.PulseSw 37:Me.TimerEnabled = 1:sw37p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw37_Timer:Me.TimerEnabled = 0:sw37p.TransX = 0:End Sub
Sub sw41_Hit  : vpmTimer.PulseSw 41:Me.TimerEnabled = 1:sw41p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw41_Timer:Me.TimerEnabled = 0:sw41p.TransX = 0:End Sub
Sub sw42_Hit  : vpmTimer.PulseSw 42:Me.TimerEnabled = 1:sw42p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw42_Timer:Me.TimerEnabled = 0:sw42p.TransX = 0:End Sub
Sub sw43_Hit  : vpmTimer.PulseSw 43:Me.TimerEnabled = 1:sw43p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw43_Timer:Me.TimerEnabled = 0:sw43p.TransX = 0:End Sub
Sub sw44_Hit  : vpmTimer.PulseSw 44:Me.TimerEnabled = 1:sw44p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw44_Timer:Me.TimerEnabled = 0:sw44p.TransX = 0:End Sub
Sub sw55_Hit  : vpmTimer.PulseSw 55:Me.TimerEnabled = 1:sw55p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw55_Timer:Me.TimerEnabled = 0:sw55p.TransX = 0:End Sub
Sub sw56_Hit  : vpmTimer.PulseSw 56:Me.TimerEnabled = 1:sw56p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw56_Timer:Me.TimerEnabled = 0:sw56p.TransX = 0:End Sub
Sub sw57_Hit  : vpmTimer.PulseSw 57:Me.TimerEnabled = 1:sw57p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw57_Timer:Me.TimerEnabled = 0:sw57p.TransX = 0:End Sub
Sub sw1_Hit  : vpmTimer.PulseSw 1:Me.TimerEnabled = 1:sw1p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw1_Timer:Me.TimerEnabled = 0:sw1p.TransX = 0:End Sub
Sub sw2_Hit  : vpmTimer.PulseSw 2:Me.TimerEnabled = 1:sw2p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw2_Timer:Me.TimerEnabled = 0:sw2p.TransX = 0:End Sub
Sub sw3_Hit  : vpmTimer.PulseSw 3:Me.TimerEnabled = 1:sw3p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw3_Timer:Me.TimerEnabled = 0:sw3p.TransX = 0:End Sub
Sub sw4_Hit  : vpmTimer.PulseSw 4:Me.TimerEnabled = 1:sw4p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw4_Timer:Me.TimerEnabled = 0:sw4p.TransX = 0:End Sub
Sub sw5_Hit  : vpmTimer.PulseSw 5:Me.TimerEnabled = 1:sw5p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw5_Timer:Me.TimerEnabled = 0:sw5p.TransX = 0:End Sub
Sub sw7_Hit  : vpmTimer.PulseSw 7:Me.TimerEnabled = 1:sw7p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw7_Timer:Me.TimerEnabled = 0:sw7p.TransX = 0:End Sub
Sub sw8_Hit  : vpmTimer.PulseSw 8:Me.TimerEnabled = 1:sw8p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw8_Timer:Me.TimerEnabled = 0:sw8p.TransX = 0:End Sub
Sub sw9_Hit  : vpmTimer.PulseSw 9:Me.TimerEnabled = 1:sw9p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
Sub sw9_Timer:Me.TimerEnabled = 0:sw9p.TransX = 0:End Sub
Sub sw10_Hit  : vpmTimer.PulseSw 10:Me.TimerEnabled = 1:sw10p.TransX = -4: playsoundAtVol "target", ActiveBall, 1 : End Sub
...
PlaySoundAtBallVOl "slingshot", 1
...
'Hanibals Bumper Script with Light
      Sub Bumper1b_Hit:vpmTimer.PulseSw 30: BumperL1.State = 1 :PlaySoundAtVol "bumper", ActiveBall, 1 :B1Drop = True:End Sub

      Sub Bumper2b_Hit:vpmTimer.PulseSw 31: BumperL2.State = 1 :PlaySoundAtVol "bumper", ActiveBall, 1 :B2Drop = True: End Sub

      Sub Bumper3b_Hit:vpmTimer.PulseSw 32: BumperL3.State = 1 :PlaySoundAtVol "bumper", ActiveBall, 1 :B3Drop = True:End Sub

      Sub Bumper4b_Hit:vpmTimer.PulseSw 33: BumperL4.State = 1 :PlaySoundAtVol "bumper", ActiveBall, 1 :B4Drop = True:End Sub
