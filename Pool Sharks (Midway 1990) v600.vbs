' Bally's Pool Sharks / IPD No. 1848 / June, 1990 / 4 Players
...
Dim bsTrough, cbCaptive, bsSharkEject, bsTopEject, dtHOT, dtSHOT, x

Const cGameName = "pool_l7"
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Pool Sharks - Bally-Midway 1990" & vbNewLine & "VPX table by jpsalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    ' Shark eject
    set bsSharkEject = new cvpmBallStack
    bsSharkEject.InitSaucer sw31, 31, 165, 10
    bsSharkEject.InitExitSnd SoundFX("fx_kicker", DOFContactors), SoundFX("fx_Solenoid", DOFContactors)
    bsSharkEject.KickForceVar = 3
    bsSharkEject.KickAngleVar = 3

    ' Top eject
    set bsTopEject = new cvpmBallStack
    bsTopEject.InitSaucer sw34, 34, 305, 10
    bsTopEject.InitExitSnd SoundFX("fx_kicker", DOFContactors), SoundFX("fx_Solenoid", DOFContactors)
    bsTopEject.KickForceVar = 3
    bsTopEject.KickAngleVar = 3

    ' HOT Targets
    Set dtHOT = New cvpmDropTarget
    dtHOT.InitDrop Array(sw17, sw18, sw19), Array(17, 18, 19) 'switch nummern im array
    dtHOT.initsnd SoundFX("fx_droptarget", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
    dtHOT.CreateEvents "dtHOT"

    ' SHOT Targets
    Set dtSHOT = New cvpmDropTarget
    dtSHOT.InitDrop Array(sw20, sw21, sw22, sw23), Array(20, 21, 22, 23) 'switch nummern im array
    dtSHOT.initsnd SoundFX("fx_droptarget", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
    dtSHOT.CreateEvents "dtSHOT"
...
Sub Gate1_Animate: GateRight.RotY = Gate1.CurrentAngle:End Sub
Sub SharkFlipper_Animate: dientes.TransY = SharkFlipper.CurrentAngle:End Sub
...
Sub sw31_Hit:PlaySoundAt "fx_kicker_enter", sw31:bsSharkEject.AddBall 0:End Sub
Sub sw34_Hit:PlaySoundAt "fx_kicker_enter",sw34:bsTopEject.AddBall 0:End Sub
...
Sub sw26_Hit:vpmTimer.PulseSw 26:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
...
SolCallback(3) = "dtHOT.SolDropUp"
SolCallback(4) = "dtSHOT.SolDropUp"
SolCallback(5) = "bsTopEject.SolOut"
SolCallBack(6) = "SolDivert"
SolCallback(7) = "VpmSolSound SoundFX(""fx_knocker"",DOFKnocker),"
SolCallback(8) = "bsSharkEject.SolOut"
SolCallback(10) = "SolGi" 'playfield gi
SolCallBack(13) = "SharkMouth"
SolCallback(23) = "vpmNudge.SolGameOn"

' Flashers

SolCallback(9) = "SetLamp 100,"
...
Sub SharkMouth(Enabled)
    If Enabled Then
        SharkFlipper.RotateToEnd
    Else
        SharkFlipper.RotateToStart
    End If
End Sub
