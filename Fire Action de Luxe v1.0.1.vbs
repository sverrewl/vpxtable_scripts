...
Sub table1_KeyDown(ByVal Keycode)
    ...
    If keycode = PlungerKey Then PlaySound "fx_kicker", 0, 1, 0.1, 0.25:Controller.Switch(65) = 1
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 15:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, -0.05:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 5:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0.05:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 25:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, -0.05:End Sub
Sub Bumper4_Hit:vpmTimer.PulseSw 35:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0.05:End Sub
...
' and orbit gate
Sub sw14_Hit:Controller.Switch(14) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall)
...
' Spinners
Sub sw24_Spin:vpmTimer.PulseSw 24:PlaySound SoundFX("fx_spinner", DOFContactors), 0, 1, 0.05:End Sub
...
Sub sw62_Hit:vpmTimer.PulseSw 62:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
