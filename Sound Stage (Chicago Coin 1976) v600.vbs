...
' Carga el core.vbs para poder usas sus funciones, sobre todo el vpmtimer.addtimer
LoadCoreFiles
...
' Valores Constants
Const TableName = "SoundStage" 'saving the highscores and credits
Const cGameName = "SoundStage" ' mostly for DOF
...
Sub Table1_Init()
    ...
    If BallsPerGame = 5 Then
        Special1 = 130000 ' puntuación a obtener para partida extra, jugando a 5 bolas
        Special2 = 148000 ' puntuación a obtener para partida extra, jugando a 5 bolas
        Special3 = 172000 ' puntuación a obtener para partida extra, jugando a 5 bolas
        Special4 = 193000 ' puntuación a obtener para partida extra, jugando a 5 bolas
    Else                  '3 bolas
        Special1 = 78000  ' puntuación a obtener para partida extra, jugando a 3 bolas
        Special2 = 89000  ' puntuación a obtener para partida extra, jugando a 3 bolas
        Special3 = 104000 ' puntuación a obtener para partida extra, jugando a 3 bolas
        Special4 = 116000 ' puntuación a obtener para partida extra, jugando a 3 bolas
    End If
...
Sub CreateNewBall()
    ...
    ' y expulsa la bola
    PlaySoundAt SoundFXDOF("fx_Ballrel", 112, DOFPulse, DOFContactors), BallRelease
...
Sub EndOfBall()
    ...
    ' cuenta los bonos al final de la bola
...
Sub BonusCountTimer_Timer 'añade los bonos y actualiza las luces
    ...
    If Bonus> 0 Then
        ...
        UpdateBonusLights
        BonusCountTimer.Interval = 250 + 200 * BonusMultiplier
    Else
        BonusCountTimer.Enabled = 0
        BonusCountTimer.Interval = 250 'ready for next count
...
Sub UpdateScore(playerpoints)
    ...
    If Score(CurrentPlayer) >= 100000 then
        Select Case CurrentPlayer
            Case 1:TurnON aSC1Rollover
            Case 2:TurnON aSC2Rollover
        End Select
    End If
    If B2SOn then
...
Sub ResetScores
    ...
    TurnOFF aSC1Rollover
    TurnOFF aSC2Rollover
    If B2SOn then
...
Sub UpdateBonusLights
    Select Case Bonus
        Case 0:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 1:bl001.State = 1:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 2:bl001.State = 0:bl002.State = 1:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 3:bl001.State = 0:bl002.State = 0:bl003.State = 1:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 4:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 1:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 5:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 1:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 6:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 1:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 7:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 1:bl008.State = 0:bl009.State = 0:bl010.State = 0
        Case 8:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 1:bl009.State = 0:bl010.State = 0
        Case 9:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 1:bl010.State = 0
        Case 10:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 11:bl001.State = 1:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 12:bl001.State = 0:bl002.State = 1:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 13:bl001.State = 0:bl002.State = 0:bl003.State = 1:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 14:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 1:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 15:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 1:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 16:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 1:bl007.State = 0:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 17:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 1:bl008.State = 0:bl009.State = 0:bl010.State = 1
        Case 18:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 1:bl009.State = 0:bl010.State = 1
        Case 19:bl001.State = 0:bl002.State = 0:bl003.State = 0:bl004.State = 0:bl005.State = 0:bl006.State = 0:bl007.State = 0:bl008.State = 0:bl009.State = 1:bl010.State = 1
    End Select
End Sub
...
Sub AwardExtraBall()
    If NOT bExtraBallWonThisBall Then 'only 1 extra ball per ball
...
Sub spinner1_animate:spinner1p.roty = spinner1.Currentangle:End Sub
Sub spinner2_animate:spinner2p.roty = spinner2.Currentangle:End Sub
...
Sub ResetNewBallVariables()     'inicia las variable para una bola ó jugador nuevo
    Bonus = 0:UpdateBonusLights ' this table starts with 0 bonus
    ...
    End If
    MatchEnabled = True     'para poder deactivar la loteria en caso de tilt en la última bola
    SpinValue = 100
End Sub
...
Sub Kicker001_Hit 'Top Right
    ...
    If Tilted Then vpmTimer.AddTimer 200, "pkickerflipper.RotateToEnd:kicker001.TimerEnabled = 1:PlaySoundAt SoundFXDOF (""fx_kicker"", 110, DOFPulse, DOFContactors), kicker001:kicker001.kick 190,10 '"
    DOF 211, DOFPulse
    DOF 231, DOFPulse
    Addscore 500
    If Light007.State Then BonusMultiplier = 2:Light002.State = 1
    vpmTimer.AddTimer 500, "pkickerflipper.RotateToEnd:kicker001.TimerEnabled = 1:PlaySoundAt SoundFXDOF (""fx_kicker"", 110, DOFPulse, DOFContactors), kicker001:kicker001.kick 190,10 '"
End Sub

Sub kicker001_Timer
    kicker001.TimerEnabled = 0
    pkickerflipper.RotateToStart
End Sub

Sub pkickerflipper_animate:Pkickarm1.Rotx = - pkickerflipper.Currentangle:End Sub
...
Sub CheckSpecials
    If tl001.State Then Light008.State = 1                 'special lane is lit
    If tl001.State AND tl002.State Then Light003.State = 1 'left outlane-extra ball
    If tl003.State AND tl004.State Then Spinvalue = 1000:TurnON aCDlights
    If tl005.State AND tl006.State Then Light007.State = 1
End Sub
...
Sub Trigger004_Hit 'left inlane
    PlaySoundAt "fx_sensor", Trigger003
    If Tilted Then Exit Sub
    AddScore 1000
    AddBonus 1
...
Sub Button002_Hit
    ...
    If Tilted Then Exit Sub
    If Light008.State Then Light004.State = 1
End Sub
...
Sub Change
    Dim tmp
    tmp = light005.State
    light005.State = light006.State
    light006.State = tmp
End Sub

' Spinner

Sub Target001_hit 'left
    PlaySoundAtBall SoundFXDOF("fx_target", 109, DOFPulse, DOFTargets)
    If Tilted Then Exit Sub
    SpinSpeed = ActiveBall.VelY * 750
    SpinTimer.Enabled = 1
End Sub

Sub Target002_hit 'right
    PlaySoundAtBall SoundFXDOF("fx_target", 109, DOFPulse, DOFTargets)
    If Tilted Then Exit Sub
    SpinSpeed = ActiveBall.VelY * 750
    SpinTimer.Enabled = 1
...
Dim SpinPosition, SpinSpeed, SpinLastPos

Const cSpinFriction = 1.5                               ' 2.0 - Friction coefficient (deg/sec/sec)
Const cSpinMinSpeed = 20                                ' 20 - Object stops at this speed (deg/sec)

SpinSpeed = 0:SpinLastPos = -1:SpinTimer.Enabled = True ' force update

' Draw Spinner and score the spinvalue
Sub SpinTimer_Timer
    Dim curPos
    Dim oldSpinSpeed:oldSpinSpeed = SpinSpeed
    SpinPosition = SpinPosition + SpinSpeed * Me.Interval / 1000
    SpinSpeed = SpinSpeed * (1 - cSpinFriction * Me.Interval / 1000)
    Do While SpinPosition> 360
        SpinPosition = SpinPosition - 360
    Loop
    curPos = INT(SpinPosition)
    If curPos <> SpinLastPos Then
        Spinner1.RotZ = 360 - SpinPosition

        If oldSpinSpeed> 0 And SpinLastPos> curPos Then
            Addscore SpinValue
        End If
        SpinLastPos = curPos
    End If
    If Abs(SpinSpeed) <cSpinMinSpeed Then
        SpinSpeed = 0:Me.Enabled = False
    End If
End Sub
...
Dim LUTImage, BallsPerGame, FlipperPin
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    ' Flipper pin
    x = Table1.Option("Flipper Pin", 0, 1, 1, 0, 0, Array("No", "Yes") )
    If x = 1 Then FlipperPin = True Else FlipperPin = False
    If FlipperPin Then
        rpin001.collidable = 1
        Rubber020.Visible = 1
        Primitive103.Visible = 1
    Else
        rpin001.collidable = 0
        Rubber020.Visible = 0
