' Gamatron / IPD No. 3116 / Sonic 1986 / 4 Players
' jpsalas 2024 v6.0.0, vpinmame script based on destruk script
...
Dim bsTrough, bsRTK, bsLTK, dt3, dt5, x

'Select the ROM
'Const cGameName = "gamatron" 'Pinstar original ROM, same rules as Flight2000 standard, do not include voices
'Const cGameName = "flight2k" 'Flight2000 standard original rom
'Cont cGameName = "gamatros" 'Sonic original ROM, it is emulated but I can't get it working
Const cGameName = "flight2m" 'New updated ROM with extra voices and rules
'Const cGameName = "flight2mb" 'Updated with extra voices and even more rules
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Gamatron - Sonic 1986" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub Kicker5_Hit
  ...
  VpmTimer.AddTimer 100, "Controller.Switch(39) = 0'"
End Sub
...
SolCallback(9) = "SolCallback9"
SolCallback(18) = "SolCallback18"

Sub SolCallback9(enabled)
  If cGameName <> "flight2mb" Or Int(Controller.Dip(1) / 32) Mod 2 = 1 Then
    SolBallLaunch(enabled)
  Else
    VpmSolSound SoundFX("fx_Knocker", DOFKnocker), enabled
  End If
End Sub

Sub SolCallback18(enabled)
  If cGameName = "flight2mb" Then
    If Int(Controller.Dip(1) / 32) Mod 2 = 1 Then
      VpmSolSound SoundFX("fx_Knocker", DOFKnocker), enabled
    Else
      SolBallLaunch(enabled)
    End If
