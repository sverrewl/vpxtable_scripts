...
Sub sw19a_Hit:Controller.Switch(19) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
Sub sw19a_UnHit:Controller.Switch(19) = 0:End Sub
Sub sw19b_Hit:Controller.Switch(19) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
...
Sub sw21a_Hit:Controller.Switch(21) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
Sub sw21a_UnHit:Controller.Switch(21) = 0:End Sub
Sub sw21b_Hit:Controller.Switch(21) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
...
Sub sw33a_Hit:Controller.Switch(33) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
...
Sub sw40a_Hit:Controller.Switch(40) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
...
Sub sw25a_Hit:Controller.Switch(25) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
Sub sw25a_UnHit:Controller.Switch(25) = 0:End Sub
Sub sw25b_Hit:Controller.Switch(25) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
Sub sw25b_UnHit:Controller.Switch(25) = 0:End Sub
Sub sw25c_Hit:Controller.Switch(25) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
...
Sub sw32b_Hit:Controller.Switch(32) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
Sub sw32b_UnHit:Controller.Switch(32) = 0:End Sub
Sub sw32c_Hit:Controller.Switch(32) = 1 : playsoundAtVol"rollover" ,ActiveBall, 1: End Sub
