...
End Sub
 ...
 '----------------------------------------------------------------------
 Sub Bumper1_Hit()
    PlaySoundAtVol SoundFXDOF("fx_bumper",105,DOFPulse,DOFContactors), ActiveBall, VolBump
    if tilt then exit sub
    bumperLight1.state=LightStateOff
 ...
 Sub Bumper2_Hit()
    PlaySoundAtVol SoundFXDOF("fx_bumper",106,DOFPulse,DOFContactors), ActiveBall, VolBump
    if tilt then exit sub
    bumperLight2.state=LightStateOff
...
Sub kicker3Timer_Timer()
  Select Case kickstep
    Case 4:
    playsoundAtVol SoundFXDOF("popper_ball",112,DOFPulse,DOFContactors), Kicker3, VolKick
    DOF 126, DOFPulse
    kickArm3.rotz=10
...
Sub kicker4_Timer()
  Select Case kickstep
    Case 4:
    playsoundAtVol SoundFXDOF("popper_ball",113,DOFPulse,DOFContactors), Kicker4, VolKick
    DOF 126, DOFPulse
    kickArm4.rotz=10
        Kicker4.Kick (Rnd*40)+160,7
    Case 5:
