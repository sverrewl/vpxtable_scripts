...
Sub sw74_Hit:PlaySound "fx_Rubber", 0, 1, pan(ActiveBall):vpmTimer.PulseSw 74:Rub1 = 1: sw74_Timer:End Sub
Sub sw74_Timer
    Select Case Rub1
...
Sub sw64_Hit:PlaySound "fx_Rubber", 0, 1, pan(ActiveBall):vpmTimer.PulseSw 64:Rub2 = 1: sw64_Timer:End Sub
Sub sw64_Timer
    Select Case Rub2
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 5:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0, -0.05:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 15:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0, 0:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 25:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0, 0.05:End Sub
