...
Sub Gate_Animate: Pgate.rotz = (Gate.currentangle*.75)+25: End Sub
...
Sub RollingTimer_Timer()
    ...
    For b = lob to UBound(BOT)
        ...
        If BOT(b).VelZ <-1 Then
            'from ramp
            If BOT(b).z <55 and BOT(b).z> 27 Then PlaySound "fx_balldrop", 0, ABS(BOT(b).velz) / 17, AudioPan(BOT(b) ), 0, Pitch(BOT(b) ), 1, 0, AudioFade(BOT(b) )
            'down a hole
            If BOT(b).z <10 and BOT(b).z> -10 Then PlaySound "fx_hole_enter", 0, ABS(BOT(b).velz) / 17, AudioPan(BOT(b) ), 0, Pitch(BOT(b) ), 1, 0, AudioFade(BOT(b) )
        End If
...
'*********************************
 ...
 Sub Abra_Ca_Dabra_OptionEvent(ByVal eventId)
    ...
    'LUT
    LutImage = Abra_Ca_Dabra.Option("Select LUT", 0, 21, 1, 0, 0, Array("Normal 0", "Normal 1", "Normal 2", "Normal 3", "Normal 4", "Normal 5", "Normal 6", "Normal 7", "Normal 8", "Normal 9", "Normal 10", _
        "Warm 0", "Warm 1", "Warm 2", "Warm 3", "Warm 4", "Warm 5", "Warm 6", "Warm 7", "Warm 8", "Warm 9", "Warm 10") )
    UpdateLUT

    ' Cabinet rails
    x = Abra_Ca_Dabra.Option("Cabinet Rails", 0, 1, 1, 1, 0, Array("Hide", "Show") )
    For each y in aRails:y.visible = x:next
  End Sub

 Sub UpdateLUT
    Select Case LutImage
        Case 0:Abra_Ca_Dabra.ColorGradeImage = "LUT0"
        Case 1:Abra_Ca_Dabra.ColorGradeImage = "LUT1"
        Case 2:Abra_Ca_Dabra.ColorGradeImage = "LUT2"
        Case 3:Abra_Ca_Dabra.ColorGradeImage = "LUT3"
        Case 4:Abra_Ca_Dabra.ColorGradeImage = "LUT4"
        Case 5:Abra_Ca_Dabra.ColorGradeImage = "LUT5"
        Case 6:Abra_Ca_Dabra.ColorGradeImage = "LUT6"
        Case 7:Abra_Ca_Dabra.ColorGradeImage = "LUT7"
        Case 8:Abra_Ca_Dabra.ColorGradeImage = "LUT8"
        Case 9:Abra_Ca_Dabra.ColorGradeImage = "LUT9"
        Case 10:Abra_Ca_Dabra.ColorGradeImage = "LUT10"
        Case 11:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 0"
        Case 12:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 1"
        Case 13:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 2"
        Case 14:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 3"
        Case 15:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 4"
        Case 16:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 5"
        Case 17:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 6"
        Case 18:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 7"
        Case 19:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 8"
        Case 20:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 9"
        Case 21:Abra_Ca_Dabra.ColorGradeImage = "LUT Warm 10"
    End Select
 End Sub
