...
Const cGameName = "rollstob" ' 7 digits
'Const cGameName = "rollston" ' 6 digits
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Rolling Stones - Bally 1979" & vbNewLine & "VPX table by JPSalas v5.5.1"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub sw27_Hit:Controller.Switch(26) = 1:PlaySoundAt "fx_sensor", sw27:sw27l.Duration 2, 2000, 0:End Sub
Sub sw27_UnHit:Controller.Switch(26) = 0:End Sub

Sub sw26_Hit:Controller.Switch(27) = 1:PlaySoundAt "fx_sensor", sw26:sw26l.Duration 2, 2000, 0:End Sub
Sub sw26_UnHit:Controller.Switch(27) = 0:End Sub

' Droptargets
Sub sw13_Dropped:Controller.Switch(13) = 1:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets),sw13:End Sub
...
' Saucer
Sub sw32_Hit:bsTP.AddBall 0:PlaySoundAt "fx_kicker_enter", sw32:End Sub
...
If cGameName = "rollstob" Then ' 7 digits
Set Digits(0) = a0
Set Digits(1) = a1
Set Digits(2) = a2
Set Digits(3) = a3
...
If cGameName = "rollston" Then ' 6 digits
Set Digits(0) = a1
Set Digits(1) = a2
Set Digits(2) = a3
Set Digits(3) = a4
