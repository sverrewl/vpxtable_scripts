...
Dim FlashLevel19, FlashLevel20, FlashLevel26, FlashLevel27, FlashLevel31, FlashLevel32

Flasherlight19.state = 0
Flasherlight20.state = 0
Flasherlight27.state = 0
Flasherlight31.state = 0
Flasherlight31a.state = 0
Flasherlight32.state = 0
...
SolModCallback(19) =  "Flash19" 'flash safehouse x3
SolModCallback(20) =  "Flash20" 'flash sniper x2
SolModCallback(26) =  "Flash26" 'flash pop x3
SolModCallback(27) =  "Flash27" 'flash right side under jet?
SolModCallback(31) =  "Flash31" 'Orange Dome Slingshots x2
SolModCallback(32) =  "Flash32" 'flash left spinner x3
...
Sub Table1_KeyDown(ByVal Keycode)
  ...
  if keycode = RightMagnaSave Then  FlashLevel1 = 1 : FlasherFlash4_Timer : Exit Sub
...
Sub sw3_Hit:bsTEject.addball 0 : playsoundAtVol "popper_ball", sw3, 1: End Sub
...
'*** FLASHER 19  ***
Sub Flash19(Level)
  Flasherflash19.intensityScale = Level / (5 * 128)
  FlashLevel19 = Level / ( 5 * 128 ) : FlasherFlash19_Timer
...
Sub FlasherFlash19_Timer()
  ...
  Primitive11.Image = "safehousetexture_ON"
    Safehouse.Image = "safehousetexture_ON"
  End If
  ...
  If FlashLevel19 < 0 Then
    ...
    Primitive11.Image = "safehousetexture"
...
'*** FLASHER 20  ***
Sub Flash20(Level)
  Flasherflash20.intensityScale = Level / (5 * 128)
  FlashLevel20 = Level / ( 2 * 128 ) : FlasherFlash20_Timer
...
Sub FlasherFlash20_Timer()
  ...
  Flasherflash20.opacity = 8000 * flashx3
  ...
  FlashLevel20 = FlashLevel20 * 0.85 - 0.01
...
Sub Flash26(Level)
  If Level > 0 Then
  Flasherflash26.intensityScale = Level / (2 * 128)
    Flasherflash26.State=1
  Else
    Flasherflash26.State=0
  End If
End Sub

'*** FLASHER 27  ***
Sub Flash27(Level)
  Flasherflash27.intensityScale = Level / (5 * 128)
  FlashLevel27 = Level / ( 2 * 128 ) : FlasherFlash27_Timer
...
Sub FlasherFlash27_Timer()
  ...
  Flasherflash27.opacity = 8000 * flashx3
...
Sub Flash31(Level)
   Flasherlight31.state = 1
   Flasherlight31a.state = 1
   FlashLevel31 = Level / ( 2 * 128 ) : FlasherFlash31_Timer
End Sub

'*** Orange flashers - sling shots ***
Sub FlasherFlash31_Timer()
  dim flashx3, matdim
  If not Flasherflash31.TimerEnabled Then
    Flasherflash31.TimerEnabled = True
    Flasherflash31.visible = 1
    Flasherflash31a.visible = 1
    Flasherlit31.visible = 1
    Flasherlit31a.visible = 1
  End If
  flashx3 = FlashLevel31 * FlashLevel31 * FlashLevel31
  Flasherflash31.opacity = 8000 * flashx3
  Flasherflash31a.opacity = 8000 * flashx3
  Flasherlit31.BlendDisableLighting = 10 * flashx3
  Flasherlit31a.BlendDisableLighting = 10 * flashx3
  Flasherbase31.BlendDisableLighting =  flashx3
  Flasherbase31a.BlendDisableLighting =  flashx3
  Flasherlight31.IntensityScale = flashx3
  Flasherlight31a.IntensityScale = flashx3
  matdim = Round(10 * FlashLevel31)
  Flasherlit31.material = "domelit" & matdim
  Flasherlit31a.material = "domelit" & matdim
  FlashLevel31 = FlashLevel31 * 0.85 - 0.01
  If FlashLevel31 < 0.15 Then
    Flasherlit31.visible = 0
    Flasherlit31a.visible = 0
  Else
    Flasherlit31.visible = 1
    Flasherlit31a.visible = 1
  end If
  If FlashLevel31 < 0 Then
    Flasherflash31.TimerEnabled = False
    Flasherflash31a.TimerEnabled = False
    Flasherflash31.visible = 0
    Flasherflash31a.visible = 0
  End If
End Sub

'*** FLASHER 32  ***
Sub Flash32(Level)
  Flasherflash32.intensityScale = Level / (5 * 128)
  FlashLevel32 = Level / ( 2 * 128 ) : FlasherFlash32_Timer
  Flasherlight32.state = 1
End Sub

'*** FLASHER 32 TIMER  ***
Sub FlasherFlash32_Timer()
  dim flashx3, matdim
  If not Flasherflash32.TimerEnabled Then
    Flasherflash32.TimerEnabled = True
    Flasherflash32.visible = 1
    Flasherlit32.visible = 1
  End If
  flashx3 = FlashLevel32 * FlashLevel32 * FlashLevel32
  Flasherflash32.opacity = 8000 * flashx3
  Flasherlit32.BlendDisableLighting = 10 * flashx3
  Flasherbase32.BlendDisableLighting =  flashx3
  Flasherlight32.IntensityScale = flashx3
  matdim = Round(10 * FlashLevel32)
  Flasherlit32.material = "domelit" & matdim
  FlashLevel32 = FlashLevel32 * 0.85 - 0.01
  If FlashLevel32 < 0.15 Then
    Flasherlit32.visible = 0
  Else
    Flasherlit32.visible = 1
  end If
  If FlashLevel32 < 0 Then
    Flasherflash32.TimerEnabled = False
