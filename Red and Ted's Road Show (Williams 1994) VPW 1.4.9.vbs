...
'----- ShakerMotor -----
'//  Shaker Volume (Ranges between 0 and 1)
Const ShakerSoundVolume = 1
...
'//  2 = Normal
'//  3 = High
Const ShakerIntensity = 3

'----- VR Room -----
Const VRRoomChoice = 1        '1 - Minimal Room, 2 - Ultra Minimal

'----- Other -----
'Const customdecals = 1       '0 - Original, 1 - Custom Target and Plunger Gate Stickers.

'------ Flipper Decals -------
'Const flipperdecals = 1            '0 - No Decals, 1 - Custom Flipper Decals
...
Dim UseVPMDMD, CabinetMode, VRRoom
...
Sub Frametimer_Timer  'The frame timer interval is -1 (once per frame).
    'flippers
    FlipperLP.ObjRotZ = LeftFlipper.CurrentAngle
    FlipperRP.ObjRotZ = RightFlipper.CurrentAngle
    FlipperL2P.ObjRotZ = LeftFlipper1.CurrentAngle
    FlipperL3P.ObjRotZ = LeftFlipper2.CurrentAngle

'If flipperdecals <> 0 Then
  FlipperRPDecals.ObjRotZ = RightFlipper.CurrentAngle
  FlipperLPDecals.ObjRotZ = LeftFlipper.CurrentAngle
'Else
...
'End If
  ...
  batleft2shadow.ObjRotZ = LeftFlipper1.CurrentAngle
  batleft3shadow.ObjRotZ = LeftFlipper2.CurrentAngle
...
FlasherLightIntensity = 0.4   ' *** lower this, if the VPX lights are too bright (i.e. 0.1)   *** default 0.2
FlasherFlareIntensity = 0.5   ' *** lower this, if the flares are too bright (i.e. 0.1)     *** default 0.3
...
Dim CustomDecals : CustomDecals = 1
Dim FlipperDecals : FlipperDecals = 1
