...
Sub SolBallRelease(Enabled):
  If Enabled Then
  Controller.Switch(15)=0:BallRelease.Kick 62,8:
  End If
End Sub
...
Sub SolBackDiverter(Enabled) 'BackWall Ramp Diverter
  If Enabled Then
     PlaySoundAtVol SoundFX("Popper",DOFContactors),RampDiverter,1
...
Sub FlipperTimer_Timer
  LFLogo.rotz = LeftFlipper.currentangle + 0
  RFLogo.rotz = RightFlipper.currentangle + 0
    LFLogo1.rotz = LeftFlipper1.currentangle + 0
  RFLogo1.rotz = RightFlipper1.currentangle + 0
...
Sub sw56_Hit:Controller.Switch(56)=1 : playsoundAtVol"rollover" , ActiveBall, 1: End Sub
...
Sub Trigger4_Hit: Stopsound"Wire Ramp" : playsoundAtVol"fx_ballrampdrop" , ActiveBall, 1: End Sub
...
NFadeL 11, L11
NFadeL 12, L12
NFadeObjm 13, l13, "bulbcover1_redOn", "AmpouleUV4VPX Red"
...
NFadeL 43, L43
NFadeL 44, L44
NFadeObjm 45, L45, "bulbcover1_yellowOn", "AmpouleUV4VPX Yellow"
Flash 45, F45 ' left ramp bottom LED
NFadeL 46, L46
NFadeObjm 47, l47, "bulbcover1_yellowOn", "AmpouleUV4VPX Yellow"
Flash 47, F47 'middle ramp LED
NFadeL 48, L48
NFadeL 49, L49
NFadeL 50, L50
NFadeL 51, L51
NFadeObjm 52, l52, "bulbcover1_redOn", "AmpouleUV4VPX Red"
Flash 52, F52 'upper drop targets Red LED
NFadeObjm 53, l53, "bulbcover1_yellowOn", "AmpouleUV4VPX Yellow"
Flash 53, F53 'left red LED - upper pf sign
NFadeObjm 54, l54, "bulbcover1_yellowOn", "AmpouleUV4VPX Green"
Flash 54, F54 'Right yellow LED - upper pf sign
NFadeL 55, L55
NFadeL 56, L56
NFadeObjm 57, l57, "bulbcover1_yellowOn", "AmpouleUV4VPX Yellow"
Flash 57, F57 'coffin yellow LED
NFadeObjm 58, l58, "bulbcover1_redOn", "AmpouleUV4VPX Red"
