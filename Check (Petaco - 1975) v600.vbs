...
' Valores Constants
Const TableName = "CheckRecel" 'saving the highscores and credits
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    If BallsPerGame = 5 Then
        ...
        If ApronEnglish Then
            apron.image = "apron_Check5i"
        Else
            apron.image = "apron_Check5e"
        End If
    Else '3 bolas
        ...
        If ApronEnglish Then
            apron.image = "apron_Check3i"
        Else
            apron.image = "apron_Check3e"
        End If
    End If
