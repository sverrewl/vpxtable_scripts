...
Const cGameName="jokrpokr",UseSolenoids=1,UseLamps=1,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SCoin="coin"
...
'*******************************************
 ...
 ' change chime sounds this line:
 Const ChimeSound = 0 ' choose 1 for chimes, 0 for electronic
...
Ramp16.visible=1
Ramp15.visible=1
Primitive35.visible=1
Else
Ramp16.visible=0
Ramp15.visible=0
Primitive35.visible=0
End if
...
' if  ChimeSound = 1 then use chimes, if not use electronic
If(ChimeSound = 1) then
  SolCallback(3)="vpmSolSound ""10"","
  SolCallback(4)="vpmSolSound ""100"","
  SolCallback(5)="vpmSolSound ""1000"","
else
  SolCallback(3)="vpmSolSound ""10_pf"","
  SolCallback(4)="vpmSolSound ""100_pf"","
  SolCallback(5)="vpmSolSound ""1000_pf"","
end if
...
'**********************************************************************************************************
 ...
 ' Rollovers
  ...
  Sub sw11b_Hit:Controller.Switch(11) = 1 : End Sub
  ...
  Sub sw12d_Hit:Controller.Switch(12) = 1 : End Sub
  Sub sw12d_UnHit:Controller.Switch(12) = 0:End Sub
  Sub sw13b_Hit:Controller.Switch(13) = 1 : End Sub
  ...
  'Drop targets
  Sub sw21_Hit:dtjj.Hit 1
  TargetBouncer Activeball, 1
  End Sub
  Sub sw22_Hit:dtjj.Hit 2
  TargetBouncer Activeball, 1
  End Sub
  Sub sw23_Hit:dtjj.Hit 3
  TargetBouncer Activeball, 1
  End Sub
  Sub sw31_Hit:dtqq.Hit 1
  TargetBouncer Activeball, 1
  End Sub
  Sub sw32_Hit:dtqq.Hit 2
  TargetBouncer Activeball, 1
  End Sub
  Sub sw33_Hit:dtqq.Hit 3
  TargetBouncer Activeball, 1
  End Sub

  Sub sw41_Hit:dtkk.Hit 1
  TargetBouncer Activeball, 1
  End Sub
  Sub sw42_Hit:dtkk.Hit 2
  TargetBouncer Activeball, 1
  End Sub
  Sub sw43_Hit:dtkk.Hit 3
  TargetBouncer Activeball, 1
  End Sub
  Sub sw44_Hit:dtkk.Hit 4
  TargetBouncer Activeball, 1
  End Sub

  Sub sw50_Hit:dtaa.Hit 1
  TargetBouncer Activeball, 1
  End Sub
  Sub sw51_Hit:dtaa.Hit 2
  TargetBouncer Activeball, 1
  End Sub
  Sub sw52_Hit:dtaa.Hit 3
  TargetBouncer Activeball, 1
  End Sub
  Sub sw53_Hit:dtaa.Hit 4
  TargetBouncer Activeball, 1
  End Sub
  Sub sw54_Hit:dtaa.Hit 5
  TargetBouncer Activeball, 1
  End Sub
