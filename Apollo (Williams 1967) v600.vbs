' Apollo / IPD No. 77 / June 19, 1967 / 1 Player
' Williams Electronics, Incorporated (1967-1985) [Trade Name: Williams]
' VPX8 by jpsalas and Halen (graphics)
' B2S by Halen and hauntfreaks
' version 6.0.0
...
' Valores Constants
Const TableName = "apollo" ' file name to save highscores and other variables
Const cGameName = "apollo" ' B2S name
Const MaxPlayers = 1       ' 2 players can play
...
Sub DiverterF_Animate: Diverter.RotZ = DiverterF.CurrentAngle: End Sub
...
Sub GiOn 'enciende las luces GI
    Dim bulb
    PlaySound "fx_gion"
    LightSeqGi.Play SeqBlinking, , 1, 25
...
Sub Game_Init 'called at the start of a new game
    ...
    'Init variables?
    BumperPos = 0
    AdvancePos = 5 'start with the 5 count down on.
    ScoreValue = 0
...
Sub Bumper003_Hit 'left bumper2
    If Tilted Then Exit Sub
    PlaySoundAt "fx_bumper", Bumper003
    If LightBumper003.State Then
        AddScore 10
    Else
        Addscore 1
    End If
...
Sub Bumper004_Hit 'right bumper2
    If Tilted Then Exit Sub
    PlaySoundAt "fx_bumper", Bumper004
    If LightBumper004.State Then
        AddScore 10
    Else
        Addscore 1
    End If
...
Sub Bumper005_Hit 'top bumper
    If Tilted Then Exit Sub
    PlaySoundAt "fx_passive_bumper", Bumper005
    If LightBumper005. State Then Advance 1
End Sub
...
Sub UpdateBumpers
    ...
    End If
    BumperPos = ABS(BumperPos - 1)
End Sub

Sub Advance(step)
    AdvancePos = AdvancePos + step
    UpdateAdvance
End Sub

Sub UpdateAdvance
    Select Case AdvancePos
        Case 0:cd010.State = 1:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 0
        Case 1:cd010.State = 0:cd009.State = 1:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 0
        Case 2:cd010.State = 0:cd009.State = 0:cd008.State = 1:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 0
        Case 3:cd010.State = 0:cd009.State = 0:cd008.State = 0:cd007.State = 1:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 0
        Case 4:cd010.State = 0:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 1:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 0
        Case 5:cd010.State = 0:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 1:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 0
        Case 6:cd010.State = 0:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 1:cd003.State = 0:cd002.State = 0:cd001.State = 0
        Case 7:cd010.State = 0:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 1:cd002.State = 0:cd001.State = 0
        Case 8:cd010.State = 0:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 1:cd001.State = 0
        Case 9:cd010.State = 0:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 1:Light020.State = 1
        Case 10:cd010.State = 1:cd009.State = 0:cd008.State = 0:cd007.State = 0:cd006.State = 0:cd005.State = 0:cd004.State = 0:cd003.State = 0:cd002.State = 0:cd001.State = 0:Light001.State = 1:AdvancePos = 0
    End Select
End Sub

Sub UpdateScoreLights 'side rockets and outlanes lights
    Dim i
    For each i in aScoreLights
        i.State = 0
    Next
    Select Case ScoreValue
        Case 0:Light010.State = 1:Light011.State = 1:Light005.State = 1:Light006.State = 1
        Case 1:Light013.State = 1:Light012.State = 1:Light004.State = 1:Light007.State = 1
        Case 2:Light015.State = 1:Light014.State = 1:Light003.State = 1:Light008.State = 1
        Case 3:Light017.State = 1:Light016.State = 1:Light002.State = 1:Light009.State = 1
    End Select
End Sub
...
Sub Trigger001_Hit 'left outlane
    ...
    If Light003.State Then AddScore 300
    If Light004.State Then AddScore 100
    If Light005.State Then AddScore 50
End Sub

Sub Trigger002_Hit 'right outlane
    PlaySoundAt "fx_sensor", Trigger002
    If Tilted Then Exit Sub
    If Light009.State Then AwardSpecial
    If Light008.State Then AddScore 300
    If Light007.State Then AddScore 100
    If Light006.State Then AddScore 50
End Sub

Sub Trigger002_UnHit:DiverterF.RotateToStart:End Sub

Sub Trigger003_Hit 'top left
...
Sub ChangeTrigger_Hit 'top
    PlaySoundAt "fx_sensor", ChangeTrigger
    If Tilted Then Exit Sub
    UpdateBumpers
End Sub
...
Sub cdtriger010_Hit
    PlaySoundAt "fx_sensor", cdtriger010
    If Tilted Then Exit Sub
    If cd010.State Then Advance 1
End Sub

Sub cdtriger009_Hit
    PlaySoundAt "fx_sensor", cdtriger009
    If Tilted Then Exit Sub
    If cd009.State Then Advance 1
End Sub

Sub cdtriger008_Hit
    PlaySoundAt "fx_sensor", cdtriger008
    If Tilted Then Exit Sub
    If cd008.State Then Advance 1
End Sub

Sub cdtriger007_Hit
    PlaySoundAt "fx_sensor", cdtriger007
    If Tilted Then Exit Sub
    If cd007.State Then Advance 1
End Sub

Sub cdtriger006_Hit
    PlaySoundAt "fx_sensor", cdtriger006
    If Tilted Then Exit Sub
    If cd006.State Then Advance 1
End Sub

Sub cdtriger005_Hit
    PlaySoundAt "fx_sensor", cdtriger005
    If Tilted Then Exit Sub
    If cd005.State Then Advance 1
End Sub

Sub cdtriger004_Hit
    PlaySoundAt "fx_sensor", cdtriger004
    If Tilted Then Exit Sub
    If cd004.State Then Advance 1
End Sub

Sub cdtriger003_Hit
    PlaySoundAt "fx_sensor", cdtriger003
    If Tilted Then Exit Sub
    If cd003.State Then Advance 1
End Sub

Sub cdtriger002_Hit
    PlaySoundAt "fx_sensor", cdtriger002
    If Tilted Then Exit Sub
    If cd002.State Then Advance 1
End Sub

Sub cdtriger001_Hit
    PlaySoundAt "fx_sensor", cdtriger001
    If Tilted Then Exit Sub
    If cd001.State Then Advance 1
End Sub

' 1 point rebounds

Sub rsband007_Hit:AddScore 1:UpdateBumpers:End Sub
Sub rsband008_Hit:AddScore 1:UpdateBumpers:End Sub
Sub rsband009_Hit:AddScore 1:UpdateBumpers:End Sub
Sub rsband010_Hit:AddScore 1:UpdateBumpers:End Sub
Sub rlband007_Hit:AddScore 1:UpdateBumpers:End Sub
Sub rlband003_Hit:AddScore 1:UpdateBumpers:End Sub

'Targets

Sub Target001_Hit 'top center
    PlaySoundAtBall "fx_target"
    If Tilted Then Exit Sub
    If Light020.State Then
        Addscore 300
        DiverterF.RotateToEnd
        PlaySoundAt "fx_diverter", DiverterF
        Light020.State = 0
        ScoreValue = ScoreValue + 1
        If ScoreValue> 3 Then ScoreValue = 3
        UpdateScoreLights
    Else
        Addscore 100
        Advance 1
...
Sub Target004_Hit
    PlaySoundAtBall "fx_target"
    If Tilted Then Exit Sub
    If Light017.State Then Addscore 300
    If Light015.State Then Addscore 100
    If Light013.State Then Addscore 50
    If Light010.State Then Addscore 10
End Sub

Sub Target005_Hit
    PlaySoundAtBall "fx_target"
    If Tilted Then Exit Sub
    If Light016.State Then Addscore 300
    If Light014.State Then Addscore 100
    If Light012.State Then Addscore 50
    If Light011.State Then Addscore 10
End Sub

'Shoot the rocket ball
Dim RocketBallPos
Dim RocketPath

Sub ShootRocketBall
    RocketBallPos = 0      'to display the ball
    RocketPath = RndNbr(5) '5 different paths, choose one at random
    RocketBallTimer.Enabled = 1
End Sub

Sub RocketBallTimer_Timer
    If B2SOn then
    Select Case RocketPath
        Case 1
            Select Case RocketBallPos
                Case 0:Controller.B2SSetData 1,1
                Case 1:Controller.B2SSetData 1,0:Controller.B2SSetData 2,1
                Case 2:Controller.B2SSetData 2,0:Controller.B2SSetData 3,1
                Case 3:Controller.B2SSetData 3,0:Controller.B2SSetData 4,1
                Case 5:Controller.B2SSetData 4,0:Controller.B2SSetData 5,1
                Case 6:Controller.B2SSetData 5,0:Controller.B2SSetData 6,1
                Case 7:Controller.B2SSetData 6,0:Controller.B2SSetData 7,1
                Case 8:Controller.B2SSetData 7,0:Controller.B2SSetData 8,1
                Case 9:Controller.B2SSetData 8,0:Controller.B2SSetData 11,1
                Case 10:Controller.B2SSetData 11,0:Controller.B2SSetData 14,1
                Case 11:Controller.B2SSetData 14,0:Controller.B2SSetData 18,1
                Case 12: Addscore 50: Light001.State = 0
                Case 17:Controller.B2SSetData 18,0:RocketBallTimer.Enabled = 0
            End Select
        Case 2
            Select Case RocketBallPos
                Case 0:Controller.B2SSetData 1,1
                ...
                Case 7:Controller.B2SSetData 6,0:Controller.B2SSetData 7,1
                Case 8:Controller.B2SSetData 7,0:Controller.B2SSetData 8,1
                Case 9:Controller.B2SSetData 8,0:Controller.B2SSetData 9,1
                Case 10:Controller.B2SSetData 9,0:Controller.B2SSetData 12,1
                Case 11:Controller.B2SSetData 12,0:Controller.B2SSetData 15,1
                Case 12:Controller.B2SSetData 15,0:Controller.B2SSetData 19,1
                Case 13: Addscore 300: Light001.State = 0
                Case 18:Controller.B2SSetData 19,0:RocketBallTimer.Enabled = 0
            End Select
        Case 3
            Select Case RocketBallPos
                Case 0:Controller.B2SSetData 1,1
                ...
                Case 9:Controller.B2SSetData 8,0:Controller.B2SSetData 9,1
                Case 10:Controller.B2SSetData 9,0:Controller.B2SSetData 12,1
                Case 11:Controller.B2SSetData 12,0:Controller.B2SSetData 16,1
                Case 12:Controller.B2SSetData 16,0:Controller.B2SSetData 21,1
                Case 13: Addscore 300: Light001.State = 0
                Case 18:Controller.B2SSetData 21,0:RocketBallTimer.Enabled = 0
            End Select
        Case 4
            Select Case RocketBallPos
                Case 0:Controller.B2SSetData 1,1
                ...
                Case 8:Controller.B2SSetData 7,0:Controller.B2SSetData 8,1
                Case 9:Controller.B2SSetData 8,0:Controller.B2SSetData 9,1
                Case 10:Controller.B2SSetData 9,0:Controller.B2SSetData 10,1
                Case 11:Controller.B2SSetData 10,0:Controller.B2SSetData 13,1
                Case 12:Controller.B2SSetData 13,0:Controller.B2SSetData 16,1
                Case 13:Controller.B2SSetData 16,0:Controller.B2SSetData 20,1
                Case 14: AwardSpecial: Light001.State = 0
                Case 19:Controller.B2SSetData 20,0:RocketBallTimer.Enabled = 0
            End Select
        Case 5
            Select Case RocketBallPos
                Case 0:Controller.B2SSetData 1,1
                ...
                Case 10:Controller.B2SSetData 9,0:Controller.B2SSetData 10,1
                Case 11:Controller.B2SSetData 10,0:Controller.B2SSetData 13,1
                Case 12:Controller.B2SSetData 13,0:Controller.B2SSetData 17,1
                Case 13:Controller.B2SSetData 17,0:Controller.B2SSetData 22,1
                Case 14: Addscore 50: Light001.State = 0
                Case 19:Controller.B2SSetData 22,0:RocketBallTimer.Enabled = 0
            End Select
    End Select
End If
    Select Case RocketPath
        Case 1
            Select Case RocketBallPos
                Case 0:balr001.SetValue 1
                Case 1:balr001.SetValue 0:balr002.SetValue 1
                Case 2:balr002.SetValue 0:balr003.SetValue 1
                Case 3:balr003.SetValue 0:balr004.SetValue 1
                Case 5:balr004.SetValue 0:balr005.SetValue 1
                Case 6:balr005.SetValue 0:balr006.SetValue 1
                Case 7:balr006.SetValue 0:balr007.SetValue 1
                Case 8:balr007.SetValue 0:balr008.SetValue 1
                Case 9:balr008.SetValue 0:balr011.SetValue 1
                Case 10:balr011.SetValue 0:balr014.SetValue 1
                Case 11:balr014.SetValue 0:balr018.SetValue 1
                Case 12: Addscore 50: Light001.State = 0
                Case 17:balr018.SetValue 0:RocketBallTimer.Enabled = 0
            End Select
        Case 2
            Select Case RocketBallPos
                Case 0:balr001.SetValue 1
                ...
                Case 7:balr006.SetValue 0:balr007.SetValue 1
                Case 8:balr007.SetValue 0:balr008.SetValue 1
                Case 9:balr008.SetValue 0:balr009.SetValue 1
                Case 10:balr009.SetValue 0:balr012.SetValue 1
                Case 11:balr012.SetValue 0:balr015.SetValue 1
                Case 12:balr015.SetValue 0:balr019.SetValue 1
                Case 13: Addscore 300: Light001.State = 0
                Case 18:balr019.SetValue 0:RocketBallTimer.Enabled = 0
            End Select
        Case 3
            Select Case RocketBallPos
                Case 0:balr001.SetValue 1
                ...
                Case 9:balr008.SetValue 0:balr009.SetValue 1
                Case 10:balr009.SetValue 0:balr012.SetValue 1
                Case 11:balr012.SetValue 0:balr016.SetValue 1
                Case 12:balr016.SetValue 0:balr021.SetValue 1
                Case 13: Addscore 300: Light001.State = 0
                Case 18:balr021.SetValue 0:RocketBallTimer.Enabled = 0
            End Select
        Case 4
            Select Case RocketBallPos
                Case 0:balr001.SetValue 1
                ...
                Case 8:balr007.SetValue 0:balr008.SetValue 1
                Case 9:balr008.SetValue 0:balr009.SetValue 1
                Case 10:balr009.SetValue 0:balr010.SetValue 1
                Case 11:balr010.SetValue 0:balr013.SetValue 1
                Case 12:balr013.SetValue 0:balr016.SetValue 1
                Case 13:balr016.SetValue 0:balr020.SetValue 1
                Case 14: AwardSpecial: Light001.State = 0
                Case 19:balr020.SetValue 0:RocketBallTimer.Enabled = 0
            End Select
        Case 5
            Select Case RocketBallPos
                Case 0:balr001.SetValue 1
                ...
                Case 10:balr009.SetValue 0:balr010.SetValue 1
                Case 11:balr010.SetValue 0:balr013.SetValue 1
                Case 12:balr013.SetValue 0:balr017.SetValue 1
                Case 13:balr017.SetValue 0:balr022.SetValue 1
                Case 14: Addscore 50: Light001.State = 0
                Case 19:balr022.SetValue 0:RocketBallTimer.Enabled = 0
            End Select
    End Select

    RocketBallPos = RocketBallPos + 1
End Sub
