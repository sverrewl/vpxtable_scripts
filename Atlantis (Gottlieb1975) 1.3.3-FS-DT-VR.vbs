...
Sub Double1_Hit()
  ...
  if TableTilted=false then
    if Double1.IsDropped=0 then
      ...
      EMSPlayDropTargetDropSound Double1
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double2_Hit()
  ...
  if TableTilted=false then
    if Double2.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double2
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double3_Hit()
  ...
  if TableTilted=false then
    if Double3.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double3
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double4_Hit()
  ...
  if TableTilted=false then
    if Double4.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double4
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double5_Hit()
  ...
  if TableTilted=false then
    if Double5.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double5
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double6_Hit()
  ...
  if TableTilted=false then
    if Double6.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double6
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double7_Hit()
  ...
  if TableTilted=false then
    if Double7.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double7
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double8_Hit()
  ...
  if TableTilted=false then
    if Double8.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double8
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
Sub Double9_Hit()
  ...
  if TableTilted=false then
    if Double9.IsDropped=0 then
      ...
      DropTargetCounter=DropTargetCounter+2
      DropTargetLight.state=1
      EMSPlayDropTargetDropSound Double9
      SetMotor(5000)
      CheckAllDrops
    end if
  end if
...
End Sub
'SoundFXDOF("SpinACard_1_10_Point_Bell",128,DOFPulse,DOFChimes)
