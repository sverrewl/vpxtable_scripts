...
'
' RobbyKingPin:
' - nFozzy/Rothbauerw physics,Fleep sound with a lot of custom sounds from VPW's Rollercoaster Tycoon and VPW Dynamic Ball Shadows (Updated v.2.3)
...
' - Added RothbauerW Standup Target codes (Updated v.2.3)
...
' Special thanks to everybody involved during development and testing: Smaug, PinStratsDan, Primetime5K, Hay Jay, gtxjoe, bietekwiet, Wylte, BountyBob, Nestorgian, fluffhead35, redbone, guus_8005, geradg, Studlygoorite, Sinizin
'
'Shoutout to:
...
Sub Table1_Init
  ...
  With bsTrough
    ...
    ' Thalamus - added more randomness
    'Kickers
    ...
    bsKickerMegaTron.KickForceVar = 3
...
Sub SolModFlasher127(level)
  Objlevel(2) = level
  Dim Flashon : Flashon = 0
  If level > 0 And Flashon = 0 Then
    Sound_Flash_Relay 1, Flasherbase2
    Flashon = 1
  End If
  If level < 0.1 And Flashon = 1 Then
    Sound_Flash_Relay 0, Flasherbase2
    Flashon = 0
  End If
End Sub
...
Sub SolModFlasher126(level)
  ...
  End If
  If level < 0.1 And Flashon = 1 Then
    Sound_Flash_Relay 0, Flasherbase1
    Flashon = 0
  End If
End Sub
...
Sub SolModFlasher118(level)
  ...
  End If
  If level < 0.1 And Flashon = 1 Then
    Sound_Flash_Relay 0, Flasherbase3
    Flashon = 0
  End If
End Sub
...
Sub SolModFlasher121(level)
  ...
  End If
  If level < 0.1 And Flashon = 1 Then
    Sound_Flash_Relay 0, Flasherbase5
    Flashon = 0
  End If
End Sub
...
Sub SolModFlasher123(level)
  ...
  End If
  If level < 0.1 And Flashon = 1 Then
    Sound_Flash_Relay 0, Flasherbase4
    Flashon = 0
  End If
End Sub
...
Sub SolModFlasher132(level)
  ...
  Dim Flashon : Flashon = 0
  If level > 0 And Flashon = 0 Then
    Sound_Flash_Relay 1, Flasherbase6
    Flashon = 1
  End If
  If level < 0.1 And Flashon = 1 Then
    Sound_Flash_Relay 0, Flasherbase6
    Flashon = 0
  End If
End Sub
...
Dim OutlaneDifficulty, ApronMod, DecalMod, InstMod, FlipperMod, JetMod, SpotLightMod, GlassMod, DMDDecalMod, DMDDetail,TopperMod, LogoPosterMod
