...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Shock - Taito 1980" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    bsSaucer.InitSaucer sw2, 2, 190, 20
...
Sub UpdateLamps()
    ...
    Lamp 82, li82
    Lamp 83, li83
    Lampm 89, BumperL001a ' left
    Lamp 89, BumperL001  ' left
    Lampm 90, BumperL003a ' center
    Lamp 90, BumperL003  ' center
    Lampm 91, BumperL002a ' right
    Lamp 91, BumperL002  ' right
    Lampm 92, li92a
    Lampm 92, li92b
    Lampm 92, li92c
    Lamp 92, li92
