...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 52:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0, -0.05:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 62:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0, 0.05:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 72:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0, 0:End Sub

' Drain & Saucers
Sub Drain_Hit:Playsound "fx_drain":bsTrough.AddBall Me:End Sub
Sub sw2_Hit::PlaySound "fx_kicker_enter", 0, 1, -0.05:bsLeftSaucer.AddBall 0:End Sub
Sub sw3_Hit::PlaySound "fx_kicker_enter", 0, 1, -0.01:bsRightSaucer.AddBall 0:End Sub
...
Sub sw55_Hit:vpmTimer.PulseSw 55:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
