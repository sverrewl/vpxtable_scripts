...
'VPX table by JPSalas version 6.0.0
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Iron Maiden - Stern 1981" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub RightSlingShot2_Slingshot
    PlaySoundAt SoundFX("fx_slingshot", DOFContactors), Remk001
  DOF 102, DOFPulse
    r011.Visible = 1
    Remk001.RotX = 26
    RStep2 = 0
...
Sub Remk002F_Animate: Remk002.Rotx = Remk002F.CurrentAngle: End Sub
Sub Remk003F_Animate: Remk003.Rotx = Remk003F.CurrentAngle: End Sub
