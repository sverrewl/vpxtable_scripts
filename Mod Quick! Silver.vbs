...
'added for mod by anthias
'triggers on rhs ramp

sub Trigger001_hit:Controller.Switch(39)=1 : End Sub
sub Trigger001_unhit:Controller.Switch(39)=0:End Sub

sub Trigger002_hit:Controller.Switch(39)=1 : End Sub
sub Trigger002_unhit:Controller.Switch(39)=0:End Sub

sub Trigger003_hit:Controller.Switch(39)=1 : End Sub
sub Trigger003_unhit:Controller.Switch(39)=0:End Sub

sub Trigger004_hit:Controller.Switch(39)=1 : End Sub
sub Trigger004_unhit:Controller.Switch(39)=0:End Sub

sub Trigger005_hit:Controller.Switch(39)=1 : End Sub
sub Trigger005_unhit:Controller.Switch(39)=0:End Sub

sub Trigger006_hit:Controller.Switch(39)=1 : End Sub
sub Trigger006_unhit:Controller.Switch(39)=0:End Sub

sub Trigger007_hit:Controller.Switch(39)=1 : End Sub
sub Trigger007_unhit:Controller.Switch(39)=0:End Sub

sub Trigger008_hit:Controller.Switch(39)=1 : End Sub
sub Trigger008_unhit:Controller.Switch(39)=0:End Sub

sub Trigger009_hit:Controller.Switch(39)=1 : End Sub
sub Trigger009_unhit:Controller.Switch(39)=0:End Sub

sub Trigger010_hit:Controller.Switch(39)=1 : End Sub
sub Trigger010_unhit:Controller.Switch(39)=0:End Sub

sub VUK_hit()
elevatorup.enabled = True
'use bumper hits to score from rom for vuk
vpmTimer.PulseSw(9) : RandomSoundBumperTop Bumper1
vpmTimer.PulseSw(10) : RandomSoundBumperMiddle Bumper2
vpmTimer.PulseSw(11) : RandomSoundBumperBottom Bumper3
...
sub elevatorup_timer()
elevatorup.enabled = False
vuk.kick 10,75,1.5
end Sub
