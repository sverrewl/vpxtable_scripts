...
'
'  Hearts Gain / IPD No. 4406 / Inder 1971 / 1 Player
'  VPX8 version by JPSalas & akiles50000, version 6.0.0 - 2025
'
' ***********************************************************************
...
' Constant Values
Const TableName = "heartsgain" ' file name to save highscores and other variables
Const cGameName = "heartsgain" ' B2S name
Const MaxPlayers = 1           ' only 1 player this table
Const FreePlay = False         ' Free play or coins
Const Special1 = 5200      ' extra ball or credit
Const Special2 = 7100
Const Special3 = 8800
...
Sub SolLFlipper(Enabled)
    If Enabled Then
        PlaySoundAt "fx_flipperup", LeftFlipper: PlaySound "fx_buzz", -1, 1, Pan(LeftFlipper), 0, 0, 0, 0, AudioFade(LeftFlipper)
    DOF 201,1
        LeftFlipper.RotateToEnd
        LeftFlipperOn = 1
    Else
        PlaySoundAt "fx_flipperdown", LeftFlipper:StopSound "fx_buzz"
        DOF 201,0
...
Sub SolRFlipper(Enabled)
    If Enabled Then
        PlaySoundAt "fx_flipperup", RightFlipper:  PlaySound "fx_buzz", -1, 1, Pan(RightFlipper), 0, 0, 0, 0, AudioFade(RightFlipper)
    DOF 202,1
        RightFlipper.RotateToEnd
        RightFlipperOn = 1
    Else
        PlaySoundAt "fx_flipperdown", RightFlipper:StopSound "fx_buzz"
    DOF 202,0
...
Sub LeftFlipper_Animate:LeftFlipperTop.RotZ = LeftFlipper.CurrentAngle:  LeftFlipperRubber.RotZ = LeftFlipper.CurrentAngle:End Sub
Sub RightFlipper_Animate: RightFlipperTop.RotZ = RightFlipper.CurrentAngle: RightFlipperRubber.RotZ = RightFlipper.CurrentAngle: End Sub
...
Sub Clear_Match()
    Dim x
    For each x in aMatch:x.State = 0:next
    If B2SOn then
...
Sub AddScore(Points)
    ...
    Select Case Points
        ...
        Case 1000
            Add100 = Add100 + 5
            AddScore100Timer.Enabled = TRUE
            vpmtimer.AddTimer 1300, "Add100 = Add100 + 5:AddScore100Timer.Enabled = TRUE '"
    End Select
...
Sub AttractTimer_Timer 'db2s lights
Select Case AttractStep
 Case 0:Controller.B2SSetData 97, 0: Controller.B2SSetData 90, 1
 Case 1:Controller.B2SSetData 90, 0: Controller.B2SSetData 91, 1
 Case 2:Controller.B2SSetData 91, 0: Controller.B2SSetData 92, 1
 Case 3:Controller.B2SSetData 92, 0: Controller.B2SSetData 93, 1
 Case 4:Controller.B2SSetData 93, 0: Controller.B2SSetData 94, 1
 Case 5:Controller.B2SSetData 94, 0: Controller.B2SSetData 95, 1
 Case 6:Controller.B2SSetData 95, 0: Controller.B2SSetData 96, 1
 Case 7:Controller.B2SSetData 96, 0: Controller.B2SSetData 97, 1
End Select
AttractStep = (AttractStep + 1) MOD 8
End Sub
...
Sub Game_Init() 'called at the start of a new game
    ...
    light022.State = 1
    light023.State = 1
    'here also turn off the db2s lights
    If B2SOn then
    'Controller.B2SSet ???
    End If
    'joker 1
...
Sub ResetNewBallLights() 'init lights for new ball/player
    ...
    LiBumper3b.State = 0
  ' specials
    If Light015.State OR Light014.State Then
        TurnOffCards
    End If
End Sub
...
Sub ExchangeSpecials
Dim tmp
tmp = light014.State
light014.State = light015.State
light015.State = tmp
tmp = light012.State
light012.State = light008.State
light008.State = tmp
End Sub
...
Sub RubberBand008_Timer
    Select Case Rub008
        Case 1:r021.Visible = 0:r023.Visible = 1:RubberBand008.TimerEnabled = 1
        Case 2:r023.Visible = 0:r024.Visible = 1
        Case 3:r024.Visible = 0:r021.Visible = 1:RubberBand008.TimerEnabled = 0
    End Select
    Rub008 = Rub008 + 1
End Sub
...
Sub RubberBand009_Timer
    Select Case Rub009
        Case 1:r022.Visible = 0:r025.Visible = 1:RubberBand009.TimerEnabled = 1
        Case 2:r025.Visible = 0:r026.Visible = 1
        Case 3:r026.Visible = 0:r022.Visible = 1:RubberBand009.TimerEnabled = 0
    End Select
    Rub009 = Rub009 + 1
End Sub
...
Sub RubberBand006_Hit:Addscore 1:End Sub
Sub RubberBand007_Hit:Addscore 1:End Sub
...
Sub Bumper3_Hit
  ...
  DOF 206,2
    AddScore 10 + 90 * LiBumper3a.State
End Sub
...
Sub Trigger001_Hit
    ...
    If Tilted Then Exit Sub
    AddScore 50 + 950 * light001.State
End Sub

Sub Trigger002_Hit
    PlaySoundAt "fx_sensor", Trigger002
    If Tilted Then Exit Sub
    AddScore 50 + 950 * light002.State
    light022.State = 0
    ck.State = 1
    If B2SOn then
        Controller.B2SSetData 96, 1
    End If
    CheckCards
End Sub
...
Sub Trigger003_Hit
    ...
    If Tilted Then Exit Sub
    AddScore 50 + 950 * light005.State
    light023.State = 0
    ca.State = 1
    If B2SOn then
        Controller.B2SSetData 97, 1
    End If
    CheckCards
End Sub
...
Sub Trigger004_Hit
    ...
    If Tilted Then Exit Sub
    AddScore 50 + 950 * light006.State
End Sub
...
Sub Trigger012_Hit
    ...
    If Tilted Then Exit Sub
    Addscore 100
    If LastSwitchHit = "Trigger011" Then CheckJokers
...
Sub Trigger011_Hit
    ...
    If Tilted Then Exit Sub
    Addscore 100
    If LastSwitchHit = "Trigger012" Then CheckJokers
...
Sub Target004_hit 'J
    ...
    LiBumper2a.State = 1
    LiBumper2b.State = 1
    If Light014.State Then 'Special
        AwardSpecial
    End If
End Sub
...
Sub Target003_hit 'Q
    ...
    LiBumper2a.State = 0
    LiBumper2b.State = 0
    If Light015.State Then 'Special
        AwardSpecial
    End If
End Sub
...
Sub kicker1_Hit 'left
    PlaySoundAt "fx_kicker_enter", kicker1
    If Tilted Then kicker1.kick 125, 16:Exit Sub
    AddScore 50 + 450 * Light013.State
    If Light012.State Then AwardSpecial
    vpmtimer.addtimer 900, "PlaySoundAt ""fx_kicker"", kicker1: kicker1.kick 125, 16 '"
End Sub

Sub kicker2_Hit 'right
    PlaySoundAt "fx_kicker_enter", kicker2
    If Tilted Then kicker2.kick 235, 16:Exit Sub
    AddScore 50 + 450 * Light007.State
    If Light008.State Then AwardSpecial
    vpmtimer.addtimer 900, "PlaySoundAt ""fx_kicker"", kicker2: kicker2.kick 235, 16 '"
End Sub
...
Sub CheckCards
    If c7.State + c8.State + c9.State + c10.State + cj.State + cq.State + ck.State + ca.State = 8 Then
        'lit specials in J
    If light015.State = 0 Then
            light014.State = 1
        End If
    End If
End Sub
...
Sub CheckJokers
    Select Case Jokers
        Case 1:Jokers = 2:Light010.State = 1:LiBumper3a.State = 1:LiBumper3b.State = 1:light013.State = 1:Light007.State = 1
        Case 2:Jokers = 3:Light009.State = 1:LiBumper3a.State = 1:LiBumper3b.State = 1:light013.State = 0:Light007.State = 0:light012.State = 1:Light008.State = 0
        Case 3:LiBumper3a.State = 1:LiBumper3b.State = 1:AwardSpecial
    End Select
End Sub

Sub TurnOffCards 'after Special
    ' cards
    Light014.State = 0
    Light015.State = 0
    light018.State = 1
