...
Dim I, x, obj, bsTrough, bsTroughVUK, bsTroughSuperVUK, bsRocket, bsTrough8BL, nbb, tempo, sap, drp, B2sko, rl
Dim mUpperSaucer, mRightSaucer, bsUpperSaucer, bsRightSaucer, mmoon,bsball003, bsBall002, ball8, noball8, noball8b
...
If Table1.ShowDT = True Then b2sko=0
If b2son Then B2sko = 1
...
Sub MoonLock_Hit()
  If Controller.Switch(36) Then
    ...
    mmoon.MagnetOn = 0
    actvb=1
    PlaySoundAtVol "SolenoidOff", MoonLock, 1
...
Sub sw54_Hit()
  ...
  PlaySoundAtVol "kicker_enter", sw54, 1
