...
' base on Kiss - Bally 1979
' re-themed,mods,art,lighting by HauntFreaks
' nfozzy physics add by Apophis
' fleep sounds added by Scampa123
' drop target shadows Apophis
' LUT chander Scampa123, Apophis  (right Magnasave/right Control key)
' music changer added by Apophis  (left Magnasave/left Control key)
...
'********************
'
' Use left magnasave button to change the song
' Use right magnasave to change the LUT
'
...
Const TargetBouncerFactor = 0.9   'Level of bounces. 0.2 - 1.5 are probably usable values.
...
sub PlayNextSong
  EndMusic
  If musicNum = 0 then PlayMusic "sdookiss\Kiss - Foo Fighters - Detroit Rock City.mp3" End If
  If musicNum = 1 then PlayMusic "sdookiss\Kiss - My Superhero - Scooby Doo Theme.mp3" End If
  If musicNum = 2 then PlayMusic "sdookiss\Kiss - Lenny Kravitz - Deuce.mp3" End If
  If musicNum = 3 then PlayMusic "sdookiss\Kiss - Motorhead - shout it out loud.mp3" End If
  If musicNum = 4 then PlayMusic "sdookiss\Kiss - Dont Touch My Ascot.mp3" End If
...
'Const cGameName = "kissc"
'Const cGameName = "kissp" ' voice prototype currently doesn't work in vpm
Const cGameName = "kissb" ,UseSolenoids=2,UseLamps=1,UseGI=1,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SFlipperOn="fx_Flipperup",SFlipperOff="fx_Flipperdown"  'bootleg 7 digits rom
...
' Initiate Table
'**********************************************************************************************************
Dim bsTrough, dtBank1, obj

Sub Table1_Init
  playsound "scooby_mystery"
  vpmInit Me
  On Error Resume Next
  With Controller
    .GameName = cGameName
...
Sub NextLUT: LUTImage = (LUTImage +1 ) MOD 16: UpdateLUT: SaveLUT: End Sub
...
Sub Table1_KeyDown(ByVal KeyCode)
  ...
  If keycode = RightMagnaSave Then bLutActive= True: NextLUT: End If
  ...
  If keycode=StartGameKey then soundStartButton(): PlayNextSong
...
Sub Table1_KeyUp(ByVal KeyCode)
  ...
  'Change LUT
  If keycode = RightMagnaSave Then bLutActive = False
...
'scoring rubbers
Sub Sling3_Hit:vpmTimer.PulseSw 25:End Sub
Sub Sling4_Hit:vpmTimer.PulseSw 25:End Sub
Sub Sling5_Hit:vpmTimer.PulseSw 25:End Sub

'Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 38: PlaySoundAt SoundFX("scooby_bump1",DOFContactors),Bumper1:RandomSoundBumperTop Bumper1: End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 40: PlaySoundAt SoundFX("scooby_bump2",DOFContactors),Bumper2:RandomSoundBumperTop Bumper2: End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 37: PlaySoundAt SoundFX("scooby_bump3",DOFContactors),Bumper3:RandomSoundBumperTop Bumper3: End Sub
'Sub Bumper4_Hit:vpmTimer.PulseSw 39: PlaySoundAt SoundFX("scooby_bump1",DOFContactors),Bumper4: End Sub

'Rollovers
Sub sw34_Hit:Controller.Switch(34) = 1 : PlaySoundAtVol "scooby_zoinks",sw34,.5: End Sub
Sub sw34_UnHit:Controller.Switch(34) = 0:End Sub
Sub sw27_Hit:Controller.Switch(27) = 1 : End Sub
Sub sw27_UnHit:Controller.Switch(27) = 0:End Sub
Sub sw26_Hit:Controller.Switch(26) = 1 : End Sub
Sub sw26_UnHit:Controller.Switch(26) = 0:End Sub
Sub sw33_Hit:Controller.Switch(33) = 1 : PlaySoundAtVol "scooby_zoinks",sw33,.5: End Sub
Sub sw33_UnHit:Controller.Switch(33) = 0:End Sub
Sub sw24_Hit:Controller.Switch(24) = 1 : End Sub
Sub sw24_UnHit:Controller.Switch(24) = 0:End Sub
Sub sw23_Hit:Controller.Switch(23) = 1 : End Sub
Sub sw23_UnHit:Controller.Switch(23) = 0:End Sub
Sub sw5_Hit:Controller.Switch(5) = 1 : PlaySoundAtVol "kiss",sw5,.5: End Sub
...
'Spinners
Sub SPinner1_Spin():vpmTimer.PulseSw 31 : PlaySoundAtVol "Scooby Spinner",Spinner1,2: End Sub
Sub SPinner2_Spin():vpmTimer.PulseSw 30 : PlaySoundAtVol "Scooby Spinner",Spinner2,2: End Sub

' Droptargets
Sub sw1_Hit:dtbank1.Hit 1
  PlaySound "scooby_k"
  ShadowK.visible=False
End Sub
Sub sw2_Hit:dtbank1.Hit 2
  PlaySound "scooby_i"
  ShadowI.visible=False
End Sub
Sub sw3_Hit:dtbank1.Hit 3
  PlaySound "scooby_s"
  ShadowS1.visible=False
End Sub
Sub sw4_Hit:dtbank1.Hit 4
  PlaySound "scooby_s"
  ShadowS2.visible=False
End Sub
...
Sub RightSlingShot_Slingshot
  ...
  PlaySoundAt SoundFX("scooby_sling2",DOFContactors),SLING1
  RSling.Visible = 0
  RSling1.Visible = 1
  sling1.TransZ = -20
  RStep = 0
...
Sub LeftSlingShot_Slingshot
  ...
  PlaySoundAt SoundFX("scooby_sling1",DOFContactors),SLING2
  LSling.Visible = 0
  LSling1.Visible = 1
  sling2.TransZ = -20
  LStep = 0
