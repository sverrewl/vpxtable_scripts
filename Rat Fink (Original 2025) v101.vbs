' Rat Fink, using the rom from Speed Test - Taito 1982 / IPD No. 4589 / 4 Players
' This is an unique table.
' VPX8 - version by JPSalas 2025, version 1.0.1
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Rat Fink" & vbNewLine & "VPX table by JPSalas v1.0.1"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    bsLeftSaucer.InitSaucer sw4, 4, 0, 24
...
Sub RightSlingShot1_Timer
    Select Case RStep1
        Case 1:RightSLing7.Visible = 0:RightSLing6.Visible = 1:Remk1.RotX = 14
        Case 2:RightSLing6.Visible = 0:RightSLing5.Visible = 1:Remk1.RotX = 2
        Case 3:RightSLing5.Visible = 0:Remk1.RotX = -20:RightSlingShot1.TimerEnabled = 0
    End Select
    RStep1 = RStep1 + 1
End Sub
...
Sub Bumper001_Hit:vpmTimer.PulseSw 13:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper001:End Sub
