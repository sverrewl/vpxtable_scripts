...
Sub Bumper2_Hit:vpmTimer.PulseSw 34:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0.05:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 64:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, -0.05:End Sub
Sub Bumper4_Hit:vpmTimer.PulseSw 54:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0.05:End Sub

' Drain & Saucers
Sub Drain_Hit:Playsound "fx_drain":bsTrough.AddBall Me:End Sub
Sub sw2_Hit::PlaySound "fx_kicker_enter", 0, 1, 0.05:bsSaucer2.AddBall 0:End Sub
Sub sw3_Hit::PlaySound "fx_kicker_enter", 0, 1, -0.05:bsSaucer.AddBall 0:End Sub
Sub sw4_Hit::PlaySound "fx_kicker_enter", 0, 1, 0.05:bsSaucer3.AddBall 0:End Sub
...
Sub sw74_Hit:Controller.Switch(74) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):x12.Duration 1, 300, 0:End Sub
Sub sw74_UnHit:Controller.Switch(74) = 0:End Sub

Sub sw71_Hit:Controller.Switch(71) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall):x13.Duration 1, 300, 0:End Sub
Sub sw71_UnHit:Controller.Switch(71) = 0:End Sub

' Spinners
Sub sw55_Spin:vpmTimer.PulseSw 55:PlaySound SoundFX("fx_spinner", DOFContactors), 0, 1, 0.05:End Sub

'Targets
Sub sw72_Hit:vpmTimer.PulseSw 72:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
...
Sub sw32_Hit:vpmTimer.PulseSw 32:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
Sub sw42_Hit:vpmTimer.PulseSw 42:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
Sub sw52_Hit:vpmTimer.PulseSw 52:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
Sub sw51_Hit:vpmTimer.PulseSw 51:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
