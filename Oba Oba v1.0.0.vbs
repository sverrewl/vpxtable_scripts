...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Oba Oba - Taito 1980" & vbNewLine & "VPX table by JPSalas v.1.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub sw13_Hit:vpmTimer.PulseSw 13:PlaySoundAtVol SoundFX("fx_rubber_band", DOFDropTargets), ActiveBall, VolRB:End Sub
...
Sub RubberBand7_Hit:Rub2 = 1:RubberBand7_Timer:End Sub
Sub RubberBand7_Timer
    Select Case Rub2
        Case 1:r4.Visible = 0:r5.Visible = 1:RubberBand7.TimerEnabled = 1
        Case 2:r5.Visible = 0:r6.Visible = 1
        Case 3:r6.Visible = 0:r4.Visible = 1:RubberBand7.TimerEnabled = 0
    End Select
    Rub2 = Rub2 + 1
End Sub
...
Sub Bumper3_Hit:vpmTimer.PulseSw 34:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper3,VolBump:End Sub

' Drain & Saucers
Sub Drain_Hit:PlaysoundAtVol "fx_drain",drain,1:bsTrough.AddBall Me:End Sub
Sub sw4_Hit::PlaySoundAtVol "fx_kicker_enter",sw4,VolKick:bsSaucer.AddBall 0:End Sub
...
Sub sw32_Dropped:dtbank1.Hit 4:End Sub
Sub sw42_Dropped:dtbank1.Hit 5:End Sub

'Targets
Sub sw5_Hit:vpmTimer.PulseSw 5:PlaySoundAtVol SoundFX("fx_target", DOFDropTargets),ActiveBall,VolTarg:End Sub
Sub sw15_Hit:vpmTimer.PulseSw 15:PlaySoundAtVol SoundFX("fx_target", DOFDropTargets),ActiveBall,VolTarg:End Sub
...
Sub sw54_Hit:vpmTimer.PulseSw 54:PlaySoundAtVol SoundFX("fx_target", DOFDropTargets),ActiveBall,VolTarg:End Sub
