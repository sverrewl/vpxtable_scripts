...
Sub sw13_Hit:vpmTimer.PulseSw 13:PlaySound SoundFX("fx_rubber_band", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
...
Sub Bumper2_Hit:vpmTimer.PulseSw 44:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0.05:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 34:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0:End Sub

' Drain & Saucers
Sub Drain_Hit:Playsound "fx_drain":bsTrough.AddBall Me:End Sub
Sub sw4_Hit::PlaySound "fx_kicker_enter", 0, 1, 0.05:bsSaucer.AddBall 0:End Sub
...
Sub sw45_Hit:vpmTimer.PulseSw 45:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
Sub sw54_Hit:vpmTimer.PulseSw 54:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
