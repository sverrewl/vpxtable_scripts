...
Const cOptions = "PostTime_1969.txt"
Const HSFileName="Post Time (Williams 1969)"
...
Sub Table1_init
  ...
  Select Case (gameOption)
    Case 1: cards.image = "cards1"
    Case 2: cards.image = "cards2"
    Case 3: cards.image = "cards3"
  End Select
  tilt = False
  state = False
  gameState
...
Sub drain_Hit()
  ...
  Select Case (gameOption)
    Case 1: nextBall
    Case 2: If extraBalls > 0 Then
          decreaseEB
          drainEB = 1
          extendPlay.enabled = 1
        Else
          nextBall
        End If
    Case 3: nextBall
...
Sub triggers_hit(index)
  If tilt = False Then
    Select Case (index)
      Case 0: addScore 100: bumperAOn: advanceRaceSegment
      Case 1: addScore 300: advanceRaceSegment3
      Case 2: addScore 100: bumperBOn: advanceRaceSegment
      Case 3: addScore 1000: If LOuterLn_Lgt.state = 1 Then advanceRace
      Case 4: addScore 1000: bumperAOn: If LInnerLn_Lgt.state = 1 Then advanceRace
      Case 5: addscore 1000: bumperBOn: If RInnerLn_Lgt.state = 1 Then advanceRace
      Case 6: addScore 1000: If ROuterLn_Lgt.state = 1 Then advanceRace
    End Select
  End If
...
Sub targets_hit(index)
  ...
  If tilt = False Then
    Select Case (index)
      Case 0: addScore 300: bumperCOn: advanceRaceSegment3
      Case 1: addScore 1000: bumperAOn
      Case 2: addScore 1000: bumperBOn
      Case 3: addScore 1000: bumperCOn
      Case 4: addScore 1000: bumperDOn
      Case 5: addScore 300: bumperDOn: advanceRaceSegment3
...
Sub extraBallPayOut
  extraBalls = extraBalls + 1
  If extraBalls > 5 Then extraBalls = 5
...
'**************Score Motor Routine
Dim bellRing, scoreMotorLoop, kickerUp, KickBonus
...
'  These Flags are passed by scores with multiple of 10, 100 or 1000
  ...
  If raceMotor = 1 Then
    Select Case scoreMotorLoop
      ...
      Case 6: scoreMotorLoop = 0: scoreMotorEnabled = 0
    End Select
  End If

  If scoreMotorLoop > 6 Then scoreMotorLoop = 0: scoreMotor.enabled = 0
