...
Sub Bumpers_Hit(Index)
  If Tilt = False Then
    Select Case (Index)
      Case 0: PlaysoundAtVol SoundFXDOF("fx_Bumper1",105,DOFPulse,DOFContactors), ActiveBall, VolBump
      Case 1: PlaysoundAtVol SoundFXDOF("fx_Bumper2",106,DOFPulse,DOFContactors), ActiveBall, VolBump
      Case 2: PlaysoundAtVol SoundFXDOF("fx_Bumper3",107,DOFPulse,DOFContactors), ActiveBall, VolBump
    End Select
...
Sub Mushrooms_Hit(Index)
  ...
  If Tilt = False Then
    Select Case (Index)
      Case 0: RubberM1.timerenabled = 1: PlaysoundAtVol"MRCollision", ActiveBall, 1: AdvanceRightSideLaneBonus: AddScore 100: If B2SOn Then DOF 114, DOFPulse
      Case 1: RubberM2.timerenabled = 1: PlaysoundAtVol"MRCollision", ActiveBall, 1: AdvanceRightSideLaneBonus: AddScore 100: If B2SOn Then DOF 116, DOFPulse
      Case 2: RubberM3.timerenabled = 1: PlaysoundAtVol"MRCollision", ActiveBall, 1: UpPost: CollectBonus: If B2SOn Then DOF 115, DOFPulse
    End Select
  End If
End Sub
