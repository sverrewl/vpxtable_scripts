...
Sub Bumper2_Hit:vpmTimer.PulseSw 42 : playsoundAtVol"fx_bumper1", Bumper2, VolBump: End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 40 : playsoundAtVol"fx_bumper1", Bumper3, VolBump: End Sub
...
'Generic Sounds
Sub Trigger1_Hit:PlaysoundAtVol"Ball Drop",Trigger1, 1:End Sub ' ball drop
Sub Trigger2_Hit:PlaysoundAtVol"Ball Drop",Trigger2, 1:End Sub ' ball drop
Sub Trigger3_Hit:playsoundAtVol"Wire Ramp",Trigger3, 1:End Sub ' wire ramp
