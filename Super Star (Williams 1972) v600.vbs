...
'*********************************
' BlueTargetValue = 1     ' Number of bonus: 1 for 5 ball, 2,3 or 4 for 3 ball
' LibertyMode = False     ' if True SU and ER lights er linked totgether, best for 3 ball game

' Table1.Option arguments are:
' - option name, minimum value, maximum value, step between valid values, default value, unit (0=None, 1=Percent), an optional array of literal strings

Dim LUTImage, BallsPerGame, BlueTargetValue, LibertyMode
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    If BallsPerGame = 5 Then BlueTargetValue = 1: LibertyMode = False
    If BallsPerGame = 3 Then BlueTargetValue = 3: LibertyMode = True
End Sub
