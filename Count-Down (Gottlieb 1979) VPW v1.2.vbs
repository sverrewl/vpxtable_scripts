...
' 1.1.7 - apophis - Added gate hit sound effect. Increased drain kicker strength.
' 1.1.8 - mcarter78 - Make chimes optional, default to just ROM sounds
' 1.1.9 - Mecha_Enron - Changed Desktop background and made reels darker
' 1.2   Release
...
' LightLevel = Table1.Option("Table Brightness (Ambient Light Level)", 0, 1, 0.01, .5, 1)
  ...
  v = Table1.Option("Sounds", 0, 1, 1, 0, 0, Array("ROM Sounds", "ROM & Chimes"))
  SetPlayChimes(v)
...
SolCallback(3) = "If PlayChimes = 1 Then VpmSolSound""10pts"","
SolCallback(4) = "If PlayChimes = 1 Then VpmSolSound""100chime"","
SolCallback(5) = "If PlayChimes = 1 Then VpmSolSound""1000chime"","
