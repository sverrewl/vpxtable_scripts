' ****************************************************************
' Universe / IPD No. 2705 / October, 1959 / 1 Player
...
' Valores Constants
Const TableName = "universe" ' se usa para cargar y grabar los highscore y creditos
Const cGameName = "universe" ' para el B2S
Const MaxPlayers = 1        ' de 1 a 4
Const MaxMultiplier = 1     ' limita el bonus multiplicador a 5
Const Special1 = 1300       ' puntuación a obtener para partida extra
Const Special2 = 1500       ' puntuación a obtener para partida extra
Const Special3 = 1600       ' puntuación a obtener para partida extra
...
Sub LeftFlipper001_Animate: LeftFlipperP001.RotZ = LeftFlipper001.CurrentAngle: LeftFlipperRubber001.Rotz = LeftFlipper001.CurrentAngle: End Sub
Sub RightFlipper001_Animate: RightFlipperP001.RotZ = RightFlipper001.CurrentAngle:RightFlipperRubber001.Rotz = RightFlipper001.CurrentAngle: End Sub
...
Dim LightPos
Dim SpecialAwarded
Dim AdvancePos   'to calculate the Trips done
Dim AdvanceSteps 'steps from the targets/triggers
Dim Trips        'the number of trips
...
Sub Check1to8
    Dim tmp
    tmp = Light014.State + Light015.State + Light016.State + Light017.State + Light010.State + Light012.State + Light002.State + Light003.State
    If tmp = 0 AND SpecialAwarded = False Then
        SpecialAwarded = True
        Light011.State = 1
        AwardSpecial
End If
...
Sub Advance(steps)
    AdvanceSteps = AdvanceSteps + steps
    AdvanceTimer.Enabled = 1
End Sub

Sub AdvanceTimer_Timer
    If AdvanceSteps> 0 Then
        PlaySound "advance"
    If B2SOn then
        Controller.B2SSetData 60 +AdvancePos ,0 'turn off the last position
    End If
        AdvancePos = AdvancePos + 1
        AdvanceSteps = AdvanceSteps -1
        rocket.setvalue AdvancePos
    If B2SOn then
        Controller.B2SSetData 60 +AdvancePos ,1
    End If
        If AdvancePos> 14 Then
            AdvancePos = 0
            Trips = Trips + 1
            UpdateTrips
        End If
    Else
        AdvanceTimer.Enabled = 0
    End If
End Sub

Sub UpdateTrips
    Select Case Trips
        Case 0:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0:tr10.State = 0:tr20.State = 0
        Case 1, 11, 21:tr1.State = 1:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0
        Case 2, 12, 22:tr1.State = 0:tr2.State = 1:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0
        Case 3, 13, 23:tr1.State = 0:tr2.State = 0:tr3.State = 1:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0
        Case 4, 14, 24:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 1:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0
        Case 5, 15, 25:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 1:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0
        Case 6, 16, 26:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 1:tr7.State = 0:tr8.State = 0:tr9.State = 0
        Case 7, 17, 27:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 1:tr8.State = 0:tr9.State = 0
        Case 8, 18, 28:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 1:tr9.State = 0
        Case 9, 19, 29:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 1
        Case 10:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0:tr10.State = 1:tr20.State = 0
        Case 20:tr1.State = 0:tr2.State = 0:tr3.State = 0:tr4.State = 0:tr5.State = 0:tr6.State = 0:tr7.State = 0:tr8.State = 0:tr9.State = 0:tr10.State = 0:tr20.State = 1
    End Select
    If trips = 9 OR Trips = 11 OR Trips = 12 OR Trips = 14 Then AwardSpecial
    If B2SOn then
Dim i
    Select Case Trips
        Case 0: For i = 41 to 51: Controller.B2SSetData i ,0: Next
        Case 1, 11, 21:Controller.B2SSetData 41 ,1
        Case 2, 12, 22:Controller.B2SSetData 41 ,0: Controller.B2SSetData 42 ,1
        Case 3, 13, 23:Controller.B2SSetData 42 ,0: Controller.B2SSetData 43 ,1
        Case 4, 14, 24:Controller.B2SSetData 43 ,0: Controller.B2SSetData 44 ,1
        Case 5, 15, 25:Controller.B2SSetData 44 ,0: Controller.B2SSetData 45 ,1
        Case 6, 16, 26:Controller.B2SSetData 45 ,0: Controller.B2SSetData 46 ,1
        Case 7, 17, 27:Controller.B2SSetData 46 ,0: Controller.B2SSetData 47 ,1
        Case 8, 18, 28:Controller.B2SSetData 47 ,0: Controller.B2SSetData 48 ,1
        Case 9, 19, 29:Controller.B2SSetData 48 ,0: Controller.B2SSetData 49 ,1
        Case 10:Controller.B2SSetData 49 ,0: Controller.B2SSetData 50 ,1
        Case 20:Controller.B2SSetData 50 ,0: Controller.B2SSetData 51 ,1
    End Select
    End If
End Sub
...
Sub Trigger014_Hit
    PlaySoundAt "fx_hole_enter", Trigger014
    If Tilted Then Exit Sub
    If Light011.State Then
        AwardSpecial
    Elseif Light018.State Then
        Addscore 300
    Elseif Light019.State Then
        Addscore 200
    Elseif Light020.State Then
        Addscore 100
    End If
End Sub
...
'***********************
' Roration of the lights
'***********************

Sub RotateLights
    PlaySound "Gion"
    Select Case LightPos
        Case 0:BumperL002.State = 1:BumperL003.State = 0:BumperL001.State = 0:Light020.State = 0:Light019.State = 1:Light018.State = 0
        Case 1:BumperL002.State = 0:BumperL003.State = 1:BumperL001.State = 0:Light020.State = 1:Light019.State = 0:Light018.State = 0
        Case 2:BumperL002.State = 0:BumperL003.State = 0:BumperL001.State = 1:Light020.State = 0:Light019.State = 0:Light018.State = 1
    End Select
    LightPos = (LightPos + 1) MOD 3
End Sub
