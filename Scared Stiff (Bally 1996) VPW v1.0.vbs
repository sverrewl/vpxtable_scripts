...
'SolCallback(10) = "Left Sling"   'Not Required
'SolCallback(11) = "Right Sling"  'Not Required
...
Sub sw64_Timer()
  ...
  dir1 = dir1 + dCos(dir1) * updown1 * FrogSpeed * (FrameTime/7)
...
Sub sw65_Timer()
  ...
  dir2 = dir2 + dCos(dir2) * updown2 * FrogSpeed * (FrameTime/7)
...
Sub sw66_Timer()
  ...
  dir3 = dir3 + dCos(dir3) * updown3 * FrogSpeed * (FrameTime/7)
