...
Sub SolRocketLift(Enabled)
  If Enabled Then
    ...
    PlaySound SoundFX("Motor_long",DOFContactors)
  Else
    StopSound SoundFX("Motor_long",DOFContactors)
  End If
End Sub
...
'2.1.2  Added standalone capability
'   Patched fix for upcoming 10.8.0 final and 10.8.1 VPX builds.  vpminit.me needed to be added.
'   Removed pinmametimer initialization.  Done in core.vbs now.
'2.1.3  Resized and moved the images for the playfield display
'2.1.4  Ended sound for rocket when not moving
