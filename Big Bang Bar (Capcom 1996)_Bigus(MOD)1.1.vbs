...
'Subway to sw52
 Sub sw53_Hit:PlaySound "popper_ball":sw53.DestroyBall:vpmTimer.PulseSwitch 53, 100, "HandleTrough":sw38a.enabled = 1:End Sub
 Sub sw54_Hit:PlaySound "popper_ball":sw54.DestroyBall:vpmTimer.PulseSwitch 54, 100, "HandleTrough":End Sub
...
'Ramp entrance Gate Triggers
 ...
 ' Ramp Triggers
 Sub sw45_Hit:Controller.Switch(45) = 1 : PlaySound "Wire Ramp":End Sub
 Sub sw45_UnHit:Controller.Switch(45) = 0:End Sub
 Sub sw47_Hit:Controller.Switch(47) = 1 : PlaySound "Wire Ramp":End Sub
 Sub sw47_UnHit:Controller.Switch(47) = 0:End Sub
 Sub sw57_Hit:Controller.Switch(57) = 1 : PlaySound "Wire Ramp":End Sub
 Sub sw57_UnHit:Controller.Switch(57) = 0:End Sub

 'Stand Up Targets
 Sub sw20_Hit:vpmTimer.PulseSw 20:sw20.TimerEnabled = 1:sw20p.TransX = -12 : playsound SoundFX("Target",DOFTargets) : End Sub
 Sub sw20_unHit:sw20p.TransX = 0:End Sub
 Sub sw21_Hit:vpmTimer.PulseSw 21:sw21.TimerEnabled = 1:sw21p.TransX = -12 : playsound SoundFX("Target",DOFTargets) : End Sub
 Sub sw21_unHit:sw21p.TransX = 0:End Sub
 Sub sw22_Hit:vpmTimer.PulseSw 22:sw22.TimerEnabled = 1:sw22p.TransX = -12 : playsound SoundFX("Target",DOFTargets) : End Sub
 Sub sw22_unHit:sw22p.TransX = 0:End Sub
 Sub sw28_Hit:vpmTimer.PulseSw 28:sw28.TimerEnabled = 1:sw28p.TransX = -12 : playsound SoundFX("Target",DOFTargets) : End Sub
 Sub sw28_unHit:sw28p.TransX = 0:End Sub
 Sub sw29_Hit:vpmTimer.PulseSw 29:sw29.TimerEnabled = 1:sw29p.TransX = -12 : playsound SoundFX("Target",DOFTargets) : End Sub
 Sub sw29_unHit:sw29p.TransX = 0:End Sub
 Sub sw30_Hit:vpmTimer.PulseSw 30:sw30.TimerEnabled = 1:sw30p.TransX = -12 : playsound SoundFX("Target",DOFTargets) : End Sub
 ...
 Sub sw56_Spin:vpmTimer.pulsesw 56 : playsound"fx_spinner" : End Sub
...
' Tombstone 
 Sub rip_Hit:vpmTimer.pulsesw 37:PlaySound SoundFX("Target",DOFTargets):End Sub
...
Sub Trigger3_Hit:PlaySound "fx_ballrampdrop":StopSound "Wire Ramp":End Sub
