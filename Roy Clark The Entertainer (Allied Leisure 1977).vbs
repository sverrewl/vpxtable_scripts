...
Const cGameName="royclark",cCredits="Roy Clark The Entertainer",UseSolenoids=1,UseLamps=1,UseGI=0,UseSync=1
...
Sub Table1_Init
  ...
  If D0="" Then 'Data doesn't exist, create it
    ...
    D7=64
    D8=1
    SaveValue "royclark","D00",D0
   SaveValue "royclark","D01",D1
   SaveValue "royclark","D02",D2
   SaveValue "royclark","D03",D3
   SaveValue "royclark","D04",D4
   SaveValue "royclark","D05",D5
   SaveValue "royclark","D06",D6
   SaveValue "royclark","D07",D7
   SaveValue "royclark","D08",D8
 Else
    D0=LoadValue("royclark","D00")
    D1=LoadValue("royclark","D01")
    D2=LoadValue("royclark","D02")
    D3=LoadValue("royclark","D03")
    D4=LoadValue("royclark","D04")
    D5=LoadValue("royclark","D05")
    D6=LoadValue("royclark","D06")
    D7=LoadValue("royclark","D07")
    D8=LoadValue("royclark","D08")
  End If
