' Hot Ball / IPD No. 4665 / 1979 / 4 Players
...
Const cGameName = "eightbll" 'uses the Bally ROM since the Taito rom is not available.
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Hot Ball - Taito 1979" & vbNewLine & "VPX table by JPSalas v6.0.0"
...
Sub editDips
    ...
    With vpmDips
        .AddForm 700, 400, "Hot Ball Settings"
