' Sure Shot / IPD No. 4574 / 1981 / 4 Players
' VPX8 - version by JPSalas 2020, version 6.0.0
...
Dim bsTrough, bsTopSaucer, dtBank1, dtBank2, dtBank3, dtBank1up, x

Const cGameName = "sureshot"
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Sure Shot - Taito 1981" & vbNewLine & "VPX table by JPSalas v6.0.0"
    ...
    bsTopSaucer.InitSaucer sw2, 2, 315, 18
    ...
    dtbank1.initsnd SoundFX("fx_droptarget_solenoid", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
    dtbank1.CreateEvents "dtbank1"

     set dtbank2 = new cvpmdroptarget
         dtbank2.initdrop array(sw12, sw22, sw32, sw42), array(12, 22, 32, 42)
    dtbank2.initsnd SoundFX("fx_droptarget_solenoid", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
    dtbank2.CreateEvents "dtbank2"

     set dtbank3 = new cvpmdroptarget
         dtbank3.initdrop sw52, 52
    dtbank3.initsnd SoundFX("fx_droptarget_solenoid", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
...
Sub rlband007_Hit:vpmTimer.PulseSw 55:Rub1 =1:rlband007_Timer:End Sub
Sub rlband007_Timer
    Select Case Rub1
        Case 1:r002.Visible = 0:r009.Visible = 1:rlband007.TimerEnabled = 1
        Case 2:r009.Visible = 0:r010.Visible = 1
        Case 3:r010.Visible = 0:r002.Visible = 1:rlband007.TimerEnabled = 0
    End Select
    Rub1 = Rub1 + 1
End Sub

Sub rlband006_Hit:vpmTimer.PulseSw 65:Rub2 =1:rlband006_Timer:End Sub
Sub rlband006_Timer
    Select Case Rub2
        Case 1:r001.Visible = 0:r011.Visible = 1:rlband006.TimerEnabled = 1
        Case 2:r011.Visible = 0:r012.Visible = 1
        Case 3:r012.Visible = 0:r001.Visible = 1:rlband006.TimerEnabled = 0
    End Select
    Rub2 = Rub2 + 1
End Sub

Sub rsband004_Hit:Rub3 =1:rsband004_Timer:End Sub
Sub rsband004_Timer
    Select Case Rub3
        Case 1:r005.Visible = 0:r007.Visible = 1:rsband004.TimerEnabled = 1
        Case 2:r007.Visible = 0:r008.Visible = 1
        Case 3:r008.Visible = 0:r005.Visible = 1:rsband004.TimerEnabled = 0
    End Select
    Rub3 = Rub3 + 1
End Sub
