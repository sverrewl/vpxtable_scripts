...
sub newgame
	...
	matchtxt.text=" "
   	Drain.kick 60,25,0
    PlaySound SoundFXDOF("ballrelease",128,DOFPulse,DOFContactors)
end sub
...
Sub resetDT
    PlaySound SoundFXDOF("BankReset",117,DOFPulse,DOFContactors), 0, 1, -0.05, 0.05
...
Sub KickerL_Timer():
	KickerL.kick 70, 20
    PlaySound SoundFXDOF("holekick",114,DOFPulse,DOFContactors)
	DOF 135, DOFPulse
	Me.TimerEnabled= 0
End Sub
...
Sub OnBallBallCollision(ball1, ball2, velocity)
  If Pyramid.VersionMinor > 3 OR Pyramid.VersionMajor > 10 Then
