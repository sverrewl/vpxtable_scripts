...
Sub RampEntry1_Hit()	'left ramp entry
 	If activeball.vely < -10 then 
		PlaySound "ramp_hit2", 0, Vol(ActiveBall)/5, Pan(ActiveBall), 0, Pitch(ActiveBall)*10, 1, 0
	Elseif activeball.vely > 3 then 
		PlaySound "PlayfieldHit", 0, Vol(ActiveBall), Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
	End If
End Sub
...
Sub Diverter_Hit()
	playsound "metalhit_medium", 0, Vol(ActiveBall)/5, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
End Sub
...
Sub RampSounds_Hit (idx)
	PlaySound "ramp_hit1", 0, Vol(ActiveBall)/2, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
End Sub
...
End Sub
Sub Targets_Hit (idx)
	PlaySound SoundFX("target",DOFTargets), 0, 0.1, Pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0
	PlaySound SoundFX("targethit",0), 0, Vol(ActiveBall)*9, Pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0
End Sub
...
Sub ApronWalls_Hit (idx)
	PlaySound "woodhitaluminium", 0, (Vol(ActiveBall)^2.5)*10, Pan(ActiveBall)/4, 0, Pitch(ActiveBall), 1, 0
End Sub
...
Sub Rubbers_Hit(idx)
 	...
 	If finalspeed > 20 then 
		PlaySound "fx_rubber2", 0, Vol(ActiveBall)*10, Pan(ActiveBall)*3, 0, Pitch(ActiveBall), 1, 0
	End if
...
Sub RandomSoundRubber()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySound "rubber_hit_1", 0, Vol(ActiveBall)*5, Pan(ActiveBall)*3, 0, Pitch(ActiveBall), 1, 0
		Case 2 : PlaySound "rubber_hit_2", 0, Vol(ActiveBall)*5, Pan(ActiveBall)*3, 0, Pitch(ActiveBall), 1, 0
		Case 3 : PlaySound "rubber_hit_3", 0, Vol(ActiveBall)*5, Pan(ActiveBall)*3, 0, Pitch(ActiveBall), 1, 0
	End Select
End Sub
...
Sub RandomSoundFlipper()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySound "flip_hit_1", 0, Vol(ActiveBall)*5, Pan(ActiveBall)*6, 0, Pitch(ActiveBall), 1, 0
		Case 2 : PlaySound "flip_hit_2", 0, Vol(ActiveBall)*5, Pan(ActiveBall)*6, 0, Pitch(ActiveBall), 1, 0
		Case 3 : PlaySound "flip_hit_3", 0, Vol(ActiveBall)*5, Pan(ActiveBall)*6, 0, Pitch(ActiveBall), 1, 0
	End Select
End Sub
