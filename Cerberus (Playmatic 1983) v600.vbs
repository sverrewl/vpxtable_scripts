' Cerberus / IPD No. 3004 / March, 1982 / 4 Players
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Cerberus - Playmatic 1982" & vbNewLine & "VPX8 table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub LeftFlipper_Collide(parm)
    PlaySound "fx_rubber_flipper", 0, Vol(ActiveBall), AudioPan(ActiveBall), 0.1, 0, 0, 0, AudioFade(ActiveBall)
End Sub
...
Sub sw24_Hit::PlaySoundAt "fx_kicker_enter", sw24:bsSaucer24.AddBall 0:End Sub
...
Sub sw32_Hit:Controller.Switch(32) = 1:End Sub 'right outlane, scores 10000 after the 3 3000 lights are off.
...
Sub sw37_Hit:Controller.Switch(37) = 1:lstar2.Duration 1, 250, 0:End Sub
Sub sw37_UnHit:Controller.Switch(37) = 0:End Sub

Sub sw38_Hit:Controller.Switch(38) = 1:lstar1.Duration 1, 250, 0:End Sub
Sub sw38_UnHit:Controller.Switch(38) = 0:End Sub

Sub sw25_Hit:Controller.Switch(25) = 1:lstar3.Duration 1, 250, 0:End Sub
...
'**********************************************************
'     JP's Lamp Fading for this table
'**********************************************************
...
Sub UpdateLamps()
    ...
    Lamp 25, l025
    Lamp 26, l026
    Lamp 27, l027 'Continuos Balls
    LampCi 28, aGi28
    Lamp 29, l029
    Lamp 30, l030
    Lamp 31, l031 'Alternate Balls
    LampCi 32, aGi32
    Lamp 33, l033
    Lamp 34, l034
    Lamp 35, l035
...
Sub LampC(nr, col)
    Dim x
    Select Case FadingStep(nr)
        Case 1:For each x in col:x.state = 1:FadingStep(nr) = -1:Next
        Case 0:For each x in col:x.state = 0:FadingStep(nr) = -1:Next
    End Select
End Sub

' Inverted collection of lights - all the Gi lights in this table

Sub LampCi(nr, col)
    Dim x
    Select Case FadingStep(nr)
        Case 0:For each x in col:x.state = 1:FadingStep(nr) = -1:Next
        Case 1:For each x in col:x.state = 0:FadingStep(nr) = -1:Next
    End Select
End Sub
