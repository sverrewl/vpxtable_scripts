...
'SolCallback(sLRFlipper)="vpmSolFlipper RightFlipper,Flipper2,"
	...
	Sub SolLFlipper(Enabled)
		 If Enabled Then
			 PlaySound SoundFX("fx_FlipperUp",DOFContactors):LeftFlipper.RotateToEnd:Flipper1.RotateToEnd
		 Else
			 PlaySound SoundFX("fx_FlipperDown",DOFContactors):LeftFlipper.RotateToStart:Flipper1.RotateToStart
		 End If
	  End Sub

	Sub SolRFlipper(Enabled)
		 If Enabled Then
			 PlaySound SoundFX("fx_FlipperUp",DOFContactors):RightFlipper.RotateToEnd:Flipper2.RotateToEnd
		 Else
			 PlaySound SoundFX("fx_FlipperDown",DOFContactors):RightFlipper.RotateToStart:Flipper2.RotateToStart
		 End If
	End Sub
