...
'
' Torpedo!! / IPD No. 4371 / 1976 / 1 Player (Petaco)
' Torpedo!! / IPD No. 2601 / 1976 / 1 Player (Recel)
'
...
' Valores Constants
Const cGameName = "Torpedo" ' B2S name & file name to save highscores and other variables
...
' *********************************************************************
'                Common routines to all the tables
' *********************************************************************
...
Sub Kicker001_Hit
    If NOT Tilted Then
        ...
        Addscore 500
    End If
    vpmtimer.AddTimer 2000, "DOF 230,DOFPulse:DOF 105,DOFPulse:PlaySoundAt ""fx_kicker"", Kicker001: Kicker001.Kick 68, 10 '"
End Sub
