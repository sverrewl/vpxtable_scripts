...
Sub RightSlingShot_Slingshot
    PlaySoundAt SoundFX("Slingshot",DOFContactors), sling1
    RSling.Visible = 0
    RSling1.Visible = 1
	sling1.TransZ = -30
    RStep = 0
...
Sub Drop_Hit
	Playsound "BallHit", 0, 1, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
	Drop.TimerEnabled = 1
End Sub
...
Sub Drop2_Hit
	Playsound "BallHit", 0, (Vol(ActiveBall)*.75), Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
...
Sub WireRampTrigger_Hit
	PlaysoundAt "Rail", WireRampTrigger
End Sub
...
Sub RandomSoundRubber()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySound "rubber_hit_1", 0, (Vol(ActiveBall)*2)*VolRH, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 2 : PlaySound "rubber_hit_2", 0, (Vol(ActiveBall)*2)*VolRH, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 3 : PlaySound "rubber_hit_3", 0, (Vol(ActiveBall)*2)*VolRH, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
	End Select
End Sub
...
Sub RandomSoundFlipper()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySound "flip_hit_1", 0, (Vol(ActiveBall)*2)*VolFlip, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 2 : PlaySound "flip_hit_2", 0, (Vol(ActiveBall)*2)*VolFlip, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
		Case 3 : PlaySound "flip_hit_3", 0, (Vol(ActiveBall)*2)*VolFlip, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall)
	End Select
End Sub
...
Sub SwampTrigger_hit
	Playsound "SwampHit", 0, Vol(ActiveBall), Pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
