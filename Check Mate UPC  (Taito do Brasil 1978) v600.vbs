...
'               Check Mate - Taito do Brasil 1978
' ****************************************************************
'
Option Explicit
Randomize
...
Sub BonusCountTimer_Timer 'añade los bonos y actualiza las luces
    ...
    If Bonus > 0 Then
        Bonus = Bonus -1
        AddScore 1000 * DoubleBonus: playSound"points10"
        UpdateBonusLights
    Else
...
Sub UpdateBonusLights
    For x = 0 to 15 '16 bonus lights, bonus count
        If aBonusLights(x).State = 1 Then
            aBonusLights(x).State = 0
            Exit Sub
        End If
    Next
    If BankLDown Then
...
Sub UpdateBallInPlay 'actualiza los marcadores de las bolas, el número de jugador y el número total de jugadores
    ...
    plReel.SetValue PlayersPlayingGame
    If B2SOn then
...
Sub AwardExtraBall()
    If NOT bExtraBallWonThisBall Then
        PlaySound SoundFXDOF("points_special", 300, DOFPulse, DOFKnocker)
        DOF 230, DOFPulse
        DOF 200, DOFOn
        ExtraBallsAwards(CurrentPlayer) = ExtraBallsAwards(CurrentPlayer) + 1
...
Sub LeftSlingShot_Slingshot
    ...
    AddScore 100: playSound"points100"
...
Sub rlband003_Hit
    If NOT Tilted Then
        ' añade 10 puntos
        AddScore 10: playSound"points10"
    End If
End Sub
...
Sub Drop1_Hit
    ...
    DOF 240, DOFPulse
    If Tilted Then Exit Sub
    AddScore 500: playSound"points100"
    AddBonus 1
    li3.State = 1
    ' haz algún chequeo
    CheckLBankTargets
...
Sub Target1_hit
    ...
    DOF 214, DOFPulse
    If Tilted Then Exit Sub
    AddScore 1000: playSound"points1000"
    AddBonus 1
    If li9.State = 0 Then
        BumperL001.State = 1
        BumperL001a.State = 1
...
Sub CheckRBankTargets
    ...
    Next                                        'mira si todas las dianas están abatidas
    If tmp = 8 Then
    PlaySound "Sino"            'todas las dianas han sido tumbadas
