...
Sub Bumper2_Hit:vpmTimer.PulseSw 64:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper2,VolBump:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 54:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper3,VolBump:End Sub

' Spinners

Sub sw52_Spin:vpmTimer.PulseSw 52:PlaySoundAtVol "spinner",sw52,VolSpin:End Sub
