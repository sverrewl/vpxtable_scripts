...
Dim bsTrough, dtbank3, dtbank5, bsSaucer, x

Const cGameName = "shock"
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Shock - Taito 1980" & vbNewLine & "VPX table by JPSalas v.1.0.1"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    bsSaucer.InitSaucer sw2, 2, 220, 20
    ...
    dtbank3.InitDrop Array(sw14, sw24, sw34), Array(14, 24, 34)
    dtbank3.initsnd SoundFX("", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)

    set dtbank5 = new cvpmdroptarget
    dtbank5.InitDrop Array(sw15, sw25, sw35, sw45, sw55), Array(15, 25, 35, 45, 55)
...
Sub sw65_Timer
    Select Case Rub1
        Case 1:r5.Visible = 0:r10.Visible = 1:sw65.TimerEnabled = 1
        Case 2:r10.Visible = 0:r11.Visible = 1
        Case 3:r11.Visible = 0:r5.Visible = 1:sw65.TimerEnabled = 0
    End Select
    Rub1 = Rub1 + 1
End Sub

Sub sw42_Hit:vpmTimer.PulseSw 42:Rub2 = 1:sw42_Timer:End Sub
Sub sw42_Timer
    Select Case Rub2
        Case 1:r1.Visible = 0:r12.Visible = 1:sw42.TimerEnabled = 1
        Case 2:r12.Visible = 0:r13.Visible = 1
        Case 3:r13.Visible = 0:r1.Visible = 1:sw42.TimerEnabled = 0
    End Select
    Rub2 = Rub2 + 1
End Sub

Sub sw63_Hit:vpmTimer.PulseSw 63:Rub3 = 1:sw63_Timer:End Sub
Sub sw63_Timer
    Select Case Rub3
        Case 1:r7.Visible = 0:r14.Visible = 1:sw63.TimerEnabled = 1
        Case 2:r14.Visible = 0:r15.Visible = 1
        Case 3:r15.Visible = 0:r7.Visible = 1:sw63.TimerEnabled = 0
    End Select
    Rub3 = Rub3 + 1
End Sub

Sub sw62_Hit:vpmTimer.PulseSw 62:Rub4 = 1:sw62_Timer:End Sub
Sub sw62_Timer
    Select Case Rub4
        Case 1:r8.Visible = 0:r16.Visible = 1:sw62.TimerEnabled = 1
        Case 2:r16.Visible = 0:r17.Visible = 1
        Case 3:r17.Visible = 0:r8.Visible = 1:sw62.TimerEnabled = 0
    End Select
    Rub4 = Rub4 + 1
End Sub

' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 44:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, -0.05:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 64:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0.05:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 54:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0:End Sub

' Spinners

Sub sw52_Spin:vpmTimer.PulseSw 52:PlaySound "spinner", 0, 1, 0, 0.15:End Sub

' Drain & Saucers
Sub Drain_Hit:Playsound "fx_drain":bsTrough.AddBall Me:End Sub
Sub sw2_Hit::PlaySound "fx_kicker_enter", 0, 1, 0.05:bsSaucer.AddBall 0:End Sub
...
Sub sw45_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
Sub sw55_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
...
Sub sw15_Dropped:dtbank5.Hit 1:End Sub
Sub sw25_Dropped:dtbank5.Hit 2:End Sub
Sub sw35_Dropped:dtbank5.Hit 3:End Sub
Sub sw45_Dropped:dtbank5.Hit 4:End Sub
Sub sw55_Dropped:dtbank5.Hit 5:End Sub
Sub sw14_Dropped:dtbank3.Hit 1:End Sub
Sub sw24_Dropped:dtbank3.Hit 2:End Sub
Sub sw34_Dropped:dtbank3.Hit 3:End Sub

'Targets
Sub sw5_Hit:vpmTimer.PulseSw 5:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
Sub sw4_Hit:vpmTimer.PulseSw 4:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall):End Sub
...
SolCallback(2) = "SolFlash"
SolCallback(3) = "bsSaucer.SolOut"
SolCallback(4) = "dtbank3.SolDropUp"
SolCallback(13) = "dtbank5.SolDropUp"
SolCallback(14) = "SolGi"
...
Sub UpdateLamps()
    ...
    NFadeL 82, li82
    NFadeL 83, li83
    NFadeLm 89, libumper1a ' left
    NFadeLm 89, libumper1b ' left
    NFadeL 89, libumper1c  ' left
    NFadeLm 90, libumper3a ' center
    NFadeLm 90, libumper3b ' center
    NFadeL 90, libumper3c  ' center
    NFadeLm 91, libumper2a ' right
    NFadeLm 91, libumper2b ' right
    NFadeL 91, libumper2c  ' right
    NFadeLm 92, li92a
    NFadeLm 92, li92b
    NFadeLm 92, li92c
    NFadeL 92, li92
