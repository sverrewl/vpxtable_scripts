...
Const cGameName="cleoptra",UseSolenoids=1,UseLamps=1,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SCoin="coin"
...
' Added Playfield mesh (thanks @Thalamus)
' Gates and brackets positioned correctly
' Kickers eject angle corrected
' Light6 and Light16 are now working
' Fixed Playfield mistake around star triggers area
' Fixed Bumpers image (100 Points istad of 1000)
' New lights, new lighting
' Added Flippers Shadows and Ball Shadows
' New table physics
' Added new Gottlieb flippers primitives
' Reworked the GI
' EM rubber rebounder positined correctly
' Changed Drop Targets type and height so they don't disappear when down
...
' Adjusted general table physics
...
'Drain hole
 ...
 Sub Kicker1_Hit:SoundSaucerLock:bsSaucer1.AddBall 0:End Sub
 Sub Kicker1_UnHit:SoundSaucerKick 1, Kicker1:End Sub

 Sub Kicker2_Hit:SoundSaucerLock:bsSaucer2.AddBall 0:End Sub
 Sub Kicker2_UnHit:SoundSaucerKick 0, Kicker2:End Sub
...
'Standup Target
Sub sw12_Hit:vpmTimer.PulseSw 12 :PlaySound SoundFX("Target",DOFTargets),0,1,-0.15,0.1:End Sub
Sub sw13_Hit:vpmTimer.PulseSw 13 :PlaySound SoundFX("Target",DOFTargets),0,1,-0.15,0.1:End Sub
Sub sw14_Hit:vpmTimer.PulseSw 14 :PlaySound SoundFX("Target",DOFTargets),0,1,-0.15,0.1:End Sub

'lower Wire triggers
Sub sw1_Hit:Controller.Switch(33)=1 : End Sub
Sub sw1_Unhit:Controller.Switch(33)=0:End Sub
Sub sw2_Hit:Controller.Switch(34)=1 : End Sub
Sub sw2_Unhit:Controller.Switch(34)=0:End Sub
Sub sw3_Hit:Controller.Switch(20)=1 : End Sub
Sub sw3_Unhit:Controller.Switch(20)=0:End Sub
Sub sw4_Hit:Controller.Switch(21)=1 : End Sub
...
'Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 11 : RandomSoundBumperTop Bumper1 : End Sub
...
Sub Gate2_Hit:End Sub
Sub Gate3_Hit:End Sub
Sub Gate4_Hit:End Sub
...
Sub RandomSoundSlingshotLeft(sling)
        PlaySoundAtLevelStatic SoundFXDOF("Sling_L" & Int(Rnd*10)+1, 109, DOFPulse, DOFContactors), SlingshotSoundLevel, Sling
End Sub

Sub RandomSoundSlingshotRight(sling)
        PlaySoundAtLevelStatic SoundFXDOF("Sling_R" & Int(Rnd*8)+1, 110, DOFPulse, DOFContactors), SlingshotSoundLevel, Sling
End Sub
