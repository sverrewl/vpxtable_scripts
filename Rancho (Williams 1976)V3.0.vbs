' ******************************************************************
'      VPX10.8 - version by Klodo81 2023, Rancho version 3.0
'
'                     Based on:
...
'- @Outhere support topic: Separate DOF Solenoids (Config 5115,5277)
'
' ******************************************************************
...
' Bumpers L/R - 105/106
' Targets C/R - 211/212
' Reset Drop Targets - 108
' BallRelease - 109
' Targets Round - 201
' Kickers L/R- 131/132/133/204
' Triggers - 205 to 209
' Knocker - 110
' Chimes - 301/302/303
' Drain - 250
...
Sub KickBall
  PlaySoundAt SoundFXDOF ("fx_kicker", 131, DOFPulse, DOFContactors), kickerML
  PlaySoundAt SoundFXDOF ("fx_kicker", 133, DOFPulse, DOFContactors), kickerR
  kickerTL.kick 205, 10 : kickerML.kick 125, 10 : kickerR.kick 0, 20
End Sub
...
Sub Target1_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 211, DOFPulse, DOFDropTargets), Target1
    If Tilted Then Exit Sub
...
Sub Target2_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 211, DOFPulse, DOFDropTargets), Target2
    If Tilted Then Exit Sub
...
Sub Target3_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 212, DOFPulse, DOFDropTargets), Target3
    If Tilted Then Exit Sub
...
Sub ResetTarget
  ...
  PlaySoundAt SoundFXDOF ("fx_resetdrop", 108, DOFPulse, DOFContactors), Target2
End Sub
...
Dim Conservative  ' 0 = Liberal ; 1 = Conservative
...
Sub Table1_OptionEvent(ByVal eventId)
  ...
  ' Conservative ou Liberal
    Conservative = Table1.Option("Conservative ou Liberal", 0, 1, 1, 1, 0, Array("Liberal","Conservative"))
