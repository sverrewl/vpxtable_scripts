...
Sub Rubbers_Hit(idx)
    ...
    If finalspeed > 20 then
        PlaySound "rubber_hit_4", 0, Vol(ActiveBall), Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
    End if
...
Sub Wall38_Hit()
	PlaySound "rubber_hit_1", 0, Vol(ActiveBall), Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
End Sub
...
Sub RandomSoundBlastZone()
    Select Case Int(Rnd * 3) + 1
        Case 1:PlaySound "BlastZone_Hit1", 0, 1, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
        Case 2:PlaySound "BlastZone_Hit2", 0, 1, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
        Case 3:PlaySound "BlastZone_Hit3", 0, 1, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
    End Select
End Sub