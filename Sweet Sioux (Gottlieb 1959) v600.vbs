' Sweet Sioux / IPD No. 2475 / September, 1959 / 4 Players
' D. Gottlieb & Company (1931-1977) [Trade Name: Gottlieb]
' VPX8 table by jpsalas with graphics by Halen & BleedinFingers.
...
' Valores Constants
Const TableName = "sweetsioux" ' file name to save highscores and other variables
Const cGameName = "sweetsioux" ' B2S name
Const MaxPlayers = 4           ' 1 to 4 can play
Const MaxMultiplier = 2        ' limit bonus multiplier
Const FreePlay = False         ' Free play or coins
Const Special1 = 1100          ' extra ball or credit
Const Special2 = 1500
Const Special3 = 1700
Const Special4 = 1900
...
Sub rlband008_Hit:AddScore 1:End Sub
Sub rlband009_Hit:AddScore 1:End Sub
Sub rlband010_Hit:AddScore 1:End Sub
...
' Spin Targets
' 15 positions:
' 10, 20, 10, 30, 10, 40, 10, 50, 10, 20, 10, 30, 10, 40, 50
...
Dim SpinPos, SpinCount, SpinTargetValue
SpinTargetValue = Array(10, 50, 40, 10, 30, 10, 20, 10, 50, 10, 40, 10, 30, 10, 20)
SpinPos = 0

Sub SpinTargets
    If SpinTimer.Enabled = 0 Then
        SpinCount = RndNbr(10) * 24
        SpinTimer.Enabled = 1
    End If
End Sub

Sub SpinTimer_Timer
    SpinPos = (SpinPos + 1) MOD 360
    SpinCount = SpinCount - 1
    If SpinCount = 0 Then
        SpinTimer.Enabled = 0
    End If
    Roto2.RotZ = 360-SpinPos
End Sub
...
Sub roto2_Hit
    ...
    If Tilted Then Exit Sub
    'AddScore
    tmp = SpinTargetValue((SpinPos)\24 MOD 15)
    If bl8.State Then
        Addscore tmp * 10
    Else
        Addscore tmp
...
Sub LeftHole_Hit
    vpmTimer.AddTimer 1000, "LeftHoleW.IsDropped = 1 '"
    vpmTimer.AddTimer 3000, "LeftHoleW.IsDropped = 0 '"
End Sub
...
Sub Kicker001_Hit
    ...
    vpmTimer.AddTimer 1500, "Kicker003.Createball: kicker003.kick 180,0 '" 'do the normal end of ball
    'AddScore
    tmp = SpinTargetValue((SpinPos)\24 MOD 15)
    If bl14.State OR bl5.State Then
        Addscore tmp * 10
    Else
        Addscore tmp
    End If
...
Sub RightHole_Hit
    vpmTimer.AddTimer 1000, "RightHoleW.IsDropped = 1 '"
    vpmTimer.AddTimer 3000, "RightHoleW.IsDropped = 0 '"
End Sub
...
Sub Kicker002_Hit
    ...
    'AddScore
    tmp = SpinTargetValue((SpinPos)\24 MOD 15)
    If bl2.State OR bl11.State Then
        Addscore tmp * 10
    Else
        Addscore tmp
    End If
