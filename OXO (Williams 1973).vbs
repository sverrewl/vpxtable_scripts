...
Const cGameName = "OXO_1973"
Const hsFileName = "OXO (Williams 1973)"
Const cOptions = "OXO_1973_v2.28.txt"
...
Sub bootTable_Timer()
  ...
  End If
  If bootCount = 1 Then
    If vrOption > 0 Then vrBackGlass.image = "oxoOn"
    If B2SOn Then
...
Sub scoreKickers
  ...
  Else
    AddScore 500
  End If
  If ticTacToe = False Then addScore 500
End Sub
...
Sub addScore(points)
  ...
  If Tilt = False Then
    If Points <100 Then
      ...
      If MatchNumber > 9 Then MatchNumber = MatchNumber - 10
      If points > 10 Then
        BellRing = (Points / 10)
...
Dim FolderPath
  ...
  Set scoreFile = fileObj.createTextFile(userDirectory & cOptions,True)
    ...
    scoreFile.WriteLine "ReplayEB (0 = ExtraBall, 1 = Replay ): " & ReplayEB
    scoreFile.Close
  Set scoreFile = Nothing
  Set fileObj = Nothing
