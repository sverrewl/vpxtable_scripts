'Shooting the Rapids / IPD No. 3606 / April, 1979 / 4 Players
'Zaccaria, of Bologna, Italy (1974-1987)
'a VPX8 table by jpsalas - 2024, version 6.0.0
...
Dim bsTrough, dtL, bsSaucer, x, FlipperActive

Const cGameName = "strapids"
...
LoadVPM "01210000", "zac1.vbs", 3.1 'this used to be the code for the vpinmame revision needed, but it as been ignored for a long time ago.
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Shooting The Rapids - Zaccaria 1979" & vbNewLine & "VPX8 table by JPSalas v6.0.0"
    ...
    vpmNudge.TiltObj = Array(Bumper001, Bumper002, Bumper003, LeftSlingshot, RightSlingshot, Rightslingshot2)
    ...
    With dtL
        .InitDrop Array(sw40, sw41, sw42, sw43, sw44, sw45, sw46, sw47), Array(40, 41, 42, 43, 44, 45, 46, 47)
...
'Solenoids
'*********
'SolCallback(1)="vpmSolSound SoundFX(""sling"",DOFContactors),"
'SolCallback(2)="vpmSolSound SoundFX(""sling"",DOFContactors),"
'SolCallback(5)="vpmSolSound SoundFX(""sling"",DOFContactors),"
'SolCallback(6)="vpmSolSound SoundFX(""jet3"",DOFContactors),"
'SolCallback(7)="vpmSolSound SoundFX(""jet3"",DOFContactors),"
...
SolCallback(12) = "dtL.SolHit 8,"
SolCallback(13) = "dtL.SolHit 1,"
SolCallback(14) = "dtL.SolHit 2,"
SolCallback(15) = "dtL.SolHit 3,"
SolCallback(17) = "dtL.SolHit 4,"
SolCallback(18) = "dtL.SolHit 5,"
SolCallback(19) = "dtL.SolHit 6,"
SolCallback(20) = "dtL.SolHit 7,"
...
Sub RightSlingShot2_Timer
    Select Case RStep2
        Case 1:RightSLing008.Visible = 0:RightSLing007.Visible = 1:Remk2.RotX = 14
        Case 2:RightSLing007.Visible = 0:RightSLing006.Visible = 1:Remk2.RotX = 2
        Case 3:RightSLing006.Visible = 0:Remk2.RotX = -20:RightSlingShot2.TimerEnabled = 0
    End Select
    RStep2 = RStep2 + 1
End Sub
...
' Bumpers
Sub Bumper001_Hit:vpmTimer.PulseSw 36:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper001:End Sub
...
Sub RollingTimer_timer()
    ...
    If Controller.Lamp(7) AND oldstate7 = 0 Then 'gameover
        FlipperActive = False
        oldstate7 = 1
    ElseIf Controller.Lamp(7)= 0 AND oldstate7 = 1 Then
        FlipperActive = True
        oldstate7 = 0
    End If

    If Controller.Lamp(51) AND oldstate51 = 0 Then 'tilt
        FlipperActive = False
        SolLFlipper 0
        SolRFlipper 0
        ...
        GiOff
        oldstate51 = 1
    ElseIf Controller.Lamp(51)= 0 AND oldstate51 = 1 Then
        FlipperActive = True
