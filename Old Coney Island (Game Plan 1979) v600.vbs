'******************************************
'     Old Coney Isand - Game Plan 1979
' IPD No. 553 / December, 1979 / 4 Players
'          VPX8 version 6.0.0
'******************************************
...
Sub table1_KeyDown(ByVal Keycode)
    ...
    if keycode = "3" then vpmTimer.PulseSw 9
End Sub
...
Sub Target1_Hit:vpmTimer.PulseSw(19):PlaySoundAtBall SoundFX("fx_target", DOFTargets):End Sub
Sub Target2_Hit:vpmTimer.PulseSw(20):PlaySoundAtBall SoundFX("fx_target", DOFTargets):End Sub
Sub Bumper1_Hit:vpmTimer.PulseSw(21):PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper1:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw(22):PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:End Sub
...
Sub GIUpdate
    If LampState(53) <> OldGiState Then
        OldGiState = LampState(53)
        If LampState(53) = 0 Then
            GiOff
        Else
            GiOn
        End If
...
Sub UpdateLamps()
    ...
    Lamp 39, l39
    Lamp 40, l40 'Tilt
    Lamp 41, l41 'High Score to Date
    Lamp 42, l42
    Lampm 43, l43b
    Lamp 43, l43
    Lampi 44, l44
    ...
    Lamp 50, l50
    Lamp 51, l51
    Lampm 52, l52b 'same player shoot again - in backdrop
    Lamp 52, l52
    'Lamp 53, l53b 'gi + blink lane
    'Lamp 54, l54
    Lamp 55, l55
    Lamp 56, l56 'GAME OVER
    Lamp 57, l57 'players 1
    Lamp 58, l58 'players 2
    Lamp 59, l59 'players 3
    Lamp 60, l60 'players 4
'Lamp 61, l61
'Lamp 62, l62
'Lamp 63, l63
End Sub
...
Patterns(5) = 102   '4
Patterns(6) = 109   '5
Patterns(7) = 124   '125   '6
Patterns(8) = 7     '7
Patterns(9) = 127   '8
Patterns(10) = 103  '111  '9
...
Sub alanes_Hit(idx):PlaySoundAt "fx_sensor", alanes(idx):End Sub
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    ' Use Chimes or not
    x = Table1.Option("Use Chimes (nedds a restart)", 0, 1, 1, 0, 0, Array("No", "Yes") )
    If x Then
