...
'-------------------------------------------------------------------------------------------------------------
Decal=1          'Change value to =0 to remove Decal
'-------------------------------------------------------------------------------------------------------------
...
'Spinners
Sub Spinner_Spin:vpmTimer.PulseSw 60 : playsoundAtVol "fx_spinner",Spinner, 1 : End Sub
Sub Spinner1_Spin:vpmTimer.PulseSw 61 : playsoundAtVol "fx_spinner" ,Spinner1, 1: End Sub
