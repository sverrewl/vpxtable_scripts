...
' August 2021 rebuild
' HauntFreaks - v1.0 - rebuilt layout, PF modded to fit layout, new and cleaned images, lighting, object and GI shadows
'       - v1.2 - more PF ajustments, added primitive apron, rails, lockdown, added missing leaf switches
' Fluffhead35 - v1.0 - Added nFozzy Flippers, targetbouncer logic, flipper Rubberizer logic, and fleep sounds
'             - v1.2 - Realligned some posts and rubbers, Added missing Rubber Wall, Changed Rubber walls to Hit Threshold of 2
'             - Added slingshot sound for Fleep to scorring Rubbers, Removed old sounds not being used anymore
'             - Added logic to swap out ball card for 3 or 5 balls per game
...
Const FiveBallsCard = 1             ' 0 = 3 balls on card, 1 = five balls on card
...
Sub Table1_Init
  ...
  if FiveBallsCard Then
    vn_BallCard.Image = "card_5_ball"
  Else
    vn_BallCard.Image = "card_3_ball"
  End If
...
Sub creditCheck_Timer()
  If Light59.State > 0 Then
    vn_CreditLight.Image = "b_CreditLightOn"
  Else
    vn_CreditLight.Image = "b_CreditLightOff"
  End If
End Sub
...
Sub sw2a_Hit:Controller.Switch(2)=1 : End Sub
Sub sw2a_unHit:Controller.Switch(2)=0:End Sub

'scoring rubbers
Sub sw34e_Hit():vpmtimer.pulsesw 34 : RandomSoundSlingshotLeft sw34e: End Sub
Sub sw34f_Hit():vpmtimer.pulsesw 34 : RandomSoundSlingshotLeft sw34f: End Sub
Sub sw34g_Hit():vpmtimer.pulsesw 34 : RandomSoundSlingshotLeft sw34g: End Sub
Sub sw34h_Hit():vpmtimer.pulsesw 34 : RandomSoundSlingshotLeft sw34h: End Sub
...
Sub Bumper3_Hit:vpmTimer.PulseSw(40) : RandomSoundBumperMiddle Bumper3: End Sub
