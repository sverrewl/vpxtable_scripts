...
'           Lucky Star - Taito do Brasil 1978 - v6.0.0
' ****************************************************************
...
' Valores Constants
Const TableName = "LuckyStrike_1978"
Const cGameName = "LuckyStrike_1978"
...
Sub BonusCountTimer_Timer 'añade los bonos y actualiza las luces
    ...
    Select Case BonusCounter
        Case 1:AddScore 1000 * BonusMultiplier * Light001.State:If Light001.State Then Light001.State = 0: PlaySound"RCA4": End If
        Case 2:AddScore 1000 * BonusMultiplier * Light006.State:If Light006.State Then Light006.State = 0: PlaySound"RCA4": End If
        Case 3:AddScore 1000 * BonusMultiplier * Light005.State:If Light005.State Then Light005.State = 0: PlaySound"RCA4": End If
        Case 4:AddScore 1000 * BonusMultiplier * Light004.State:If Light004.State Then Light004.State = 0: PlaySound"RCA4": End If
        Case 5:AddScore 1000 * BonusMultiplier * Light007.State:If Light007.State Then Light007.State = 0: PlaySound"RCA4": End If
        Case 6:AddScore 1000 * BonusMultiplier * Light008.State:If Light008.State Then Light008.State = 0: PlaySound"RCA4": End If
        Case 7:AddScore 1000 * BonusMultiplier * Light009.State:If Light009.State Then Light009.State = 0: PlaySound"RCA4": End If
        Case 8:AddScore 1000 * BonusMultiplier * Light8_1.State:If Light8_1.State Then Light8_1.State = 0: PlaySound"RCA4": End If
        Case 9:AddScore 1000 * BonusMultiplier * Light003.State:If Light003.State Then Light003.State = 0: PlaySound"RCA": End If
        Case 10:AddScore 1000 * BonusMultiplier * Light10.State:If Light10.State Then Light10.State = 0: PlaySound"RCA": End If
        Case 11:AddScore 1000 * BonusMultiplier * Light11.State:If Light11.State Then Light11.State = 0: PlaySound"RCA": End If
        Case 12:AddScore 1000 * BonusMultiplier * Light12.State:If Light12.State Then Light12.State = 0: PlaySound"RCA": End If
        Case 13:AddScore 1000 * BonusMultiplier * Light13.State:If Light13.State Then Light13.State = 0: PlaySound"RCA": End If
        Case 14:AddScore 1000 * BonusMultiplier * Light14.State:If Light14.State Then Light14.State = 0: PlaySound"RCA": End If
        Case 15:AddScore 1000 * BonusMultiplier * Light15.State:If Light15.State Then Light15.State = 0: PlaySound"RCA": End If
        Case 16
...
Sub AwardSpecial()
  PlaySound SoundFXDOF ("Special", 130, DOFPulse, DOFKnocker)
    DOF 230, DOFPulse
    DOF 125, DOFOn
    AddCredits 1
End Sub
...
Sub rlband013_Hit
  ...
  PlaySound "RCA"
        AddScore 10
    End If
  Rub1= 1: rlband013_Timer
End Sub

Sub rlband013_Timer
    Select Case Rub1
        Case 1:r008.Visible = 0:r012.Visible = 1:rlband013.TimerEnabled = 1
        Case 2:r012.Visible = 0:r013.Visible = 1
        Case 3:r013.Visible = 0:r008.Visible = 1:rlband013.TimerEnabled = 0
    End Select
    Rub1 = Rub1 + 1
End Sub
...
Sub rlband014_Hit
  ...
  PlaySound "RCA"
        AddScore 10
    End If
  Rub2= 1: rlband014_Timer
End Sub

Sub rlband014_Timer
    Select Case Rub2
        Case 1:r008.Visible = 0:r010.Visible = 1:rlband014.TimerEnabled = 1
        Case 2:r010.Visible = 0:r011.Visible = 1
        Case 3:r011.Visible = 0:r008.Visible = 1:rlband014.TimerEnabled = 0
    End Select
    Rub2 = Rub2 + 1
End Sub
...
Sub rlband011_Hit
  ...
  PlaySound "RCA1"
        AddScore 10
    End If
  Rub3= 1: rlband011_Timer
End Sub

Sub rlband011_Timer
    Select Case Rub3
        Case 1:r009.Visible = 0:r014.Visible = 1:rlband011.TimerEnabled = 1
        Case 2:r014.Visible = 0:r015.Visible = 1
        Case 3:r015.Visible = 0:r009.Visible = 1:rlband011.TimerEnabled = 0
    End Select
    Rub3 = Rub3 + 1
End Sub
...
Sub rlband012_Hit
  ...
  PlaySound "RCA1"
        AddScore 10
    End If
  Rub4= 1: rlband012_Timer
End Sub

Sub rlband012_Timer
    Select Case Rub4
        Case 1:r009.Visible = 0:r016.Visible = 1:rlband012.TimerEnabled = 1
        Case 2:r016.Visible = 0:r017.Visible = 1
        Case 3:r017.Visible = 0:r009.Visible = 1:rlband012.TimerEnabled = 0
    End Select
    Rub4 = Rub4 + 1
End Sub
...
Sub Bumper1_Hit
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF ("fx_Bumper",106,DOFPulse,DOFContactors), bumper1
  PlaySound "RCA2"
    DOF 206, DOFPulse
    If Epileptikdof = True Then DOF 201, DOFPulse End If
    ' añade algunos puntos
...
Sub LitBumper:BumperL001.State = 1:BumperL001a.State = 1:End Sub
...
Sub sw002_Hit
  ...
  PlaySound "RCA5"
    DOF 212, DOFPulse
    AddScore 100 + 400 * LowerLightB.State
    LitBumper
End Sub
...
Sub sw003_Hit
  ...
  PlaySound "RCA5"
    DOF 213, DOFPulse
    AddScore 100 + 400 * LowerLightC.State
    LitBumper
End Sub
...
Sub sw005_Hit
  ...
  PlaySound "RCA6"
    DOF 215, DOFPulse
    AddScore 100 + 400 * UpperLightA.State
    UpperLightA.State = 1
    CheckDoubleBonus
End Sub
...
Sub sw006_Hit
  ...
  PlaySound "RCA5"
    DOF 216, DOFPulse
    AddScore 100 + 400 * UpperLightB.State
    UpperLightB.State = 1
    LowerLightB.State = 1
    CheckDoubleBonus
End Sub
...
Sub sw008_Hit
  ...
  PlaySound "RCA5"
    DOF 218, DOFPulse
    AddScore 100 + 400 * UpperLightC.State
    UpperLightC.State = 1
    LowerLightC.State = 1
    CheckDoubleBonus
End Sub
...
Sub sw009_Hit
  ...
  PlaySound "RCA6"
    DOF 219, DOFPulse
    AddScore 100 + 400 * UpperLightD.State
    UpperLightD.State = 1
CheckDoubleBonus
End Sub

Sub sw007_Hit 'centro
    PlaySoundAt "fx_sensor", sw007
    If Tilted Then Exit Sub
  PlaySound "RCA8"
    DOF 217, DOFPulse
    AddScore 500 + 500 * Light8_2.State
    Light8_1.State = 1
    Light8_2.State = 1
End Sub

Sub CheckDoubleBonus
    If UpperLightA.State + UpperLightB.State + UpperLightC.State + UpperLightD.State = 4 Then
        DoubleBonusWhenLit. State = 1
  End If
End Sub
...
Sub Target1_hit
  ...
  PlaySound "RCA9"
    DOF 236, DOFPulse
    Addscore 100
    If LightLeftTarget.State Then AwardSpecial
End Sub
...
Sub Target2_hit
  ...
  PlaySound "RCA9"
    DOF 226, DOFPulse
    Addscore 100
    If LightRightTarget.State Then AwardSpecial
End Sub
...
Sub sw010_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 105, DOFPulse, DOFDropTargets), sw010
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light001.State = 1
...
Sub sw011_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 105, DOFPulse, DOFDropTargets), sw011
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light006.State = 1
...
Sub sw012_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 105, DOFPulse, DOFDropTargets), sw012
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light005.State = 1
...
Sub sw013_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 105, DOFPulse, DOFDropTargets), sw013
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light004.State = 1
...
Sub sw014_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 105, DOFPulse, DOFDropTargets), sw014
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light007.State = 1
...
Sub sw015_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 105, DOFPulse, DOFDropTargets), sw015
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light008.State = 1
...
Sub sw016_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 105, DOFPulse, DOFDropTargets), sw016
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light009.State = 1
...
Sub CheckLeftBank
    If Light001.State + Light006.State + Light005.State + Light004.State + Light007.State + Light008.State + Light009.State = 7 Then
        If LightRightExtraBall.State Then
            LightLeftTarget.State = 1
        Else
            LightLeftExtraBall.State = 1
        End If
    End If
End Sub
...
Sub sw017_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 107, DOFPulse, DOFDropTargets), sw017
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light003.State = 1
...
Sub sw018_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 107, DOFPulse, DOFDropTargets), sw018
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light10.State = 1
...
Sub sw019_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 107, DOFPulse, DOFDropTargets), sw019
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light11.State = 1
...
Sub sw020_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 107, DOFPulse, DOFDropTargets), sw020
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light12.State = 1
...
Sub sw021_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 107, DOFPulse, DOFDropTargets), sw021
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light13.State = 1
...
Sub sw022_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 107, DOFPulse, DOFDropTargets), sw022
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light14.State = 1
...
Sub sw023_Hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 107, DOFPulse, DOFDropTargets), sw023
    If Tilted Then Exit Sub
  PlaySound "RCA15"
    Addscore 500
    Light15.State = 1
...
Sub CheckRightBank
    If Light003.State + Light10.State + Light11.State + Light12.State + Light13.State + Light14.State + Light15.State = 7 Then
        If LightLeftExtraBall.State Then
            LightRightTarget.State = 1
        Else
            LightRightExtraBall.State = 1
        End If
    End If
End Sub
...
Dim i
PlaySoundAt SoundFXDOF("fx_resetdrop",115,DOFPulse,DOFContactors), sw013
...
Dim i
PlaySoundAt SoundFXDOF("fx_resetdrop",117,DOFPulse,DOFContactors), sw020
...
Sub kicker001_Hit
  ...
  PlaySound "RCA3"
        ...
        End If
    End If
    vpmtimer.addtimer 1500, "DOF 230,DOFPulse:DOF 108,DOFPulse:PlaySoundAt SoundFX(""fx_kicker"",DOFContactors), kicker001: kicker001.kick 135,16 + RND(1) * 4:k1.RotX = -10 '"
    vpmtimer.addtimer 1700, "k1.RotX = 0 '"
End Sub
...
Sub kicker002_Hit 'center
  ...
  PlaySound "RCA3"
        AddScore 500
        gatef.Rotatetoend 'open gate
        If DoubleBonusWhenLit.State Then
            Multiplier2.State = 1
            BonusMultiplier = 2
        End If
    End If
    vpmtimer.addtimer 1500, "DOF 230,DOFPulse:DOF 109,DOFPulse:PlaySoundAt SoundFX(""fx_kicker"",DOFContactors), kicker002: kicker002.kick 190,16 + RND(1) * 4:k2.RotX = -10 '"
    vpmtimer.addtimer 1700, "k2.RotX = 0 '"
End Sub
...
Sub kicker003_Hit
  ...
  PlaySound "RCA3"
        ...
        End If
    End If
    vpmtimer.addtimer 1500, "DOF 230,DOFPulse:DOF 110,DOFPulse:PlaySoundAt SoundFX(""fx_kicker"",DOFContactors), kicker003: kicker003.kick 225,16 + RND(1) * 4:k3.RotX = -10 '"
    vpmtimer.addtimer 1700, "k3.RotX = 0 '"
End Sub
