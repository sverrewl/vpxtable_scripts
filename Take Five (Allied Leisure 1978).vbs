...
Const cGameName="takefive",cCredits="Take Five",UseSolenoids=1,UseLamps=1,UseGI=0,UseSync=1
...
Sub Table1_Init
  ...
  If D0="" Then 'Data doesn't exist, create it
    ...
    D7=64
    D8=1
    SaveValue "Take5","D00",D0
    SaveValue "Take5","D01",D1
    SaveValue "Take5","D02",D2
    SaveValue "Take5","D03",D3
    SaveValue "Take5","D04",D4
    SaveValue "Take5","D05",D5
    SaveValue "Take5","D06",D6
    SaveValue "Take5","D07",D7
    SaveValue "Take5","D08",D8
  Else
    D0=LoadValue("Take5","D00")
   D1=LoadValue("Take5","D01")
   D2=LoadValue("Take5","D02")
   D3=LoadValue("Take5","D03")
   D4=LoadValue("Take5","D04")
   D5=LoadValue("Take5","D05")
   D6=LoadValue("Take5","D06")
   D7=LoadValue("Take5","D07")
   D8=LoadValue("Take5","D08")
  End If
...
Sub Table1_KeyUp(ByVal KeyCode)
  ...
  If DipsShown=False Then
      If KeyCode=PlungerKey Then:Plunger.Fire:PlaySoundAtVol "Plunger", ActiveBall, 1:End If
...
Sub Drain_Hit:PlaySoundAtVol "ALBallDrain", ActiveBall, 1:bsTrough.AddBall Me:End Sub                                        '80
