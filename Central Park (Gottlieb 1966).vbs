...
'******DefineKeysUsed
 ...
 Sub Table1_KeyDown(ByVal keycode)
   ...
   If keycode = PlungerKey Then
    Plunger.PullBack
         PlaySoundAtVol "PlungePull", Plunger, 1
   End If
   ...
   If keycode = LeftFlipperKey  AND MaxPlayers>0 Then
      ...
      Flipper1.RotateToEnd:LFlip.objrotz = LFlip.objrotz -53
           PlaySoundAtVol "flipper", LFlip, 1
         End If
   End If
   ...
   If keycode = RightFlipperKey  AND MaxPlayers>0 Then
       ...
       PlaySoundAtVol "flipper", RFlip, 1
         End If
   End If
...
Sub Table1_KeyUp(ByVal keycode)
  ...
  If keycode = PlungerKey Then
    Plunger.Fire
         PlaySoundAtVol "PlungeRel", Plunger, 1
  ...
  If keycode = LeftFlipperKey  AND MaxPlayers>0 Then
    Flipper1.RotateToStart:LFlip.objrotz = LFlip.objrotz +53
       If Tilt<3 And Round>0 Then
    PlaySoundAtVol "flipper2", LFlip, 1
       End If
  End If
  ...
  If keycode = RightFlipperKey  AND MaxPlayers>0 Then
    ...
    If Tilt<3 And Round>0 Then
     PlaySoundAtVol "flipper2", RFlip, 1
       End If
  End If
...
Sub LightP1_Timer()
   ...
   For Each I In Lights1to5
    I.State =1
     Next
     PlaySoundAtVol "TargetBankReset", T121, 1
     If LBonus<5 Then
        LBonus=Lbonus+1
        SetBonusLights
   Else
...
' Thalamus - importing basic SSF routines
' *******************************************************************************************************
...
' Thalamus - importing basic ball rolling script
' You will need to import those sounds to the table, and create or rename the current ballrolling timer.
