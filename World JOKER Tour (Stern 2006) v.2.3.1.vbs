...
' $$$  / \$$$ |$$ |  $$ |$$ |      $$ |$$ |  $$ |      $$ |  $$ |$$ |  $$ |$$ |\$$\  $$ |      $$ |  $$ |         $$ |$$ |  $$ |$$ |  $$ |$$ |
' $$  /   \$$ |\$$$$$$  |$$ |      $$ |\$$$$$$$ |      \$$$$$$  | $$$$$$  |$$ | \$$\ $$$$$$$$\ $$ |  $$ |         $$ |\$$$$$$  |\$$$$$$  |$$ |
' \__/     \__| \______/ \__|      \__| \_______|       \______/  \______/ \__|  \__|\________|\__|  \__|         \__| \______/  \______/ \__|
'
' $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
' VERSION 2.3.1 by RobbyKingPin Aug 8 2025
...
' - Added VR assets from 24 (DGrimmReaper)
' - Shared assets for the VR Mega Room. Provided feedback and guidance to help bake it all. (DaRdog)
' - Created a custom POV to fit on Legends Cabinets. (LoadedWeapon)
' - Added color corrections on the backpanel and one of the custom sideblades textures (LoadedWeapon)
' - Tweaked the upward kicker settings on the shooter lane VUK and used AI for performance improvements on the script (Enthusiast)
' - Updated the texture for the bumpercaps (guus_8005)
' - Added some missing cablights on top of the targets and lighted up the backwall cabs as well. Added playfield light reflections on the sidewalls (fidiko)
' - Made adjustments on target lights and the playfield display settings (fidiko)
' - Gave support and assisted on helping sorting out issues on refraction and depth bias on the upper playfield (Gravy)
'⠀⠀⠀⠀⠀⠀
' World JOKER Tour conversion by Cheese3075!
' - Merged necessary files and VPX assets
' - Created new plastics.
' - A TON of manual photoshop redraws to the playfield and apron. This is all 4K art cleanup, fixing glitches, smothing textures, sharepening text. Stuff like replacing the center 10, J, Q, K cards with crisp images or manual redraws on the WPT text near the outlanes.  This stuff takes a ton of time!
' - Updated lights.
' - Updated f12 menu with new resources (flippers, sidewalls, etc).
' - Added new table level file and code to moves with table bumps. :P
' - NOTE: no physics were changed, table has NFOZZY and Fleep thanks to RobbyKingPin.
'
'**** SHOUTOUT to RobbyKingPin and JP Salas!  Thanks both for allowing me to mod and thanks JP for supplying World Joker Tour files!
...
Sub Table1_Init
  ...
  With Controller
    ...
    .SplashInfoLine = "World JOKER Tour (Stern 2006)"
    .HandleKeyboard = 0
    .ShowTitle = 0
    .ShowDMDOnly = 1
    .ShowFrame = 0
...
Sub Table1_KeyDown(ByVal Keycode)
  ...
  If keycode = PlungerKey Then
    ...
    plungerpress = 1
  End If
  If keycode = LeftTiltKey Then Nudge 90, 1 : NudgeType = 1 : level_move : SoundNudgeLeft     ' Sets the nudge angle and power
  If keycode = RightTiltKey Then Nudge 270, 1 : NudgeType = 2 : level_move : SoundNudgeRight    ' ^
  If keycode = CenterTiltKey Then Nudge 0, 1 : NudgeType = 3 : level_move : SoundNudgeCenter    ' ^
...
Sub level_move()
  ...
  elseIF NudgeType = 2 Then
    levelR1.visible = 1
    level_timer.Enabled = true
  end If
End Sub

Sub Level_timer_timer
  If bFinalStep = false Then
    ...
    ElseIf NudgeType = 2 Then
      levelR2.visible = 1
    End If
    level_timer2.Enabled = true
  ElseIf bFinalStep = true Then
    level_timer.Enabled = false
    levelL1.visible = 0
    levelR1.visible = 0
    level.visible = 1
...
Sub Level_timer2_timer
  level_timer2.Enabled = false
  levelL2.visible = 0
  levelR2.visible = 0
  if NudgeType = 1 Then
    levelL1.visible = 1
...
Sub Table1_OptionEvent(ByVal eventId)
  ...
  PlayfieldReflections = Table1.Option("Playfield Reflections", 0, 1, 0.05, 0.50, 1)
  ...
  BackglassReflOpt = Table1.Option("Backglass Reflections", 0, 1, 1, 0, 0, Array("Off", "On"))
  ...
  SetupOutlanes
  'Instruction Cards NOT AVAILABLE WITH MOD
  ...
  'Custom Flippers
  FlipperMod = Table1.Option("Flipperbats", 0, 2, 1, 0, 0, Array("World JOKER Tour", "Tiltgraphics", "Poker Tour Originals"))
  SetupFlippers
  'Sideblades
  SideBladeMod = Table1.Option("Side Blades", 0, 5, 1, 0, 0, Array("World JOKER tour", "None", "Tiltgraphics 1", "Retrorefurbs 1", "Tiltgraphics 2", "Retrorefurbs 2"))
  SetupBlades
  'LegendsCab
...
Sub SetupFlippers
  ...
  If FlipperMod = 2 Then
    LFLogo.image = "BatWhiteBlack_org"
    RFLogo.image = "BatWhiteBlack_org"
    LFLogo1.image = "flipper-l2_org"
    RFLogo1.image = "flipper-r2_org"
  End If
End Sub
...
Sub SetupBlades
  ...
  End if
  If SideBladeMod = 6 Then
    PinCab_Blades.image = "PinCab_Blades_Custom6"
  End if
End Sub
