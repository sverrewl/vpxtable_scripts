...
Sub table1_KeyUp(ByVal Keycode)
  ...
  End If
    ...
    If keycode = PlungerKey And GiLights=1 Then SoundPlungerReleaseBall():Plunger.Fire:StopSound"alien5":PlaySound"alien2": moviemode = 13: digitsoff: framenumber=0
...
Sub splash
  ...
  Dim xx
  xx =  INT(5 * RND(1) )
  If UseFlexDMD then PlaySound ("splash"& xx)
End Sub
Sub moo
  Dim xx
  xx =  INT(4 * RND(1) )
  If UseFlexDMD then  PlaySound ("cow"& xx)
End Sub
Sub giggle
  Dim xx
  xx =  INT(4 * RND(1) )
  If UseFlexDMD then  PlaySound ("girl"& xx)
End Sub
