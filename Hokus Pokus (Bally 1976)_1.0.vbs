...
'    RFlogo.ObjRotZ = RightFlipper.CurrentAngle+90
  ...
  SpinnerP3.Rotz = Spinner3.CurrentAngle
  SpinnerRod3.TransZ = Sin ((Spinner3.CurrentAngle + 180) * (2 * PI / 360)) * 5
  SpinnerRod3.TransX = -1 * (Sin ((Spinner3.CurrentAngle - 90) * (2 * PI / 360)) * 5)
...
'   Controller.B2SSetScorePlayer4 0
  ...
  Bumper1LightB.state=1
  Bumper2Light.state=1
  Bumper2LightA.state=1
  Bumper2LightB.state=1
  AlternatingRelay=0
  ZeroNineCounter=0
  LeftSpinnerCounter=0
  BumpersOn
