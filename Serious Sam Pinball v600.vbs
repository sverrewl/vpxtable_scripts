...
Sub DMDScore()
    ...
    if(dqHead = dqTail)Then
        ...
        Select Case Battle(CurrentPlayer, 0)
            ...
            Case 15:tmp1 = CL("BATTLE MORDEKAI " & "Ball " & Balls)
        End Select
        tmp2 = ""
    End If
...
Sub Trees_Timer()
    ...
    Tree2.RotY = TreeDir *2
    Tree3.RotY = - TreeDir *2
    Tree4.RotY = TreeDir *2
    Tree5.RotY = - TreeDir *2
    Tree6.RotY = TreeDir *2
    Tree7.RotY = - TreeDir *2
    Tree8.RotY = TreeDir *2
    Tree9.RotY = - TreeDir *2
    Tree10.RotY = TreeDir *2
    Tree13.RotY = - TreeDir *2
    Tree14.RotY = TreeDir *2
    Tree15.RotY = - TreeDir *2
End Sub
...
Sub GiveRandomAward() 'from the Pyramid
    ...
    DMD CL("PYRAMID AWARD"), "", "", eNone, eNone, eNone, 50, False, "fx_spinner"
...
Sub StartBattle
    ...
    Select Case NewBattle
        Case 1 'Serpent Yards = Super Spinners
            DMD CL("SERPENT YARDS"), CL("SHOOT THE SPINNERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light45.State = 2
            Light49.State = 2
            SpinCount = 0
        Case 2 'Calakmul = Super Pop Bumpers
            DMD CL("CALAKMUL"), CL("HIT THE POP BUMPERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light22.State = 2
            LightSeqBumpers.Play SeqRandom, 10, , 1000
            SuperBumperHits = 0
        Case 3 'Sierra de Chiapas = Ramps
            DMD CL("SIERRA CHIAPAS"), CL("SHOOT THE RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light47.State = 2
            Light48.State = 2
            RampHits3 = 0
        Case 4 'Karnak = Orbits
            DMD CL("KARNAK"), CL("SHOOT THE ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            Light45.State = 2
            Light49.State = 2
            OrbitHits = 0
        Case 5 'CopÃ¡n = Shoot the lights 2
            DMD CL("COPAN"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light44.State = 2
            Light45.State = 2
            Light46.State = 2
            Light47.State = 2
        ...
        Case 6 'The Pit = Shoot the lights 1
            DMD CL("THE PIT"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light44.State = 2
        Case 7 'Palenque=  Target Frenzy
            DMD CL("PALENQUE"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            LightSeqAllTargets.Play SeqRandom, 10, , 1000
            TargetHits7 = 0
        Case 8 'ChichÃ©n ItzÃ¡ = Left & Right Targets
            DMD CL("CHICHEN ITZA"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            Light44.State = 2
            Light50.State = 2
            TargetHits8 = 0
        Case 9 'Bonampak = Captive Ball
            DMD CL("BONAMPAK"), CL("SHOOT CAPTIVE BALL"), "", eNone, eNone, eNone, 1500, True, ""
            Light29.State = 2
            CaptiveBallHits = 0
        Case 10 'Monte Alban = Ramps and Orbits
            'uses the ramphits10 to count the hits
            DMD CL("MONTE ALBAN"), CL("SHOOT RAMPS ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            Light47.State = 2
            Light48.State = 2
            RampHits10 = 0
        Case 11 'Uxmal = Blue Targets
            DMD CL("UXMAL"), CL("SHOOT BLUE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            LightSeqBlueTargets.Play SeqRandom, 10, , 1000
            TargetHits11 = 0
        Case 12 'Valley of the Jaguar = Super Loops
            DMD CL("JAGUAR VALLEY"), CL("SHOOT THE LOOPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light45.State = 2
            Light49.State = 2
            Gate2.Open = 1
            Gate3.Open = 1
        ...
        Case 13 'The Grand Cathedral = Follow the Lights 1
            DMD CL("GRAND CATHEDRAL"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            AddMultiball 2
            StartJackpots
            ChangeGi green
        Case 14 'The City of the Gods = Follow the Lights 2
            DMD CL("CITY OF GODS"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            AddMultiball 2
            StartJackpots
            ChangeGi green
        Case 15 'Mordekai the Summoner - the final battle
            DMD CL("MORDEKAI"), CL("SHOOT THE JACKPOTS"), "", eNone, eNone, eNone, 1500, True, ""
            AddMultiball 4
            StartJackpots
            ChangeGi green
    End Select
