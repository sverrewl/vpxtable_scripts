' ****************************************************************
'     Travel Time / IPD No. 2636 / September 05, 1972 / 1 Player
'         Williams Electronics, Incorporated (1967-1985)
' Travel Time video: https://www.youtube.com/watch?v=gbEXaKv7tKE
' Travel Time rules: https://www.youtube.com/watch?v=9VpUPuYrTYY
...
' Valores Constants
Const TableName = "TravelTime" 'saving the highscores and credits
Const cGameName = "TravelTime" ' mostly for DOF
Const MaxPlayers = 1           ' omly 1 in this table
Const Special1 = 40000         ' puntuación a obtener para partida extra
...
Sub UpdateScore(playerpoints)
    ...
    End Select
    If Score(CurrentPlayer) >= 100000 then TurnON aHundred
    If B2SOn then
...
Sub ResetNewBallVariables() 'inicia las variable para una bola ó jugador nuevo
    MatchEnabled = True     'activa la loteria
End Sub
