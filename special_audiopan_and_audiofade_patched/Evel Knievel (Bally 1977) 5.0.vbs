...
'**********************************
'Originally scripted by: 32assassin
'Graphics,layout,lighting and shadows: HauntFreaks
'2023 v5.0 update: TastyWasps
'* nFozzy Physics
'* Fleep Sounds
'* Dynamic Ball Shadows
'* DTShadows added
'* Hybrid VR Room
'VR backglass/lighting/displays: leojreimroc
'**********************************
...
Const cGameName = "evelknie",UseSolenoids=2,UseLamps=1,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SCoin="coin", BallSize = 50, BallMass = 1
...
Sub SetBackglass()
  ...
  For Each obj In VRBackglass
    ...
    obj.y = 90 '78 'adjusts the distance from the backglass towards the user
    obj.RotX = 270
  Next
...
Sub SW29_Hit:bsSaucer.AddBall 0 : SoundSaucerLock : End Sub

 ' Droptargets
Sub SW1_Dropped:dtR.Hit 1:DS1.Visible=False:End Sub
Sub SW2_Dropped:dtR.Hit 2:DS2.Visible=False:End Sub
Sub SW3_Dropped:dtR.Hit 3:DS3.Visible=False:End Sub
Sub SW4_Dropped:dtR.Hit 4:DS4.Visible=False:End Sub
Sub SW5_Dropped:dtR.Hit 5:DS5.Visible=False:End Sub
...
Sub SW32A_Hit:Controller.Switch(32)=1 :  DOF 105, DOFOn : End Sub
Sub SW32A_unHit:Controller.Switch(32)=0: DOF 105, DOFOff : End Sub
Sub SW32B_Hit:Controller.Switch(32)=1 :  DOF 106, DOFOn : End Sub
...
Sub UpdateMultipleLamps()
  IF VRRoom <> 0 Then
  'Bike
  If Controller.Lamp(12) = 0 Then: L12.visible=0: else: L12.visible=1
  If Controller.Lamp(28) = 0 Then: L28.visible=0: else: L28.visible=1
  If Controller.Lamp(44) = 0 Then: L44.visible=0: else: L44.visible=1
  If Controller.Lamp(60) = 0 Then: L60.visible=0: else: L60.visible=1

  If Controller.Lamp(13) = 0 Then: L13BallInPlay.visible=0 : else: L13BallInPlay.visible=1
  If Controller.Lamp(29) = 0 Then: L29HighScore.visible=0: else: L29HighScore.visible=1
  If Controller.Lamp(43) = 0 Then: L43SPSA.visible=0: else: L43SPSA.visible=1
  If Controller.Lamp(45) = 0 Then: L45GameOver.visible=0: else: L45GameOver.visible=1
  If Controller.Lamp(45) = 0 Then: L45Match.visible=0: else: L45Match.visible=1
  If Controller.Lamp(61) = 0 Then: L61Tilt.visible=0: else: L61Tilt.visible=1
  'Players
  If Controller.Lamp(14) = 0 Then: L14.visible=0: else: L14.visible=1
  If Controller.Lamp(30) = 0 Then: L30.visible=0: else: L30.visible=1
  If Controller.Lamp(46) = 0 Then: L46.visible=0: else: L46.visible=1
  If Controller.Lamp(62) = 0 Then: L62.visible=0: else: L62.visible=1
  'Players Up
  If Controller.Lamp(15) = 0 Then: L15.visible=0: else: L15.visible=1
  If Controller.Lamp(31) = 0 Then: L31.visible=0: else: L31.visible=1
  If Controller.Lamp(47) = 0 Then: L47.visible=0: else: L47.visible=1
  If Controller.Lamp(63) = 0 Then: L63.visible=0: else: L63.visible=1
  End If
End Sub
