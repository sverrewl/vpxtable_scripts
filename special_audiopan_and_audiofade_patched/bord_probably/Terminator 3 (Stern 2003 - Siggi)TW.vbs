...
'----- Difficulty Options -----
Const MiddlePeg = 1         ' 0 = No middle peg under flippers (default Stern machine), 1 = Middle Peg enabled
...
If MiddlePeg = 0 Then
  ...
  rpin014.Collidable = 0
  rpin014.Visible = 0
  zCol_Rubber_Corner_041.Collidable = 0
Else
  Primitive042.Visible = 1
  rpin014.Collidable = 1
  rpin014.Visible = 1
  zCol_Rubber_Corner_041.Collidable = 1
End If
