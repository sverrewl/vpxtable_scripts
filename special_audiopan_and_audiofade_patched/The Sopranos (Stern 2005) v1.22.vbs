...
'----- Sound Options -----
Const RomSounds = 0         ' 1 - use the sounds from the rom, 0 - use sampled sounds (if the rom sounds like shit) (it probably does) (idigstuff is working on it!)
