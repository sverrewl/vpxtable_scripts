...
'| $$  | $$| $$  | $$      | $$  \ $$| $$  | $$   | $$      | $$   | $$        | $$  | $$      | $$  \ $$
'| $$$$$$$/|  $$$$$$$      |  $$$$$$/|  $$$$$$/   | $$      | $$   | $$$$$$$$ /$$$$$$| $$$$$$$$| $$$$$$$/
'|_______/  \____  $$       \______/  \______/    |__/      |__/   |________/|______/|________/|_______/
'           /$$  | $$
'          |  $$$$$$/
'           \______/

'********************************************************************************************************************************
'Version .56- PF image, Physical Table build, and plastics by Tom (Armyaviation)
'       Plastic resources from pinside members Stagio and Sckurk
'             Primitives, Scripting (Roto Target) and previous tables for reference Borgdog
'             Additional table testing and help Lumi, Arelyel Krele
'********************************************************************************************************************************

'******** Revisions done by UnclePaulie on Hybrid version 0.57 - 2.0 *********
' UnclePaulie   updated to latest VPW standards, physics, GI baking, Lampz and 3D inserts, shadows, updated backglass for desktop,
'       playfield mesh for a saucer bevel, roth drop and standup targets, standalone compatibility, sling corrections,
'       optional DIP adjustments, updated flipper physics, roto lighting, VR and fully hybrid, Flupper style bumpers and lighting,
'       and several errors corrected.  Full details at the bottom of the script.
'********************************************************************************************************************************
...
Dim gion: gion = 0
Dim DT0up, DT10up, DT20up, DT40up
...
SolCallBack(1)  = "SolSaucerMid"  'Left Saucer kickout
SolCallBack(2)  = "SolRoto"     'Rotating targets
SolCallback(5)  = "SolDTReset"    'Drop Target Reset
...
Sub Table1_Init
  vpmInit Me
    ...
    .SplashInfoLine = "Circus (Gottlieb 1980)"&chr(13)&"by UnclePaulie and ArmyAviation"
    .HandleKeyboard = 0
    .ShowTitle = 0
    .ShowDMDOnly = 1
    .ShowFrame = 0
  ...
  vpmNudge.TiltObj = Array(Bumper1,Bumper2,LeftSlingshot,LeftFlipper,LeftFlipper1,RightFlipper, RightFlipper1, RightFlipper2)
...
Sub Table1_KeyUp(ByVal keycode)
  ...
  If keycode = PlungerKey Then
    Plunger.firespeed = RndInt(120,126)   ' Generate random value variance of +/- 3 from 123
    Plunger.Fire
    If BIPL = 1 Then
...
Sub SolSaucerMid(Enabled)
  If Enabled Then
  If sw23.BallCntOver = 1 Then
    RNDKickAngle1 = RndInt(144,146)   ' Generate random value variance of +/- 1 from 145
    RNDKickValue1 = RndInt(19,21)   ' Generate random value variance of +/- 1 from 20
    sw23.kick RNDKickAngle1, RNDKickValue1
    sw23.uservalue=1
    sw23.timerenabled=1
    PkickarmSW23.rotz=15
  End If
  End if
End Sub
...
Sub sw23_timer
  select case sw23.uservalue
    case 2:
      PkickarmSW23.rotz=0
      me.timerenabled=0
  end Select
  sw23.uservalue=sw23.uservalue+1
End Sub
...
Sub SpinnerTimer
  SpinnerP.Rotz = sw25.CurrentAngle
  SpinnerRod.TransX = sin( (sw25.CurrentAngle+180) * (2*PI/360)) * 3.5
...
Sub sw6a_Hit:vpmTimer.PulseSw 6:End Sub
Sub sw6b_Hit:vpmTimer.PulseSw 6:End Sub
Sub sw6c_Hit:vpmTimer.PulseSw 6:End Sub
Sub sw6d_Hit:vpmTimer.PulseSw 6:End Sub
Sub sw6e_Hit:vpmTimer.PulseSw 6:End Sub
...
Sub sw01_Hit:Controller.Switch(1) = 1:End Sub
Sub sw01_UnHit:Controller.Switch(1) = 0:End Sub
...
Sub sw04_Hit:Controller.Switch(4) = 1:End Sub
Sub sw04_UnHit:Controller.Switch(4) = 0:End Sub
Sub sw05_Hit:Controller.Switch(5) = 1:End Sub
...
Sub sw15b_Hit:Controller.Switch(15) = 1:End Sub
...
' notes:  roto target:  switch 42-46 is left roto target (receive 100X value);  52-56 is center (rcv 1000X value);  62-66 is right (100X value).  Stars are value of 5

Dim RotoTick, NewRotoPos, CurrRotoPos, RotoSpinning, rotoSW, rotoP
'Dim R1Value, R2Value, R3Value
rotoSW = array(5,4,3,2,1,5,4,3,2,1,5,4,3,2,1,5,4)
rotoP = array(LXM, Proto1, Proto2, Proto3, Proto4, Proto5, Proto6, Proto7, Proto8, Proto9, Proto10, Proto11, Proto12, Proto13, Proto14, Proto15)
...
Sub SolRoto(Enabled)
  ...
  DOF 111, DOFOn
  PlaySoundat SoundFX("roto9",DOFGear), TrotoCenter
  end if
End Sub
...
Sub TrotoLeft_Hit 'LEFT ROTO
  ...
  Select Case (rotoSW(CurrRotoPos-1))
    Case 1:vpmtimer.PulseSw(42) '42
    Case 2:vpmtimer.PulseSw(43) '43
    Case 3:vpmtimer.PulseSw(44) '44
    Case 4:vpmtimer.PulseSw(45) '45
    Case 5:vpmtimer.PulseSw(46) '46
  End Select
End Sub
...
Sub TrotoCenter_Hit 'CENTER ROTO
  ...
  Select Case (rotoSW(CurrRotoPos))
    Case 1:vpmtimer.PulseSw(53) '53
    Case 2:vpmtimer.PulseSw(54) '54
    Case 3:vpmtimer.PulseSw(55) '55
    Case 4:vpmtimer.PulseSw(56) '56
    Case 5:vpmtimer.PulseSw(52) '52
  End Select
End Sub
...
Sub TrotoRight_Hit 'RIGHT ROTO
  ...
  If RotoTimer.enabled=1 Then Exit Sub
  Select Case (rotoSW(CurrRotoPos+1))
    Case 1:vpmtimer.PulseSw(64) '64
    Case 2:vpmtimer.PulseSw(65) '65
    Case 3:vpmtimer.PulseSw(66) '66
    Case 4:vpmtimer.PulseSw(62) '62
    Case 5:vpmtimer.PulseSw(63) '63
  End Select
End Sub
...
Sub editDips
  if SetDIPSwitches = 1 Then
    ...
    With vpmDips
      .AddForm 700,400,"cIRCUS - DIP switches"
...
Sub SetDefaultDips
  ...
  SetDip &H00200000,1   '1=Playfield Special of extra ball when A-B-C hit, and then star on roto
...
'
Sub InitPolarity()
   dim x, a : a = Array(LF, RF, LF1, RF1, RF2)
  for each x in a
...
Dim LFPress, RFPress, LFCount, RFCount, LFPress1, RFPress1, LFCount1, RFCount1, RFPress2, RFCount2
Dim LFState, RFState, LFState1, RFState1, RFState2
Dim EOST, EOSA,Frampup, FElasticity,FReturn
Dim RFEndAngle, LFEndAngle, RFEndAngle1, LFEndAngle1,RFEndAngle2
...
Set DT0  = (new DropTarget)(sw0, sw0a, sw0p, 0, 0, false)
...
Dim DTArray
DTArray = Array(DT0, DT10, DT20, DT40)
...
Sub DTShadowInit(dtnbr)
  ...
  if dtnbr = 1 Then
    Set DTShadow(dtnbr) = Eval("dtsh" & 0)
  elseif dtnbr = 2 Then
    Set DTShadow(dtnbr) = Eval("dtsh" & 10)
  elseif dtnbr = 3 Then
...
'Playfield
  ...
  Lampz.Callback(3) = "DisableLighting2 p3, insert_dl_on_red, 1,"
  Lampz.Callback(3) = "DisableLighting2 bulb3, redbulb, 5,"
  Lampz.Callback(3) = "DisableLighting2 p3off, .1, insert_dl_off_red,"
  Lampz.MassAssign(12)= l12
  Lampz.MassAssign(12)= l12a
  Lampz.Callback(12) = "DisableLighting2 p12, insert_dl_on_yellow, 1,"
  Lampz.Callback(12) = "DisableLighting2 bulb12, yellowbulb, 5,"
  Lampz.Callback(12) = "DisableLighting2 p12off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(13)= l13
  Lampz.MassAssign(13)= l13a
  Lampz.Callback(13) = "DisableLighting2 p13, insert_dl_on_yellow, 1,"
  Lampz.Callback(13) = "DisableLighting2 bulb13, yellowbulb, 5,"
  Lampz.Callback(13) = "DisableLighting2 p13off, .1, insert_dl_off_yellow,"
  ...
  Lampz.Callback(15) = "DisableLighting2 p15, insert_dl_on_yellow, 1,"
  Lampz.Callback(15) = "DisableLighting2 bulb15, yellowbulb, 5,"
  Lampz.Callback(15) = "DisableLighting2 p15off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(16)= l16
  Lampz.MassAssign(16)= l16a
  Lampz.Callback(16) = "DisableLighting2 p16, insert_dl_on_yellow, 1,"
  Lampz.Callback(16) = "DisableLighting2 bulb16, yellowbulb, 5,"
  Lampz.Callback(16) = "DisableLighting2 p16off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(17)= l17
  Lampz.MassAssign(17)= l17a
  Lampz.Callback(17) = "DisableLighting2 p17, insert_dl_on_yellow, 1,"
  Lampz.Callback(17) = "DisableLighting2 bulb17, yellowbulb, 5,"
  Lampz.Callback(17) = "DisableLighting2 p17off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(18)= l18
  Lampz.MassAssign(18)= l18a
  Lampz.Callback(18) = "DisableLighting2 p18, insert_dl_on_yellow, 1,"
  Lampz.Callback(18) = "DisableLighting2 bulb18, yellowbulb, 5,"
  Lampz.Callback(18) = "DisableLighting2 p18off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(19)= l19
  Lampz.MassAssign(19)= l19a
  Lampz.Callback(19) = "DisableLighting2 p19, insert_dl_on_yellow, 1,"
  Lampz.Callback(19) = "DisableLighting2 bulb19, yellowbulb, 5,"
  Lampz.Callback(19) = "DisableLighting2 p19off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(20)= l20
  Lampz.MassAssign(20)= l20a
  Lampz.Callback(20) = "DisableLighting2 p20, insert_dl_on_medwhite, 1,"
  Lampz.Callback(20) = "DisableLighting2 bulb20, whitebulb, 5,"
  Lampz.Callback(20) = "DisableLighting2 p20off, .1, insert_dl_off_white,"
  Lampz.MassAssign(21)= l21
  Lampz.MassAssign(21)= l21a
  Lampz.Callback(21) = "DisableLighting2 p21, insert_dl_on_medwhite, 1,"
  Lampz.Callback(21) = "DisableLighting2 bulb21, whitebulb, 5,"
  Lampz.Callback(21) = "DisableLighting2 p21off, .1, insert_dl_off_white,"
  Lampz.MassAssign(22)= l22
  Lampz.MassAssign(22)= l22a
  Lampz.Callback(22) = "DisableLighting2 p22, insert_dl_on_medwhite, 1,"
  Lampz.Callback(22) = "DisableLighting2 bulb22, whitebulb, 5,"
  ...
  Lampz.Callback(23) = "DisableLighting2 p23off, .1, insert_dl_off_blue,"
  ...
  Lampz.Callback(24) = "DisableLighting2 p24off, .1, insert_dl_off_blue,"
  Lampz.MassAssign(25)= l25
  Lampz.MassAssign(25)= l25a
  Lampz.Callback(25) = "DisableLighting2 p25, insert_dl_on_orange, 1,"
  Lampz.Callback(25) = "DisableLighting2 bulb25, orangebulb, 5,"
  Lampz.Callback(25) = "DisableLighting2 p25off, .1, insert_dl_off_orange,"
  Lampz.MassAssign(26)= l26
  Lampz.MassAssign(26)= l26a
  Lampz.Callback(26) = "DisableLighting2 p26, insert_dl_on_blue, 1,"
  Lampz.Callback(26) = "DisableLighting2 bulb26, bluebulb, 5,"
  Lampz.Callback(26) = "DisableLighting2 p26off, .1, insert_dl_off_blue,"
  Lampz.MassAssign(27)= l27
  Lampz.MassAssign(27)= l27a
  Lampz.Callback(27) = "DisableLighting2 p27, insert_dl_on_bigyellow, 1,"
  Lampz.Callback(27) = "DisableLighting2 bulb27, yellowbulb, 5,"
  Lampz.Callback(27) = "DisableLighting2 p27off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(28)= l28
  Lampz.MassAssign(28)= l28a
  Lampz.Callback(28) = "DisableLighting2 p28, insert_dl_on_bigyellow, 1,"
  Lampz.Callback(28) = "DisableLighting2 bulb28, yellowbulb, 5,"
  Lampz.Callback(28) = "DisableLighting2 p28off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(29)= l29
  Lampz.MassAssign(29)= l29a
  Lampz.Callback(29) = "DisableLighting2 p29, insert_dl_on_bigyellow, 1,"
  Lampz.Callback(29) = "DisableLighting2 bulb29, yellowbulb, 5,"
  Lampz.Callback(29) = "DisableLighting2 p29off, .1, insert_dl_off_yellow,"
  Lampz.MassAssign(30)= l30
  Lampz.MassAssign(30)= l30a
  Lampz.Callback(30) = "DisableLighting2 p30, insert_dl_on_bigyellow, 1,"
  ...
  Lampz.Callback(31) = "DisableLighting2 p31, insert_dl_on_bigwhite, 1,"
  Lampz.Callback(31) = "DisableLighting2 bulb31, whitebulb, 5,"
  Lampz.Callback(31) = "DisableLighting2 p31off, .1, insert_dl_off_white,"
  Lampz.MassAssign(31)= l31b
  Lampz.MassAssign(31)= l31ba
  Lampz.Callback(31) = "DisableLighting2 p31b, insert_dl_on_medwhite, 1,"
  Lampz.Callback(31) = "DisableLighting2 bulb31b, whitebulb, 5,"
  Lampz.Callback(31) = "DisableLighting2 p31boff, .1, insert_dl_off_white,"
  Lampz.MassAssign(32)= l32
  Lampz.MassAssign(32)= l32a
  Lampz.Callback(32) = "DisableLighting2 p32, insert_dl_on_white, 1,"
  Lampz.Callback(32) = "DisableLighting2 bulb32, whitebulb, 5,"
  ...
  Lampz.Callback(33) = "DisableLighting2 bulb33, whitebulb, 5,"
  ...
  Lampz.Callback(34) = "DisableLighting2 bulb34, whitebulb, 5,"
  ...
  Lampz.Callback(35) = "DisableLighting2 bulb35, whitebulb, 5,"
  Lampz.Callback(35) = "DisableLighting2 p35off, .1, insert_dl_off_white,"
  Lampz.MassAssign(36)= l36
  Lampz.MassAssign(36)= l36a
  Lampz.Callback(36) = "DisableLighting2 p36, insert_dl_on_white, 1,"
  Lampz.Callback(36) = "DisableLighting2 bulb36, whitebulb, 5,"
  Lampz.Callback(36) = "DisableLighting2 p36off, .1, insert_dl_off_white,"
  ...
  Lampz.Callback(37) = "DisableLighting2 p37off, .1, insert_dl_off_white,"
  Lampz.MassAssign(38)= l38
  Lampz.MassAssign(38)= l38a
  Lampz.Callback(38) = "DisableLighting2 p38, insert_dl_on_white, 1,"
  Lampz.Callback(38) = "DisableLighting2 bulb38, whitebulb, 5,"
  Lampz.Callback(38) = "DisableLighting2 p38off, .1, insert_dl_off_white,"
  Lampz.MassAssign(39)= l39
  Lampz.MassAssign(39)= l39a
  Lampz.Callback(39) = "DisableLighting2 p39, insert_dl_on_white, 1,"
  Lampz.Callback(39) = "DisableLighting2 bulb39, whitebulb, 5,"
  Lampz.Callback(39) = "DisableLighting2 p39off, .1, insert_dl_off_white,"
  Lampz.MassAssign(40)= l40
  Lampz.MassAssign(40)= l40a
  Lampz.Callback(40) = "DisableLighting2 p40, insert_dl_on_white, 1,"
  Lampz.Callback(40) = "DisableLighting2 bulb40, whitebulb, 5,"
  ...
  Lampz.Callback(42) = "DisableLighting2 p42, insert_dl_on_red, 1,"
  Lampz.Callback(42) = "DisableLighting2 bulb42, redbulb, 5,"
  ...
  Lampz.Callback(43) = "DisableLighting2 bulb43, pinkbulb, 5,"
  Lampz.Callback(43) = "DisableLighting2 p43off, .1, insert_dl_off_pink,"
  Lampz.MassAssign(44)= l44
  Lampz.MassAssign(44)= l44a
  Lampz.Callback(44) = "DisableLighting2 p44, insert_dl_on_green, 1,"
  Lampz.Callback(44) = "DisableLighting2 bulb44, greenbulb, 5,"
  Lampz.Callback(44) = "DisableLighting2 p44off, .1, insert_dl_off_green,"
  Lampz.MassAssign(44)= l44b
  Lampz.MassAssign(44)= l44ba
  Lampz.Callback(44) = "DisableLighting2 p44b, insert_dl_on_green, 1,"
  Lampz.Callback(44) = "DisableLighting2 bulb44b, greenbulb, 5,"
  Lampz.Callback(44) = "DisableLighting2 p44boff, .1, insert_dl_off_green,"
  Lampz.MassAssign(45)= l45
  Lampz.MassAssign(45)= l45a
  Lampz.Callback(45) = "DisableLighting2 p45, insert_dl_on_green, 1,"
  Lampz.Callback(45) = "DisableLighting2 bulb45, greenbulb, 5,"
  Lampz.Callback(45) = "DisableLighting2 p45off, .1, insert_dl_off_green,"
  Lampz.MassAssign(45)= l45b
  Lampz.MassAssign(45)= l45ba
  Lampz.Callback(45) = "DisableLighting2 p45b, insert_dl_on_green, 1,"
  Lampz.Callback(45) = "DisableLighting2 bulb45b, greenbulb, 5,"
  Lampz.Callback(45) = "DisableLighting2 p45boff, .1, insert_dl_off_green,"
  Lampz.MassAssign(46)= l46
  Lampz.MassAssign(46)= l46a
  Lampz.Callback(46) = "DisableLighting2 p46, insert_dl_on_green, 1,"
  Lampz.Callback(46) = "DisableLighting2 bulb46, greenbulb, 5,"
  ...
  Lampz.Callback(46) = "DisableLighting2 bulb46b, greenbulb, 5,"
  ...
  Lampz.Callback(47) = "DisableLighting2 bulb47, greenbulb, 5,"
  ...
  Lampz.Callback(47) = "DisableLighting2 bulb47b, greenbulb, 5,"
  Lampz.Callback(47) = "DisableLighting2 p47boff, .1, insert_dl_off_green,"
  Lampz.MassAssign(48)= l48
  Lampz.MassAssign(48)= l48a
  Lampz.Callback(48) = "DisableLighting2 p48, insert_dl_on_green, 1,"
  Lampz.Callback(48) = "DisableLighting2 bulb48, greenbulb, 5,"
  Lampz.Callback(48) = "DisableLighting2 p48off, .1, insert_dl_off_green,"
  Lampz.MassAssign(49)= l49
  Lampz.MassAssign(49)= l49a
  Lampz.Callback(49) = "DisableLighting2 p49, insert_dl_on_green, 1,"
  Lampz.Callback(49) = "DisableLighting2 bulb49, greenbulb, 5,"
  Lampz.Callback(49) = "DisableLighting2 p49off, .1, insert_dl_off_green,"
  Lampz.MassAssign(50)= l50
  Lampz.MassAssign(50)= l50a
  Lampz.Callback(50) = "DisableLighting2 p50, insert_dl_on_green, 1,"
  Lampz.Callback(50) = "DisableLighting2 bulb50, greenbulb, 5,"
  Lampz.Callback(50) = "DisableLighting2 p50off, .1, insert_dl_off_green,"
...
FlInitBumper 1, "circus"
FlInitBumper 2, "circus"
...
Sub FlFadeBumper(nr, Z)
  ...
  Select Case FlBumperColor(nr)
    ...
    Case "circus"
      ...
      FlBumperTop(nr).BlendDisableLighting = 1 * DayNightAdjust - 0.5 * Z / (1 + DNA90)
      MaterialColor "bumpertopmat" & nr, RGB(255,235,220 - Z * 170)
      FLBumperCapBase(nr).BlendDisableLighting = 1 * DayNightAdjust - 0.7 * Z / (1 + DNA90)
...
Sub PFGI(enabled)
  ...
  if DT0up = 1 Then dtsh0.visible = True
  if DT10up = 1 Then dtsh10.visible = True
  if DT20up = 1 Then dtsh20.visible = True
  if DT40up = 1 Then dtsh40.visible = True
End Sub
...
' Standup Targets
  For each x in GITargets
    x.blenddisablelighting = 0.125 * alvl + .1
  Next
...
' prims (Top Lane Rollovers)
  ...
  For each x in GIPlasticTents
    x.blenddisablelighting = .25 * alvl + .25
  Next
...
' prims (Cutouts)
  ...
  Hole_lg_001.blenddisablelighting = .1 * alvl + .2
...
'spinner
  SpinnerP.blenddisablelighting = 0.095 * alvl + .005

'saucer
  Pkickerhole1.blenddisablelighting = 0.125 * alvl + .025
  PkickarmSW23.blenddisablelighting = 0.125 * alvl + .025
...
' ball
  ...
  if vr_room = 0 and cab_mode = 0 Then
    if aLvl = 0 then
      L_DT_Circus.visible = 0
      L_DT_Lady.visible = 0
    Else
      L_DT_Circus.visible = 1
      L_DT_Lady.visible = 1
    End If
  Else
      L_DT_Circus.visible = 0
...
Sub SaveLUT
  ...
  Set ScoreFile=FileObj.CreateTextFile(UserDirectory & "Circus_LUT.txt",True)
...
Sub LoadLUT
  ...
  If Not FileObj.FolderExists(UserDirectory) then
    ...
    Exit Sub
  End if
  If Not FileObj.FileExists(UserDirectory & "Circus_LUT.txt") then
    LUTset=17
    Exit Sub
  End if
  Set ScoreFile=FileObj.GetFile(UserDirectory & "Circus_LUT.txt")
...
'v0.57  Locked everything on table. Looked through what all needs to be done.
'   Removed duplicate AudioFade function
'   Removed duplicate flipper timer
'   LUT code was overwriting Apollo (guessing code was reused from that table.)
'     Adjust background color (needs to be black for VR to look proper)
'   Added simple ruleset to table info.
'   Decided to implement ONLY the 6 digit ROM.
'v0.58  Converted all code to latest VPW standard, shadows, LUT, physics, flippers, standalone, dropt targets, sling corrections, etc.
'   Updated to latest Fleep sounds.
'   Created new trough system to accomodate gBOT.  Also, added apron physics.
...
'   Implemented new drop and standup targets by Rothbaurer
'   Implemented standalone code
'   Implemented sling corrections.
'   Added some randomness to the plunger.
'   Added a GameInPlay variable, and a GameInPlayFirstTime variable to control first knocker sound, tilt, and ball eject.
'     Every once in awhile, the ball falls below playfield after ball ejects to plungerlane
'   Altered the plunger stop wall, and moved the up ramp to groove a little, and added a physics wall to ensure it doesn't fall.
'   Added a physics wall under the flippers.
'   Added a glass top.
'   One sensor was missing on top right/middle.  Also, one rubber sensor had to be added to rubber sub.
'   Added various ball options
'   Added cutouts for triggers and other holes.
'   Updated playfield with GI bulb cutouts, and missing sensor on upper right.  And filled in holes in lower playfield under apron.
'   Added all bulb prims, including in standup target holes.
'   Added all new GI.  Will bake later.
'   Updated the lane pyramids to be red.
'   Changed the material on top rollover pegs to be transparent.
'   Updated the leaf sensors and the sling movement.  Also, made the rubbers on the sling to be reflection enabled.
'   Adjusted light emission color, and adjusted day/night slider
'   Updated the metal wall images and material
'v0.59  Updated playfield for all insert holes and text overlay
'   Set the Z adjustment slightly below zero on the plunger to help with the random times if falls below PF. And momentum xfer to 1.
'     Added VPW dynamic shadows, and ensured doesn't go in plunger lane
'   Added Lampz and 3D primitive inserts.
'   Tweaked insert prim materials and lampz constants to get best look.
'     Added physics wall to plastics areas
'v0.60  Added Flupper Bumpers, and adjusted color, dL, of tops, base, skirt, etc.
'   Added a hole for the spinner prim.
'   Tied GI and bumpers to Lampz
'   Adjusted post near right flipper slightly, as it didn't follow rubber exactly.
'   Got the backbox functional for DesktopMode, updated new picture, and added GI bg lights for Destktop.  Got rails to show in DesktopMode
'   Adjusted the material/color on desktop rails to be brighter
'   Updated code to change instruction cards depending on ball selection and reward
'   Added lighting to Roto and tied to GI.
...
'   Added screws and screw caps
'   Added Roth standup and targetbouncer to roto targets, as well as target sounds.
'   Added Drop Target Shadows and modified code to accomodate for a light hit.
'   Updated the text overlay image.
...
'     Dip 22 playfield special extra ball of 1 = "Awards Extra Ball when A-B-C hit, and "Star" hit on roto.
'v0.61  Implemented cab mode and higher side blades.
'   Added VR Cab and VR Room
'   Updated the VR Backglass displays, color, position, etc.
'   Adjusted the cab pov
'v0.62  Converted images to webp
'   Updated the disk color on flupper bumpers
'   After viewing in VR, updated some images, a behind plunger VR wall block, and adjusted saucer prim location.
'   Adjusted the bumper tops and skirt for initial startup and then with GI on.
'v0.63  Adjusted slope to 5 degrees.
'   Physics dPosts weren't in rubbers collection... added.
'   Changed the slingshot timer to 17 ms (was 50.. .and a bit sluggish.)
'   Flipper TriggersXF's were too much margin and needed to be appropriately sized.
'   The player 1-4 desktop lights were changed to blue when lit by accident.  Changed back to red.
'v0.64  Bord suggested I change to a more flat insert style with limited translucency.  Updated, and changed colors of a couple of them to blue and pink.
'   Added additional physics wall near flippers to avoid ball sitting there.
'v0.65  Made lockdown bar visible and adjusted height for desktop, in case user widens screen.
'   VR Plunger didn't move in vpx_gl version, updated code to fix.
'   Added option for both 6 and 7 digit ROM.
'v2.0.0 Added sys80 rails for DT.
'   Corrected some metals collections. Also removed one repeat rubber post physics.
'   Fine tuned the plunger release to allow for variablility in plunger speed and metal rail guide physics update.
'   Released

' Thanks to apophis, bord, and pinstratsdan for feedback and testing, Hauntfreaks for the updated backglass VR images, Redbone for upscaling the PF, and to the VPW team for testing.

'   great video that highlights the colors of inserts:   https://www.youtube.com/watch?v=MYeTZ9jS2Q8
