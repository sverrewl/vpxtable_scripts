...
Const cGameName="attila",UseSolenoids=2,UseLamps=1,UseGI=0,UseSync=1,SCoin="coin3"
...
Sub SolRFlipper(Enabled)
     If Enabled Then
         PlaySound SoundFX("fx_Flipperup",DOFContactors):RightFlipper.RotateToEnd:RightFlipper.RotateToEnd
     Else
         PlaySound SoundFX("fx_Flipperdown",DOFContactors):RightFlipper.RotateToStart:RightFlipper.RotateToStart
     End If
End Sub
...
Sub Table1_KeyDown(ByVal KeyCode)
    ...
    If KeyCode=PlungerKey Then playsound "fx_plungerpull":Plunger.Pullback:End if
...
Sub aGates_Hit(idx):PlaySound "fx_Gate", 0, Vol(ActiveBall), Audiopan(ActiveBall), 0, Pitch(ActiveBall), 1, 0:End Sub
Sub aMetals_Hit(idx):PlaySound "fx_MetalHit", 0, Vol(ActiveBall), Audiopan(ActiveBall), 0, Pitch(ActiveBall), 1, 0:End Sub
