...
Sub sw32_Hit:bsSaucer.AddBall 0 : playsoundAtVol "popper_ball", ActiveBall, VolKick: End Sub

 'Scoring Rubber
Sub sw13_hit:vpmTimer.pulseSw 13 : playsoundAtVol"flip_hit_3" , ActiveBall, 1: End Sub
Sub sw14_hit:vpmTimer.pulseSw 14 : playsoundAtVol"flip_hit_3" , ActiveBall, 1: End Sub
...
'Wire Triggers
  ...
  Sub sw2_Hit:Controller.Switch(2) = 1:PlaySoundAtVol "rollover", ActiveBall, VolRol:End Sub
...
'Bumpers
Sub Bumper1_Hit : vpmTimer.PulseSw(38) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors), ActiveBall, VolBump: End Sub
Sub Bumper2_Hit : vpmTimer.PulseSw(39) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors), ActiveBall, VolBump: End Sub
Sub Bumper3_Hit : vpmTimer.PulseSw(40) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors), ActiveBall, VolBump: End Sub
