...
LHDTW.isdropped = 1
LHDTW1.isdropped = 1
PlaySound SoundFX("dtresetl",DOFContactors)
LHDBU.enabled = 1
...
XRHDTW.isdropped = 1
XRHDTW1.isdropped = 1
PlaySound SoundFX("dtresetr",DOFContactors)
RHDBU.enabled = 1
...
If enabled Then
Rorbit.open = 1
PlaySound SoundFX("dtr",DOFDropTargets)
else
Rorbit.open = 0
End If
End Sub
...
Sub sw1_Hit:sw1.IsDropped = 1:sw1a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 1:PlaySound SoundFX("target",DOFTargets):End Sub
Sub sw1_Timer:sw1.IsDropped = 0:sw1a.IsDropped = 1:Me.TimerEnabled = 0:End Sub
Sub sw2_Hit:sw2.IsDropped = 1:sw2a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 2:PlaySound SoundFX("target",DOFTargets):End Sub
Sub sw2_Timer:sw2.IsDropped = 0:sw2a.IsDropped = 1:Me.TimerEnabled = 0:End Sub
Sub sw3_Hit:sw3.IsDropped = 1:sw3a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 3:PlaySound SoundFX("target",DOFTargets):End Sub
Sub sw3_Timer:sw3.IsDropped = 0:sw3a.IsDropped = 1:Me.TimerEnabled = 0:End Sub
Sub sw4_Hit:sw4.IsDropped = 1:sw4a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 4:PlaySound SoundFX("target",DOFTargets):End Sub
Sub sw4_Timer:sw4.IsDropped = 0:sw4a.IsDropped = 1:Me.TimerEnabled = 0:End Sub
Sub sw5_Hit:sw5.IsDropped = 1:sw5a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 5:PlaySound SoundFX("target",DOFTargets):End Sub
...
Sub sw41_Hit:sw41.IsDropped = 1:sw41a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 41:PlaySound SoundFX("target",DOFTargets):End Sub
Sub sw41_Timer:sw41.IsDropped = 0:sw41a.IsDropped = 1:Me.TimerEnabled = 0:End Sub
Sub sw42_Hit:sw42.IsDropped = 1:sw42a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 42:PlaySound SoundFX("target",DOFTargets):End Sub
...
Sub sw54_Hit:sw54.IsDropped = 1:sw54a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 54:PlaySound SoundFX("target",DOFTargets):End Sub
Sub sw54_Timer:sw54.IsDropped = 0:sw54a.IsDropped = 1:Me.TimerEnabled = 0:End Sub
Sub sw55_Hit:sw55.IsDropped = 1:sw55a.IsDropped = 0:Me.TimerEnabled = 1:vpmTimer.PulseSw 55:PlaySound SoundFX("target",DOFTargets):End Sub
Sub sw55_Timer:sw55.IsDropped = 0:sw55a.IsDropped = 1:Me.TimerEnabled = 0:End Sub
Sub lhdtw_Hit:vpmTimer.PulseSw 57:Playsound SoundFX("target",DOFTargets):End Sub
Sub xrhdtw_Hit:vpmTimer.PulseSw 56:Playsound SoundFX("target",DOFTargets):End Sub
...
'***Slings and rubbers
 ...
 Sub LeftSlingShot_Slingshot
 	...
 	PlaySound SoundFX("Slingshot",DOFContactors):vpmTimer.PulseSw 26:LStep = 0:Me.TimerEnabled = 1
  End Sub
 ...
 Sub RightSlingShot_Slingshot
 	...
 	PlaySound SoundFX("Slingshot",DOFContactors):vpmTimer.PulseSw 27:RStep = 0:Me.TimerEnabled = 1
  End Sub
 ...
 End Sub
   ...
   'Bumpers
      Sub Bumper1_Hit:vpmTimer.PulseSw 30:PlaySound SoundFX("bumper",DOFContactors):End Sub
     
        
      Sub Bumper2_Hit:vpmTimer.PulseSw 32:PlaySound SoundFX("bumper",DOFContactors):End Sub
     
        
      Sub Bumper3_Hit:vpmTimer.PulseSw 33:PlaySound SoundFX("bumper",DOFContactors):End Sub
     
      
      Sub Bumper4_Hit:vpmTimer.PulseSw 31:PlaySound SoundFX("bumper",DOFContactors):End Sub
