'Trick Shooter / IPD No. 5888 / 4 Players /LTD do Brasil 1986
'VPX8 table by jpsalas 2024, version 6.0.0
'Graphics by Halen
'Vpinmame script based on the whitewood table by mfuegemann
...
Const cGameName = "tricksht"

Dim bsTrough, dtBank1, dtBank2, Flipperactive, bsTopHole
Dim obj, x
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Trick Shooter - LTD do Brasil 1986" & vbNewLine & "VPX table by JPSalas v6.0.0"
    ...
    With bsTopHole
        .InitKicker TopHole, 45, 200, 15, 0
        .InitSounds SoundFX("fx_kicker_enter", DOFContactors), SoundFX("fx_kicker", DOFContactors), SoundFX("fx_popper", DOFContactors)
    ...
    With dtBank1
        .InitDrop Array(DT1, DT2, DT3), Array(43, 42, 41)
    ...
    With dtBank2
        .InitDrop Array(DT4, DT5, DT6, DT7), Array(36, 35, 34, 33)
        .InitSnd SoundFX("fx_droptarget", DOFDropTargets), SoundFX("fx_resetdrop", DOFContactors)
...
' Scoring rubbers
Sub rlband004_Hit:vpmtimer.pulsesw 27:End Sub

' Bumpers
Sub Bumper001_Hit:vpmTimer.PulseSw 19:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper001:End Sub
Sub Bumper002_Hit:vpmTimer.PulseSw 20:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper002:End Sub
Sub Bumper003_Hit:vpmTimer.PulseSw 21:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper003:End Sub
Sub Bumper004_Hit:vpmTimer.PulseSw 22:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper004:End Sub
...
Sub TopHole_Hit
    ...
    bsTopHole.AddBall 0
    If l48.State Then
        vpmtimer.addtimer 300, "vpmTimer.PulseSw 37 '" 'do this 5 times to score 25k
        vpmtimer.addtimer 600, "vpmTimer.PulseSw 37 '"
        vpmtimer.addtimer 900, "vpmTimer.PulseSw 37 '"
        vpmtimer.addtimer 1200, "vpmTimer.PulseSw 37 '"
        vpmtimer.addtimer 1500, "vpmTimer.PulseSw 37 '"
    Else
        if l41.state Then vpmtimer.addtimer 300, "vpmTimer.PulseSw 30 '"  'x2 I use the switch 30 to add 2000 points for each light that is on
        if l42.state Then vpmtimer.addtimer 600, "vpmTimer.PulseSw 30 '"  'x3
        if l43.state Then vpmtimer.addtimer 900, "vpmTimer.PulseSw 30 '"  'x4
        if l44.state Then vpmtimer.addtimer 1200, "vpmTimer.PulseSw 30 '" 'x5
    End If
End Sub

' Rollovers
Sub Lane1_Hit:Controller.Switch(53) = 1:PlaySoundAt "fx_sensor", Lane1:End Sub
Sub Lane1_Unhit:Controller.Switch(53) = 0:End Sub
Sub Lane2_Hit:Controller.Switch(52) = 1:PlaySoundAt "fx_sensor", Lane2:End Sub
Sub Lane2_Unhit:Controller.Switch(52) = 0:End Sub
Sub Lane3_Hit:Controller.Switch(51) = 1:PlaySoundAt "fx_sensor", Lane3:End Sub
Sub Lane3_Unhit:Controller.Switch(51) = 0:End Sub
Sub Lane4_Hit:Controller.Switch(50) = 1:PlaySoundAt "fx_sensor", Lane4:End Sub
Sub Lane4_Unhit:Controller.Switch(50) = 0:End Sub
Sub Lane5_Hit:Controller.Switch(49) = 1:PlaySoundAt "fx_sensor", Lane5:End Sub
Sub Lane5_Unhit:Controller.Switch(49) = 0:End Sub
Sub LaneX_Hit:Controller.Switch(54) = 1:PlaySoundAt "fx_sensor", LaneX:End Sub
Sub LaneX_Unhit:Controller.Switch(54) = 0:End Sub

Sub LeftLane_Hit:Controller.Switch(46) = 1:PlaySoundAt "fx_sensor", LeftLane:End Sub
Sub LeftLane_Unhit:Controller.Switch(46) = 0:End Sub

Sub RightLane_Hit:Controller.Switch(44) = 1:PlaySoundAt "fx_sensor", RightLane:End Sub
Sub RightLane_Unhit:Controller.Switch(44) = 0:End Sub

Sub LeftOutlane_Hit:Controller.Switch(38) = 1:PlaySoundAt "fx_sensor", LeftOutlane:End Sub
Sub LeftOutlane_Unhit:Controller.Switch(38) = 0:End Sub

Sub Leftinlane_Hit:Controller.Switch(37) = 1:PlaySoundAt "fx_sensor", LeftInlane:End Sub
Sub Leftinlane_Unhit:Controller.Switch(37) = 0:End Sub

'Spinners

Sub spinner1_Spin():vpmTimer.PulseSw 28:PlaySoundAt "fx_spinner", Spinner1:End Sub

'Targets
Sub Target1_Hit:vpmTimer.PulseSw 29:PlaySoundAtBall SoundFX("fx_target", DOFTargets):End Sub
Sub Target2_Hit:vpmTimer.PulseSw 30:PlaySoundAtBall SoundFX("fx_target", DOFTargets):End Sub
...
SolCallback(9) = "bsTopHole.SolOut"
SolCallback(10) = "dtBank2.SolDropUp"
SolCallback(11) = "dtBank1.SolDropUp"
