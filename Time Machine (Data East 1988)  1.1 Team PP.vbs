...
' Thalamus seems this tables used both built-in fastflip and useSolenoids=2 - reverted
...
sub SW45Wait_timer()
 ...
 Sub LeftFlipper_Collide(parm)
     PlaySoundAt "rubber_flipper", LeftFlipper
 End Sub

 Sub RightFlipper_Collide(parm)
     PlaySoundAt "rubber_flipper", RightFlipper
 End Sub
...
Sub SolLFlipper(Enabled)
     If Enabled Then
       PlaySound SoundFX("LFlipperUp",DOFFlippers)
      LeftFlipper.RotateToEnd
      Controller.Switch(15)=True
  else
      PlaySound SoundFX("LFlipperRel",DOFFlippers)
  ...
  Sub SolRFlipper(Enabled)
     If Enabled Then
       PlaySound SoundFX("RFlipperUp",DOFFlippers)
      RightFlipper.RotateToEnd
      Controller.Switch(16)=True
     Else
       PlaySound SoundFX("RFlipperRel",DOFFlippers)
...
End Sub
 ...
 'Slings
 Sub LeftSlingshot_SlingShot() : PlaySound SoundFX("LSlingshot",DOFContactors):vpmTimer.PulseSw 21 : End Sub
 Sub RightSlingshot_SlingShot() : PlaySound SoundFX("RSlingshot",DOFContactors):vpmTimer.PulseSw 22 : End Sub

 '********************* Bumpers ****************************

 Sub Switch46_Hit() : PlaySoundAt SoundFX("bumperyellow",DOFContactors), Switch46 : vpmTimer.PulseSw 46 : : bump1=1 : Me.TimerEnabled=1 : End Sub
 Sub Switch46_Timer():  Me.Timerenabled = 0 : End Sub

 Sub Switch48_Hit() : PlaySoundAt SoundFX("bumperblue",DOFContactors), Switch48 : vpmTimer.PulseSw 48 : bump2=1 : Me.TimerEnabled=1 : End Sub
 Sub Switch48_Timer():  Me.Timerenabled = 0 : End Sub

 Sub Switch47_Hit() : PlaySoundAt SoundFX("bumperred",DOFContactors), Switch47 : vpmTimer.PulseSw 47 : Me.TimerEnabled=1 : End Sub
 ...
 'Out Lanes
 Sub Switch17_Hit() : PlaysoundAt "sensor", Switch17 : Controller.Switch(17)=1 : End Sub
 Sub Switch17_UnHit() : Controller.Switch(17)=0 : End Sub

 Sub Switch19_Hit() : PlaysoundAt "sensor", Switch19 : Controller.Switch(19)=1 : End Sub
 Sub Switch19_UnHit() : Controller.Switch(19)=0 : End Sub

 'In Lanes
 Sub Switch18_Hit() : PlaysoundAt "sensor", Switch18 : Controller.Switch(18)=1 : End Sub
 Sub Switch18_UnHit() : Controller.Switch(18)=0 : End Sub

 Sub Switch20_Hit() : PlaysoundAt "sensor", Switch20 : Controller.Switch(20)=1 : End Sub
 Sub Switch20_UnHit() : Controller.Switch(20)=0 : End Sub

 'TopLane
 Sub Switch25_Hit() : PlaysoundAt "sensor", Switch25 : Controller.Switch(25)=1 : End Sub
 Sub Switch25_UnHit() : Controller.Switch(25)=0 : End Sub
 Sub Switch26_Hit() : PlaysoundAt "sensor", Switch26 : Controller.Switch(26)=1 : End Sub
 Sub Switch26_UnHit() : Controller.Switch(26)=0 : End Sub
 Sub Switch27_Hit() : PlaysoundAt "sensor", Switch27 : Controller.Switch(27)=1 : End Sub
 ...
 'Left Targets
Sub SWsqr5_hit():sqr5.transz = 10:sqr6.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 35:PlaysoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub SWror5_hit():ror5.transz = 10:ror6.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 34:PlaysoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub swtrr5_hit():trr5.transz = 10:trr6.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 33:PlaySoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub swtrr5a:trr5.transZ = 0:trr6.transz = 0:End Sub
 ...
 'Center Targets
Sub SWsqr3_hit():sqr3.transz = 10:sqr4.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 43:PlaySoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub SWror3_hit():ror3.transz = 10:ror4.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 42:PlaySoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub swtrr3_hit():trr3.transz = 10:trr4.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 41:PlaySoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub swtrr3a:trr3.transZ = 0:trr4.transz = 0:End Sub
 ...
 'Right Targets
Sub SWsqr1_hit():sqr1.transz = 10:sqr2.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 51:PlaySoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub SWror1_hit():ror1.transz = 10:ror2.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 50:PlaySoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub swtrr1_hit():trr1.transz = 10:trr2.transz = 10:Me.TimerEnabled = 1:vpmTimer.PulseSw 49:PlaySoundAt SoundFX("target",DOFTargets),ActiveBall:End Sub
...
Sub LampTimer_Timer()
    ...
    If l54h.state = 1 then BumpCircle2.enabled = 0:Primitive9.image = "bumpCircle0":circle2=0:end if
    UpdateLamps
End Sub
...
End Sub
 ...
 '*****************
  ...
  Sub Rhelp_Hit() : PlaySoundAt "ballhit", ActiveBall : End Sub
  Sub Lhelp_Hit() : PlaySoundAt "ballhit", ActiveBall : End Sub
' Sub Targets_Hit(idx):PlaySound"SwitchTarget":End Sub

  Sub Gates_Hit(idx):PlaySoundAt "Gate", ActiveBall:End Sub

  Sub Metal_Hit (idx):RandomSoundMetal():End Sub
  Sub RandomSoundMetal()
    Select Case Int(Rnd*4)+1
      Case 1 : PlaySound "metal_1", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
      Case 2 : PlaySound "metal_2", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
      Case 3 : PlaySound "metal_3", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
      Case 4 : PlaySound "metal_4", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
    End Select
  End Sub
  Sub Rubbers_Hit(idx)
    dim finalspeed
    ...
    If finalspeed > 20 then
      PlaySound "rubber_hit_1", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
    End if
  ...
  Sub RandomSoundRubber()
    Select Case Int(Rnd*3)+1
      Case 1 : PlaySound "rubber_hit_1", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
      Case 2 : PlaySound "rubber_hit_2", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
      Case 3 : PlaySound "rubber_hit_3", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
    End Select
  End Sub
...
Sub MetTrig01_Hit()
PlaySound "metal_1", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
Sub MetTrig02_Hit()
PlaySound "metal_2", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
Sub MetTrig03_Hit()
PlaySound "metal_3", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
Sub MetTrig04_Hit()
PlaySound "metal_4", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
Sub MetTrig05_Hit()
PlaySound "metal_2", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
...
Sub WoodTrig01_Hit()
PlaySound "woodhit", 0, Vol(ActiveBall)*GlobalSoundLevel , pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
...
Function AudioFade(ball) ' Can this be together with the above function ?
  Dim tmp
  tmp = ball.y * 2 / Time_Machine.height-1
  If tmp > 0 Then
    AudioFade = Csng(tmp ^10)
  Else
    AudioFade = Csng(-((- tmp) ^10) )
...
Sub OnBallBallCollision(ball1, ball2, velocity)
  If Time_Machine.VersionMinor > 3 OR Time_Machine.VersionMajor > 10 Then
...
Sub shfl_Timer()
  ...
  if ABS(Vlock.balls) = 1 and vla = 0 then
      PlaySoundAtVol "Wirestop", Switch38Kick, GlobalSoundLevel
    vla=1:vlb=0:vlc=0:vlaa=0:vlbb=0:vlcc=0
  end if

  if ABS(Vlock.balls) = 2 and vla = 1 and vlb = 0 then
    PlaySoundAtVol "Wirestopball", Switch38Kick, GlobalSoundLevel
