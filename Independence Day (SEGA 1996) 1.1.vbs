...
Sub SolRFlipper(Enabled)
     If Enabled Then
         PlaySound SoundFX("fx_Flipperup",DOFFlippers):RightFlipper.RotateToEnd:UpperRightFlipper.RotateToEnd
     Else
         PlaySound SoundFX("fx_Flipperdown",DOFFlippers):RightFlipper.RotateToStart:UpperRightFlipper.RotateToStart
     End If
End Sub
...
Sub Table1_Init
	...
	On Error Resume Next
		...
		.SplashInfoLine = "ID4 Sega"&chr(13)&"You Suck"
		.HandleMechanics=0
		.HandleKeyboard=0
		.ShowDMDOnly=1
		.ShowFrame=0
...
Sub MiniLoopSU_Hit:vpmTimer.PulseSw 25:Playsound SoundFX("target",DOFTargets):End Sub
Sub CenterRampSU_Hit:vpmTimer.PulseSw 27:Playsound SoundFX("target",DOFTargets):End Sub
Sub RightRampLeftSU_Hit:vpmTimer.PulseSw 28:Playsound SoundFX("target",DOFTargets):End Sub
Sub RightRampRightSU_Hit:vpmTimer.PulseSw 29:Playsound SoundFX("target",DOFTargets):End Sub
Sub superjackpotSU_Hit:vpmTimer.PulseSw 24:Playsound SoundFX("target",DOFTargets):End Sub
Sub Area51Bot_Hit:vpmTimer.PulseSw 47:Playsound SoundFX("target",DOFTargets):End Sub
Sub Area51Mid_Hit:vpmTimer.PulseSw 34:Playsound SoundFX("target",DOFTargets):End Sub
Sub Area51Top_Hit:vpmTimer.PulseSw 33:Playsound SoundFX("target",DOFTargets):End Sub
Sub HurryUpBot_hit:vpmTimer.PulseSw 48:Playsound SoundFX("target",DOFTargets):End Sub
Sub HurryUpMid_Hit:vpmTimer.PulseSw 36:Playsound SoundFX("target",DOFTargets):End Sub
Sub HurryUpTop_Hit:vpmTimer.PulseSw 35:Playsound SoundFX("target",DOFTargets):End Sub
