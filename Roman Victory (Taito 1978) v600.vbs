...
' Roman Victory - Taito do Brasil 1978 - version 6.0.0
' ****************************************************************
...
' Valores Constants
Const TableName = "RomanVictory"
Const cGameName = "RomanVictory"
...
Sub AwardExtraBall()
    If NOT bExtraBallWonThisBall Then
        PlaySound SoundFXDOF ("Sino", 130, DOFPulse, DOFKnocker)
        DOF 230, DOFPulse
        DOF 125, DOFOn
        ExtraBallsAwards(CurrentPlayer) = ExtraBallsAwards(CurrentPlayer) + 1
