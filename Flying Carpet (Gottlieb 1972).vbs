...
sub ballreltimer_timer
  ...
  Drain.kick 60,12,0
    ballreltimer.enabled=false
  playsoundAtVol SoundFXDOF("kickerkick", 121, DOFPulse,DOFContactors), Drain, 1
  end if
end sub
...
Sub Bumper1_Hit
   if tilt=false then
    PlaySoundAtVol SoundFXDOF("fx_bumper4",104, DOFPulse,DOFContactors), Bumper1, VolBump
...
Sub Bumper2_Hit
   if tilt=false then
    PlaySoundAtVol SoundFXDOF("fx_bumper4",103, DOFPulse,DOFContactors), Bumper2, VolBump
...
Sub Bumper3_Hit
   if tilt=false then
    PlaySoundAtVol SoundFXDOF("fx_bumper4",105, DOFPulse,DOFContactors), Bumper3, VolBump
