...
Const cGameName="amazonh"
'Const cGameName="amazonha"
...
FullStrokeEOS_Torque = 0.5  ' EOS Torque when flipper hold up ( EOS Coil is fully charged. Ampere increase due to flipper can't move or when it pushed back when "On". EOS Coil have more power )
...
'********************************************
' Table Options F12 / User Options (JP Salas)
'********************************************
