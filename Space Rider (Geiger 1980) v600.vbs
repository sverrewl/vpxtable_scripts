...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Space Rider - Geiger 1979" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub Sling1_Hit:PlaySoundAtBall "fx_Rubber":vpmTimer.PulseSw 34:End Sub
Sub Sling2_Hit:PlaySoundAtBall"fx_Rubber":vpmTimer.PulseSw 34:End Sub
...
Sub sw24_Hit:PlaySoundAt "fx_kicker_enter",sw24:bsMSaucer.AddBall 0:End Sub
Sub sw32_Hit:PlaySoundAt "fx_kicker_enter",sw32:bsRSaucer.AddBall 0:End Sub
...
Sub RightLaneGate_Collide(parm)
    PlaySound "fx_MetalWire", 0, parm / 60, pan(ActiveBall), 0.2, 0, 0, 0, AudioFade(ActiveBall)
End Sub
...
Sub RightLaneGate_Animate: Diverter.RotZ = RightLaneGate.CurrentAngle: End Sub
