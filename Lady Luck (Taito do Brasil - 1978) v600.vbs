' Lady Luck / Taito / IPD No. 5010 / 4 Players
' VPX - version by JPSalas 2019, version 6.0.0
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Lady Luck - Taito 1979" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub Bumper2_Hit:vpmTimer.PulseSw 24:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 34:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:End Sub
Sub Bumper4_Hit:vpmTimer.PulseSw 44:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper4:End Sub
