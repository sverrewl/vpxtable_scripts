...
Sub LeftSlingShot_Slingshot
    PlaySoundAtVol SoundFX("fx_slingshot_left", DOFContactors), Lemk, 1
...
Sub RightSlingShot_Slingshot
    PlaySoundAtVol SoundFX("fx_slingshot_right", DOFContactors), Remk, 1
...
Sub sw40_Hit():PlaySoundAtVol "fx_Rubber", ActiveBall, VolRH ::vpmTimer.PulseSw 40:End Sub
Sub sw33_Hit():PlaySoundAtVol "fx_Rubber", ActiveBall, VolRH ::vpmTimer.PulseSw 33:End Sub
Sub sw34_Hit():PlaySoundAtVol "fx_Rubber", ActiveBall, VolRH ::vpmTimer.PulseSw 34:End Sub


' Bumpers
Sub sw60_Hit:vpmTimer.PulseSw 60:PlaySoundAtVol SoundFX("fx_bumper1", DOFContactors), ActiveBall, VolBump:End Sub
Sub sw61_Hit:vpmTimer.PulseSw 61:PlaySoundAtVol SoundFX("fx_bumper3", DOFContactors), ActiveBall, VolBump:End Sub
Sub sw62_Hit:vpmTimer.PulseSw 62:PlaySoundAtVol SoundFX("fx_bumper2", DOFContactors), ActiveBall, VolBump:End Sub
...
Sub sw13_Hit:Controller.Switch(13) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
Sub sw13_UnHit:Controller.Switch(13) = 0:End Sub

Sub sw14_Hit:Controller.Switch(14) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
Sub sw14_UnHit:Controller.Switch(14) = 0:End Sub

Sub sw36_Hit:Controller.Switch(36) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
Sub sw36_UnHit:Controller.Switch(36) = 0:End Sub

Sub sw30_Hit:Controller.Switch(30) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
Sub sw30_UnHit:Controller.Switch(30) = 0:End Sub

Sub sw31_Hit:Controller.Switch(31) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
Sub sw31_UnHit:Controller.Switch(31) = 0:End Sub

Sub sw35_Hit:Controller.Switch(35) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
Sub sw35_UnHit:Controller.Switch(35) = 0:End Sub

Sub sw41_Hit:Controller.Switch(41) = 1:sw41.Timerenabled = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
...
Sub sw43_Hit:Controller.Switch(43) = 1:sw43.Timerenabled = 1:PlaySoundAtVol "fx_sensor", ActiveBall, VolRol :End Sub
...
Sub sw19_1_Hit:vpmTimer.PulseSw 19:PlaySoundAtVol SoundFX("fx_target", DOFContactors), ActiveBall, VolTarg:Fisht.transY = -50:sw19w11.IsDropped = 1:sw19w21.IsDropped = 0:End Sub

Sub sw19_2_Hit:vpmTimer.PulseSw 19:PlaySoundAtVol SoundFX("fx_target", DOFContactors), ActiveBall, VolTarg:Fisht.transY = -95:sw19w21.IsDropped = 1:sw19w31.IsDropped = 0:End Sub

Sub sw19_3_Hit:vpmTimer.PulseSw 19:PlaySoundAtVol SoundFX("fx_target", DOFContactors), ActiveBall, VolTarg:Fisht.transY = -135:sw19w31.IsDropped = 1:sw19w41.IsDropped = 0:End Sub

Sub sw19_4_Hit:vpmTimer.PulseSw 19:PlaySoundAtVol SoundFX("fx_target", DOFContactors), ActiveBall, VolTarg:End Sub
...
'Droptargets VPX
Sub sw25_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
Sub sw25_Dropped:dtBird.hit 1:If GIState=1 then:sw25l.State = 1:end if: sw25.Image = "BirdTD": End Sub

Sub sw26_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
Sub sw26_Dropped:dtBird.hit 2:If GIState=1 then:sw26l.State = 1:end if:sw26.Image = "BirdTD": End Sub

Sub sw27_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
Sub sw27_Dropped:dtBird.hit 3:If GIState=1 then:sw27l.State = 1:end if:sw27.Image = "BirdTD": End Sub

Sub sw28_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
Sub sw28_Dropped:dtBird.hit 4:If GIState=1 then:sw28l.State = 1:end if:sw28.Image = "BirdTD": End Sub

Sub sw29_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
Sub sw29_Dropped:dtBird.hit 5:sw29.Image = "BirdTD": End Sub

Sub sw37_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
Sub sw37_Dropped:dtMilk.hit 1:If GIState=1 then:sw37l.State = 1:end if:sw37.Image = "MilkD": End Sub

Sub sw38_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
Sub sw38_Dropped:dtMilk.hit 2:If GIState=1 then:sw38l.State = 1:end if:sw38.Image = "MilkD": End Sub

Sub sw39_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFContactors), ActiveBall, VolTarg:End Sub 'hit event only for the sound
...
Sub Ralfie_Hit:PlaysoundAtVol "fx_scoop", ActiveBall, 1 :bsDog.AddBall Me:End Sub

'  Ramp Helpers
Sub LHelp_Hit():PlaysoundAtVol "fx_balldrop", ActiveBall, 1 :end Sub

Sub RHelp_Hit():PlaysoundAtVol "fx_balldrop", ActiveBall, 1 :end Sub

Sub WireRampSound_Hit():PlaysoundAtVol "WireRamp", ActiveBall, 1 :end Sub
'***********
' Solenoids
'***********
