' Namkwah based on Hawkman - Taito 1983
' IPD No. 4512 / 1983 / 4 Players
' VPX8 - version by JPSalas 2025, version 1.0.0
...
Sub Biggate_Animate: BigGateP.RotX = Biggate.CurrentAngle: End Sub
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Namkwah - original 2025" & vbNewLine & "VPX table by JPSalas v1.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
' Bumpers
Sub Bumper1_Hit:DOF 101, DOFPulse:vpmTimer.PulseSw 44:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper1:BumperL001a.Duration 1, 200, 0:BumperL001.Duration 1, 200, 0:End Sub
Sub Bumper2_Hit:DOF 103, DOFPulse:vpmTimer.PulseSw 44:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:BumperL002a.Duration 1, 200, 0:BumperL002.Duration 1, 200, 0:End Sub
Sub Bumper3_Hit:DOF 102, DOFPulse:vpmTimer.PulseSw 44:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:BumperL003a.Duration 1, 200, 0:BumperL003.Duration 1, 200, 0:End Sub

' Drain & Saucers
Sub Drain_Hit:PlaysoundAt "fx_drain", Drain:bsTrough.AddBall Me:End Sub
Sub sw3_Hit:PlaysoundAt "fx_kicker_enter", sw3:bsRightSaucer.AddBall 0:End Sub
Sub sw1_Hit:PlaysoundAt "fx_kicker_enter", sw1:bsTopSaucer.AddBall 0:End Sub
...
' Spinners
Sub Spinner1_Spin:vpmTimer.PulseSw 32:PlaySoundAt "fx_spinner", Spinner1:End Sub
