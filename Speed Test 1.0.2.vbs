...
Sub sw4_Hit:PlaySound "fx_kicker_enter", 0, 1, -0.05:bsLeftSaucer.AddBall 0:End Sub

' Rollovers
Sub sw44_Hit:Controller.Switch(44) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw44_UnHit:Controller.Switch(44) = 0:End Sub

Sub sw24_Hit:Controller.Switch(24) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw24_UnHit:Controller.Switch(24) = 0:End Sub

Sub sw14_Hit:Controller.Switch(14) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw14_UnHit:Controller.Switch(14) = 0:End Sub

Sub sw34_Hit:Controller.Switch(34) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw34_UnHit:Controller.Switch(34) = 0:End Sub

Sub sw74_Hit:Controller.Switch(74) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):LTleft.State = 1:LTlefta.Visible = 1:End Sub
Sub sw74_UnHit:Controller.Switch(74) = 0:LTleft.State = 0:LTlefta.Visible = 0:End Sub

Sub sw33_Hit:Controller.Switch(33) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):sw33l.Duration 1, 400, 0:End Sub
Sub sw33_UnHit:Controller.Switch(33) = 0:End Sub

Sub sw11_Hit:Controller.Switch(11) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):sw11l.Duration 1, 400, 0:End Sub
Sub sw11_UnHit:Controller.Switch(11) = 0:End Sub

Sub sw72_Hit:Controller.Switch(72) = 1:PlaySound "fx_sensor", 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):LTright.State = 1:End Sub
...
' Droptargets
Sub sw42_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw52_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw62_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
...
Sub sw32_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw43_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw53_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw63_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw73_Hit:PlaySound SoundFX("fx_droptarget", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
...
'Targets
Sub sw21_Hit:vpmTimer.PulseSw 21:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub

Sub sw41_Hit:vpmTimer.PulseSw 41:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
...
Sub sw61_Hit:vpmTimer.PulseSw 61:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
Sub sw71_Hit:vpmTimer.PulseSw 71:PlaySound SoundFX("fx_target", DOFDropTargets), 0, 1, pan(ActiveBall), 0, 0, AudioFade(ActiveBall):End Sub
