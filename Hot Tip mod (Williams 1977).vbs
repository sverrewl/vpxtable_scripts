...
Const cGameName="httip_l1",UseSolenoids=1,UseLamps=1,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SCoin="coin"
...
Sub sw22_Hit : bsTop.addBall 0 : PlaySound "Wave6"End Sub
Sub sw29_Hit : bsLeft.addBall 0 : PlaySound "Wave5":End Sub

'scoring rubbers
Sub sw21_Slingshot:vpmTimer.PulseSw 21:playsound SoundFX("slingshot",DOFContactors):End Sub
