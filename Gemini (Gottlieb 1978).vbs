...
Function AudioFade(tableobj) ' Fades between front and back of the table (for surround systems or 2x2 speakers, etc), depending on the Y position on the table. "Gemini" is the name of the table
	Dim tmp
...
Function AudioPan(tableobj) ' Calculates the pan for a tableobj based on the X position on the table. "Gemini" is the name of the table
    Dim tmp
