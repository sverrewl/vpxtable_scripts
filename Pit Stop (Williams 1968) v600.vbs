' Pit Stop / IPD No. 1806 / October 19, 1968 / 2 Players
...
' Valores Constants
Const TableName = "pitstop" ' file name to save highscores and other variables
Const cGameName = "pitstop" ' B2S name
...
Sub ResetScores
    ...
    LapsReel1.ResetToZero
    LapsReel2.ResetToZero
    If B2SOn then
...
Dim Laps(2)
Dim LapPos(2)
Dim steps     'for the animation of the lights
Dim LightStep
...
Sub Trigger001_Hit 'left outlane
    ...
    If Tilted Then Exit Sub
    AddScore 100
    If Light002.State Then AdvanceLap(11 - LapPos(CurrentPlayer) )
End Sub
...
Sub Trigger002_Hit 'right outlane
    ...
    If Tilted Then Exit Sub
    AddScore 100
    If Light003.State Then AdvanceLap(11 - LapPos(CurrentPlayer) )
End Sub
...
Sub Trigger006_Hit 'top left lane
    PlaySoundAt "fx_sensor", Trigger006
    If Tilted Then Exit Sub
    AddScore 100
    AdvanceLap(11 - LapPos(CurrentPlayer) ) 'advance 1 lap
    If Light004.State Then AwardExtraBall
End Sub
...
Sub Trigger009_Hit
    ...
    If Tilted Then Exit Sub
    If Light006.State Then AdvanceLap 1
End Sub

Sub Trigger010_Hit
    PlaySoundAt "fx_sensor", Trigger010
    If Tilted Then Exit Sub
    If Light007.State Then AdvanceLap 1
End Sub

' 1 point rebounds

Sub rsband003_Hit:AddScore 1:ExchangeLights:End Sub
Sub rsband008_Hit:AddScore 1:ExchangeLights:End Sub
Sub rlband007_Hit:AddScore 1:ExchangeLights:End Sub
Sub rlband006_Hit:AddScore 1:ExchangeLights:End Sub
...
Sub Target005_Hit
    ...
    If Tilted Then Exit Sub
    Addscore 200
    If Light005.State Then AdvanceLap 5
End Sub
...
Sub LapsTimer_Timer
    If steps> 0 Then
        LapPos(CurrentPlayer) = LapPos(CurrentPlayer) + 1
        If LapPos(CurrentPlayer) = 11 Then
            LapPos(CurrentPlayer) = 1
            Laps(CurrentPlayer) = Laps(CurrentPlayer) + 1
            UpdateLapScore
            If Laps(CurrentPlayer) = 20 Then AwardSpecial
            If Laps(CurrentPlayer) = 26 Then AwardSpecial
        End If
        steps = steps - 1
        UpdateLapLights
    Else
...
Sub UpdateLapLights
    ' update lights
    PlaySound"fx_reel2"
    Select Case LapPos(1) 'Player 1
        Case 1:pc001.State = 1:pc002.State = 0:pc003.State = 0:pc004.State = 0:pc005.State = 0:pc006.State = 0:pc007.State = 0:pc008.State = 0:pc009.State = 0:pc010.State = 0:Light004.State = 1
        Case 2:pc001.State = 0:pc002.State = 1:pc003.State = 0:pc004.State = 0:pc005.State = 0:pc006.State = 0:pc007.State = 0:pc008.State = 0:pc009.State = 0:pc010.State = 0:Light004.State = 0
        Case 3:pc001.State = 0:pc002.State = 0:pc003.State = 1:pc004.State = 0:pc005.State = 0:pc006.State = 0:pc007.State = 0:pc008.State = 0:pc009.State = 0:pc010.State = 0:Light004.State = 0
        Case 4:pc001.State = 0:pc002.State = 0:pc003.State = 0:pc004.State = 1:pc005.State = 0:pc006.State = 0:pc007.State = 0:pc008.State = 0:pc009.State = 0:pc010.State = 0:Light004.State = 0
        Case 5:pc001.State = 0:pc002.State = 0:pc003.State = 0:pc004.State = 0:pc005.State = 1:pc006.State = 0:pc007.State = 0:pc008.State = 0:pc009.State = 0:pc010.State = 0:Light004.State = 0
        Case 6:pc001.State = 0:pc002.State = 0:pc003.State = 0:pc004.State = 0:pc005.State = 0:pc006.State = 1:pc007.State = 0:pc008.State = 0:pc009.State = 0:pc010.State = 0:Light004.State = 1
