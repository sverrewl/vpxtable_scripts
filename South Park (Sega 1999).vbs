...
Sub SolLFlipper(Enabled)
    If Enabled Then
        PlaySoundAtVol SoundFX("FlipperUpLeft", DOFFlippers),FlipperLeft,VolFlip:FlipperLeft.RotateToEnd
    Else
        PlaySoundAtVol SoundFX("FlipperDown", DOFFlippers),FlipperLeft,VolFlip:FlipperLeft.RotateToStart
    End If
End Sub

Sub SolRFlipper(Enabled)
    If Enabled Then
        PlaySoundAtVol SoundFX("FlipperUpRightBoth", DOFFlippers),FlipperRight,VolFlip:FlipperRight.RotateToEnd
    Else
        PlaySoundAtVol SoundFX("FlipperDown", DOFFlippers),FlipperRight,VolFlip:FlipperRight.RotateToStart
    End If
End Sub
