...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Vortex - Taito 1981" & vbNewLine & "VPX table by JPSalas v.1.0.2"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
' Scoring rubbers
Sub sw44_Hit:vpmTimer.PulseSw 44:PlaySoundAtVol SoundFX("fx_rubber_band", DOFDropTargets),ActiveBall,1:End Sub

Sub sw54_Hit:vpmTimer.PulseSw 54:PlaySoundAtVol SoundFX("fx_rubber_band", DOFDropTargets),ActiveBall,1:End Sub
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 3:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper1,VolBump:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 13:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper2,VolBump:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 23:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper3,VolBump:End Sub

' Drain & Saucers
Sub Drain_Hit:PlaysoundAtVol "fx_drain",drain,1:bsTrough.AddBall Me:End Sub
Sub sw2_Hit::PlaySoundAtVol "fx_kicker_enter",sw2,VolKick:bsRightSaucer.AddBall 0:End Sub
...
' Spinners
Sub Spinner1_Spin: vpmTimer.PulseSw 22: PlaySoundAtVol SoundFX("fx_spinner", DOFContactors),Spinner1,VolSpin:End Sub
Sub Spinner2_Spin: vpmTimer.PulseSw 12: PlaySoundAtVol SoundFX("fx_spinner", DOFContactors),Spinner2,VolSpin:End Sub
Sub Spinner3_Spin: vpmTimer.PulseSw 32: PlaySoundAtVol SoundFX("fx_spinner", DOFContactors),Spinner3,VolSpin:End Sub
...
Sub sw53_Hit:vpmTimer.PulseSw 53:PlaySoundAtVol SoundFX("fx_target", DOFDropTargets),ActiveBall,VolTarg:End Sub
Sub sw63_Hit:vpmTimer.PulseSw 63:PlaySoundAtVol SoundFX("fx_target", DOFDropTargets),ActiveBall,VolTarg:End Sub
Sub sw73_Hit:vpmTimer.PulseSw 73:PlaySoundAtVol SoundFX("fx_target", DOFDropTargets),ActiveBall,VolTarg:End Sub
