...
Sub DocVUKexit_Hit
	If sw17Premuto= 0 Then Playsound "WireRampHit": Playsound "metalrolling"
End Sub

Sub VenomOK_Hit
	If sw16Premuto= 0 Then Playsound "WireRampHit": Playsound "metalrolling": StopSound "plasticrolling"
End Sub
