...
Dim cGameName
If Digits7 Then
    cGameName = "ngndshkb" ' 7 Digit ROM
Else
    cGameName = "ngndshkr" ' 6 Digit ROM - original
End If
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Nitro Ground Shaker - Bally 1980" & vbNewLine & "VPX table by JPSalas v.5.5.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub Bumper3_Hit:vpmTimer.PulseSw 36:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:End Sub
...
SolCallBack(9) = "SolSaucer"  '"bsSaucer.SolOut"
SolCallBack(8) = "SolSaucer2" '"bsSaucer2.SolOut"
...
Sub UpdateLamps()
    ...
    Lamp 11, li11
    Lamp 12, li12
    Lamp 13, li13 'ball in play
    Lamp 14, li14
    Lamp 15, li15 'player 1
    'Lamp 16, li16
    Lamp 17, li17
    Lamp 18, li18
    Lamp 19, li19
    ...
    Lamp 27, li27 'match
    Lamp 28, li28
    Lamp 29, li29 'highscore to date
    Lamp 30, li30
    Lamp 31, li31 'player 2
    'Lamp 32, li32
    Lamp 33, li33
    Lamp 34, li34
    Lamp 35, li35
...
Dim LUTImage, FlipperPeg, FlippersDecor
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    ' Flipper's peg
    FlipperPeg = Table1.Option(" Flipper's peg", 0, 1, 1, 1, 0, Array("Hide", "Show") )
    If FlipperPeg Then
        Primitive104.Visible = 1
        rubber3.Visible = 1
        RubberPin4.Collidable = 1
    Else
        Primitive104.Visible = 0
        rubber3.Visible = 0
        RubberPin4.Collidable = 0
    End If

    ' Flipper's Decor
    FlippersDecor = Table1.Option(" Flipper's decor", 0, 1, 1, 1, 0, Array("Hide", "Show") )
    If FlippersDecor Then
        LeftFlipper_top.Image = "checkered"
        RightFlipper_top.Image = "checkered"
    Else
        LeftFlipper_top.Image = ""
        RightFlipper_top.Image = ""
    End If
End Sub
