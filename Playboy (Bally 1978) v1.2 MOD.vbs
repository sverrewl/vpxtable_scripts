...
'
' Changed the scoring LED's to use PacDude's LED strip
' Moved the Option Explicit line down below the comment header
' Re-imported the fx_ballrolling0 sound to change the vol value from -1 to 0.
'
' v1.2 changes by djredick
...
Sub Drain_Hit(): vpmTimer.pulseSw 8: PlaySoundAtVol "Drain",Drain,1:bsTrough.AddBall Me:End Sub
