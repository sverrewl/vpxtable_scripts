...
Sub Bumper1_Hit:vpmtimer.pulsesw(10):PlaySoundAtVol SoundFX("fx_bumper4",DOFContactors), Bumper1, VolBump:End Sub
Sub Bumper2_Hit:vpmtimer.pulsesw(11):PlaySoundAtVol SoundFX("fx_bumper4",DOFContactors), Bumper2, VolBump:End Sub
...
Function AudioFade(tableobj) ' Fades between front and back of the table (for surround systems or 2x2 speakers, etc), depending on the Y position on the table. "Kidnap" is the name of the table
  Dim tmp
  tmp = tableobj.y * 2 / Kidnap.height-1
  If tmp > 0 Then
...
Function AudioPan(tableobj) ' Calculates the pan for a tableobj based on the X position on the table. "Kidnap" is the name of the table
  Dim tmp
  tmp = tableobj.x * 2 / Kidnap.width-1
  If tmp > 0 Then
...
Function Pan(ball) ' Calculates the pan for a ball based on the X position on the table. "Kidnap" is the name of the table
    Dim tmp
