...
' Valores Constants
Const TableName = "starship" ' file name to save highscores and other variables
Const cGameName = "starship" ' B2S name
Const MaxPlayers = 2         ' 1 to 4 can play
Const MaxMultiplier = 5      ' limit bonus multiplier
Const FreePlay = False       ' Free play or coins
Const Special1 = 170000      ' extra ball or credit
Const Special2 = 290000
Const Special3 = 410000
...
Sub UpdateBonusLights
    Select Case Bonus
        Case 0:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 1:bl1.State = 1:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 2:bl1.State = 0:bl2.State = 1:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 3:bl1.State = 0:bl2.State = 0:bl3.State = 1:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 4:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 1:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 5:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 1:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 6:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 1:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 7:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 8:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0:bl10.State = 0:bl20.State = 0
        Case 9:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 1:bl10.State = 0:bl20.State = 0
        Case 10:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 11:bl1.State = 1:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 12:bl1.State = 0:bl2.State = 1:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 13:bl1.State = 0:bl2.State = 0:bl3.State = 1:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 14:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 1:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 15:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 1:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 16:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 1:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 17:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 18:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0:bl10.State = 1:bl20.State = 0
        Case 19:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 1:bl10.State = 1:bl20.State = 0
        Case 20:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 21:bl1.State = 1:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 22:bl1.State = 0:bl2.State = 1:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 23:bl1.State = 0:bl2.State = 0:bl3.State = 1:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 24:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 1:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 25:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 1:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 26:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 1:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 27:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 28:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0:bl10.State = 0:bl20.State = 1
        Case 29:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 1:bl10.State = 0:bl20.State = 1
        Case 30:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 31:bl1.State = 1:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 32:bl1.State = 0:bl2.State = 1:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 33:bl1.State = 0:bl2.State = 0:bl3.State = 1:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 34:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 1:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 35:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 1:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 36:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 1:bl7.State = 0:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 37:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 1:bl8.State = 0:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 38:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 1:bl9.State = 0:bl10.State = 1:bl20.State = 1
        Case 39:bl1.State = 0:bl2.State = 0:bl3.State = 0:bl4.State = 0:bl5.State = 0:bl6.State = 0:bl7.State = 0:bl8.State = 0:bl9.State = 1:bl10.State = 1:bl20.State = 1
...
Sub AddScore(Points)
    ...
    Select Case Points
        ...
        Case 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 25000
...
Sub AddBonusMultiplier(multi)
    If(Tilted = False) Then
        ...
        End If
        If BonusMultiplier = 4 Then BonusMultiplier = 5
...
Sub UpdateMultiplierLights
    Select Case BonusMultiplier
        Case 1:bmli2.State = 0:bmli3.State = 0:bmli5.State = 0:li57.State = 1:li41a.State = 0:li25a.State = 0
        Case 2:bmli2.State = 1:bmli3.State = 0:bmli5.State = 0:li57.State = 0:li41a.State = 1:li25a.State = 0
        Case 3:bmli2.State = 0:bmli3.State = 1:bmli5.State = 0:li57.State = 0:li41a.State = 0:li25a.State = 1
        Case 5:bmli2.State = 0:bmli3.State = 0:bmli5.State = 1:li57.State = 0:li41a.State = 0:li25a.State = 0
    End Select
End Sub
...
Sub Bumper003_Hit 'right
    ...
    DOF 209, DOFPulse
    AddScore 100 + 900 * b3l.State
End Sub

Sub BumperLights 'exchange the bumper Lights
    If b1l.State Then
        b1l.State = 0
        b1la.State = 0
        b2l.State = 0
...
Sub RubberBand8_Hit:AddScore 10:End Sub
Sub RubberBand7_Hit:AddScore 10:End Sub
Sub RubberBand10_Hit:AddScore 10:End Sub

' Top Lanes
Sub Sw12_Hit 'top rollover
...
Sub Sw22_Hit '1st from the left
    PlaySoundAt "fx_sensor", sw22
    If Tilted Then Exit Sub
    AddScore 300 + 2700 * li53.State
    li4a.State = 0
    li4.State = 0
    Select Case Rounds12345
        Case 0:li7.State = 1
        Case 1:li8.State = 1
    End Select
    Check12345
...
Sub Sw21_Hit
    ...
    End If
    Select Case Rounds12345
        Case 0:li21.State = 1:li22a.State = 1
        Case 1:li37.State = 1
    End Select
    Check12345
    BumperLights
    'turn on spinner light
    li22.state = 1
End Sub
...
Sub Check12345
    Dim tmp
    tmp = li4a.State + li4b.State + li5.State + li52.State + li20.state
    debug.print tmp
    If tmp = 0 Then
        Rounds12345 = Rounds12345 + 1
        Addscore 25000
        LightSeqTop.Play SeqBlinking, , 5, 75
        'reset Lights
        ResetTopLaneLights
        Select Case Rounds12345
            Case 2:li12.State = 1:li53.State = 1:li53a.State = 1:li58.State = 1:li28.State = 1:li42.State = 0 'light 3000 points top lights & Special on the outlanes
            Case 3:li6.State = 1:li6a.State = 1:AwardExtraBall                                                'side and center rollovers and EB
        End Select
    End If
End Sub

Sub ResetTopLaneLights
    'turn on the top lane lights
    li4a.State = 1
    li4b.State = 1
    li5.State = 1
    li52.State = 1
...
'Center star rollovers

Sub sw30_Hit 'nr 1
    PlaySoundAt "fx_sensor", sw30
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6.State
    If li7.State Then addbonus 2
End Sub

Sub sw29_Hit 'nr 2
    PlaySoundAt "fx_sensor", sw29
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6.State
    If li21.State Then addbonus 2
End Sub

Sub sw28_Hit 'nr 3
    PlaySoundAt "fx_sensor", sw28
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6.State
    If li23.State Then addbonus 2
End Sub

Sub sw27_Hit 'nr 4
    PlaySoundAt "fx_sensor", sw27
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6.State
    If li39.State Then addbonus 2
End Sub
...
Sub sw26_Hit 'nr 5
    ...
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6.State
    If li55.State Then addbonus 2
End Sub

'Left side star rollovers - Jet Stream

Sub sw38_Hit 'nr 1
    PlaySoundAt "fx_sensor", sw38
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6a.State
    If li8.State Then addbonus 1
End Sub

Sub sw37_Hit 'nr 2
    PlaySoundAt "fx_sensor", sw37
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6a.State
    If li37.State Then addbonus 1
End Sub

Sub sw36_Hit 'nr 3
    PlaySoundAt "fx_sensor", sw36
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6a.State
    If li24.State Then addbonus 1
End Sub
...
Sub sw35_Hit 'nr 4
    ...
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6a.State
    If li40.State Then addbonus 1
End Sub

Sub sw34_Hit 'nr 5
    PlaySoundAt "fx_sensor", sw34
    If Tilted Then Exit Sub
    AddScore 100 + 900 * li6a.State
    If li56.State Then addbonus 1
End Sub

' Out & inlanes

Sub sw15_Hit 'left outlane
    PlaySoundAt "fx_sensor", sw15
    If Tilted Then Exit Sub
    AddScore 1000
    If li58.State Then AwardSpecial
End Sub

Sub sw14_Hit 'right outlane
    PlaySoundAt "fx_sensor", sw14
    If Tilted Then Exit Sub
    AddScore 1000
    If li42.State Then AwardSpecial
    vpmTimer.AddTimer 1000, "Closegate '"
End Sub

Sub sw23_Hit 'left inlane
    PlaySoundAt "fx_sensor", sw23
    If Tilted Then Exit Sub
    AddScore 300
    RotateSpecial
End Sub

Sub sw23a_Hit 'right inlane
    PlaySoundAt "fx_sensor", sw23a
    If Tilted Then Exit Sub
    AddScore 300
    RotateSpecial
End Sub
...
'Left Bank
Sub sw1_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 111, DOFPulse, DOFDROPTargets), sw1:End Sub
Sub sw2_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 111, DOFPulse, DOFDROPTargets), sw2:End Sub
Sub sw3_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 111, DOFPulse, DOFDROPTargets), sw3:End Sub
Sub sw4_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 111, DOFPulse, DOFDROPTargets), sw4:End Sub
Sub sw5_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 111, DOFPulse, DOFDROPTargets), sw5:End Sub
...
Sub CheckBank
    If t1 + t2 + t3 + t4 + t5 = 5 Then
        ...
        Select Case BankHits
            Case 1:li44.State = 1                               ' lit extra ball
            Case 2:AwardExtraball:li44.State = 0:li60.State = 1 'and lit special
            Case 3:AwardSpecial                              '3 or more times awards special
            Case else:AwardSpecial: AddScore 25000
        End Select
        vpmTimer.AddTimer 800, "ResetBank '"
        if li12.State Then AddScore 3000
    End If
End Sub

Sub ResetBank
    PlaySoundAt SoundFXDOF("fx_resetdrop", 113, DOFPulse, DOFContactors), sw3
    sw1.Isdropped = 0
    sw2.Isdropped = 0
    sw3.Isdropped = 0
    sw4.Isdropped = 0
...
Sub sw24_Hit 'Top Right hole
    Dim tmp
    PlaySoundAt SoundFXDOF("fx_kicker_enter", 109, DOFPulse, DOFTargets), sw24
    If Tilted Then vpmTimer.AddTimer 200, "PlaySoundAt SoundFXDOF (""fx_kicker"", 110, DOFPulse, DOFContactors), sw24:sw24.kick 204,19 '"
    DOF 211, DOFPulse
    DOF 231, DOFPulse
    Addscore 3000
    ...
    vpmTimer.AddTimer 1200, "PlaySoundAt SoundFXDOF (""fx_kicker"", 110, DOFPulse, DOFContactors), sw24:sw24.kick 204,20 '"
End Sub
