...
'Select the ROM
Const cGameName = "gamatron" 'Pinstar original ROM, same rules as Flight 2000 standard, do not include voices
'Const cGameName = "flight2k" 'Flight 2000 original rom
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Gamatron - Pinstar 1985" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
