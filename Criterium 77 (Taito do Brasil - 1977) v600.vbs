...
'               Criterium - Taito do Brasil 1977
' ****************************************************************
...
' Valores Constants
Const cGameName = "criterium77"
Const MaxPlayers = 4    ' de 1 a 4
Const MaxMultiplier = 4 ' limita el bonus multiplicador
Const Special1 = 650000 ' puntuación a obtener para partida extra
Const Special2 = 820000 ' puntuación a obtener para partida extra
...
Sub Table1_Init()
    ...
    ' bolas cautivas
    Set cbball1 = New cvpmCaptiveBall
    With cbball1
        .InitCaptive CapTrigger1, CapWall1, CapKicker1, 0
        .ForceTrans = .9
        .MinForce = 3.5
        .CreateEvents "cbball1"
        .Start
    End With

    Set cbball2 = New cvpmCaptiveBall
    With cbball2
        .InitCaptive CapTrigger2, CapWall2, CapKicker2, 0
        .ForceTrans = .9
        .MinForce = 3.5
        .CreateEvents "cbball2"
        .Start
    End With

    Set cbball3 = New cvpmCaptiveBall
    With cbball3
        .InitCaptive CapTrigger3, CapWall3, CapKicker3, 0
        .ForceTrans = .9
        .MinForce = 3.5
        .CreateEvents "cbball3"
        .Start
    End With
...
Sub CapKicker1_Unhit:PlaySoundAt "fx_collide", CapKicker1:End Sub
Sub CapKicker2_Unhit:PlaySoundAt "fx_collide", CapKicker2:End Sub
Sub CapKicker3_Unhit:PlaySoundAt "fx_collide", CapKicker3:End Sub
...
Dim bctmp 'variables for the sound when counting the bonus
Dim bctmp2
...
Sub BonusCountTimer_Timer 'añade los bonos y actualiza las luces
    ...
    If Bonus > 0 Then
        Bonus = Bonus -1
        If Bonus MOD 10 = 0 Then  PlaySound "Sino"
        AddScore 1000
        UpdateBonusLights
        bctmp = (bctmp + 1) MOD 10
        If bctmp = 0 Then
           bctmp2 = (bctmp2 +1) MOD 3
        End If
        Select Case bctmp2
            Case 0: PlaySound"BeepBonus1"
            Case 1: PlaySound"BeepBonus2"
            Case 2: PlaySound"BeepBonus3"
            Case 3: PlaySound"BeepBonus4"
        End Select
    Else
...
Sub UpdateMultiplierLights
    Select Case BonusMultiplier
        Case 1:li19.State = 1:li20.State = 0:li21.State = 0:li22.State = 0
        Case 2:li19.State = 1:li20.State = 1:li21.State = 0:li22.State = 0
        Case 3:li19.State = 1:li20.State = 1:li21.State = 1:li22.State = 0
        Case 4:li19.State = 1:li20.State = 1:li21.State = 1:li22.State = 1
    End Select
End Sub

Sub UpdateBonusLights 'enciende o apaga las luces de los bonos según la variable "Bonus"
    If Bonus = 0 Then
        li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 0
    Else
        Select Case Bonus MOD 10
            Case 1:li8.State = 1:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 0
            Case 2:li8.State = 0:li9.State = 1:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 0
            Case 3:li8.State = 0:li9.State = 0:li10.State = 1:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 0
            Case 4:li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 1:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 0
            Case 5:li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 1:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 0
            Case 6:li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 1:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 0
            Case 7:li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 1:li5.State = 0:li6.State = 0:li7.State = 0
            Case 8:li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 1:li6.State = 0:li7.State = 0
            Case 9:li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 1:li7.State = 0
            Case 0:li8.State = 0:li9.State = 0:li10.State = 0:li11.State = 0:li12.State = 0:li13.State = 0:li1.State = 0:li5.State = 0:li6.State = 0:li7.State = 1
        End Select
    End If
    If Bonus > 49 Then
        li18.State = 1
    ...
    Select Case Bonus MOD 50
        Case 1, 2, 3, 4, 5, 6, 7, 8, 9
            li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0
        Case 11, 12, 13, 14, 15, 16, 17, 18, 19
            li14.State = 1:li15.State = 0:li16.State = 0:li17.State = 0
        Case 21, 22, 23, 24, 25, 26, 27, 28, 29
            li14.State = 1:li15.State = 1:li16.State = 0:li17.State = 0
        Case 31, 32, 33, 34, 35, 36, 37, 38, 39
            li14.State = 1:li15.State = 1:li16.State = 1:li17.State = 0
        Case 41, 42, 43, 44, 45, 46, 47, 48, 49
            li14.State = 1:li15.State = 1:li16.State = 1:li17.State = 1
    End Select

    Select Case Bonus \ 50
        Case 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0
        Case 1:li19.State = 1:li20.State = 0:li21.State = 0:li22.State = 0
        Case 2:li19.State = 1:li20.State = 1:li21.State = 0:li22.State = 0
        Case 3:li19.State = 1:li20.State = 1:li21.State = 1:li22.State = 0
        Case Else:li19.State = 1:li20.State = 1:li21.State = 1:li22.State = 1
    End Select

    ' Special on the central side lanes
    If Bonus > 0 And Bonus MOD 10 = 0 Then
        li23.State = 1:li24.State = 1
    Else
        li23.State = 0:li24.State = 0
    End If
...
Sub LeftSlingShot_Slingshot
  ...
  PlaySound "BeepSlingshot"
    If Epileptikdof = True Then DOF 250, DOFPulse End If
...
Sub kicker1_Hit
    ...
    If Not Tilted Then
        ...
        AddBonus 10
    End If
    vpmtimer.addtimer 1500, "PlaySoundAt SoundFXDOF(""fx_kicker"",110,DOFPulse,DOFContactors), kicker1: : DOF 235, DOFPulse : kicker1.kick 335,20 + RND(1) * 4 '"
End Sub

Sub LitLeftHole
    LightBumper1.State = 1
    LightBumper2.State = 0
    LightBumper1a.State = 1
    LightBumper2a.State = 0
    li4.State = 1
    li3.State = 0
    li2.State = 0
End Sub
...
Sub LitRightHole
    ...
    LightBumper1a.State = 0
    LightBumper2a.State = 1
    li4.State = 0
    li3.State = 0
    li2.State = 1
End Sub
...
Sub LeftHole_Hit
    ...
    If Not Tilted Then
        ...
        PostLight001.State = 0
    End If
    vpmtimer.addtimer 1500, "PlaySoundAt SoundFXDOF(""fx_kicker"",109,DOFPulse,DOFContactors), LeftHole: DOF 231, DOFPulse: LeftHole.kick 180,4 '"
End Sub
...
Sub RightHole_Hit
    ...
    If Not Tilted Then
        ...
        PostLight001.State = 0
    End If
    vpmtimer.addtimer 1500, "PlaySoundAt SoundFXDOF(""fx_kicker"",109,DOFPulse,DOFContactors), RightHole: DOF 233, DOFPulse: RightHole.kick 180,4 '"
End Sub
...
Sub CenterHole_Hit
    ...
    End If
    vpmtimer.addtimer 1500, "PlaySoundAt SoundFXDOF(""fx_kicker"",109,DOFPulse,DOFContactors), CenterHole: DOF 232, DOFPulse: CenterHole.kick 180,4 '"
End Sub
