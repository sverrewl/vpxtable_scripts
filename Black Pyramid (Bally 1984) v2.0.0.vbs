...
Dim FlipperColor, ScrewCapColor, cabsideblades
...
sub MovingTargetTimer_timer()
  ...
  if movedirection=1 Then
    ...
    Elseif movetarget > 24 AND movetarget < 49 Then
      PtargetC.z = PtargetC.z + zt
    elseif movetarget = 49 Then PtargetC.z = -140
    elseif movetarget = 0  Then PtargetC.z = -140
    elseif movetarget = 24 Then PtargetC.z = -143.75
    end If
