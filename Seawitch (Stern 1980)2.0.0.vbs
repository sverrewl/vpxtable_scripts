...
Const cGameName="seawitch",UseSolenoids=2,UseLamps=0,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SCoin="coin"
...
Sub Table1_Init
	...
	On Error Resume Next
		...
		.SplashInfoLine = "SeaWitch"&chr(13)&"You Suck"
		.HandleMechanics=0
		.HandleKeyboard=0
		.ShowDMDOnly=1
		.ShowFrame=0
...
'Bumpers
     Sub Bumper1_Hit:vpmTimer.PulseSw 9:playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper1,VolBump:SetLamp 181, 0:Me.TimerEnabled = 1::End Sub
      ...
      End Sub
       ...
       Sub Bumper2_Hit:vpmTimer.PulseSw 10:playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper2,VolBump:SetLamp 180, 0:Me.TimerEnabled = 1::End Sub
     ...
     Sub Bumper3_Hit:vpmTimer.PulseSw 14:playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper3,VolBump:SetLamp 182, 0:Me.TimerEnabled = 1::End Sub
...
Sub sw25_Hit():DivDir = -1:closedSL.IsDropped=1:OpenSL.IsDropped=0:Controller.Switch(25) = 1:lrro.State=0:PlaySoundAtVol "rollover",ActiveBall, VolRol:End Sub
...
'Drop Targets
Sub Sw21_Dropped: DTBank.Hit 1:end sub
Sub Sw22_Dropped: DTBank.Hit 2:end sub
Sub Sw23_Dropped: DTBank.Hit 3:end sub
Sub Sw24_Dropped: DTBank.Hit 4:end sub

Sub Sw40_Dropped: DTLBank.Hit 1:end sub
Sub Sw39_Dropped: DTLBank.Hit 2:end sub
Sub Sw38_Dropped: DTLBank.Hit 3:end sub

Sub Sw32_Dropped: DTRBank.Hit 1:end sub
Sub Sw31_Dropped: DTRBank.Hit 2:end sub
Sub Sw30_Dropped: DTRBank.Hit 3:end sub
Sub Sw29_Dropped: DTRBank.Hit 4:end sub
...
End Sub
 ...
 End Sub
 Dim DivDir: DivDir=0
 Dim DivPos: DivPos = 55
Sub UpdateDiverter_Timer
	DivPos = DivPos + DivDir
	If DivPos >= 44 then DivPos = 44:DivDir = 0
	If DivPos <= 34 then DivPos = 34:DivDir = 0
...
Sub RightSlingShot_Slingshot
	vpmTimer.PulseSw 42
    PlaySoundAtVol SoundFX("right_slingshot",DOFContactors), slin1, 1
    RSling.Visible = 0
    RSling1.Visible = 1
    sling1.TransZ = -20
    RStep = 0
