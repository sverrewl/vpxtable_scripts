...
Sub Table_KeyDown(ByVal Keycode)
 	...
 	If Keycode = LeftFlipperKey then
		...
		If bsTrough.balls < 4 and FlipperDisabled < 4 Then
			PlaySoundAtVol SoundFX("flipperupleft",DOFContactors), LeftFlipper, VolFlip
 	...
 	If Keycode = RightFlipperKey then
		...
		If bsTrough.balls < 4 and FlipperDisabled < 4 Then
			PlaySoundAtVol SoundFX("flipperupright",DOFContactors), RightFlipper, VolFlip
...
'***Slings and rubbers
 ...
 Sub LeftSlingShot_Slingshot
	...
	Controller.Switch(41) = 1
 	PlaySoundAtVol Soundfx("slingshotleft",DOFContactors), ActiveBall, 1:LeftSlingshot.TimerEnabled = 1
  End Sub
...
End Sub
 ...
 Sub RightSlingShot_Slingshot
	...
	Controller.Switch(42) = 1
 	PlaySoundAtVol Soundfx("slingshotright",DOFContactors), ActiveBall, 1:RightSlingshot.TimerEnabled = 1
  End Sub
...
Sub Bumper1_Hit:vpmTimer.PulseSw 57:PlaySoundAtVol SoundFX("bumper",DOFContactors), ActiveBall, VolBump:Bumper1.TimerEnabled = 1:End Sub
Sub Bumper1_Timer:Bumper1.TimerEnabled = 0:End Sub

Sub Bumper2_Hit:vpmTimer.PulseSw 58:PlaySoundAtVol SoundFX("bumper",DOFContactors), ActiveBall, VolBump:Bumper2.TimerEnabled = 1:End Sub
Sub Bumper2_Timer:Bumper2.TimerEnabled = 0:End Sub

Sub Bumper3_Hit:vpmTimer.PulseSw 59:PlaySoundAtVol SoundFX("bumper",DOFContactors), ActiveBall, VolBump:Bumper3.TimerEnabled = 1:End Sub
...
Sub sw32_Hit  : vpmTimer.PulseSw 49:sw32.TimerEnabled = 1:sw32p.TransX = -4: playsoundAtVol SoundFX("target",DOFContactors), ActiveBall, VolTarg: End Sub 'captive ball
Sub sw32_Timer:Me.TimerEnabled = 0:sw32p.TransX = 0:End Sub

Sub swPlunger_Hit:Me.TimerEnabled = 1:Controller.Switch(43) = 1:PlaySoundAtVol "rollover", ActiveBall, VolRol:End Sub 'plunger lane
...
Sub sw49_Hit  : vpmTimer.PulseSw 49:sw49.TimerEnabled = 1:sw49p.TransX = -4: playsoundAtVol SoundFX("target",DOFContactors), ActiveBall, VolTarg: End Sub
Sub sw49_Timer:Me.TimerEnabled = 0:sw49p.TransX = 0:End Sub
Sub sw50_Hit  : vpmTimer.PulseSw 50:sw50.TimerEnabled = 1:sw50p.TransX = -4: playsoundAtVol SoundFX("target",DOFContactors), ActiveBall, VolTarg: End Sub
Sub sw50_Timer:Me.TimerEnabled = 0:sw50p.TransX = 0:End Sub
Sub sw60_Hit  : vpmTimer.PulseSw 60:sw60.TimerEnabled = 1:sw60p.TransX = -4: playsoundAtVol SoundFX("target",DOFContactors), ActiveBall, VolTarg: End Sub
Sub sw60_Timer:Me.TimerEnabled = 0:sw60p.TransX = 0:End Sub
Sub sw63_Hit  : vpmTimer.PulseSw 63:sw63.TimerEnabled = 1:sw63p.TransX = -4: playsoundAtVol SoundFX("target",DOFContactors), ActiveBall, VolTarg: End Sub
...
Sub sw17_Spin:vpmTimer.PulseSw 17:PlaySoundAtVol "spinner", sw17, VolSpin:End Sub 'right ramp spinner
...
Sub LRRail_Hit:PlaySound "fx_metalrolling", 0, 150, Pan(ActiveBall)*VolMetal, 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall):End Sub
Sub RLRail_Hit:PlaySound "fx_metalrolling", 0, 150, Pan(ActiveBall)*VolMetal, 0, Pitch(ActiveBall), 1, 0, AudioFade(ActiveBall):End Sub
