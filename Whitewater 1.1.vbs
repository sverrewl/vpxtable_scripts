...
Sub whitewater_Init
  ...
  With Controller
    cGameName = "ww_l5"
    ' cGameName = "ww_lh6" ' Original from 1.1
    .GameName = cGameName
...
Sub KickPopper(Enabled) : sw61.Kick 305,50,0 : Controller.Switch(61) = 0  : If popped Then Playsound "vuk" : popped = false : End If : End Sub
...
Sub GIMiddleFade(step)
  ...
  Flasher7.opacity = step * 400 : Flasher8.opacity = step * 300 : Flasher9.opacity = step * 10 : Flasher10.opacity = step * 500
...
Sub GIUpperFade(step)
  ...
  Flasher1.opacity = step * 50 : Flasher2.opacity = step * 20
