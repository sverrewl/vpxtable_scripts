...
For Each visbl In InsertIndirectLights : visbl.TransmissionScale = 0.2 :Next
    ...
    For cnt = 0 To UBound(chgLamp)
      ...
      Select case ii
        ...
        case 106 ' *** white GI ***
          ...
          RolloversGI
        case 107 ' *** red GI ***
          If PFInsertState(ii) < 0.1 Then
            gi1brfull = 0 : gi1br = gi1brfull
          Else
...
Sub RolloversGI()
  ...
  MaterialColor "rollovers", RGB(80 + colR * 175, 80 + ColG * 175, 80 + ColB * 175)
...
' End If
  If gi0brfull^0.8 > gi1brfull^0.5 - 0.1 Then
    MaterialColor "insertswitchoff", RGB(20 + 90 * gi0brfull, 20 + 100 * gi0brfull, 20 + 128 * gi0brfull)
    MaterialColor "insertrolloveroff", RGB(20 + 45 * gi0brfull, 20 + 50 * gi0brfull, 20 + 64 * gi0brfull)
  Else
    MaterialColor "insertswitchoff", RGB(50 + 100 * gi1brfull, 50 + 100 * gi0brfull, 50 + 100 * gi0brfull)
    'MaterialColor "insertrolloveroff", RGB(50 + 100 * gi1brfull, 50 + 100 * gi0brfull, 50 + 100 * gi0brfull)
    MaterialColor "insertrolloveroff", RGB(20 + 45 * gi1brfull, 20 + 45 * gi0brfull, 20 + 45 * gi0brfull)
  End If
...
Sub initVLM()
  ...
  For Each nrx in BL_GI0 : nrx.color = RGB(150,180,255) : nrx.opacity = 150 : next : LM_GI0_Wellzom.opacity = 100 : LM_GI0_Playfield.opacity = 150
  For Each nrx in BL_GI1 : nrx.color = RGB(255,0,0) : nrx.opacity = 75 : next : LM_GI1_Wellzom.opacity = 50 : LM_GI1_Playfield.opacity = 60 : LM_GI1_Wellzom.color = RGB(255,32,32)
  ...
  For Each nrx in BL_insrt60 : nrx.opacity = 200 : next : LM_insrt60_armp2.opacity = 1000 : LM_insrt60_doorright.opacity = 1000 : LM_insrt60_Playfield.opacity = 400 : LM_insrt60_Parts.opacity = 800
  For Each nrx in BL_insrt61 : nrx.opacity = 200 : next : LM_insrt61_armp2.opacity = 1500 :  LM_insrt61_armp3.opacity = 1500 : LM_insrt61_Playfield.opacity = 400 : LM_insrt61_Parts.opacity = 800
  For Each nrx in BL_insrt62 : nrx.opacity = 200 : next : LM_insrt62_Playfield.opacity = 400 : LM_insrt62_Parts.opacity = 800
  LM_insrt_063_Parts.opacity = 500
  For each nrx in BL_insrt_070: nrx.opacity = 150 : Next '300
  For each nrx in BL_insrt_071: nrx.opacity = 150 : Next '300
  LM_insrt_071_wellzom.opacity = 500 : LM_insrt_071_armp3.opacity = 600
  LM_insrt_072_Parts.opacity = 300
  For each nrx in BL_insrt_073: nrx.opacity = 75 : Next '150
  For each nrx in BL_insrt_074: nrx.opacity = 75 : Next '150
  For each nrx in BL_insrt_075: nrx.opacity = 75 : Next '150
  ...
  LM_insrt_078_armp0.opacity = 700 : LM_insrt_078_Parts.opacity = 100
  ...
  For Each nrx in BL_insrt_133 : nrx.color = 0 : next : LM_insrt_133_Parts.opacity = 100:  LM_insrt_133_Playfield.opacity = 200
  For Each nrx in BL_insrt_136 : nrx.color = 0 : next : LM_insrt_136_Parts.opacity = 100:  LM_insrt_136_Playfield.opacity = 200
...
Dim FlasherIntensity : FlasherIntensity = 0.3
...
' End Select
  Select case GlassVisible
    Case 1 : Primitive001.blenddisablelighting = 1 : Primitive001.visible = 1
    Case 2 : Primitive001.visible = 0
    Case 3 : Primitive001.blenddisablelighting = 0.02 : Primitive001.visible = 1
    Case 4 : Primitive001.blenddisablelighting = 0.2 : Primitive001.visible = 1
    Case 5 : Primitive001.blenddisablelighting = 0.4 : Primitive001.visible = 1
    Case 6 : Primitive001.blenddisablelighting = 0.6 : Primitive001.visible = 1
  End Select
  ...
  FlasherIntensity = Table1.Option("Flasher intensity (default=30%)", 0.3, 2, 0.1, 0.3, 1)', Array("Enabled", "Disabled"))
