...
Sub sw29_Hit:bsKicker.addball 0 : playsoundAtVol"popper_ball",sw29,VolKick: End Sub

'Bumpers
Sub Bumper1_Hit : vpmTimer.PulseSw(9) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper1,VolBump: End Sub
Sub Bumper2_Hit : vpmTimer.PulseSw(10) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper2,VolBump: End Sub
Sub Bumper3_Hit : vpmTimer.PulseSw(11) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper3,VolBump: End Sub
...
'Scoring Rubbers
Sub sw38a_Hit:vpmTimer.PulseSw 38 : playsoundatvol "flip_hit_3",ActiveBall,VolRH : End Sub
Sub sw38b_Hit:vpmTimer.PulseSw 38 : playsoundatvol "flip_hit_3",ActiveBall,VolRH : End Sub
Sub sw38c_Hit:vpmTimer.PulseSw 38 : playsoundatvol "flip_hit_3",ActiveBall,VolRH : End Sub
Sub sw38d_Hit:vpmTimer.PulseSw 38 : playsoundatvol "flip_hit_3",ActiveBall,VolRH : End Sub
