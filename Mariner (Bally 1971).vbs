...
Const cGameName = "mariner_1971"
Const cOptions = "mariner_1971_v2.06.txt"
Const hsFileName = "Mariner (Bally 1971)"
...
Sub bootTable_Timer()
  ...
  If bootCount = 1 Then
    If vrOption > 0 Then vrBackGlass.image = "mnOn"
    If B2SOn Then
...
'     Number Matching, decrement the match unit for each 10 point score roll up from 0 to 9
    ...
    If points > 99 and points < 1000 Then
      If points > 100 Then
        bellRing = (points / 100)
        point = 100: flag100 = 1: If motorOn = 0 Then scoreMotor.enabled = 1
      Else
