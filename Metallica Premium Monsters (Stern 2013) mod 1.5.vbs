...
Const VolFlip   = 2    ' Flipper volume.
  ...
  SnakeSkin = 2 ' 0 = original, 1 = snake ramp mod, 2 = textured ramps
  LightsMod = 0 ' 0 = off, 1 = color mode lights
...
Sub CapBall_Hit:PlaySoundAtVol "fx_collide",Primitive1,2:End Sub
