...
Dim LUTImage, BallsPerGame, MalthaelMode, bFreePlay
bFreePlay = 1
MalthaelMode = 1
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    ' FreePlay
    bFreePlay = Table1.Option("Free Play", 0, 1, 1, 1, 0, Array("No", "Yes") )

    ' MalthaelMode
    MalthaelMode = Table1.Option("Malthael Mode", 0, 2, 1, 1, 0, Array("Easy", "Hard", "Insane") )
    If MalthaelMode = 0 Then
