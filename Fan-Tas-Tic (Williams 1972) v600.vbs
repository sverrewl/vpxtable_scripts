...
' Valores Constants
Const TableName = "Fantastic" 'saving the highscores and credits
Const cGameName = "Fantastic" ' mostly for DOF
...
Sub Table1_Init()
    ...
    If BallsPerGame = 5 Then
        Special1 = 48000 ' puntuación a obtener para partida extra, jugando a 5 bolas
        Special2 = 71000 ' puntuación a obtener para partida extra, jugando a 5 bolas
        Special3 = 86000 ' puntuación a obtener para partida extra, jugando a 5 bolas
    Else                 '3 bolas
...
Sub BonusCountTimer_Timer 'añade los bonos y actualiza las luces
    ...
    Else
        ...
        vpmTimer.AddTimer 750, "ExitKicker '"
    End If
End Sub
...
Sub VPObjects_Init
    rkicker007.CreateSizedBallWithMass 19, 1
End Sub
...
Sub ResetNewBallVariables()     'inicia las variable para una bola ó jugador nuevo
    Stars = 0
    Bonus = 1:UpdateBonusLights ' this table starts with 1 bonus
    BonusMultiplier = 1         'multiplicador de los bonos
    MatchEnabled = True         'deactiva la loteria en caso de tilt en la última bola
...
Sub Trigger010_Hit 'A left orbit
...
Sub Trigger003_Hit 'B right orbit
...
Sub Trigger002_Hit 'right outlane
    ...
    If Light006.State Then
        AddScore 3000
        vpmTimer.AddTimer 1500, "diverter.rotatetostart '"
        Light006.State = 0
    End If
End Sub
...
Sub Kicker001_Hit
    ...
    If Tilted Then vpmTimer.AddTimer 200, "kicker001.kick 186,12: PlaySoundAt""fx_kicker"",kicker001 '"
    StartSpinner
    KickerNr = 1
End Sub

Sub Kicker002_Hit
    PlaySoundAt "fx_hole_enter", Kicker002
    If Tilted Then vpmTimer.AddTimer 200, "kicker002.kick 150,12: PlaySoundAt""fx_kicker"",kicker002 '"
    StartSpinner
    KickerNr = 2
End Sub

Sub Kicker003_Hit
    PlaySoundAt "fx_hole_enter", Kicker003
    If Tilted Then vpmTimer.AddTimer 200, "kicker003.kick 210,12: PlaySoundAt""fx_kicker"",kicker003 '"
    StartSpinner
    KickerNr = 3
End Sub

Sub ExitKicker
Select Case KickerNr
Case 1
    kicker001.kick 186,12: kickerp001.Rotx = -10: PlaySoundAt"fx_kicker",kicker001
    vpmTimer.AddTimer 500, "kickerp001.Rotx = 0 '"
Case 2
    kicker002.kick 150,12:kickerp002.Rotx = -10:PlaySoundAt"fx_kicker",kicker002
    vpmTimer.AddTimer 500, "kickerp002.Rotx = 0 '"
Case 3
    kicker003.kick 210,12: kickerp003.Rotx = -10: PlaySoundAt"fx_kicker",kicker003
    vpmTimer.AddTimer 500, "kickerp003.Rotx = 0 '"
End Select
End Sub
...
Dim kv(11) 'kickers awards after rotation
'0 Bonus
'1 Advance Bonus to Top
'2 Lites A&B lanes
'3 3000
'4 star
'5 OPen Gates
...
kv(0) = Array(0, 1, 2, 3, 4, 5, 0, 4, 6, 3, 7, 4)
kv(1) = Array(4, 0, 1, 2, 3, 4, 5, 0, 4, 6, 3, 7)
kv(2) = Array(7, 4, 0, 1, 2, 3, 4, 5, 0, 4, 6, 3)
kv(3) = Array(3, 7, 4, 0, 1, 2, 3, 4, 5, 0, 4, 6)
kv(4) = Array(6, 3, 7, 4, 0, 1, 2, 3, 4, 5, 0, 4)
kv(5) = Array(4, 6, 3, 7, 4, 0, 1, 2, 3, 4, 5, 0)
kv(6) = Array(0, 4, 6, 3, 7, 4, 0, 1, 2, 3, 4, 5)
kv(7) = Array(5, 0, 4, 6, 3, 7, 4, 0, 1, 2, 3, 4)
kv(8) = Array(4, 5, 0, 4, 6, 3, 7, 4, 0, 1, 2, 3)
kv(9) = Array(3, 4, 5, 0, 4, 6, 3, 7, 4, 0, 1, 2)
kv(10) = Array(2, 3, 4, 5, 0, 4, 6, 3, 7, 4, 0, 1)
kv(11) = Array(1, 2, 3, 4, 5, 0, 4, 6, 3, 7, 4, 0)
...
Sub StartSpinner
    ...
    vpmTimer.AddTimer 500 + RndNbr(10) * 50, "StopSpinner '"
End Sub

Sub SpinnerTimer_Timer
    RotPos = (RotPos + 1) MOD 24
    ruleta.Rotz = Rotpos * 15
    ruleta2.Rotz = Rotpos * 15
End Sub
...
Sub StopSpinner
    ...
    vpmTimer.AddTimer 1500 + RndNbr(10) * 10, "Dim i: For each i in aRuletaK: i.Enabled = 1: next '"
End Sub

Sub aRuletaK_Hit(idx)
    Dim tmp
    PlaySoundAt"fx_metal", screw1
    Select Case kv(RotPos) (idx)
        Case 0: 'Bonus Count
            BonusMultiplier = 1:BonusCountTimer.Enabled = 1
        Case 1: ' Advance Bonus to Top
            tmp = 10 - Bonus
            AddBonus tmp
            vpmTimer.AddTimer 200*tmp, "ExitKicker '"
        Case 2: ' Lites A&B lanes
            PlaySound"10000"
            Light008.State = 1
            Light007.State = 1
            vpmTimer.AddTimer 1000, "ExitKicker '"
        Case 3: ' 3000
            Addscore 3000
            vpmTimer.AddTimer 1000, "ExitKicker '"
        Case 4: ' star
        ...
        Case 5: ' Open Gate
            ...
            light006.State = 1
            vpmTimer.AddTimer 1000, "ExitKicker '"
        Case 6: ' Tripple Bonus
            BonusMultiplier = 3:BonusCountTimer.Enabled = 1
        Case 7: ' Double Bonus
            BonusMultiplier = 2:BonusCountTimer.Enabled = 1
    End Select
End Sub

Sub Speedup_Hit:ActiveBall.Velx = -15:End Sub
Sub Speedup001_Hit:ActiveBall.Vely = -15:End Sub
Sub Speedup002_Hit:ActiveBall.Velx = 15:End Sub
Sub Speedup003_Hit:ActiveBall.Vely = 15:End Sub

' Stars and Shoot Again
Sub AddStar
    If Stars < 3 Then
        Stars = Stars + 1
        Select Case Stars
            Case 1:starlight001.State = 1
            Case 2:starlight002.State = 1
            Case 3:starlight003.State = 1:AwardExtraBall: ResetStars
        End Select
    End If
End Sub
...
Sub ResetStars
    Stars = 0
    starlight001.State = 0
    starlight002.State = 0
    starlight003.State = 0
End Sub
