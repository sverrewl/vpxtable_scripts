...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 40:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, -0.05:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 39:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0.05:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 36:PlaySound SoundFX("fx_bumper", DOFContactors), 0, 1, 0:End Sub

' Drain & Saucers
Sub Drain_Hit:Playsound "fx_drain":bsTrough.AddBall Me:End Sub
Sub Kicker1_Hit:Playsound "fx_kicker_enter":bsSaucer.AddBall 0:End Sub
Sub Kicker2_Hit:Playsound "fx_kicker_enter", 0, 1, -0.05:bsSaucer2.AddBall 0:End Sub
