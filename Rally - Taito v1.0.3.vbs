...
Sub sw74_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 74:End Sub
Sub sw74a_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 74:End Sub
Sub sw53_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 53:End Sub
Sub sw75_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 75:End Sub
Sub sw65_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 65:End Sub
Sub sw64_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 64:End Sub
Sub sw55_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 55:End Sub

' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 71:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper1,VolBump:Bumper1L.Duration 1, 500, 0:Bumper1La.Duration 1, 500, 0:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 72:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper2,VolBump:Bumper2L.Duration 1, 500, 0:Bumper2La.Duration 1, 500, 0:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 73:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper3,VolBump:Bumper3L.Duration 1, 500, 0:Bumper3La.Duration 1, 500, 0:End Sub

' Drain hole
Sub Drain_Hit:PlaysoundAtVol "fx_drain",drain,1:bsTrough.AddBall Me:End Sub

' Saucer
Sub sw2_Hit():bsSaucer.AddBall 0:PlaysoundAtVol "fx_kicker_enter",sw2,VolKick:End Sub
...
Sub sw41_Hit:Controller.Switch(41) = 1:PlaySoundAtVol "fx_sensor",ActiveBall,1:sw41l.Duration 2, 1000, 1:End Sub
Sub sw41_UnHit:Controller.Switch(41) = 0:End Sub

Sub sw51_Hit:Controller.Switch(51) = 1:PlaySoundAtVol "fx_sensor",ActiveBall,1:sw51l.Duration 2, 1000, 1:End Sub
Sub sw51_UnHit:Controller.Switch(51) = 0:End Sub

'Spinners
Sub sw61_Spin():vpmTimer.PulseSw 61:PlaySoundAtVol "fx_spinner",sw61,VolSpin:End Sub

' Droptargets
'Left
Sub sw3_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall,VolTarg:End Sub
Sub sw13_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall,VolTarg:End Sub
Sub sw23_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall,VolTarg:End Sub
Sub sw33_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets),ActiveBall,VolTarg:End Sub
