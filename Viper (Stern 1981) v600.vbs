...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Viper - Stern 1981" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub awt1_Hit(idx):vpmTimer.PulseSw 31:tw1.TransY = -113: t1w.TimerEnabled = 1:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
Sub t1w_Timer: tw1.TransY = -120: t1w.TimerEnabled = 0: End Sub

Sub awt2_Hit(idx):vpmTimer.PulseSw 32:tw2.TransY = -113: t2w.TimerEnabled = 1:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
Sub t2w_Timer: tw2.TransY = -120: t2w.TimerEnabled = 0: End Sub

Sub awt3_Hit(idx):vpmTimer.PulseSw 39:tw3.TransY = -113: t3w.TimerEnabled = 1:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
Sub t3w_Timer: tw3.TransY = -120: t3w.TimerEnabled = 0: End Sub

Sub awt4_Hit(idx):vpmTimer.PulseSw 38:tw4.TransY = -113: t4w.TimerEnabled = 1:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
Sub t4w_Timer: tw4.TransY = -120: t4w.TimerEnabled = 0: End Sub

Sub awt5_Hit(idx):vpmTimer.PulseSw 31:tw5.TransY = -113: t5w.TimerEnabled = 1:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
Sub t5w_Timer: tw5.TransY = -120: t5w.TimerEnabled = 0: End Sub

Sub awt6_Hit(idx):vpmTimer.PulseSw 32:tw6.TransY = -113: t6w.TimerEnabled = 1:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
Sub t6w_Timer: tw6.TransY = -120: t6w.TimerEnabled = 0: End Sub

Sub awt7_Hit(idx):vpmTimer.PulseSw 39:tw7.TransY = -113: t7w.TimerEnabled = 1:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
...
Sub SolBallWalker(Enabled)
    If Enabled Then
        ...
        Lock2.IsDropped = 1
        Lock3.IsDropped = 1
        PlaySoundAt "fx_SolenoidOn", sw11
        ResetLock.Enabled = 1
    End If
End Sub
...
Sub ResetLock_Timer
    ...
    Lock2.IsDropped = 0
    Lock3.IsDropped = 0
    PlaySoundAt "fx_SolenoidOff", sw11
End Sub
...
Sub UpdateLamps()
    ...
    If VarHidden Then
        ...
        Text 13, l13, "HIGH SCORE"
        Text 63, l63, "MATCH"
        Text 64, l64, "BALL IN PLAY"
    End If
    Lamp 1, l1
    Lamp 2, l2
    Lamp 3, l3
