...
End Sub
 ...
 Sub SolURFlipper(Enabled)
	 ...
	 Else
		 PlaySoundAtVol SoundFX("fx_Flipperdown",DOFContactors),RightFlipper1, 1:RightFlipper1.RotateToStart
	 End If
 End Sub
...
Sub SolRampUp(Enabled)
    If Enabled Then
        ...
        playsoundAtVol SoundFX("fx_diverterUp",DOFContactors), div_ramp, 1
		div_ramp.ObjRotY=15
		ramptrig=0
    End If
End Sub
...
Sub SuperchargerDiverter(enabled)
	If Enabled Then
		...
		sc_div.ObjRotZ=0
		PlaySoundAtVol SoundFX("fx_DiverterUp",DOFContactors), sc_div, 1
	Else
		Wall29.collidable=False
		sc_div.ObjRotZ=-43
		PlaySoundAtVol SoundFX("sc_diverter",DOFContactors), sc_div, 1
	End If
End Sub
...
Sub e_kick_Hit()
	...
	PlaySoundAtVol "fx_rr6", ActiveBall, 1
End Sub
...
Sub sw77_Hit(): bsEjectHole.Addball me : playsoundAtVol "kicker_enter_center", ActiveBall, 1: End Sub

'Bumpers
Sub Bumper1_Hit : vpmTimer.PulseSw(61) : playsoundAtVol SoundFX("RightJet",DOFContactors), ActiveBall, VolBump: End Sub
Sub Bumper2_Hit : vpmTimer.PulseSw(62) : playsoundAtVol SoundFX("LeftJet",DOFContactors), ActiveBall, VolBump: End Sub
Sub Bumper3_Hit : vpmTimer.PulseSw(63) : playsoundAtVol SoundFX("BottomJet",DOFContactors), ActiveBall, VolBump: End Sub
...
Sub SW73_Hit:Controller.Switch(73)=1 : playsoundAtVol"rollover" , ActiveBall, VolRol: End Sub
...
Sub SW67_Hit:Controller.Switch(67)=1 : playsoundAtVol"rollover" , ActiveBall, 1: End Sub
Sub SW67_unHit:Controller.Switch(67)=0:End Sub
Sub SW84_Hit:Controller.Switch(84)=1 : playsoundAtVol"rollover" , ActiveBall, 1: End Sub
...
Sub SW83_Hit
	...
	'activeball.velY=5
	activeball.velX=activeball.velX+24
End Sub
...
Sub SW85_Hit
	...
	playsoundAtVol"sc_loop2", ActiveBall, 1
End Sub
...
Sub Trigger1_Hit():activeball.velY=activeball.velY * 0.8:playSoundAtVol "fx_metalrolling", ActiveBall, 1:End Sub

Sub Trigger2_Hit():stopSound "fx_shortmetal" : End Sub

Sub Trigger3_Hit():stopSound "fx_metalrolling" : End Sub

Sub Trigger4_Hit():playSoundAtVol "fx_rr7", ActiveBall, 1:End Sub

Sub Trigger5_Hit():playSoundAtVol "fx_rrenter", ActiveBall, 1:End Sub

Sub Trigger6_Hit()
	If ramptrig=1 Then
		playSoundAtVol "fx_rrenter", ActiveBall, 1
	End If
End Sub

Sub Trigger7_Hit():playSoundAtVol "fx_shortmetal", ActiveBall, 1:End Sub

Sub Trigger8_Hit():playSoundAtVol "fx_rr7", ActiveBall, 1:End Sub

Sub Gate1_Hit():playSoundAtVol "gate", ActiveBall, VolGates:End Sub

Sub Gate5_Hit():playSoundAtVol "gate", ActiveBall, VolGates:End Sub

Sub BallReleaseGate_Hit():playSoundAtVol "gate", ActiveBall, VolGates:End Sub
...
Sub Rubbers_Hit(idx)
 	...
 	If finalspeed > 20 then
		PlaySound "rubber1", 0, Vol(ActiveBall)*VolRH, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
	End if
...
Sub Posts_Hit(idx)
 	...
 	If finalspeed > 16 then
		PlaySound "rubber1", 0, Vol(ActiveBall)*VolPo, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
	End if
...
Sub RandomSoundRubber()
	Select Case Int(Rnd*3)+1
		Case 1 : PlaySound "rubber1", 0, Vol(ActiveBall)*VolRH, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
		Case 2 : PlaySound "post4", 0, Vol(ActiveBall)*VolRH, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
