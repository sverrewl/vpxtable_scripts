'**************************************************
'*   VPX Version , graphic by Balater             *
'**************************************************
Option Explicit
Randomize


' Thalamus 2021 April : Better randiomization for kickers
...
Sub SolKickBack(Enabled)
  If Enabled Then
        PlaysoundAtVol SoundFX("bumper_retro",DOFContactors), Primitive31, 1
...
Sub LampFlasher()
 ...
 If l7.state = 1 Then
    FlasherLight7.opacity = 100
    FlasherLight7a.state = 1
  Else
    FlasherLight7.opacity = 0
    FlasherLight7a.state = 0
 End If
End Sub
...
Sub UpdateLamps
    ...
    NFadeLm 60, BumperL_Flasher001
    NFadeL 60, BumperL_Flasher_a
    NFadeLm 61, BumperR_Flasher
    NFadeLm 61, BumperR_Flasher001
