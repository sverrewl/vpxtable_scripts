...
Sub SolLFlipper(Enabled)
     If Enabled Then
         PlaySoundAtVol SoundFX("fx_Flipup",DOFContactors),LeftFlipper,VolFlip:LeftFlipper.RotateToEnd
     Else
         PlaySoundAtVol SoundFX("fx_Flipdown",DOFContactors),LeftFlipper,VolFlip:LeftFlipper.RotateToStart
     End If
  End Sub

Sub SolRFlipper(Enabled)
     If Enabled Then
         PlaySoundAtVol SoundFX("fx_Flipup",DOFContactors),RightFlipper,VolFlip:RightFlipper.RotateToEnd
     Else
         PlaySoundAtVol SoundFX("fx_Flipdown",DOFContactors),RightFlipper,VolFlip:RightFlipper.RotateToStart
     End If
End Sub
...
Sub Bumper33_Hit
  vpmTimer.PulseSw 33
  PlaysoundAtVol SoundFX("fx_bumper",DOFContactors), Bumper33, VolBump
  G1.state=1
  G1.timerenabled=1
...
Sub Bumper34_Hit
  vpmTimer.PulseSw 34
  PlaysoundAtVol SoundFX("fx_bumper",DOFContactors), Bumper34, VolBump
  G2.state=1
  G2.timerenabled=1
...
Sub Bumper35_Hit
  vpmTimer.PulseSw 35
  PlaysoundAtVol SoundFX("fx_bumper",DOFContactors), Bumper35, VolBump
  G3.state=1
  G3.timerenabled=1
...
'Gates
Sub Gate_Hit:PlaySoundAtVol "Gate5",gate, VolGates:End Sub
...
Sub Targets_Hit (idx)
  PlaySound "metalhit_thin", 0, Vol(ActiveBall)*VolTarg, Pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
