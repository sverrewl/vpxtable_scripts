...
Sub Rubbers_Hit(idx)
	...
	If finalspeed > 20 then
		PlaySoundAtBall "fx_rubber2" ' PlaySound "fx_rubber2", 0, Vol(ActiveBall), Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
	ElseIf finalspeed >= 4 then
 		PlaySoundAtBall "rubber_hit_" & (Int(Rnd*3)+1) ' RandomSoundRubber()
 	End If
