...
Const cGameName="v1",UseSolenoids=1,UseLamps=0,UseGI=0, SCoin="coin"

LoadVPM "02060000","idsa.VBS",3.2
...
'1 - coin counter (switch #6)
'2 - coin counter (switch #4)
'3 - coin counter (switch #5)
'4 - bumper (switch #12)
'5 - bumper (switch #13)
SolCallback(6) = "bsTrough.SolOut"
'7 - slingshot (switch #15)
'8 - slingshot (switch #14)
...
LeftCaptiveKicker.createball.Image="Ball"
LeftCaptiveKicker.Kick 180,0
RightCaptiveKicker.createball.Image="Ball"
RightCaptiveKicker.Kick 180,0
...
Sub Table1_KeyDown(ByVal keycode)
  ...
  If keycode = RightMagnaSave Then
    ...
    End If
  If keycode=RightFlipperKey then Controller.Switch(05)=1
...
Sub Table1_KeyUp(ByVal keycode)
  ...
  If keycode=RightFlipperKey then Controller.Switch(05)=0
        If KeyCode = PlungerKey Then
                Plunger.Fire
                If BIPL = 1 Then
...
'Spinners
Sub sw2_Spin:vpmTimer.PulseSw 2 : playsound"fx_spinner" : End Sub

'Scoring Rubber

sub sw3a_hit:vpmTimer.PulseSw 3 : playsound"flip_hit_3" : End Sub
sub sw3b_hit:vpmTimer.PulseSw 3 : playsound"flip_hit_3" : End Sub
sub sw3c_hit:vpmTimer.PulseSw 3 : playsound"flip_hit_3" : End Sub
sub sw3d_hit:vpmTimer.PulseSw 3 : playsound"flip_hit_3" : End Sub
sub sw3e_hit:vpmTimer.PulseSw 3 : playsound"flip_hit_3" : End Sub

'Bumpers

Sub Bumper1_Hit:vpmTimer.PulseSw(13):RandomSoundBumperTop Bumper1 : End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw(15):RandomSoundBumperBottom Bumper2: End Sub
...
End Sub
sub sw19_hit:vpmTimer.PulseSw 19
TargetBouncer Activeball, 1
End Sub
sub sw20_hit:vpmTimer.PulseSw 20
TargetBouncer Activeball, 1
End Sub
sub sw21_hit:vpmTimer.PulseSw 21
TargetBouncer Activeball, 1
End Sub
...
Sub editDips
  ...
  With vpmDips
    .AddForm 700,310,"V-1 - DIP switches"

    .AddFrame 0,0,130,"Coin Chute 1 Credits",&H00000043,Array("1",&H00000043,"2",&H00000003,"3",&H00000041,"5",&H00000042)'dip 1&2&7
    .AddFrame 0,80,130,"Coin Chute 2 Credits",&H00000038,Array("1",&H00000038,"2",&H00000028,"3",&H00000030,"4",&H00000020)'dip 4&5&6
    .AddFrame 0,160,130,"Coin Chute 3 Credits",&H00000084,Array("1",&H00000084,"1/2",&H00000004)'dip 3&8

    .AddFrame 150,0,120,"Balls per game",&H00008100,Array("5 balls",0,"4 balls",&H00008000,"3 balls",&H00000100,"2 balls",&H00008100)'dip 9&16
    .AddFrame 150,80,120,"Score threshold",&H00001800,Array("400K/600K points",&H00001800,"500K/700K points",&H00000800,"600K/800K points",&H00001000,"700K/900K points",0)'dip 12&13
    .AddChk 150,166,120,Array("Attract Sound",&H00000400)'dip 11
    .AddChk 150,192,120,Array("Test Mode",&H00002000)'dip 14

    .AddFrame 0,210,270,"Special",&H00000200,Array("1 Credit per Ball",&H00000200,"Locked (Special stays lit)",0)'dip 10

    '.AddChk 150,210,120,Array("DIP 15",&H00004000)'dip 15
    .AddLabel 0,270,280,20,"After hitting OK, press F3 to reset game with new settings."
    .ViewDips
  End With
End Sub
