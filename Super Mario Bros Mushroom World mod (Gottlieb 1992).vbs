...
Sub sw14_Hit:bsBL.AddBall Me : playsoundAtVol "popper_ball",sw14,VolKick: End Sub
Sub sw24_Hit:bsTop.AddBall 0 : playsoundAtVol "popper_ball",sw24,VolKick: End Sub
Sub sw34_Hit:bsBR.AddBall Me : playsoundAtVol "popper_ball",sw34,VolKick: End Sub

Sub sw80_Hit:Me.DestroyBall:vpmTimer.PulseSwitch 80,200,"HandleLeft" : playsoundAtVol "popper_ball",sw80,VolKick: End Sub
Sub HandleLeft(swNo):bsBL.AddBall 0:End Sub

Sub sw90_Hit:Me.DestroyBall:vpmTimer.PulseSwitch 90,200,"HandleRight" : playsoundAtVol "popper_ball",sw90,VolKick: End Sub
...
'Bumpers
Sub Bumper1_Hit : vpmTimer.PulseSw(10) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper1,VolBump: End Sub
Sub Bumper2_Hit : vpmTimer.PulseSw(11) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper2,VolBump: End Sub
Sub Bumper3_Hit : vpmTimer.PulseSw(12) : playsoundAtVol SoundFX("fx_bumper1",DOFContactors),Bumper3,VolBump: End Sub
