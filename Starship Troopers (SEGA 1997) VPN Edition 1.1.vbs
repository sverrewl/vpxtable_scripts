...
Sub BugT1_Hit:vpmTimer.PulseSw 35:PlaySound "rollover":End Sub									'35
Sub BugT2_Hit:vpmTimer.PulseSw 35:PlaySound "rollover":End Sub
Sub BugT3_Hit:vpmTimer.PulseSw 35:PlaySound "rollover":End Sub
Sub BugT4_Hit:vpmTimer.PulseSw 35:PlaySound "rollover":End Sub
Sub BugT5_Hit:vpmTimer.PulseSw 35:PlaySound "rollover":End Sub
...
Sub Bumper3_Hit:vpmTimer.PulseSw 51:Playsound SoundFX("Jet1",DOFContactors):End Sub								'51
...
Sub S53_Hit:Controller.switch(18) = True : playsound"RampMidway" : End Sub 
Sub S53_Unhit:Controller.switch(18) = False:end sub
Sub S26_Hit:Controller.switch(19) = True : playsound"fx_metalrolling" : End Sub 
Sub S26_Unhit:Controller.switch(19) = False:end sub
Sub S99_Hit:Controller.switch(20) = True : playsound"RampUp" : End Sub 
Sub S99_Unhit:Controller.switch(20) = False:end sub
Sub S98_Hit:Controller.switch(22) = True : playsound"RampUp" : End Sub 
Sub S98_Unhit:Controller.switch(22) = False:end sub
Sub S57_Hit:Controller.switch(57) = True : playsound"rollover" : End Sub 
Sub S57_Unhit:Controller.switch(57) = False:end sub
Sub S58_Hit:Controller.switch(58) = True : playsound"rollover" : End Sub 
Sub S58_Unhit:Controller.switch(58) = False:end sub
Sub S60_Hit:Controller.switch(60) = True : playsound"rollover" : End Sub 
Sub S60_Unhit:Controller.switch(60) = False:end sub
Sub S61_Hit:Controller.switch(61) = True : playsound"rollover" : End Sub 
Sub S60_Unhit:Controller.switch(61) = False:end sub
Sub S47_Hit:Controller.switch(37) = True : playsound"rollover" : End Sub 
Sub S47_Unhit:Controller.switch(37) = False:end sub
Sub S48_Hit:Controller.switch(39) = True : playsound"rollover" : End Sub 
Sub S48_Unhit:Controller.switch(39) = False:end sub
Sub S41_Hit:Controller.switch(30) = True : playsound"rollover" : End Sub 
Sub S41_Unhit:Controller.switch(30) = False:end sub
Sub S42_Hit:Controller.switch(31) = True : playsound"RampMidway" : End Sub 
Sub S42_Unhit:Controller.switch(31) = False:end sub
Sub S43_Hit:Controller.switch(32) = True : playsound"RampEnd" : End Sub 
