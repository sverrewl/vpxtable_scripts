...
Const cGameName = "spaceinb" '7-Digit conversion (Oliver)
'Const cGameName = "spaceinv"  ' 6-Digit Production Rom

'<<<<<<<<<<<<<<< ROM OPTIONS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>

LoadVPM "01130100", "Bally.VBS", 3.21

Dim bsTrough, cpLeft, dtL, dtR, bBackBoxLights, x
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Space Invaders - Bally 1980" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
'vpmTimer.AddTimer 2000, "Controller.SolMask(0)=&Hffffffff'" 'ignore all solenoids - then add the Timer to renable all the solenoids after 2 seconds
        Controller.Run GetPlayerHWnd:If Err Then MsgBox Err.Description
        On Error Goto 0
    End With
    ...
    Set cpLeft = New cvpmCaptiveBall
    With cpLeft
        .InitCaptive CapLead, CapHit, CapMove, 25
        .NailedBalls = 0
        .ForceTrans = 0.95
        .CreateEvents "cpLeft"
        .Start
    ...
    vpmNudge.TiltObj = Array(LeftSlingshot, RightSlingshot, Bumper001, Bumper002, Bumper003)
...
Sub Bumper002_Hit:vpmTimer.PulseSw 38:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper002:End Sub
Sub Bumper003_Hit:vpmTimer.PulseSw 39:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper003:End Sub

' Top Bumpers
Sub TopBumper001_Hit:vpmTimer.PulseSw 5:PlaySoundAt "fx_passive_bumper", Primitive077:End Sub
Sub TopBumper002_Hit:vpmTimer.PulseSw 5:PlaySoundAt "fx_passive_bumper", Primitive076:End Sub
Sub TopBumper003_Hit:vpmTimer.PulseSw 5:PlaySoundAt "fx_passive_bumper", Primitive075:End Sub
Sub TopBumper004_Hit:vpmTimer.PulseSw 5:PlaySoundAt "fx_passive_bumper", Primitive074:End Sub

' Scoring rubbers - sound plays in the collection
Sub RubberBand004_Hit:vpmTimer.PulseSw 5:End Sub
Sub RubberBand007_Hit:vpmTimer.PulseSw 5:End Sub
Sub RubberBand005_Hit:vpmTimer.PulseSw 5:End Sub
Sub RubberBand009_Hit:vpmTimer.PulseSw 5:End Sub
...
' Captive ball sound hit

' Droptargets
Sub sw1_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw1:End Sub
Sub sw2_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw2:End Sub
Sub sw3_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw3:End Sub
Sub sw34_Hit:PlaySoundAt SoundFX("fx_droptarget", DOFDropTargets), sw34:End Sub
...
Sub GIUpdate
    ...
    If UBound(tmp) <> OldGiState Then
        ...
        If UBound(tmp) = lob - 1 Then 'changit to reflect the number of locked ball
            GiOff
        Else
            GiOn
        End If
...
Sub UpdateLamps()
    ...
    Lampm 10, li10
    Lamp 10, li10
    Reel 11, ShootAgainReel
    Lamp 12, li12
    Reel 13, BallInPlayReel
    Lamp 14, li14
    Lamp 15, li15
    Lamp 17, li17
    Lamp 18, li18
    ...
    'Backbox Lights 117, 65, 81, 97, 113, 68, 84, 100, 116
    If bBackBoxLights Then
        'alien
        Lampm 117, li117b
        Lampm 117, li048
        Lampm 117, li050
