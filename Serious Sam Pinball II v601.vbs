...
Sub DMDScore()
    ...
    if(dqHead = dqTail)Then
        ...
        Select Case Battle(CurrentPlayer, 0)
            ...
            Case 13:tmp1 = CL("MORDEKAI BATTLE")
        End Select
        tmp2 = ""
    End If
...
Sub DoorF_Animate: doorp.Roty = - DoorF.CurrentAngle + 90: End Sub
...
Sub Trigger001_Hit: PlaySoundAt "fx_hole_enter", lock: End Sub
...
Sub GiveRandomAward() 'from the Jackal Sphynx
    ...
    DMD CL("JACKAL AWARD"), "", "", eNone, eNone, eNone, 50, False, "fx_spinner"
    ...
    Select Case tmp
        ...
        Case 45, 46, 47, 48 ' Ball Save
            ...
            EnableBallSaver 20
        Case 49, 50, 51, 52
            DMD CL("OUTLANE SAVER"), CL("ACTIVATED"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1"
            Light13.State = 1
...
Sub StartBattle
    ...
    Select Case NewBattle
        Case 1         'Bast = Super Spinners
            DMD CL("BAST"), CL("SHOOT THE SPINNERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light33.State = 2
            Light35.State = 2
            SpinCount = 0
        Case 2 'Isis = Super Pop Bumpers
            ...
            SuperBumperHits = 0
        Case 3 'Amon = Ramps
            DMD CL("AMON"), CL("SHOOT THE RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light36.State = 2
            Light34.State = 2
            RampHits3 = 0
        Case 4 'Shu = Orbits
            DMD CL("SHU"), CL("SHOOT THE ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            Light33.State = 2
            Light35.State = 2
            OrbitHits = 0
        Case 5 'Set = Shoot the lights 2
            DMD CL("SET"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light29.State = 2
            Light30.State = 2
            Light31.State = 2
            Light32.State = 2
        ...
        Case 6 'Nepthys= Shoot the lights 1
            DMD CL("NEPTHYS"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light30.State = 2
        Case 7 'Bes =  Blue Target Frenzy
            DMD CL("BES"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            LightSeqBlueTargets.Play SeqRandom, 10, , 1000
            TargetHits7 = 0
        Case 8 'Serget = Left & Right Targets
            DMD CL("SERGET"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            Light31.State = 2
            Light29.State = 2
            TargetHits8 = 0
        Case 9 'Anubis = Follow the Lights 1
            DMD CL("ANUBIS"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            LightHits9 = 0
        Case 10 'Osiris = Super Loops
            DMD CL("OSIRIS"), CL("SHOOT THE LOOPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light33.State = 2
            Light35.State = 2
            Gate2.Open = 1
            Gate3.Open = 1
        ...
        Case 11 'Horus = Follow the Lights 2
            DMD CL("HORUS"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            LightHits11 = 0
        Case 12 'Ra = Ramps and Orbits
            'uses the ramphits12 to count the hits
            DMD CL("RA"), CL("SHOOT RAMPS ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            Light36.State = 2
            Light34.State = 2
            RampHits12 = 0
