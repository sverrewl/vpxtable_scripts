...
Dim InstMod, GlassMod, DirtyClownMod, LogoMod, PosterMod
...
If RenderingMode = 2 or Table1.ShowFSS = True or VRTest = 1 Then
  ...
  For Each VR_Obj in VRBackglassFlash:VR_Obj.Visible = 1:Next
  SetBackglass
...
Else
  ...
  For Each VR_Obj in VRBackglassFlash:VR_Obj.Visible = 0:Next
...
Sub FrameTimer_Timer() 'The frame timer interval should be -1, so executes at the display frame rate
  ...
  If VRMode = True Then ' Update VR Backglass
    VRDisplayTimer
  End If
...
Sub Table1_Init()
  ...
  If ModSol = 0 Then
    ...
    For each bub in GI2:bub.State = 1:Next
  End If
...
Sub sw18_Hit
  ...
  'PlaySound "DropTarget", 0, MechVolume, AudioPan(sw18), 0, Pitch(ActiveBall), 1, 0, AudioFade(sw18)
End Sub
...
Sub SolModGI(level)
  ...
  For each xx in GI2:xx.State = lvl:Next
  FlFadeBumper 1,lvl
  FlFadeBumper 2,lvl
  FlFadeBumper 3,lvl
...
Sub InitLampsNF()
  ...
  If VRMode = True Then  ' VR mystery wheel
    Lampz.MassAssign(33)= FL33
    Lampz.MassAssign(34)= FL34
    Lampz.MassAssign(35)= FL35
    Lampz.MassAssign(36)= FL36
    Lampz.MassAssign(37)= FL37
    Lampz.MassAssign(38)= FL38
    Lampz.MassAssign(39)= FL39
    Lampz.MassAssign(40)= FL40
    Lampz.MassAssign(41)= FL41
    Lampz.MassAssign(42)= FL42
    Lampz.MassAssign(43)= FL43
    Lampz.MassAssign(44)= FL44
    Lampz.MassAssign(45)= FL45
    Lampz.MassAssign(46)= FL46
    Lampz.MassAssign(47)= FL47
  ...
  if VRMode=True Then Lampz.MassAssign(55)= FL55

  if VRMode=True Then Lampz.MassAssign(56)= FL56

  Lampz.MassAssign(57)= L57
  Lampz.MassAssign(57)= L57b
  if VRMode=True Then Lampz.MassAssign(57)= FL57

  Lampz.MassAssign(58)= L58
  Lampz.MassAssign(58)= L58b
  if VRMode=True Then Lampz.MassAssign(58)= FL58

  Lampz.MassAssign(58)= L59
  Lampz.MassAssign(58)= L59b
  if VRMode=True Then Lampz.MassAssign(59)= FL59

  Lampz.MassAssign(60)= L60
  Lampz.MassAssign(60)= L60b
  if VRMode=True Then Lampz.MassAssign(60)= FL60

  Lampz.MassAssign(61)= L61
  Lampz.MassAssign(61)= L61b
  if VRMode=True Then Lampz.MassAssign(61)= FL61

  Lampz.MassAssign(62)= L62
  Lampz.MassAssign(62)= L62b
  if VRMode=True Then Lampz.MassAssign(62)= FL62

  Lampz.MassAssign(63)= L63
  Lampz.MassAssign(63)= L63b
  if VRMode=True Then Lampz.MassAssign(63)= FL63

  Lampz.MassAssign(64)= L64
  Lampz.MassAssign(64)= L64b
  if VRMode=True Then Lampz.MassAssign(64)= FL64
...
Sub Table1_OptionEvent(ByVal eventId)
  ...
  'Modulated Lights
  ModSol = Table1.Option("Mod. Lights (Restart)", 0, 1, 1, 1, 0, Array("Off", "PWM"))
  SaveModSol
  'Instruction Cards
  ...
  SetupGlass
  'VR Room
    VRRoomChoice = Table1.Option("VR Room (VR-FSS)", 1, 2, 1, 1, 0, Array("Gameroom", "Minimal Room"))
  SetupRoom
...
Sub SetBackglass()
  ...
  For Each obj In VRBackglassFlash
    obj.x = obj.x
    obj.height = - obj.y + 160
    obj.y = -70 'adjusts the distance from the backglass towards the user
  Next
End Sub

Sub UpdateVRBGlamps()
  If Controller.Solenoid(25) = 0 Then: FL25.visible=0: else: FL25.visible=1 ' Jackpot
  If Controller.Solenoid(28) = 0 Then: FL28.visible=0: else: FL28.visible=1 ' Firework 1
  If Controller.Solenoid(29) = 0 Then: FL29.visible=0: else: FL29.visible=1 ' Firework 2
  If Controller.Solenoid(26) = 0 Then: FL26.visible=0: else: FL26.visible=1 ' Mouth
  If Controller.Solenoid(27) = 0 Then: FL27.visible=0: else: FL27.visible=1 ' Left Eye
  If Controller.Solenoid(31) = 0 Then: FL31.visible=0: else: FL31.visible=1 ' Right Eye
  If Controller.Solenoid(32) = 0 Then: FL32.visible=0: else: FL32.visible=1 ' Firework 3
  If Controller.Solenoid(11) = 0 Then ' GI for backglass on or off
    Pincab_Backglass_On.Visible = 1
  Else
    Pincab_Backglass_On.Visible = 0
  End If
End Sub
