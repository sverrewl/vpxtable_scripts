'Camel Lights / IPDB No. 3675 / May, 1978 / 4 Players
'Game Plan, Incorporated, of Illinois (1978-1985)
'VPX8 by jpsalas 2025, version 1.0.0
'includes my physycs 4.3.1
'vpinmame script by destruk

'Converted from Black Velvet to Camel Lights by Itchigo.
...
' Controller.B2SName = "Camel Lights"  ' *****!!!!This must match the name of your directb2s file!!!!
 'Controller.Run()
' End Sub
...
Const cGameName = "camlight"

Dim VarHidden 'hide the vpinmame window
VarHidden = 1

Dim chimesON  'play the chimes or not
chimesON = True
...
Sub table1_Init
    vpmInit me
    With Controller
Controller.B2SName = "Camel Lights"
        .GameName = cGameName
        If Err Then MsgBox "Can't start Game" & cGameName & vbNewLine & Err.Description:Exit Sub
        .SplashInfoLine = "Camel Lights - Game Plan 1978" & vbNewLine & "VPX8 table by jpsalas 1.0.0"
...
LiveStrokeEOS_Torque = 0.25 ' EOS Torque when flipper rotate to end ( When flipper move, EOS coil have less Ampere due to flipper can freely move. EOS Coil have less power )
