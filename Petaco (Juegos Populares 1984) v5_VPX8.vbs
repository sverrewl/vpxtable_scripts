...
'VPX8, version 5, by pedator & jpsalas
...
Sub Petaco_KeyDown(ByVal KeyCode)
    ...
    If keycode = LeftMagnaSave Then bLutActive = True:SetLUTLine "Color LUT image " & Petaco.ColorGradeImage
...
Sub NextLUT:LUTImage = (LUTImage + 1) MOD 22:UpdateLUT:SaveLUT:SetLUTLine "Color LUT image " & Petaco.ColorGradeImage:End Sub
