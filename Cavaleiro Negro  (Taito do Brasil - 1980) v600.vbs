...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Cavaleiro Negro - Taito 1981" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub LockMech_Hit
    PlaysoundAt "fx_kicker_enter", LockMech
    bsLock.AddBall Me
End Sub

Sub sw24_Hit
    PlaysoundAt "fx_kicker_enter", sw24
    bsSaucer.AddBall 0
End Sub
...
' Rollovers
Sub sw11_Hit:Controller.Switch(5) = 1:PlaySoundAt "fx_sensor", sw11:End Sub
Sub sw11_UnHit:Controller.Switch(5) = 0:End Sub

Sub sw16_Hit:Controller.Switch(25) = 1:PlaySoundAt "fx_sensor", sw16:End Sub
Sub sw16_UnHit:Controller.Switch(25) = 0:End Sub

Sub sw15_Hit:Controller.Switch(45) = 1:PlaySoundAt "fx_sensor", sw15:End Sub
Sub sw15_UnHit:Controller.Switch(45) = 0:End Sub

Sub sw12_Hit:Controller.Switch(55) = 1:PlaySoundAt "fx_sensor", sw12:End Sub
Sub sw12_UnHit:Controller.Switch(55) = 0:End Sub

Sub sw23_Hit:Controller.Switch(44) = 1:PlaySoundAt "fx_sensor", sw23:End Sub
Sub sw23_UnHit:Controller.Switch(44) = 0:End Sub

Sub sw14_Hit:Controller.Switch(43) = 1:PlaySoundAt "fx_sensor", sw14:End Sub
Sub sw14_UnHit:Controller.Switch(43) = 0:End Sub

Sub sw44_Hit:Controller.Switch(33) = 1:PlaySoundAt "fx_sensor", sw44:End Sub
Sub sw44_UnHit:Controller.Switch(33) = 0:End Sub

Sub sw45_Hit:Controller.Switch(41) = 1:PlaySoundAt "fx_sensor", sw45:End Sub
Sub sw45_UnHit:Controller.Switch(41) = 0:End Sub

'Spinner
Sub sw13_Spin:PlaySoundAt "fx_spinner", sw13:vpmTimer.PulseSw 4:End Sub
...
Sub UpdateLamps()
    ...
    Lamp 1,   l50 '3
    Lamp 10,  l53 '6
    Lamp 100, l32 'contagem tripla
    Lamp 101, l10 'defesa esquerda armada
    Lamp 102,  l9 'defesa direita armada
    Lamp 103, l56 '9
    Lamp 11,  l54 '7
    Lamp 109, l47 'mesmo jogador
    Lamp 111, l16 'cuando defendido esquerdo
    Lamp 112, l15 'cuando defendido direito
    Lamp 113, l57 '10
    Lamp 119, l61 '2x
    Lamp 12,  l55 '8
    Lamp 120, l62 '3x
    Lamp 121, l63 '4x
    Lamp 122, l64 '5x
    Lamp 123, l33 'seta superior esquerda 1
  Lamp 82,  l41 'bola exra superior
    Lamp 130, l13 'rampa 2500
    Lamp 131, l12 'ultima chance direito
    Lamp 132, l11 'ultima chance esquerdo
    Lamp 143, l29 'seta centro 1
    Lamp 153, l25 'seta inferior esquerda 1
    Lamp 2,   l51 'bonus 4
    Lamp 30,  l58 'bonus 20
    Lamp 31,  l59 'bonus 30
    Lamp 32,  l60 'bonus 40
    Lamp 40,  l34 'seta superior esquerda 2
    Lamp 41,  l35 'seta superior esquerda 3
    Lamp 42,  l19 '3 alvos acendem seta superior esquerdo
    Lamp 50,  l38 'seta superior direita 2
    Lamp 51,  l39 'seta superior direita 3
    Lamp 52,  l20 '3 alves acendem seta superior direito
    Lamp 60,  l30 'seta centro 2
    Lamp 61,  l31 'seta centro 3
    Lamp 62,  l18 '3 alvos acendem sete inferior centro
    Lamp 70,  l26 'seta inferior esquerda 2
    Lamp 71,  l27 'seta inferior esquerda 3
    Lamp 72,  l17 '3 alvos acendem seta inferior esquerdo
    Lamp 79,  l42 '1 bola presa
    Lamp 80,  l21 '2 bolas presas
    Lamp 133, l37 'seta superior direita 1
    Lamp 83,  l48 'bonus 1
    Lamp 89,  l24 'multibola se aceso
    Lamp 90,  l14 'misterio
    Lamp 91,  l22 'especial inferior
    Lamp 92,  l23 'extraball inferior
    Lamp 93,  l52 'bonus 5
    Lamp 99,  l28 'contagem dupla
    Lampm 129,l36a'externo bumper
    Lampm 129,l36 'centro bumper
    Lamp 129, l40 '3 bolas presas
    Lamp 110,  l7 'nao coloque fichas c luz acesa
    ...
    'backdrop lights
        ...
        Lamp 141, li141
        Lamp 142, li142
        Lamp 149, li149 'game over
        Lamp 150, li150 ' tilt
        Lamp 151, li151 ' novo
        Lamp 152, li152 'recorde
End Sub
