...
' VPX8 - version by JPSalas 2022, version 6.0.0
...
If Table1.ShowDT = true then
    ...
    For each x in aReels
        x.Visible = 0
    Next
    vpmhidden = 0 'show the vpinmame window
end if

if B2SOn = true then vpmhidden = 1
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Eight Ball - Bally 1977" & vbNewLine & "VPX table by JPSalas v6.0.0"
...
Sub Bumper3_Hit:vpmTimer.PulseSw 40:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:End Sub
...
' Spinners
Sub Spinner1_Spin:vpmTimer.PulseSw 17:PlaySoundAt "fx_spinner", Spinner1:End Sub
...
Sub sw27_Hit:vpmTimer.PulseSw 27:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
Sub sw28_Hit:vpmTimer.PulseSw 28:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
