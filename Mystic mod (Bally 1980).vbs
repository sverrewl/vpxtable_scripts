...
Const cGameName="mysticb",UseSolenoids=1,UseLamps=0,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff", SCoin="coin"
...
'Leaf Switches
 Sub sw12_Hit:vpmTimer.PulseSw 12 : playsound"flip_hit_3" : End Sub
 Sub sw12b_Hit:vpmTimer.PulseSw 12 : playsound"flip_hit_3" : End Sub
