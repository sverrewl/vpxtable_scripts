...
'******** Select your rom 6 or 7 digits ***************************

Const cGameName = "futurspa" '6 digits
'Const cGameName = "futurspb" '7 digits
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Future Spa - Bally 1979" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub sw13a_Hit:vpmTimer.PulseSw 13:End Sub
Sub sw13b_Hit:vpmTimer.PulseSw 13:End Sub
Sub sw13c_Hit:vpmTimer.PulseSw 13:End Sub
Sub sw13d_Hit:vpmTimer.PulseSw 13:End Sub
...
Sub Bumper4_Hit:vpmTimer.PulseSw 36:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper4:End Sub
Sub Bumper5_Hit:vpmTimer.PulseSw 37:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper5:End Sub

' Drain hole
Sub Drain_Hit:PlaySoundAt "fx_drain", Drain:bsTrough.AddBall Me:End Sub

' Saucer
Sub sw24_Hit():bsSaucer.AddBall Me:PlaySoundAt "fx_kicker_enter", sw24:End Sub
...
If cGameName = "futurspa" Then '6 Digits
...
If cGameName = "futurspb" AND Table1.ShowDT Then '7 Digits
