...
Const cGameName="t2_l8" ' use t2_p2f for profanity
...
Sub Table1_KeyDown(ByVal KeyCode)
  If keycode = PlungerKey or keycode = LockBarKey Then controller.Switch(34) = 1 : Playsound "Trigger", 0, 0.1, 0.05  'sw34 Grip Trigger
...
Sub Table1_KeyUp(ByVal KeyCode)
  If keycode = PlungerKey or keycode = LockBarKey Then controller.Switch(34) = 0 'sw34 Grip Trigger
