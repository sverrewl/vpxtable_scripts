...
' Bumpers
Sub Bumper1_Hit:DOF 101, DOFPulse:vpmTimer.PulseSw 44:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors), Bumper1, VolBump:LiBumper1a.Duration 1, 200, 0:LiBumper1b.Duration 1, 200, 0:LiBumper1c.Duration 1, 200, 0:End Sub
Sub Bumper2_Hit:DOF 103, DOFPulse:vpmTimer.PulseSw 44:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors), Bumper2, VolBump:LiBumper2a.Duration 1, 200, 0:LiBumper2b.Duration 1, 200, 0:LiBumper2c.Duration 1, 200, 0:End Sub
Sub Bumper3_Hit:DOF 102, DOFPulse:vpmTimer.PulseSw 44:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors), Bumper3, VolBump:LiBumper3a.Duration 1, 200, 0:LiBumper3b.Duration 1, 200, 0:LiBumper3c.Duration 1, 200, 0:End Sub
...
Sub sw1_Hit::PlaySoundAtVol "fx_kicker_enter", sw1, VolKick:bsTopSaucer.AddBall 0:End Sub

' Rollovers
Sub sw4_Hit:Controller.Switch(4) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
Sub sw4_UnHit:Controller.Switch(4) = 0:End Sub

Sub sw75_Hit:Controller.Switch(75) = 1:PlaySoundAtVol "fx_sensor", ActiveBall, 1:End Sub
...
' Droptargets
Sub sw2_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
Sub sw12_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
Sub sw13_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
Sub sw22_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
...
Sub sw42_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
Sub sw43_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
...
Sub sw54_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
Sub sw62_Hit:PlaySoundAtVol SoundFX("fx_droptarget", DOFDropTargets), ActiveBall, 1:End Sub
...
' Spinners
Sub Spinner1_Spin:vpmTimer.PulseSw 32:PlaySoundAtVol SoundFX("fx_spinner", DOFContactors), Spinner1, VolSpin:End Sub

'Targets
Sub sw61_Hit:vpmTimer.PulseSw 61:PlaySoundAtVol SoundFX("fx_target", DOFDropTargets), sw61, 1:End Sub
