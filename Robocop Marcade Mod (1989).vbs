'==============================================================================================='
'                                               '
'                                    Robocop (Marcade Mod Art Remix) Data East (1989)     '
'                                          Marcade Mod Adjustments: 2021                    '
'                                    www.ipdb.org/machine.cgi?id=1976                 '
'                                               '
'                    Original Created by ICPjuggla, Talantyyr, Dozer316 and dark            '
'                     Art Remix by Mark Paulik                      '
'==============================================================================================='
...
Sub Drain_Hit()
  PlaySoundAtVol "drain", Drain, 1
    PlaySound "ed209_powerdown",0,1,0,0.25
    bsTrough.AddBall Me
End Sub

Sub Bumper1_Hit
  PlaySoundAtVol SoundFX("fx_bumper4",DOFContactors), ActiveBall, 1
  vpmTimer.PulseSw(46)
...
Sub sw44_Spin() : vpmtimer.pulsesw(44) : PlaySoundAtVol "fx_spinner", sw44, 1
  FlashForMs muzzleFlasher1, 1000, 20, 0:
  FlashForMs muzzleFlasher2, 1000, 20, 0:
End Sub
