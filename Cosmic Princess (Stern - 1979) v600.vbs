'Cosmic Princess by Stern 1979
'VPX8 table by JPSalas version 6.0.0
'Light numbers and other parts of the script based on Destruk's script.
'Dip Switches by Inkochnito
'Cosmic Princess / IPD No. 3967 / August, 1979 / 4 Players
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Cosmic Princess - Stern 1979" & vbNewLine & "VPX table by JPSalas 6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    With bsTrough
        .InitNoTrough BallRelease, 33, 90, 6
    ...
    With dtBank
        .InitDrop Array(sw32, sw31, sw30, sw29, sw28), Array(32, 31, 30, 29, 28)
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 12:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper1:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 15:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 16:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:End Sub

' Drain & holes
Sub Drain_Hit:PlaysoundAt "fx_drain",Drain:bsTrough.AddBall Me:End Sub
Sub sw26_Hit:PlaysoundAt "fx_kicker_enter", sw26:bsSaucer.AddBall 0:End Sub

' Rollovers
Sub sw19_Hit:Controller.Switch(19) = 1:PlaySoundAt "fx_sensor",sw19:DOF 107, DOFOn:End Sub
Sub sw19_UnHit:Controller.Switch(19) = 0:DOF 107, DOFOff:End Sub

Sub sw19a_Hit:Controller.Switch(19) = 1:PlaySoundAt "fx_sensor",sw19a:DOF 108, DOFOn:End Sub
Sub sw19a_UnHit:Controller.Switch(19) = 0:DOF 108, DOFOff:End Sub
...
Sub sw22a_Hit:Controller.Switch(22) = 1:PlaySoundAt "fx_sensor",sw22a:DOF 110, DOFOn:End Sub
Sub sw22a_UnHit:Controller.Switch(22) = 0:DOF 110, DOFOff:End Sub

Sub sw24_Hit:Controller.Switch(24) = 1:PlaySoundAt "fx_sensor",sw24:DOF 114, DOFOn:End Sub
Sub sw24_UnHit:Controller.Switch(24) = 0:DOF 114, DOFOff:End Sub

Sub sw24a_Hit:Controller.Switch(24) = 1:PlaySoundAt "fx_sensor",sw24a:DOF 115, DOFOn:End Sub
Sub sw24a_UnHit:Controller.Switch(24) = 0:DOF 115, DOFOff:End Sub

Sub sw20_Hit:Controller.Switch(20) = 1:PlaySoundAt "fx_sensor",sw20:End Sub
Sub sw20_UnHit:Controller.Switch(20) = 0:End Sub

Sub sw23a_Hit:Controller.Switch(23) = 1:PlaySoundAt "fx_sensor",sw23a:DOF 104, DOFOn:End Sub
Sub sw23a_UnHit:Controller.Switch(23) = 0:DOF 104, DOFOff:End Sub

Sub sw21a_Hit:Controller.Switch(21) = 1:PlaySoundAt "fx_sensor",sw21a:DOF 112, DOFOn:End Sub
Sub sw21a_UnHit:Controller.Switch(21) = 0:DOF 112, DOFOff:End Sub

Sub sw39_Hit:Controller.Switch(39) = 1:PlaySoundAt "fx_sensor",sw39:DOF 105, DOFOn:End Sub
Sub sw39_UnHit:Controller.Switch(39) = 0:DOF 105, DOFOff:End Sub

Sub sw39a_Hit:Controller.Switch(39) = 1:PlaySoundAt "fx_sensor",sw39a:DOF 106, DOFOn:End Sub
Sub sw39a_UnHit:Controller.Switch(39) = 0:DOF 106, DOFOff:End Sub

Sub sw27_Hit:Controller.Switch(27) = 1:PlaySoundAt "fx_sensor",sw27:End Sub
Sub sw27_UnHit:Controller.Switch(27) = 0:End Sub

Sub sw10_Hit:Controller.Switch(10) = 1:PlaySoundAt "fx_sensor",sw10:DOF 113, DOFOn:End Sub
Sub sw10_UnHit:Controller.Switch(10) = 0:DOF 113, DOFOff:End Sub
...
'Targets
Sub sw21_Hit:vpmTimer.PulseSw 21:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):DOF 111, DOFPulse:End Sub
Sub sw23_Hit:vpmTimer.PulseSw 23:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):DOF 103, DOFPulse:End Sub

'*********
'Solenoids
'*********
SolCallback(4) = "dtBank.SolHit 1,"
SolCallback(5) = "dtBank.SolHit 2,"
SolCallback(6) = "vpmSolSound SoundFX(""fx_Knocker"",DOFKnocker),"
SolCallback(8) = "dtBank.SolHit 3,"
SolCallback(11) = "dtBank.SolHit 4,"
SolCallback(12) = "dtBank.SolHit 5,"
...
Sub editDips
    ...
    With vpmDips
        .AddForm 700, 400, "Cosmic Princess - DIP switches"
        ...
        .AddFrame 205, 76, 190, "Extra ball alternation", &H04000000, Array("no alternation", 0, "alternate", &H04000000)                                                                                                                                                'dip 27
