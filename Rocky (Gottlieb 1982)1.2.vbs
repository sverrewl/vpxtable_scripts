...
'    .Hidden = HiddenValue
  ...
  '**DropTargets
    ...
    DTBankR.InitDrop Array(sw1,sw11,sw21), Array(1,11,21)
        DTBankR.InitSnd SoundFX("fx_droptarget2",DOFDropTargets),SoundFX("fx_DTReset2",DOFDropTargets)


    Set DTBankT=New cvpmDropTarget 'Blue Trap Targets
        DTBankT.InitDrop Array(sw00,sw10,sw20,sw50,sw60), Array(0,10,20,50,60)
        DTBankT.InitSnd SoundFX("fx_droptarget3",DOFDropTargets),SoundFX("fx_DTReset3",DOFDropTargets)
