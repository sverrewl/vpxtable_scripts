...
Const HSFileName="Bronco_77VPX.txt"
...
sub BumpersOff
  ...
  BumperLight1a.visible=False
  Bumper2Light.Visible=false
  BumperLight2.visible=False
  BumperLight2a.visible=False
  Bumper3Light.Visible=false
  BumperLight3.visible=False
  BumperLight3a.visible=False
end sub

sub BumpersOn
  Bumper1Light.Visible=True
  BumperLight1.visible=True
  BumperLight1a.visible=True
  Bumper2Light.Visible=True
  BumperLight2.visible=True
  BumperLight2a.visible=True
  Bumper3Light.Visible=True
  BumperLight3.visible=True
  BumperLight3a.visible=True
end Sub
