' Close Encounters of the Third Kind / IPD No. 4692 / September, 1978 / 4 Players
...
' Valores Constants
Const TableName = "closeencEM" ' file name to save highscores and other variables
Const cGameName = "closeencEM" ' B2S name
...
Sub BlinkBumperLights
    TurnOFF aBumper1L
    TurnOFF aBumper2L
    vpmTimer.AddTimer 500, "TurnON aBumper1L: TurnON aBumper2L '"
End Sub
...
Sub rsband007_Hit:AddScore 10:SwapLights:End Sub
Sub rlband005_Hit:AddScore 10:SwapLights:End Sub
Sub rlband006_Hit:AddScore 10:SwapLights:End Sub
Sub rlband004_Hit:AddScore 10:SwapLights:End Sub
Sub rsband003_Hit:AddScore 10:SwapLights:End Sub
Sub rlband007_Hit:AddScore 10:SwapLights:End Sub
Sub rlband003_Hit:AddScore 10:SwapLights:End Sub

Sub SwapLights
    Dim tmp
    tmp = Light015.State
    Light015.State = Light014.state
    Light014.State = tmp
End Sub

' Top Lanes
Sub Trigger006_Hit 'left top rollover
...
Sub Trigger007_Hit 'center top rollover
    PlaySoundAt "fx_sensor", Trigger007
    If Tilted Then Exit Sub
    AddScore 500 + 4500 * Light017.State
    AddBonus 1
    SpinRoto
    BlinkBumperLights
    Light017.State = 0
...
Sub Trigger008_Hit 'right top rollover
    PlaySoundAt "fx_sensor", Trigger008
    If Tilted Then Exit Sub
    AddScore 500 + 4500 * Light018.State
    AddBonus 1
    SpinRoto
    BlinkBumperLights
    Light018.State = 0
...
Sub CheckABC
    If Light016.State + Light017.State + Light018.State = 0 Then
        Light011.State = 1
        Light012.State = 1
    End If
End Sub
...
Sub Trigger005_Hit 'right center rollover
...
Sub Trigger001_Hit 'left outlane
    ...
    Select Case(rotoSW(CurrRotoPos-1) )
        Case 1:Addscore 500:DOF 108, DOFPulse 'Star
        Case 3:Addscore 300                   '300
        Case 4:Addscore 400                   '400
        Case 5:Addscore 500                   '500
    End Select
End Sub
...
Sub Trigger004_Hit 'right outlane
    ...
    'score right roto
    Select Case(rotoSW(CurrRotoPos + 1) )
        Case 1:Addscore 500:DOF 111, DOFPulse 'Star
        Case 3:Addscore 300                   '300
        Case 4:Addscore 400                   '400
        Case 5:Addscore 500                   '500
    End Select
...
Sub sw1_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 109, DOFPulse, DOFDROPTargets), sw1:End Sub
Sub sw2_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 109, DOFPulse, DOFDROPTargets), sw2:End Sub
Sub sw3_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 109, DOFPulse, DOFDROPTargets), sw3:End Sub
Sub sw4_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 109, DOFPulse, DOFDROPTargets), sw4:End Sub
Sub sw5_Hit:PlaySoundAt SoundFXDOF("fx_droptarget", 109, DOFPulse, DOFDROPTargets), sw5:End Sub

Sub sw1_Dropped
    If Tilted Then Exit Sub
    DOF 203, DOFPulse
    AddScore 500 + 4500 * Light007.State
    AddBonus 1
    t1 = 1
    CheckBank
End Sub
...
Sub sw3_Dropped
    If Tilted Then Exit Sub
    DOF 203, DOFPulse
    AddScore 500 + 4500 * Light006.State
    AddBonus 1
    t3 = 1
    CheckBank
End Sub
...
Sub CheckBank
    If t1 + t2 + t3 + t4 + t5 = 5 Then
        Light011.State = 1 'Special
        Light012.State = 1 'Extra Ball
        vpmTimer.AddTimer 500, "ResetBank '"
    End If
End Sub
...
Sub spinner1_Spin
    ...
    If Tilted Then Exit Sub
    Addscore 100 + 900 * Light013.state
End Sub

Sub Spinner1_Animate:Spinner.RotY = Spinner1.CurrentAngle:End Sub
...
Dim LUTImage, BallsPerGame, Special1, Special2, Special3
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    If BallsPerGame = 3 Then
        Special1 = 110000 ' extra ball or credit
        Special2 = 140000
        Special3 = 180000
    Else
        Special1 = 180000 ' extra ball or credit
        Special2 = 220000
        Special3 = 260000
    End If
End Sub
...
' ROTO CODE by Pinuck modified by BorgDog to fit primitive roto targets
' modified by jpsalas to work on this EM table
' ========================
...
rotoP = array(dummy, Proto1, Proto2, Proto3, Proto4, Proto5, Proto6, Proto7, Proto8, Proto9, Proto10, Proto11, Proto12, Proto13, Proto14, Proto15)
...
Sub TrotoLeft_Hit 'LEFT ROTO
    ...
    Select Case(rotoSW(CurrRotoPos-1) )
        Case 1:DOF 108, DOFPulse:AddBonusMultiplier 1 'Star
            If Light010.State Then Addscore 5000 Else Addscore 500:End If
        Case 3:                                       '300
            If Light010.State Then Addscore 3000 Else Addscore 300:End If
        Case 4:                                       '400
            If Light010.State Then Addscore 4000 Else Addscore 400:End If
        Case 5:                                       '500
            If Light010.State Then Addscore 5000 Else Addscore 500:End If
    End Select
    Light030.Duration 1, 800, 0
End Sub
...
Sub TrotoCenter_Hit 'CENTER ROTO
    ...
    Select Case(rotoSW(CurrRotoPos) )
        Case 1: 'Star
            If Light009.State Then Addscore 5000 Else Addscore 500:End If
            AddBonusMultiplier 1
            If Light012.State Then AwardExtraBall
            If Light011.State Then AwardSpecial
        Case 3: '300
            If Light009.State Then Addscore 3000 Else Addscore 300:End If
        Case 4: '400
            If Light009.State Then Addscore 4000 Else Addscore 400:End If
        Case 5: '500
            If Light009.State Then Addscore 5000 Else Addscore 500:End If
    End Select
    Light029.Duration 1, 800, 0
End Sub
...
Sub TrotoRight_Hit 'RIGHT ROTO
    ...
    If RotoTimer.enabled = 1 Then Exit Sub
    Select Case(rotoSW(CurrRotoPos + 1) )
        Case 1:DOF 111, DOFPulse:AddBonusMultiplier 1 'Star
            If Light008.State Then Addscore 5000 Else Addscore 500:End If
        Case 3:                                       '300
            If Light008.State Then Addscore 3000 Else Addscore 300:End If
        Case 4:                                       '400
            If Light008.State Then Addscore 4000 Else Addscore 400:End If
        Case 5:                                       '500
            If Light008.State Then Addscore 5000 Else Addscore 500:End If
    End Select
    Light028.Duration 1, 800, 0
End Sub
