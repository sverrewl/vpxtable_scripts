...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Warlok - Williams 1982" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub Bumper3_Hit:vpmTimer.PulseSw 15:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:End Sub
...
Sub UpdateLamps()
    NfReel 1, li1 ' "Shoot Again"
    NfReel 2, li2 ' "Ball in Play"
    NfReel 3, li3 ' "TILT"
    NfReel 4, li4 ' "Game Over"
    NfReel 5, li5 ' "Match"
    NfReel 6, li6 ' "High Score to Date"
    Lamp 7, li7
    Lamp 8, li8
    Lamp 9, li9
    Lamp 10, li10
