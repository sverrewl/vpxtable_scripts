  ...
  'Left Drop Ramp Stuff (Modified Destruk script)
    ...
    Sub UpdateRamp_Timer
      ...
      If RRampCurrPos> 52 Then
        RRampCurrPos = 52
        PlaySoundAtVol SoundFX("DTLReset",DOFContactors), dropramp1, 1
        UpdateRamp.Enabled = 0
        dropramp1.Collidable= 0
      End If
      If RRampCurrPos <0 Then
        RRampCurrPos = 0
        PlaySoundAtVol SoundFX("left_flipper_down",DOFContactors), dropramp1, 1
...
'Switches
  ...
  Sub sw41_Hit():vpmTimer.PulseSw 41:PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  Sub sw41_Timer():ME.TimerEnabled=0:End Sub
  Sub sw42_Hit():vpmTimer.PulseSw 42:PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  Sub sw42_Timer():ME.TimerEnabled=0:End Sub
  Sub sw43_Hit():vpmTimer.PulseSw 43:PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  Sub sw43_Timer():ME.TimerEnabled=0:End Sub
  Sub sw49_Hit():vpmTimer.PulseSw 49:PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  Sub sw49_Timer():ME.TimerEnabled=0:End Sub
  Sub sw50_Hit():vpmTimer.PulseSw 50:PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  Sub sw50_Timer():ME.TimerEnabled=0:End Sub
  Sub sw62_Hit():vpmTimer.PulseSw 62:PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  Sub sw62_Timer():ME.TimerEnabled=0:End Sub
  Sub sw65_Hit():vpmTimer.PulseSw 65:PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  Sub sw65_Timer():ME.TimerEnabled=0:End Sub
  Sub sw66_Hit():vpmTimer.PulseSw 66: PlaySoundAtVol SoundFX("target",DOFTargets), ActiveBall, 1:ME.TimerEnabled=1:End Sub
  ...
  Sub Kicker5_Hit:PlaySoundAtVol "kicker_enter_left", ActiveBall, 1:LockDoor.IsDropped=0:bsBottomSaucer.AddBall 0:End Sub

  Dim Speed1
  Sub Kicker6_Hit:Speed1=SQR(ActiveBall.VelY*ActiveBall.VelY)/3:vpmTimer.PulseSw 73:Kicker6.DestroyBall:PlaySoundAtVol "rail",Kicker8, 1:Kicker8.TimerEnabled=1:End Sub
  ...
  End Sub
  Dim Speed2
  Sub Kicker7_Hit:Speed2=SQR(ActiveBall.VelY*ActiveBall.VelY)/3:vpmTimer.PulseSw 74:Kicker7.DestroyBall:PlaySoundAtVol "rail",Kicker9, 1:Kicker9.TimerEnabled=1:End Sub
...
Sub SolLFlipper(Enabled)
  ...
  Else
    If Enabled Then
        PlaySoundAtVol SoundFX("left_flipper_up",DOFFlippers), LeftFlipper, 1
        LeftFlipper.RotateToEnd
    Else
        PlaySoundAtVol SoundFX("left_flipper_down",DOFFlippers), LeftFlipper, 1
        LeftFlipper.RotateToStart
    End If
  End If
End Sub
...
Sub SolRFlipper(Enabled)
  ...
  Else
    If Enabled Then
        PlaySoundAtVol SoundFX("right_flipper_up",DOFFlippers), RightFlipper, 1
        RightFlipper.RotateToEnd
    Else
        PlaySoundAtVol SoundFX("right_flipper_down",DOFFlippers), RightFlipper, 1
        RightFlipper.RotateToStart
    End If
    End If
End Sub
