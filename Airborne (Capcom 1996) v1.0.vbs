	...
	'Left Drop Ramp Stuff (Modified Destruk script)
		...
		Sub UpdateRamp_Timer
			...
			If RRampCurrPos> 52 Then
				RRampCurrPos = 52
				PlaySound SoundFX("DTLReset",DOFContactors) 
				UpdateRamp.Enabled = 0
				dropramp1.Collidable= 0
			End If
			If RRampCurrPos <0 Then
				RRampCurrPos = 0
				PlaySound SoundFX("left_flipper_down",DOFContactors) 
...
Sub Table1_Init
	...
	Set bsBottomSaucer=New cvpmBallStack
        ...
        bsBottomSaucer.InitExitSnd SoundFX("popper_ball",DOFContactors), SoundFX("popper_ball",DOFContactors)
...
'Switches
	...
	Sub Kicker1_Hit:PlaySound "kicker_enter":bsLeftSaucer.AddBall 0:End Sub
	Sub Kicker2_Hit:PlaySound "kicker_enter":RightDiverter.TimerEnabled=0:RightDiverter.IsDropped=0:RightDiverter2.IsDropped=1:bsRightSaucer.AddBall 0:RampTimer.Enabled=1: End Sub
	Sub RampRight_Hit:Controller.Switch(55)=1:End Sub
	Sub RampRight_UnHit:Controller.Switch(55)=0:End Sub

	Sub sw41_Hit():vpmTimer.PulseSw 41:PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	Sub sw41_Timer():ME.TimerEnabled=0:End Sub
	Sub sw42_Hit():vpmTimer.PulseSw 42:PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	Sub sw42_Timer():ME.TimerEnabled=0:End Sub
	Sub sw43_Hit():vpmTimer.PulseSw 43:PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	Sub sw43_Timer():ME.TimerEnabled=0:End Sub
	Sub sw49_Hit():vpmTimer.PulseSw 49:PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	Sub sw49_Timer():ME.TimerEnabled=0:End Sub
	Sub sw50_Hit():vpmTimer.PulseSw 50:PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	Sub sw50_Timer():ME.TimerEnabled=0:End Sub
	Sub sw62_Hit():vpmTimer.PulseSw 62:PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	Sub sw62_Timer():ME.TimerEnabled=0:End Sub
	Sub sw65_Hit():vpmTimer.PulseSw 65:PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	Sub sw65_Timer():ME.TimerEnabled=0:End Sub
	Sub sw66_Hit():vpmTimer.PulseSw 66: PlaySound SoundFX("target",DOFTargets):ME.TimerEnabled=1:End Sub
	...
	Sub LeftInlane_Hit:Controller.Switch(35)=1:PlaySound "Sensor":End Sub
	Sub LeftInlane_UnHit:Controller.Switch(35)=0:End Sub
	Sub RightInlane_Hit:Controller.Switch(37)=1:PlaySound "Sensor":End Sub
	Sub RightInlane_UnHit:Controller.Switch(37)=0:End Sub
	Sub RightOutlane_Hit:Controller.Switch(38)=1:PlaySound "Sensor":End Sub
	Sub RightOutlane_UnHit:Controller.Switch(38)=0:End Sub

	Sub Kicker5_Hit:PlaySound "kicker_enter_left":LockDoor.IsDropped=0:bsBottomSaucer.AddBall 0:End Sub

	Dim Speed1
	Sub Kicker6_Hit:Speed1=SQR(ActiveBall.VelY*ActiveBall.VelY)/3:vpmTimer.PulseSw 73:Kicker6.DestroyBall:PlaySound "rail":Kicker8.TimerEnabled=1:End Sub
	...
	End Sub
	Dim Speed2
	Sub Kicker7_Hit:Speed2=SQR(ActiveBall.VelY*ActiveBall.VelY)/3:vpmTimer.PulseSw 74:Kicker7.DestroyBall:PlaySound "rail":Kicker9.TimerEnabled=1:End Sub
...
'Slingshots
 ...
 Sub LeftSlingShot_Slingshot
 	PlaySound SoundFX("LSling",DOFContactors):vpmTimer.PulseSw 33:LStep = 0:Me.TimerEnabled = 1
  End Sub 
 ...
 Sub RightSlingShot_Slingshot
 	PlaySound SoundFX("RSling",DOFContactors):vpmTimer.PulseSw 34:RStep = 0:Me.TimerEnabled = 1
  End Sub
...
Sub SolLFlipper(Enabled)
	...
	Else 
		If Enabled Then
        PlaySound SoundFX("left_flipper_up",DOFFlippers), 0, 1, -0.1, 0.15
        LeftFlipper.RotateToEnd
		Else
        PlaySound SoundFX("left_flipper_down",DOFFlippers), 0, 1, -0.1, 0.15
        LeftFlipper.RotateToStart
		End If
	End If
End Sub
...
Sub SolRFlipper(Enabled)
	...
	Else 
		If Enabled Then
        PlaySound SoundFX("right_flipper_up",DOFFlippers), 0, 1, 0.1, 0.15
        RightFlipper.RotateToEnd
		Else
        PlaySound SoundFX("right_flipper_down",DOFFlippers), 0, 1, 0.1, 0.15
        RightFlipper.RotateToStart
		End If
    End If
End Sub
...
'Gate Sounds
Sub agates_Hit(idx):PlaySound "gate": End Sub
