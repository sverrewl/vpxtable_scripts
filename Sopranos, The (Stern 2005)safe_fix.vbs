...
Sub sw17_Hit:bsRScoop.AddBall Me : playsoundAtVol "popper_ball", ActiveBall, 1: End Sub
Sub sw28_Hit:bsTEject.AddBall 0 : playsoundAtVol "popper_ball", ActiveBall, 1: End Sub
...
'SafeHouse Primitive
Sub sw21_Hit  : vpmTimer.PulseSw 21:sw21.TimerEnabled = 1:sw21p.TransX = -4: playsoundAtVol"Target", ActiveBall, VolTarg: End Sub
Sub sw21_Timer:Me.TimerEnabled = 0:sw21p.TransX = 0:End Sub
Sub sw24_Hit  : vpmTimer.PulseSw 24:sw24.TimerEnabled = 1:sw24p.TransX = -4: playsoundAtVol"Target", ActiveBall, VolTarg: End Sub
