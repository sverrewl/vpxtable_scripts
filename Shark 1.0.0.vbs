...
Sub sw43_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 43:Rub1 = 1:sw43_Timer:End Sub
...
Sub sw53_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 53:Rub2 = 1:sw53_Timer:End Sub
Sub sw53_Timer
    Select Case Rub2
...
Sub sw63_Hit:PlaySoundAtVol "fx_Rubber",ActiveBall,VolRH:vpmTimer.PulseSw 63:End Sub

' Saucer
Sub sw2_Hit:bsSaucer.AddBall 0:PlaySoundAtVol SoundFX("fx_kicker_enter", DOFContactors),ActiveBall,VolKick:End Sub

' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 73:PlaySoundAtVol SoundFX("fx_bumper", DOFContactors),Bumper1,VolBump:End Sub

' Drain hole
Sub Drain_Hit:PlaysoundAtVol "fx_drain",drain,1:bsTrough.AddBall Me:End Sub

' Spinner
Sub Spinner1_Spin:vpmTimer.PulseSw 13:PlaySoundAtVol "fx_spinner", Spinner1, VolSpin:End Sub
...
'Targets
Sub sw35_Hit:vpmTimer.PulseSw 35:PlaySoundAtVol "fx_target",ActiveBall,VolTarg:End Sub
