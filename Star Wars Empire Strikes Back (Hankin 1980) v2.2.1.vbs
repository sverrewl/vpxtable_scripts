...
Const cGameName="empsback",UseSolenoids=19,UseLamps=1,UseGI=0,SSolenoidOn="SolOn",SSolenoidOff="SolOff",SCoin="coin",cCredits=""
...
Sub Table1_KeyUp(ByVal keycode)
	...
	If keycode=PlungerKey Then Plunger.Fire:playsound"plunger":sw12.timerenabled=0:Starstop
	...
	If KeyCode=PlungerKey Then
              ...
              End Select
              End If
	If KeyCode=PlungerKey and BIP=1 and AAA=1 Then playsound"plunger":BBB=0
...
'Kickers
Sub RightHole_Hit:bsSaucer2.AddBall 0 : playsound "popper_ball":FlashLevel26 = 1 : FlasherFlash26_Timer:FlashLevel19 = 1 : FlasherFlash19_Timer:sw6.timerinterval=400:sw6.timerenabled=1 
    If Starpic=0 Then
			Dim x
			x = INT(14 * RND(1) )
			Select Case x
...
Sub LeftHole_Hit:bsSaucer.AddBall 0 : playsound "popper_ball":FlashLevel1 = 1 : FlasherFlash1_Timer:FlashLevel4 = 1 : FlasherFlash4_Timer:sw5.timerinterval=400:sw5.timerenabled=1 
      If Starpic=0 Then
			Dim x
			x = INT(14 * RND(1) )
			Select Case x
...
Sub Drain_Hit:bsTrough.addball me : playsound"drain" :BBB=0:AAA=0:BIP=0:FlashLevel21 = 1 : FlasherFlash21_Timer:Flasherlight30.IntensityScale = 0:Flasherlight31.IntensityScale = 0:Flasherlight32.IntensityScale = 0:Flasherlight33.IntensityScale = 0:Flasherlight34.IntensityScale = 0:Flasherlight35.IntensityScale = 0:Flasherlight36.IntensityScale = 0
      If Starpic=0 Then
			Dim x
			x = INT(22 * RND(1) )
			Select Case x
...
'Lower Trigger wires
Sub sw4_Hit:Controller.Switch(4)=1 : playsound"rollover" :PlaySound"0ESBC05":FlashLevel10 = 1 : FlasherFlash10_Timer:FlashLevel27 = 1 : FlasherFlash27_Timer: End Sub
...
sw4.timerenabled=0
End sub
Sub sw5_Hit:Controller.Switch(5)=1 : playsound"rollover" :PlaySound"0ESBC05":FlashLevel9 = 1 : FlasherFlash9_Timer:FlashLevel27 = 1 : FlasherFlash27_Timer: End Sub
Sub sw5_UnHit:Controller.Switch(5)=0:End Sub
Sub sw5_timer
    FlashLevel1 = 1 : FlasherFlash1_Timer:FlashLevel4 = 1 : FlasherFlash4_Timer

End sub 
Sub sw6_Hit:Controller.Switch(6)=1 : playsound"rollover":FlashLevel10 = 1 : FlasherFlash10_Timer
    Dim x
    x = INT(2 * RND(1) )
    Select Case x
...
End sub 
Sub sw12_Hit:Controller.Switch(12)=1 : playsound"rollover" :PlaySound"0ESB00r":FlashLevel10 = 1 : FlasherFlash10_Timer: End Sub
...
End sub
Sub sw17_Hit:Controller.Switch(17)=1 : playsound"rollover":FlashLevel9 = 1 : FlasherFlash9_Timer
    Dim x
    x = INT(2 * RND(1) )
    Select Case x
    Case 0:PlaySound"0ESB00q"
...
End sub
Sub sw29_Hit:Controller.Switch(29)=1 : playsound"rollover" :PlaySound"0ESB00r":FlashLevel9 = 1 : FlasherFlash9_Timer: End Sub
...
End sub
'Top wire triggers
Sub sw11_Hit:Controller.Switch(11)=1 : playsound"rollover":FlashLevel6 = 1 : FlasherFlash6_Timer
    Dim x
    x = INT(2 * RND(1) )
    Select Case x
    Case 0:PlaySound"0ESB00q"
...
sw11.timerenabled=0
End sub
Sub sw13_Hit:Controller.Switch(13)=1 : playsound"rollover":FlashLevel6 = 1 : FlasherFlash6_Timer
    Dim x
    x = INT(2 * RND(1) )
    Select Case x
    Case 0:PlaySound"0ESB00q"
...
Sub sw14_Hit:Controller.Switch(14)=1 : playsound"rollover":FlashLevel2 = 1 : FlasherFlash2_Timer
    Dim x
    x = INT(2 * RND(1) )
    Select Case x
    Case 0:PlaySound"0ESB00q"
...
sw14.timerenabled=0
End sub
Sub sw15_Hit:Controller.Switch(15)=1 : playsound"rollover":FlashLevel2 = 1 : FlasherFlash2_Timer
    Dim x
    x = INT(2 * RND(1) )
    Select Case x
    Case 0:PlaySound"0ESB00q"
...
Sub sw39_Hit:Controller.Switch(39)=1 : playsound"rollover" 
...
'Spinners
  Sub Spinner1_Spin():vpmTimer.pulsesw 7 : playsound"fx_spinner" :FlashLevel25 = 1 : FlasherFlash25_Timer:FlashLevel20 = 1 : FlasherFlash20_Timer:FlashLevel2 = 1 : FlasherFlash2_Timer:FlashLevel27 = 1 : FlasherFlash27_Timer: End Sub
  Sub Spinner2_Spin():vpmTimer.pulsesw 8 : playsound"fx_spinner" :FlashLevel1 = 1 : FlasherFlash1_Timer:FlashLevel4 = 1 : FlasherFlash4_Timer:FlashLevel6 = 1 : FlasherFlash6_Timer:FlashLevel27 = 1 : FlasherFlash27_Timer: End Sub
