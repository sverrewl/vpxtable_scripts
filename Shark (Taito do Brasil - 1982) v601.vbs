...
' VPX8 - version by JPSalas 2025, version 6.0.1
...
Sub table1_Init
  vpmInit me
    With Controller
        ...
        .SplashInfoLine = "Shark - Taito 1982" & vbNewLine & "VPX table by JPSalas v6.0.1"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub SolLockRelease(Enabled)
    If Enabled Then
        Lock1a.Isdropped = 1:Lock2a.Isdropped = 1:Lock3a.Isdropped = 1:PlaySoundAt "fx_solenoidon",sw40a2
    Else
     Lock1a.TimerEnabled = 1
    End If
End Sub

Sub Lock1a_Timer
   Me.TimerEnabled = 0
   Lock1a.Isdropped = 0:Lock2a.Isdropped = 0:Lock3a.Isdropped = 0:PlaySoundAt"fx_solenoidoff",sw40a2
End Sub
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    ' English Apron
    x = Table1.Option("English Apron", 0, 1, 1, 0, 0, Array("No", "Yes") )
    if x Then apron.image = "plastics_eng" Else apron.image="plastics" End If
End Sub
