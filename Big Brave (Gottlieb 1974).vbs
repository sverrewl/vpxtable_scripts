...
Sub RightSlingShot1_Timer
    Select Case LStep
        ...
        Case 4:LSLing2.Visible = 0:LSling.Visible = 1:sling2.TransZ = 0:RightSlingShot1.TimerEnabled = 0
    End Select
    LStep = LStep + 1
End Sub
...
Sub Bumper1_Hit
	If TableTilted=false then
		...
		PlaySoundAtVol SoundFXDOF("bumper1",105,DOFPulse,DOFContactors), Bumper1, VolBump
'		DOF 105, DOFPulse
		bump1 = 1
...
Sub Bumper2_Hit
	If TableTilted=false then
		...
		PlaySoundAtVol SoundFXDOF("bumper1",106,DOFPulse,DOFContactors), Bumper2, VolBump
'		DOF 106, DOFPulse
		bump2 = 1
...
Sub ResetDrops
	...
	PlaySoundAtVol"dropsup", Target5, 1
	DropTargetCounter=0
