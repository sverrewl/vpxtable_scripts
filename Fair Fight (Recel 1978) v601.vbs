...
'           Fair Fight - Recel 1978 - version 6.0.1
'Fair Fight / IPD No. 808 / May, 1978 / 4 Players
...
' Valores Constants
Const TableName = "Fair Fight"
Const cGameName = "Fair Fight"
Const MaxPlayers = 4    ' de 1 a 4
Const MaxMultiplier = 2 ' limita el bonus multiplicador a 5
...
Sub BonusCountTimer_Timer 'añade los bonos y actualiza las luces
    ...
    If Bonus > 0 Then
        If Bonus MOD 5 = 0 Then
            PlaySound"BeepBonus2"
        Else
            PlaySound"BeepBonus1"
        End If
        Bonus = Bonus -1
...
Sub UpdateBonusLights 'enciende o apaga las luces de los bonos según la variable "Bonus"
    Select Case Bonus
        Case 0:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 0
        Case 1:li14.State = 1:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 0
        Case 2:li14.State = 0:li15.State = 1:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 0
        Case 3:li14.State = 0:li15.State = 0:li16.State = 1:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 0
        Case 4:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 1:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 0
        Case 5:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 1:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 0
        Case 6:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 1:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 0
        Case 7:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 1:li21.State = 0:li22.State = 0:li23.State = 0
        Case 8:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 1:li22.State = 0:li23.State = 0
        Case 9:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 1:li23.State = 0
        Case 10:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 1
        Case 11:li14.State = 1:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 1
        Case 12:li14.State = 0:li15.State = 1:li16.State = 0:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 1
        Case 13:li14.State = 0:li15.State = 0:li16.State = 1:li17.State = 0:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 1
        Case 14:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 1:li18.State = 0:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 1
        Case 15:li14.State = 0:li15.State = 0:li16.State = 0:li17.State = 0:li18.State = 1:li19.State = 0:li20.State = 0:li21.State = 0:li22.State = 0:li23.State = 1
    End Select
End Sub
...
Sub AwardExtraBall()
    If NOT bExtraBallWonThisBall Then
        PlaySound SoundFXDOF ("", 130, DOFPulse, DOFKnocker)
        DOF 230, DOFPulse
        DOF 125, DOFOn
    Playsound "Sino"
        ExtraBallsAwards(CurrentPlayer) = ExtraBallsAwards(CurrentPlayer) + 1
...
Sub AwardSpecial()
    PlaySound SoundFXDOF ("SinoSpecial", 130, DOFPulse, DOFKnocker)
    DOF 230, DOFPulse
    DOF 125, DOFOn
...
Sub ResetNewBallVariables() 'inicia las variable para una bola ó jugador nuevo
    ...
    ABCDCompleted = 0
    For each x in aTargets  'reset targets value
        x.UserValue = 0
    Next
End Sub
...
Sub LeftSlingShot_Slingshot
    If Tilted Then Exit Sub
    PlaySoundAtBall SoundFXDOF ("left_slingshot",103,DOFPulse,DOFcontactors)
    DOF 203, DOFPulse
  PlaySound "BeepSlingshot"
...
Sub RightSlingShot_Slingshot
    If Tilted Then Exit Sub
    PlaySoundAtBall SoundFXDOF ("right_slingshot",104,DOFPulse,DOFcontactors)
    DOF 204, DOFPulse
  PlaySound "BeepSlingshot"
    If Epileptikdof = True Then DOF 201, DOFPulse End If
...
'**************************
'  Gomas de 10 o 100 puntos
'**************************

Sub rsband001_Hit
    If NOT Tilted Then
  PlaySound "Beep 3 Agudo"
        ' añade 10 puntos
        AddScore 10
    End If
End Sub
...
Sub Bumper2_Hit
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF ("fx_Bumper",117,DOFPulse,DOFContactors), bumper2
    DOF 207, DOFPulse
  PlaySound "Beep"
    If Epileptikdof = True Then DOF 201, DOFPulse End If
    ' añade algunos puntos
...
Sub Trigger5_Hit ' pasillo superior izquierdo
    PlaySoundAt "fx_sensor", Trigger5
    DOF 215, DOFPulse
  PlaySound "Beep 1 Normal"
    If Tilted Then Exit Sub
    If li9.State Then
        AddScore 30000
    Else
    ...
    If li7.State Then
        ...
        Target5.UserValue = 0
        Target6.UserValue = 0
        Target11.UserValue = 0
        Target11.UserValue = 0
    End If
End Sub

Sub Trigger6_Hit ' pasillo superior derecho
...
Sub Trigger7_Hit ' pasillo lateral izquierdo
...
Sub Trigger8_Hit ' pasillo lateral derecho
...
Sub CheckAtargets
    If Target5.UserValue + Target6.UserValue = 2 Then
        li11.State = 1
    End If
End Sub

'B lits the left rollover
...
Sub CheckBtargets
    If Target11.UserValue + Target11.UserValue = 2 Then
        li9.State = 1
    End If
End Sub

Sub CheckABtargets
    If li9.State + li11.State = 2 Then 'A + B completed. Enable middle left rollover for 30.000 points and double bonus
        li3.State = 1
        li1.State = 1
    End If
End Sub

'C lits the right rollover
...
Sub CheckCtargets
    If Target10.UserValue + Target9.UserValue = 2 Then
        li10.State = 1
    End If
End Sub

Sub CheckCDtargets
    If li10.State + li12.State = 2 Then 'C + D completed. Enable middle right rollover for 30.000 points and double bonus
        li6.State = 1
        li2.State = 1
    End If
End Sub
...
Sub CheckDtargets
    If Target7.UserValue + Target8.UserValue = 2 Then
        li12.State = 1
    End If
End Sub

Sub CheckABCDtargets
    If ABCDCompleted = 0 Then
        if li3.State + li11.State + li12.State + li6.State = 4 Then 'first time ABCD completed then turn on extra ball
            If LeftCenterT.IsDropped = 0 Then
                li4.State = 1
            Else
                li5.State = 1
            End If
            ABCDCompleted = 1
            For each x in aTargets 'reset targets value ready for 2nd round
                x.UserValue = 0
            Next
        End If
    Else 'ABCD has been completed once
        'check AB targets
        If Target5.UserValue + Target6.UserValue + Target11.UserValue + Target11.UserValue = 4 Then 'AB has been completed for the second time, turn on left special
            li7.State = 1
        End If
        'check CD targets
        If Target7.UserValue + Target8.UserValue + Target9.UserValue + Target10.UserValue = 4 Then 'CD has been completed for the second time, turn on rightt special
            li8.State = 1
        End If
    End If
End Sub
...
Sub LeftCenterT_Hit
  ...
  PlaySound "Beep 4 Grave"
    ...
    If li4.State = 1 Then
        ...
        li4.State = 0
    End If
    LeftCenterT.IsDropped = 1
    LeftCenterT1.IsDropped = 1
    LeftCenterP.Y = 814
    RightCenterT.IsDropped = 0
    RightCenterT1.IsDropped = 0
    RightCenterP.Y = 842
End Sub

Sub RightCenterT_Hit
    PlaySoundAtBall SoundFXDOF ("fx_target", 109, DOFPulse, DOFTargets)
    If Tilted Then Exit Sub
    DOF 229, DOFPulse
  PlaySound "Beep 4 Grave"
    ...
    If li5.State = 1 Then
        ...
        li4.State = 1
    End If
    LeftCenterT.IsDropped = 0
    LeftCenterT1.IsDropped = 0
    LeftCenterP.Y = 842
    RightCenterT.IsDropped = 1
    RightCenterT1.IsDropped = 1
    RightCenterP.Y = 814
End Sub
...
Sub Spinner1_Spin:PlaySoundAt "fx_spinner", Spinner1:Addscore 100:DOF 226, DOFPulse:PlaySound "Beep 3 Agudo":End Sub
Sub Spinner2_Spin:PlaySoundAt "fx_spinner", Spinner2:Addscore 100:DOF 225, DOFPulse:PlaySound "Beep 3 Agudo":End Sub
