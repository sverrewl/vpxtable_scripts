' Bob Cuspe - based on Drakor / IPD No. 4569 / Taito / 1979 / 4 Players
...
Dim bsTrough, dtbank1, dtbank2, bsLeftSaucer, LeftMagnet,  cbleft, cbRight, x
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Bob Cuspe - Drakor - Taito 1979" & vbNewLine & "VPX table by JPSalas v6.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    vpmNudge.TiltObj = Array(Bumper2, Bumper3, LeftSlingshot, RightSlingshot)
...
Sub sw002_Hit:PlaySoundAt "fx_sensor", sw002:End Sub
