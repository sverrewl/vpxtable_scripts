...
Const VolDiv = 100     ' Lower numper louder ballrolling sound
Const VolCol = 10      ' Ball collition divider ( voldiv/volcol )

Const ColEnabled = 0   ' Disable ball collition ( because of trapped balls on table )
...
Const VolRH     = 1.5  ' Rubber hits volume.
...
'***********************************************************************
	...
	CoffinMod = 1 ' 0 = off, 1 = skulls coffin mod
	SnakeSkin = 2 ' 0 = original release, 1 = snake ramp mod, 2 = nice textured ramps
	LightsMod = 1 ' 0 = off, 1 = color playfield lights
...
'Hole bsRHole - right eject
	...
	If LightsMod = 1 Then
		l37.image = "pf-metallica_premium-4K2color"
		l38.image = "pf-metallica_premium-4K2color"
		l39.image = "pf-metallica_premium-4K2color"
		l40.image = "pf-metallica_premium-4K2color"
		l41.image = "pf-metallica_premium-4K2color"
		l59.image = "pf-metallica_premium-4K2color"
		l60.image = "pf-metallica_premium-4K2color"
		l61.image = "pf-metallica_premium-4K2color"
		l62.image = "pf-metallica_premium-4K2color"
	Else
		l37.image = "pf-metallica_premium-4K"
		l38.image = "pf-metallica_premium-4K"
		l39.image = "pf-metallica_premium-4K"
		l40.image = "pf-metallica_premium-4K"
		l41.image = "pf-metallica_premium-4K"
		l59.image = "pf-metallica_premium-4K"
		l60.image = "pf-metallica_premium-4K"
		l61.image = "pf-metallica_premium-4K"
		l62.image = "pf-metallica_premium-4K"
	End If
...
Sub table_KeyUp(ByVal keycode)
    ...
    If keycode = PlungerKey Then
		Plunger.Fire
        PlaySoundAtVol "Plunger", Plunger, 2
	End If
End Sub
...
PlaySoundAtVol SoundFX("DTC",DOFDropTargets), sw60, 2
End sub

Sub sw61_hit
sw61.Isdropped=True
Controller.switch (61)= 0
PlaySoundAtVol SoundFX("DTC",DOFDropTargets), sw61, 2
End sub

Sub sw62_hit
sw62.Isdropped=True
Controller.switch (62)= 0
PlaySoundAtVol SoundFX("DTC",DOFDropTargets), sw62, 2
End sub
...
Sub resetinline(Enabled)
	If Enabled Then
		...
		Controller.switch (62)=1
		PlaySoundAtVol SoundFX("DTReset",DOFContactors), sw62, 2
	End If
 End Sub
...
Sub sw54_Timer()
	PlaySoundAt SoundFX("popper_ball", DOFContactors), sw54
    sw54.Kick 195, 32
...
Sub SolSparkyHead(Enabled)
    If Enabled Then
        SparkyShake
        PlaysoundAtVol "SmallSol", sparkyhead, 2
    End If
End Sub
...
Sub SolRFlipper(Enabled)
     If Enabled Then
		 PlaySoundAtVol SoundFX("FlipperUpRight",DOFFlippers), RightFlipper, VolFlip
...
Sub Kicker1_Hit
	PlaysoundAtVol "ScoopLeft", Kicker1, 2
End Sub
...
Sub sw1_Hit:Controller.Switch(1) = 1:PlaySoundAt "sensor",sw1:End Sub
Sub sw1_UnHit:Controller.Switch(1) = 0:End Sub
Sub sw3_Hit:Controller.Switch(3) = 1:PlaySoundAt "sensor",sw3:End Sub
Sub sw3_UnHit:Controller.Switch(3) = 0:End Sub
Sub sw4_Hit:vpmTimer.PulseSw 4:PlaySoundAtVol SoundFX("target",DOFTargets), sw4, VolTarg:End Sub
Sub sw7_Hit:vpmTimer.PulseSw 7:PlaySoundAtVol SoundFX("target",DOFTargets), sw7, VolTarg:End Sub
Sub sw9_Hit:vpmTimer.PulseSw 9:PlaySoundAtVol SoundFX("target",DOFTargets), sw9, VolTarg:End Sub
Sub sw23_Hit:Controller.Switch(23) = 1:PlaySoundAt "sensor", sw23:End Sub
Sub sw23_UnHit:Controller.Switch(23) = 0:End Sub
Sub sw24_Hit:Controller.Switch(24) = 1:PlaySoundAt "sensor", sw24:End Sub
Sub sw24_UnHit:Controller.Switch(24) = 0:End Sub
Sub sw25_Hit:Controller.Switch(25) = 1:PlaySoundAt "sensor", sw25:End Sub
Sub sw25_UnHit:Controller.Switch(25) = 0:End Sub
Sub sw28_Hit:Controller.Switch(28) = 1:PlaySoundAt "sensor", sw28:End Sub
Sub sw28_UnHit:Controller.Switch(28) = 0:End Sub
Sub sw29_Hit:Controller.Switch(29) = 1:PlaySoundAt "sensor", sw29:End Sub
Sub sw29_UnHit:Controller.Switch(29) = 0:End Sub
Sub sw35_Hit:vpmTimer.PulseSw 35:PlaySoundAtVol SoundFX("target",DOFTargets), sw35, VolTarg:End Sub
Sub sw36_Hit():playsoundAtVol SoundFX("target",DOFTargets), sw36, VolTarg:vpmTimer.PulseSw 36:End Sub
Sub sw37_Hit():playsoundAtVol SoundFX("target",DOFTargets), sw37, VolTarg:vpmTimer.PulseSw 37:End Sub
Sub Lspinner_Spin():vpmTimer.PulseSW 38:End Sub
Sub Rspinner_Spin():vpmTimer.PulseSW 39:End Sub
Sub sw40_Hit():playsoundAtVol SoundFX("target",DOFTargets), sw40, VolTarg:vpmTimer.PulseSw 40:End Sub
Sub sw41_Hit():playsoundAtVol SoundFX("target",DOFTargets), sw41, VolTarg:vpmTimer.PulseSw 41:End Sub

Sub sw42_Hit()
	playsoundAtVol "target", sw42, VolTarg
	vpmTimer.PulseSw 42
	sw42.HasHitEvent = 0
	sw42.timerenabled = 1
End Sub
...
Sub sw43_Hit:Controller.Switch(43) = 1:PlaySoundAt "sensor", sw43:End Sub
Sub sw43_UnHit:Controller.Switch(43) = 0:End Sub
Sub sw44_Hit:Controller.Switch(44) = 1:PlaySoundAt "sensor", sw44:End Sub
Sub sw44_UnHit:Controller.Switch(44) = 0:End Sub
Sub sw45_Hit:Controller.Switch(45) = 1:PlaySoundAt "sensor", sw45:End Sub
Sub sw45_UnHit:Controller.Switch(45) = 0:End Sub
Sub sw46_Hit:Controller.Switch(46) = 1:PlaySoundAt "sensor", sw46:End Sub
Sub sw46_UnHit:Controller.Switch(46) = 0:End Sub
Sub sw47g_hit:PlaysoundAtVol "Gate", sw47g,VolGates:vpmTimer.PulseSw 47:PlaySoundAtVol "RightRampWire", ActiveBall,2:End Sub
Sub sw50g_hit:PlaysoundAtVol "Gate", sw50g,VolGates:vpmTimer.PulseSw 50:PlaysoundAtVol "LeftRampWire", ActiveBall, 2:End Sub
Sub sw52_Hit:Controller.Switch(52)=1:End Sub
Sub sw52_unHit:Controller.Switch(52)=0:End Sub
Sub sw53_Hit:vpmTimer.PulseSw 53:End Sub
Sub sw54_Hit:Controller.Switch(54) = 1:Playsoundatvol "kicker_enter_center", sw54, 3: End Sub
Sub JawLatch_Hit:playsoundatvol "target", Primitive19, VolTarg:Controller.Switch(55) = 1:me.TimerEnabled = 1:End Sub
...
Sub LeftSlingShot_Slingshot
	...
	Controller.Switch(26) = 1
 	PlaySoundAt Soundfx("left_slingshot",DOFContactors),Left2:LeftSlingshot.TimerEnabled = 1
  End Sub
...
Dim Leftsling:Leftsling = False
 ...
 Sub RightSlingShot_Slingshot
	...
	Controller.Switch(27) = 1
 	PlaySoundAt Soundfx("right_slingshot",DOFContactors), Right2:RightSlingshot.TimerEnabled = 1
  End Sub
...
Sub RightSlingShot_Timer:Me.TimerEnabled = 0:Controller.Switch(27) = 0:End Sub
    ...
    End With
      ...
      Sub Bumper1b_Hit
      vpmTimer.PulseSw 31
      PlaySoundAtVol SoundFX("fx_bumper1",DOFContactors), Bumper1b, VolBump
    	End Sub


      Sub Bumper2b_Hit
      vpmTimer.PulseSw 30
      PlaySoundAtVol SoundFX("fx_bumper1",DOFContactors), Bumper2b, VolBump
       End Sub

      Sub Bumper3b_Hit
      vpmTimer.PulseSw 32
      PlaySoundAtVol SoundFX("fx_bumper1",DOFContactors), Bumper3b, VolBump
       End Sub
...
Sub Pins_Hit (idx)
	PlaySound "pinhit_low", 0, Vol(ActiveBall)*VolRH, Pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0, AudioFade(ActiveBall)
End Sub
    ...
    For b = 0 to UBound(BOT)
      If BallVel(BOT(b) ) > 1 Then
        ...
        Else ' Ball on raised ramp
          PlaySound("fx_ballrolling" & b), -1, Vol(BOT(b) )*.7, Pan(BOT(b) ), 0, Pitch(BOT(b) )+50000, 1, 0, AudioFade(BOT(b) )
        End If
      Else
...
' Thalamus, disable due to trapped balls for now.

Sub OnBallBallCollision(ball1, ball2, velocity)
	if ColEnabled = 1 then
...
Sub leftdrop2_Hit:
	If leftdrop = 1 then
		PlaySoundAt "drop_left", leftdrop2
	End If
	StopSound "RightRamp"
	leftdrop = 0
End Sub
...
Sub rightdrop2_Hit
	If rightdrop = 1 then
		PlaySoundAt "drop_Right", rightdrop2
	End If
	StopSound "RightRamp"
	rightdrop = 0
End Sub
...
Sub RRamp_Hit
	Playsound "RightRampMetal", 0, Vol(ActiveBall)*VolMetal, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
End Sub

Sub LRamp_Hit
	Playsound "LeftRampMetal", 0, Vol(ActiveBall)*VolMetal, Pan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
End Sub
