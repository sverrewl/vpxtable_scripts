...
' VPX8 table by jpsalas & Halen on the graphics & db2s. version 6.0.1
...
Dim LUTImage, BallsPerGame, bResetBonus
...
Sub Table1_OptionEvent(ByVal eventId)
    ...
    ' Reset Bonus
    x = Table1.Option("Reset Bonus when new ball", 0, 1, 1, 1, 0, Array("No", "Yes") )
    If x = 1 Then bResetBonus = True Else bResetBonus = False
End Sub
