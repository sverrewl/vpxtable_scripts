' ******************************************************************
'     VPX 10.8 - version by Klodo81 2023, Mars Trek version 3.0
'
'                     Based on:
'                     JPSalas Basic EM script
'                       JPSalas VPX8 Physics V3.1
'
'          Mars Trek / IPD No.1550 / August,1977 / 4 Players
'
' ******************************************************************
'
'V1.1 mod Table
'- Mod Rev3 Physics from JPSalas
'- Mod script sequence lights alternate
'- Mod 3D playfield Mesh + new kickers
'- Reduced max ball velocity
'
'V1.2 mod Table and V1.1 mod B2S
'- New LUT from JPSalas
'- Updated Playfield Mesh
'- New images plastics
'- Added "Same player shoots again" on Backglass DT
'- Added light on score display on B2S
'- Some others things
'
'V2.0 mod Table
...
' Slingshots L/R - 105/106
' Bumpers L to R - 103/104
' Kickers - 118/119/106
' Targets Round - 121/133
' Knocker - 107
' Chimes - 301/302/303
' Drain - 134
...
' Constants
Const TableName = "MarsTrek_77VPX"   ' file name to save highscores and other variables
Const cGameName = "marstrek"   ' B2S and DOF name
...
Const Special4 = 490000      ' 5 Balls award credit
Const Special5 = 570000      ' 5 Balls award credit
...
Sub BonusCountTimer_Timer 'The bonus are count when the ball is lost And Kicker
    ...
    Else
      KickerTBonus = 0
      vpmtimer.addtimer 300, "PlaySoundAt SoundFXDOF (""fx_kicker"", 119, DOFPulse, DOFContactors), kickerR : kickerR.kick 207, 10 + RndNbr(3) '"
    End If
    End If
End Sub
...
Sub Verification_Match()
  Playsound"fx_match"
    ...
    Display_Match
    If(Score(1) MOD 1000) = Match * 100 Then
        AwardSpecial
    End If
    If PlayersPlayingGame = 1 then Exit Sub
    If(Score(2) MOD 1000) = Match * 100 Then
         AwardSpecial
    End If
    If PlayersPlayingGame = 2 then Exit Sub
    If(Score(3) MOD 1000) = Match * 100 Then
         AwardSpecial
    End If
    If PlayersPlayingGame = 3 then Exit Sub
    If(Score(4) MOD 1000) = Match * 100 Then
        AwardSpecial
    End If
End Sub
...
Sub AddScore(Points)
    ...
    Select Case Points
      ...
      If Points = 10000 Then
                PlaySound SoundFXDOF ("chime10000sonic", 303, DOFPulse, DOFChimes)
      ElseIf Points = 1000 Then
                PlaySound SoundFXDOF ("chime1000sonic", 302, DOFPulse, DOFChimes)
      ElseIf Points = 100 Then
                PlaySound SoundFXDOF ("chime100sonic", 301, DOFPulse, DOFChimes)
            End If
...
Sub AddBonus
  ...
  If Bonus < 10 Then
    ...
    If Bonus = 5 then
      LightEB1.State = 1 : LightEB2.State = 1
    Else
      LightEB1.State = 0 : LightEB2.State = 0
    End If
    Alternate
    End If
End Sub
...
Sub AwardSpecial()
    PlaySound SoundfXDOF ("fx_knocker", 107, DOFPulse, DOFKnocker)
    AddCredits 1
End Sub
...
Sub GameTimer_Timer
  Dim SpinnerRadius1: SpinnerRadius1=7
  SpinnerRod1.TransZ = (cos((spinner1.CurrentAngle + 180) * (PI/180))+1) * SpinnerRadius1
  SpinnerRod1.TransY = sin((spinner1.CurrentAngle) * (PI/180)) * -SpinnerRadius1
  Dim SpinnerRadius2: SpinnerRadius2=7
  SpinnerRod2.TransZ = (cos((spinner2.CurrentAngle + 180) * (PI/180))+1) * SpinnerRadius2
  SpinnerRod2.TransY = sin((spinner2.CurrentAngle) * (PI/180)) * -SpinnerRadius2
End Sub
...
Sub ResetNewBallLights()    'init lights for new ball/player
  ...
  TurnOnNewBallLights()
  UpdateBonusLights()
  If bAlternate = True then vpmtimer.addtimer 400, "Alternate '"
End Sub
...
Sub LeftSlingShot_Slingshot   'left slingshot
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF ("fx_slingshot",105,DOFPulse,DOFcontactors), Lemk
...
Sub RightSlingShot_Slingshot    'right slingshot
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF ("fx_slingshot",106,DOFPulse,DOFcontactors), Remk
...
Sub RubberBand001_Timer
    Select Case Rub1
        Case 1:r009.Visible = 0:r005.Visible = 1:RubberBand001.TimerEnabled = 1
        Case 2:r005.Visible = 0:r006.Visible = 1
        Case 3:r006.Visible = 0:r009.Visible = 1:RubberBand001.TimerEnabled = 0
    End Select
    Rub1 = Rub1 + 1
End Sub
...
Sub RubberBand002_Timer
    Select Case Rub2
        Case 1:r010.Visible = 0:r014.Visible = 1:RubberBand002.TimerEnabled = 1
        Case 2:r014.Visible = 0:r015.Visible = 1
        Case 3:r015.Visible = 0:r010.Visible = 1:RubberBand002.TimerEnabled = 0
    End Select
    Rub2 = Rub2 + 1
End Sub
...
Sub RubberBand003_Timer
    Select Case Rub3
        Case 1:r010.Visible = 0:r011.Visible = 1:RubberBand003.TimerEnabled = 1
        Case 2:r011.Visible = 0:r013.Visible = 1
        Case 3:r013.Visible = 0:r010.Visible = 1:RubberBand003.TimerEnabled = 0
    End Select
    Rub3 = Rub3 + 1
End Sub
...
Sub RubberBand004_Timer
    Select Case Rub4
        Case 1:r016.Visible = 0:r019.Visible = 1:RubberBand004.TimerEnabled = 1
        Case 2:r019.Visible = 0:r020.Visible = 1
        Case 3:r020.Visible = 0:r016.Visible = 1:RubberBand004.TimerEnabled = 0
    End Select
    Rub4 = Rub4 + 1
End Sub
...
Sub RubberBand005_Timer
    Select Case Rub5
        Case 1:r016.Visible = 0:r021.Visible = 1:RubberBand005.TimerEnabled = 1
        Case 2:r021.Visible = 0:r022.Visible = 1
        Case 3:r022.Visible = 0:r016.Visible = 1:RubberBand005.TimerEnabled = 0
    End Select
    Rub5 = Rub5 + 1
End Sub
...
Sub RubberBand007_Timer
    Select Case Rub6
        Case 1:r016.Visible = 0:r023.Visible = 1:RubberBand007.TimerEnabled = 1
        Case 2:r023.Visible = 0:r024.Visible = 1
        Case 3:r024.Visible = 0:r016.Visible = 1:RubberBand007.TimerEnabled = 0
    End Select
    Rub6 = Rub6 + 1
End Sub
...
Sub Bumper001_Hit 'left
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF ("fx_Bumper",104,DOFPulse,DOFContactors), bumper001
    If LightBumper001.State = 1 Then AddScore 1000 Else AddScore 100
End Sub

Sub Bumper002_Hit ' center
    If Tilted Then Exit Sub
    PlaySoundAt SoundFXDOF ("fx_Bumper",103,DOFPulse,DOFContactors), bumper002
    If LightBumper002.State = 1 Then AddScore 1000 Else AddScore 100
End Sub
...
Sub Trigger001_Hit  'Left Special
    If Tilted Then Exit Sub
...
Sub Trigger002_Hit 'Left/Right E
    If Tilted Then Exit Sub
  Addscore 5000
  AddBonus
  If LightE1.State = 1 Then
    LightE1.State = 0
    LightE2.State = 0
    LightE.State = 1
  End If
...
Sub Trigger003_Hit 'Right/Left K
    If Tilted Then Exit Sub
  Addscore 5000
  AddBonus
  If LightK1.State = 1 Then
    LightK1.State = 0
    LightK2.State = 0
    LightK.State = 1
  End If
...
Sub Trigger004_Hit  'Right Special
...
Sub Trigger010_Hit 'Center Left
    If Tilted Then Exit Sub
  Addscore 1000
  AddBonus
End Sub

Sub Trigger011_Hit 'Center Right
    If Tilted Then Exit Sub
  Addscore 1000
  AddBonus
End Sub

Sub Trigger012_Hit 'Top left
    If Tilted Then Exit Sub
  Addscore 5000
  AddBonus
End Sub

Sub Trigger015_Hit 'Run-Way
    If Tilted Then Exit Sub
  If LightEB1.State = 1 And LightEB2.State = 1 And LightShootAgain.State = 0 Then
    AwardExtraBall
    LightEB1.State = 0 : LightEB2.State = 0
  Else
    Addscore 5000
...
Sub TargetM_hit
  ...
  DOF 121, DOFPulse
    If Tilted Then Exit Sub
  If LightMARS.State = 1 Then Addscore 10000 Else AddScore 1000
  If LightM1.State = 1 Then
    LightM1.State = 0
    LightM.State = 1
  End If
  CheckMARS
...
Sub TargetEK_hit
  ...
  DOF 133, DOFPulse
    If Tilted Then Exit Sub
  If LightTREK.State = 1 Then Addscore 10000 Else AddScore 1000
  If LightE2.State = 1 Then
    LightE1.State = 0
    LightE2.State = 0
    LightE.State = 1
  End If
  If LightK2.State = 1 Then
    LightK1.State = 0
    LightK2.State = 0
    LightK.State = 1
  End If
...
Sub KickerR_Hit
  ...
  End Select
  CBonus = 0
  LightSP1.State = 0 : LightSP2.State = 0
    BonusCountTimer.Enabled = 1
End Sub
...
Sub KickerT_Hit
  ...
  If Tilted Then
    ...
    End If
  AddScore 5000
  If LightT1.State = 1 Then
    LightT1.State = 0
    LightT2.State = 0
    LightT.State = 1
  End If
  If LightRR1.State = 1 Then
    LightRR1.State = 0
    LightRR2.State = 0
    LightRR.State = 1
  End If
  AddBonus
  CheckTREK
  vpmtimer.addtimer 1500, "PlaySoundAt SoundFXDOF (""fx_kicker"", 118, DOFPulse, DOFContactors), kickerT : kickerT.kick 170, 10 + RndNbr(3) '"
End Sub

'Kick all ball

Sub KickBall
  PlaySoundAt SoundFXDOF ("fx_kicker", 118, DOFPulse, DOFContactors), kickerT
  kickerR.kick 207, 10 : kickerT.kick 170, 10 '"
End Sub
...
Sub Spinner1_Spin
    If Tilted Then Exit Sub
  If LightSP1.state = 1 then  AddScore 1000 Else  AddScore 100
end sub

Sub Spinner2_Spin
    If Tilted Then Exit Sub
  If LightSP2.state = 1 then  AddScore 1000 Else  AddScore 100
end sub
...
Sub CheckEK()
  If LightE.State = 1 And LightK.State = 1 Then
...
Sub CheckMARS()
  If LightM.State = 1 And LightA.State = 1 And LightR.State = 1 And LightSS.State = 1 Then
    LightMARS.State = 1
    CheckMARSTREK
  End If
End Sub
...
Sub CheckTREK()
  If LightT.State = 1 And LightRR.State = 1 And LightE.State = 1 And LightK.State = 1 Then
    LightTREK.State = 1
    CheckMARSTREK
  End If
End Sub
...
Sub CheckMARSTREK()
  If LightMARS.State = 1 And LightTREK.State = 1 Then
...
Sub Alternate
  If LightE2.State = 0 AND LightE.State = 0 Then LightE2.State = 1 Else LightE2.State = 0
  If LightK2.State = 0 AND LightK.State = 0 Then LightK2.State = 1 Else LightK2.State = 0
  If LightRR1.State = 0 AND LightRR.State = 0 Then LightRR1.State = 1 Else LightRR1.State = 0
  If LightT1.State = 0 AND LightT.State = 0 Then LightT1.State = 1 Else LightT1.State = 0
  If LightBumper001.State = 1 Then
    LightBumper001.State = 0 : LightBumper002.State = 1
    LightBumper1.State = 0 : LightBumper2.State = 1
    bAlternate = True
  Else
    LightBumper001.State = 1 : LightBumper002.State = 0
    LightBumper1.State = 1 : LightBumper2.State = 0
    bAlternate = False
  End If
  If BL100K.State = 1 Then
    If LightSP1.State = 1 Then
      LightSP1.State = 0 : LightSP2.State = 1
    Else
      LightSP1.State = 1 : LightSP2.State = 0
    End If
  Else
    LightSP1.State = 0 : LightSP2.State = 0
  End If
  If SpecialMarsTrek = 1 Then
    If LightSpecialLeft.State = 1 Then
