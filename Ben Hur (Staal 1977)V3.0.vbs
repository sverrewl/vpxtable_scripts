' ******************************************************************
'       VPX 10.8 - version by Klodo81 2024, Ben Hur version 3.0
'
'                     Based on:
...
Const cGameName = "BenHur1977"   ' B2S name & DOF config
...
Sub Bumper001_Hit
    ...
    If BumperLight.State = 1 Then AddScore 1000 Else AddScore 100
End Sub
...
Sub Target5_hit  'Top Special
  ...
  'Light Special Unlitted + Reset 5 Bonus Targets
...
Sub Target20_hit ' Left
    PlaySoundAt SoundFXDOF ("fx_droptarget", 204, DOFPulse, DOFDropTargets), Target20
    If Tilted Then Exit Sub
...
Sub Target21_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 204, DOFPulse, DOFDropTargets), Target21
    If Tilted Then Exit Sub
  TargetDoubleBonus = TargetDoubleBonus + 1
  CheckDoubleBonus
  If switch1 = 0 Then AddScore 1000
...
Sub Target22_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 204, DOFPulse, DOFDropTargets), Target22
    If Tilted Then Exit Sub
  TargetDoubleBonus = TargetDoubleBonus + 1
  CheckDoubleBonus
  If switch1 = 0 Then AddScore 1000
...
Sub Target23_hit
    PlaySoundAt SoundFXDOF ("fx_droptarget", 204, DOFPulse, DOFDropTargets), Target23
    If Tilted Then Exit Sub
  TargetDoubleBonus = TargetDoubleBonus + 1
  CheckDoubleBonus
  If switch1 = 0 Then AddScore 1000
...
Sub Target24_hit'Right
    PlaySoundAt SoundFXDOF ("fx_droptarget", 204, DOFPulse, DOFDropTargets), Target24
    If Tilted Then Exit Sub
  TargetDoubleBonus = TargetDoubleBonus + 1
  CheckDoubleBonus
  If switch1 = 0 Then AddScore 1000
...
Sub ResetTargetBonus
  ...
  PlaySoundAt SoundFXDOF ("fx_resetdrop", 111, DOFPulse, DOFContactors), Target22
  TargetDoubleBonus = 0
End Sub
...
Sub CheckDoubleBonus()
    'debug.print **
  If  TargetDoubleBonus = 5 And SpecialAwarded = False Then
    ...
    CheckSpecial
  End If
  If  TargetDoubleBonus = 5 And SpecialAwarded = True Then
    CheckSpecial
  End If
End Sub
...
Sub UpdateLights()
  ...
  If LHorseBlack1.State = 1 Then
    ...
    Else
    LHorseBlack1.State = 1
    LHorseBlack2.State = 0
    LHorseBlack3.State = 0
  End If
End Sub
...
'************************************************
'  User Options (Script from VPINWORKSHOP)
'************************************************
